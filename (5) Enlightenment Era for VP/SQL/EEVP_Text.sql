...
('TXT_KEY_BUILDING_EE_ACADEMY_HELP', '+1 [ICON_RESEARCH] Science for every 6 [ICON_CITIZEN] Citizens in the City. Cost of [ICON_GOLD] Gold purchasing in this City reduced by 10%. Receive 15 [ICON_RESEARCH] Science, scaling with Era, and 10 [ICON_GREAT_GENERAL] Great General Points when a [ICON_CITIZEN] Citizen is born in this City.[NEWLINE][NEWLINE]+20% [ICON_GREAT_SCIENTIST] Great Scientist, [ICON_GREAT_ENGINEER] Great Engineer, [ICON_GREAT_MERCHANT] Great Merchant, and [ICON_DIPLOMAT] Great Diplomat rate in the City.[NEWLINE][NEWLINE]City must not contain a [COLOR_NEGATIVE_TEXT]Seminary[ENDCOLOR].'),
...
UPDATE Language_en_US
SET Text = Replace(Text, '+5% [ICON_CULTURE] Culture in the City. [ICON_GREAT_WORK] Great Works in the City produce +1 [ICON_TOURISM] Tourism. +33% [ICON_GREAT_MUSICIAN] Great Musician Rate in the City.', '+1 [ICON_CULTURE] Culture for every 6 [ICON_CITIZEN] Citizens in the City. [ICON_GREAT_WORK] Great Works in the City produce +1 [ICON_TOURISM] Tourism. +33% [ICON_GREAT_MUSICIAN] Great Musician Rate in the City.[NEWLINE][NEWLINE]Nearby [ICON_RES_INCENSE] Incense: +2 [ICON_GOLD] Gold and +1 [ICON_TOURISM] Tourism.[NEWLINE]Nearby [ICON_RES_WINE] Wine: +1 [ICON_FOOD] Food, [ICON_GOLD] Gold, and [ICON_CULTURE] Culture.[NEWLINE]Nearby [ICON_RES_TRUFFLES] Truffles: +1 [ICON_GOLD] Gold and +2 [ICON_TOURISM] Tourism.[NEWLINE]Nearby [ICON_RES_OLIVE] Olives: +1 [ICON_FOOD] Food and [ICON_CULTURE] Culture.[NEWLINE]Nearby [ICON_RES_MARBLE] Marble: +1 [ICON_CULTURE] Culture and [ICON_TOURISM] Tourism.[NEWLINE]Nearby [ICON_RES_TOBACCO] Tobacco: +2 [ICON_GOLD] Gold and +1 [ICON_CULTURE] Culture.')
