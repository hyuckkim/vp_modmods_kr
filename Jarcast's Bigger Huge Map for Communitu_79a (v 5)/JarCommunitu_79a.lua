...
function MapGlobals:New()
	...
	-- Features
	--------------
	mglobal.featurePercent = 0.35; -- Percent of potential feature tiles that actually create a feature (marsh/jungle/forest)
	...
	if Map.GetCustomOption(17) ==2  then
		mglobal.numNaturalWonders = Round(mglobal.numNaturalWonders *1.25)
	elseif Map.GetCustomOption(17) ==3 then
		mglobal.numNaturalWonders = Round(mglobal.numNaturalWonders *1.5)
	elseif Map.GetCustomOption(17) ==4 then
		mglobal.numNaturalWonders = Round(mglobal.numNaturalWonders *2)
	elseif Map.GetCustomOption(17) ==5 then
		mglobal.numNaturalWonders = Round(mglobal.numNaturalWonders *2.7)
	end
...
function GetMapScriptInfo()
	...
	return {
		...
		CustomOptions = {
			...
			{
				Name = "Bigger Huge Map",
				Description = "Changes the size of Huge map only, ratio being equal.",
				Values = {
					"Normal",
					"x1.25 (~14 civs, 41 CS)",
					"x1.5 (~16 civs, 41 CS)",
					"x2 (~19 civs, 41 CS)",
					"Giant Earth-like (x2.7)",
				},
				DefaultValue = 1,
				SortPriority = 13,
			},
...
isJarCommunituMap = false
function GetMapInitData(worldSize)	print("GetMapInitData")
	isJarCommunituMap = true
	print("isJarCommunituMap: ", isJarCommunituMap )
	--x1.25 (2):	109,74  | 122,83
	--x1.5  (3):	119,81	| 133,91
	--x2	(4):	138,93	| 154,105
	--Giant Earth (5): 160,108
	...
	elseif Map.GetCustomOption(17) == 3 then
		...
		[GameInfo.Worlds.WORLDSIZE_STANDARD.ID] = {79, 53},
		[GameInfo.Worlds.WORLDSIZE_LARGE.ID] = {87, 59},
		[GameInfo.Worlds.WORLDSIZE_HUGE.ID] = {119,81}
		}
	elseif Map.GetCustomOption(17) == 4 then
		worldsizes = {
		[GameInfo.Worlds.WORLDSIZE_DUEL.ID] = {39, 28},
		...
		[GameInfo.Worlds.WORLDSIZE_STANDARD.ID] = {79, 53},
		[GameInfo.Worlds.WORLDSIZE_LARGE.ID] = {87, 59},
		[GameInfo.Worlds.WORLDSIZE_HUGE.ID] = {138,93}
		}
	elseif Map.GetCustomOption(17) == 5 then
		worldsizes = {
		[GameInfo.Worlds.WORLDSIZE_DUEL.ID] = {39, 28},
		...
		[GameInfo.Worlds.WORLDSIZE_STANDARD.ID] = {79, 53},
		[GameInfo.Worlds.WORLDSIZE_LARGE.ID] = {87, 59},
		[GameInfo.Worlds.WORLDSIZE_HUGE.ID] = {160,108}
		}
	end
	if Map.GetCustomOption(5) == 1 then
		...
		if Map.GetCustomOption(17) == 2 then
			...
			[GameInfo.Worlds.WORLDSIZE_STANDARD.ID] = {90, 60},
			[GameInfo.Worlds.WORLDSIZE_LARGE.ID] = {99, 66},
			[GameInfo.Worlds.WORLDSIZE_HUGE.ID] = {122,83}
			}
		elseif Map.GetCustomOption(17) == 3 then
			worldsizes = {
			[GameInfo.Worlds.WORLDSIZE_DUEL.ID] = {44, 31},
			...
			[GameInfo.Worlds.WORLDSIZE_STANDARD.ID] = {90, 60},
			[GameInfo.Worlds.WORLDSIZE_LARGE.ID] = {99, 66},
			[GameInfo.Worlds.WORLDSIZE_HUGE.ID] = {133,91}
			}
		elseif Map.GetCustomOption(17) == 4 then
			worldsizes = {
			[GameInfo.Worlds.WORLDSIZE_DUEL.ID] = {44, 31},
			...
			[GameInfo.Worlds.WORLDSIZE_STANDARD.ID] = {90, 60},
			[GameInfo.Worlds.WORLDSIZE_LARGE.ID] = {99, 66},
			[GameInfo.Worlds.WORLDSIZE_HUGE.ID] = {154,105}
			}
		elseif Map.GetCustomOption(17) == 5 then
			worldsizes = {
			[GameInfo.Worlds.WORLDSIZE_DUEL.ID] = {44, 31},
