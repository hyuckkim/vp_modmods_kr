...
INSERT INTO Resources 
			(Type,						TechReveal,		TechCityTrade, 		Description,					Civilopedia, 						Help,	ResourceClassType, 		ArtDefineTag, 					CivilizationType,		OnlyMinorCivs,  Happiness,  IconString, 		PortraitIndex, 	IconAtlas,				LandResource,	PlantResource,	Hills,	Flatlands,	ResourceUsage)
VALUES		('RESOURCE_ROME_FIGS',		null,			null,				'TXT_KEY_RESOURCE_ROME_FIGS',	'TXT_KEY_RESOURCE_ROME_FIGS_TEXT',	null,	'RESOURCECLASS_BONUS',	'ART_DEF_RESOURCE_ROME_FIGS',	'CIVILIZATION_ROME',	0,				0,			'[ICON_RES_FIGS]',	0, 				'RESOURCE_ROME_ATLAS',	1,				1,				1,		1,			0);
------------------------------
...
VALUES		('RESOURCE_ROME_FIGS',	'TERRAIN_PLAINS'),
			('RESOURCE_ROME_FIGS',	'TERRAIN_GRASS'),
			('RESOURCE_ROME_FIGS',	'TERRAIN_TUNDRA'),
			('RESOURCE_ROME_FIGS',	'TERRAIN_DESERT');
------------------------------
-- Resource_FeatureBooleans
------------------------------
INSERT INTO Resource_FeatureBooleans
			(ResourceType,	FeatureType)
VALUES		('RESOURCE_ROME_FIGS',	'FEATURE_FOREST'),
			('RESOURCE_ROME_FIGS',	'FEATURE_JUNGLE'),
			('RESOURCE_ROME_FIGS',	'FEATURE_MARSH'),
			('RESOURCE_ROME_FIGS',	'FEATURE_FLOOD_PLAINS');
------------------------------
