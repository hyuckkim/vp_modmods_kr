...
UPDATE UnitPromotions SET PromotionPrereqOr2 = 'PROMOTION_SHRAPNEL_ROUNDS' WHERE Type = 'PROMOTION_LOGISTICS';
UPDATE UnitPromotions SET PromotionPrereqOr1 = 'PROMOTION_TARGETING_3' WHERE Type = 'PROMOTION_SHRAPNEL_ROUNDS';
