...
-- Longbowman
UPDATE Language_ko_KR 
SET Text = '석궁병을 대체하는 영국의 강력한 지상 원거리 유닛입니다. 더 긴 공격 범위를 제공하는 [COLOR_POSITIVE_TEXT]사거리[ENDCOLOR] 승급과 기마 유닛에 효과적인 [COLOR_PLAYER_PURPLE]무기의 크기[ENDCOLOR] 승급을 보유합니다.'
...
--Coffee House
UPDATE Language_ko_KR
SET Text = ' 매 턴 [ICON_CULTURE]문화의 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR]를 [ICON_RESEARCH]과학으로 전환합니다.[NEWLINE][ICON_GREAT_PEOPLE]위인 출현율이 [COLOR_POSITIVE_TEXT]33%[ENDCOLOR] 증가합니다.[NEWLINE][NEWLINE][ICON_CITIZEN]시민 5명마다 [ICON_FOOD]식량이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. [ICON_CITIZEN]시민이 증가할 때 사용한 [ICON_FOOD]식량의 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR]가 저장됩니다. [NEWLINE][NEWLINE][ICON_GOLD]빈곤에서 오는 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]  감소합니다.[NEWLINE][NEWLINE][ICON_RES_FIGS]무화과: [ICON_GOLD]골드 +1, [ICON_PRODUCTION]생산 +1, [ICON_FOOD]식량 +1.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]송수로[ENDCOLOR]가 있어야 건설이 가능합니다.'
WHERE Tag = 'TXT_KEY_BUILDING_COFFEE_HOUSE_HELP';

--Grocer
UPDATE Language_ko_KR
SET Text = '[ICON_CITIZEN]시민 5명마다 [ICON_FOOD]식량이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. [ICON_CITIZEN]시민이 증가할 때 사용한 [ICON_FOOD]식량의 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR]가 저장됩니다. [NEWLINE][NEWLINE][ICON_GOLD]빈곤에서 오는 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]  감소합니다.[NEWLINE][NEWLINE][ICON_RES_FIGS]무화과: [ICON_GOLD]골드 +1, [ICON_PRODUCTION]생산 +1, [ICON_FOOD]식량 +1.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]송수로[ENDCOLOR]가 있어야 건설이 가능합니다.'
WHERE Tag = 'TXT_KEY_BUILDING_GROCER_HELP';

--Parthenon
UPDATE Language_ko_KR
SET Text = '모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]시장[ENDCOLOR]은 [ICON_CULTURE] 문화가 [COLOR_POSITIVE_TEXT]3[ENDCOLOR] 증가합니다. 도시에서 생산하는 외교 유닛에 [COLOR_POSITIVE_TEXT]{TXT_KEY_PROMOTION_NOBILITY}[ENDCOLOR] 승급을 부여합니다.[NEWLINE][NEWLINE]무료 [COLOR_YELLOW]특사[ENDCOLOR]가 2명 출현합니다. 외교 유닛을 생산할 때 [ICON_PRODUCTION] 생산보너스를 [COLOR_POSITIVE_TEXT]25%[ENDCOLOR] 제공합니다.[NEWLINE][NEWLINE][ICON_RES_PAPER]종이 [COLOR_POSITIVE_TEXT]2개[ENDCOLOR]를 제공합니다. [NEWLINE][NEWLINE][ICON_CITY_STATE] 도시 국가 [COLOR_POSITIVE_TEXT]우호[ENDCOLOR] 보너스: 각각 [ICON_FOOD] 식량 +1[NEWLINE][ICON_CITY_STATE] 도시 국가 [COLOR_CYAN]동맹[ENDCOLOR] 보너스: 각각 [ICON_FOOD] 식량 +1,  [ICON_PEACE]신앙 +1[NEWLINE][NEWLINE]문명에 도시가 많을수록 건설에 필요한[ICON_PRODUCTION] 생산과 [ICON_CITIZEN] 시민이 증가합니다.'
