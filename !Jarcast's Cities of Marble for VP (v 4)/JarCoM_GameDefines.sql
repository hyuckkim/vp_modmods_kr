...
UPDATE Buildings SET NationalPopRequired = 5, NeverCapture=1, Cost = 60,
...
NumCityCostMod = (SELECT NumCityCostMod FROM Buildings WHERE Type = 'BUILDING_FOREIGN_BUREAU'),
Cost = (SELECT round(Cost*1.1) FROM Buildings WHERE Type = 'BUILDING_HERMITAGE'), NationalPopRequired = 40,
PrereqTech = (SELECT PrereqTech FROM Buildings WHERE Type = 'BUILDING_PUBLIC_SCHOOL'),
HurryCostModifier = (SELECT HurryCostModifier FROM Buildings WHERE Type = 'BUILDING_FOREIGN_BUREAU')
...
NumCityCostMod = (SELECT NumCityCostMod FROM Buildings WHERE Type = 'BUILDING_FOREIGN_BUREAU'),
NationalPopRequired = (SELECT NationalPopRequired FROM Buildings WHERE Type = 'BUILDING_FOREIGN_BUREAU'),
HurryCostModifier = (SELECT HurryCostModifier FROM Buildings WHERE Type = 'BUILDING_FOREIGN_BUREAU'),
...
VALUES	('BUILDING_DUMMY_CONCERT_HALL', 	'YIELD_TOURISM', 		10);
------------------------------------------------------------------------------------------------------------------------
-- Building_Flavors
------------------------------------------------------------------------------------------------------------------------
...
SELECT 	Type, 				'BUILDINGCLASS_WALLS' FROM Buildings WHERE BuildingClass='BUILDINGCLASS_SCRIVENERS_OFFICE' UNION ALL
...
SELECT 	Type, 				'BUILDINGCLASS_WIRE_SERVICE' FROM Buildings WHERE BuildingClass='BUILDINGCLASS_FOREIGN_BUREAU' UNION ALL
...
WHERE Tag IN (SELECT Help FROM Buildings WHERE BuildingClass='BUILDINGCLASS_FOREIGN_BUREAU');
...
UPDATE Language_en_US SET Text = Text||' [NEWLINE]Newly founded Cities start with [COLOR_POSITIVE_TEXT]{TXT_KEY_BUILDING_WALLS}[ENDCOLOR].'
WHERE Tag IN (SELECT Help FROM Buildings WHERE BuildingClass='BUILDINGCLASS_SCRIVENERS_OFFICE');

UPDATE Language_en_US SET Text = 'Newly founded Cities start with a [COLOR_POSITIVE_TEXT]{TXT_KEY_BUILDING_WALLS}[ENDCOLOR].'
WHERE Tag = 'TXT_KEY_BUILDING_SCRIVENERS_OFFICE_HELP';
UPDATE Language_en_US SET Text = 'Newly founded Cities start with a [COLOR_POSITIVE_TEXT]{TXT_KEY_BUILDING_CHANCERY}[ENDCOLOR].'
WHERE Tag = 'TXT_KEY_BUILDING_PRINTING_PRESS_HELP';
UPDATE Language_en_US SET Text = 'Newly founded Cities start with a [COLOR_POSITIVE_TEXT]{TXT_KEY_BUILDING_WIRE_SERVICE}[ENDCOLOR].'
...
('TXT_KEY_BUILDING_JAR_DURUNTASH_HELP', ''),	
...
('TXT_KEY_BUILDING_JAR_WATERWORKS_HELP', 'Newly founded Cities start with +1 [ICON_CITIZEN] Citizen.'),
...
('TXT_KEY_BUILDING_JAR_JOUSTING_HELP', 'Newly founded Cities start with an [COLOR_POSITIVE_TEXT]{TXT_KEY_BUILDING_ARMORY}[ENDCOLOR].'),	
...
('TXT_KEY_BUILDING_JAR_DIPLOMIS_HELP', 'Newly founded Cities start with a [COLOR_POSITIVE_TEXT]{TXT_KEY_BUILDING_CONSTABLE}[ENDCOLOR].'),
...
('TXT_KEY_BUILDING_JAR_NATTHEATRE_HELP', 'Newly founded Cities start with an [COLOR_POSITIVE_TEXT]{TXT_KEY_BUILDING_AMPHITHEATER}[ENDCOLOR].'),
...
('TXT_KEY_BUILDING_JAR_NATAQUARIUM_HELP', 'Newly founded Cities start with a [COLOR_POSITIVE_TEXT]Circus[ENDCOLOR].'),
...
('TXT_KEY_BUILDING_JAR_NATSTADIUM_HELP', 'Newly founded Cities start with a [COLOR_POSITIVE_TEXT]{TXT_KEY_BUILDING_THEATRE}[ENDCOLOR].'),
...
('TXT_KEY_BUILDING_JAR_POLYTECHNIC_HELP', 'Newly founded Cities start with a [COLOR_POSITIVE_TEXT]{TXT_KEY_BUILDING_PUBLIC_SCHOOL}[ENDCOLOR].'),
...
('TXT_KEY_BUILDING_JAR_GWAYSTATION_HELP', 'Newly founded Cities start with a [COLOR_POSITIVE_TEXT]{TXT_KEY_BUILDING_CARAVANSARY}[ENDCOLOR].'),
...
('TXT_KEY_BUILDING_JAR_CENTRALBANK_HELP', 'Newly founded Cities start with a [COLOR_POSITIVE_TEXT]{TXT_KEY_BUILDING_BANK}[ENDCOLOR].'),
...
('TXT_KEY_BUILDING_JAR_STATEARCHIVES_HELP', 'Newly founded Cities start with a [COLOR_POSITIVE_TEXT]{TXT_KEY_BUILDING_MUSEUM}[ENDCOLOR].'),
...
('TXT_KEY_BUILDING_JAR_INDUSTRYCONFED_HELP', '+2 [ICON_PRODUCTION] Production on Snow tiles in the Empire. [NEWLINE][NEWLINE]Newly founded Cities start with a [COLOR_POSITIVE_TEXT]{TXT_KEY_BUILDING_FACTORY}[ENDCOLOR].'),
...
('TXT_KEY_BUILDING_JAR_CONCERT_HALL_HELP', '+10% [ICON_TOURISM] Tourism in the Empire during [ICON_GOLDEN_AGE] Golden Ages. [NEWLINE][NEWLINE]Possible Theming Bonuses:
  [NEWLINE][ICON_BULLET] +20 [ICON_CULTURE] and [ICON_TOURISM] for three [COLOR_POSITIVE_TEXT]Domestic[ENDCOLOR] [ICON_GW_MUSIC] Great Works of Music. [NEWLINE]Newly founded Cities start with an [COLOR_POSITIVE_TEXT]{TXT_KEY_BUILDING_OPERA_HOUSE}[ENDCOLOR]. '),
...
WHEN NEW.BuildingClassType='BUILDINGCLASS_FOREIGN_BUREAU' AND NEW.BuildingType IS NOT NULL
BEGIN
	INSERT INTO Building_FreeBuildingClassFoundedCity
			(BuildingType,		BuildingClassType)
