...
INSERT INTO CityEvents 
	(Type, EventClass, NumChoices, RandomChance, RequiredBuildingClass, RequiredPolicy, PrereqTech)
VALUES
	('CITY_EVENT_METALSMITH_1', 'EVENT_CLASS_CIV_SPECIFIC', 1, 100, 'BUILDINGCLASS_WORKSHOP', 'POLICY_CD_CELTIC', NULL),
	('CITY_EVENT_METALSMITH_2', 'EVENT_CLASS_CIV_SPECIFIC', 1, 100, 'BUILDINGCLASS_WORKSHOP', 'POLICY_CD_CELTIC', NULL),
	('CITY_EVENT_METALSMITH_3', 'EVENT_CLASS_CIV_SPECIFIC', 1, 100, 'BUILDINGCLASS_WORKSHOP', 'POLICY_CD_CELTIC', NULL),
	('CITY_EVENT_METALSMITH_4', 'EVENT_CLASS_CIV_SPECIFIC', 1, 100, 'BUILDINGCLASS_WORKSHOP', 'POLICY_CD_CELTIC', NULL),
	('CITY_EVENT_METALSMITH_5', 'EVENT_CLASS_CIV_SPECIFIC', 1, 100, 'BUILDINGCLASS_WORKSHOP', 'POLICY_CD_CELTIC', 'TECH_INDUSTRIALIZATION');

INSERT INTO CityEventChoices
	(Type, Description, Help, EventDuration)
VALUES
	('CITY_EVENT_METALSMITH_1_CHOICE', 'TXT_KEY_CITY_EVENT_METALSMITH', 'TXT_KEY_CITY_EVENT_METALSMITH_1_HELP', -1),
	('CITY_EVENT_METALSMITH_2_CHOICE', 'TXT_KEY_CITY_EVENT_METALSMITH', 'TXT_KEY_CITY_EVENT_METALSMITH_2_HELP', -1),
	('CITY_EVENT_METALSMITH_3_CHOICE', 'TXT_KEY_CITY_EVENT_METALSMITH', 'TXT_KEY_CITY_EVENT_METALSMITH_3_HELP', -1),
	('CITY_EVENT_METALSMITH_4_CHOICE', 'TXT_KEY_CITY_EVENT_METALSMITH', 'TXT_KEY_CITY_EVENT_METALSMITH_4_HELP', -1),
	('CITY_EVENT_METALSMITH_5_CHOICE', 'TXT_KEY_CITY_EVENT_METALSMITH', 'TXT_KEY_CITY_EVENT_METALSMITH_5_HELP', -1);
...
VALUES
	...
	('CITY_EVENT_METALSMITH_2', 'CITY_EVENT_METALSMITH_2_CHOICE', 1, 0),
