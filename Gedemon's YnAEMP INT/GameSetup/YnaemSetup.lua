...
function OnStartClicked()
	...
	if ( g_bBadCS ) then
		...
		Controls.StartButton:SetToolTipString("다음 모드 중 하나만 활성화해야 합니다:[NEWLINE]-Ynaemp 도시 국가[NEWLINE]-Ynaemp 도시 국가 확장[NEWLINE]-Ynaemp 도시 국가 Madeira[NEWLINE]-Ynaemp 역동적인 역사[NEWLINE]모드 선택 메뉴로 돌아가서 불필요한 모드의 선택을 모두 해제하세요.")
	else
