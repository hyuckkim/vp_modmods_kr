		...
		for i = 0, GameDefines.MAX_MAJOR_CIVS - 1, 1 do
			...
			if slot == nil then
				...
				if civType ~= nil then
					...
					elseif slot.startBias == START_ESTUARY then
						RemoveStartBias(civType);			
						for _ in DB.Query("INSERT INTO Civilization_Start_Along_Ocean(CivilizationType, StartAlongOcean) VALUES(?, ?)", civType, true) do end;
						for _ in DB.Query("INSERT INTO Civilization_Start_Along_River(CivilizationType, StartAlongRiver) VALUES(?, ?)", civType, true) do end;
