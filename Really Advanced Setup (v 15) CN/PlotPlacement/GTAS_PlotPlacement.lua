...
ElevationText = {
	[ELEVATION_NO_CHANGE] = "*",
	[ELEVATION_MOUNTAIN] = "TXT_KEY_MAP_OPTION_MOUNTAINS",
	[ELEVATION_HILLS] = "TXT_KEY_MAP_OPTION_HILLS",
	[ELEVATION_FLAT] = "TXT_KEY_MAP_OPTION_FLAT",
	[ELEVATION_RANDOM] = "TXT_KEY_MAP_OPTION_RANDOM",
};
...
PlacementText = { 
	[NEAR_PLACEMENT] = "TXT_KEY_GTAS_NEAR", 
	[FAR_PLACEMENT] = "TXT_KEY_GTAS_FAR", 
	[RND_PLACEMENT] = "TXT_KEY_MAP_OPTION_RANDOM",
	[FILL_PLACEMENT] = "TXT_KEY_GTAS_FILL",
	[MAP_PLACEMENT] = "TXT_KEY_GTAS_MAP",
};
...
function GetElevationText(elevationType)
	return Locale.ConvertTextKey(ElevationText[elevationType]) or "";
end

-------------------------------------------------------------------------------
function GetPlacementText(placementType)
	return Locale.ConvertTextKey(PlacementText[placementType]) or "";
end
