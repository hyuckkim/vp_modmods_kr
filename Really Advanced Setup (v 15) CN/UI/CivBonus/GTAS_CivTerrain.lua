...
function BuildTerrain()
	...
	if terrainInfo ~= nil then
		...
		Controls.TerrainPulldown:GetButton():SetText("TXT_KEY_GTAS_TERRAIN_ERROR");
	end
	...
	if slot:HasTerrain() then
		...
		for index, terrain in slot:TerrainList() do
			...
			if info ~= nil then
				...
				instance.TerrainName:LocalizeAndSetText("TXT_KEY_GTAS_RANDOM_TERRAIN");
			end
			...
			instance.TerrainWaterLand:LocalizeAndSetText(terrain.changeWaterLand and "TXT_KEY_YES_BUTTON" or "TXT_KEY_NO_BUTTON");
