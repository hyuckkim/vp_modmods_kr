...
local ConvertedUnitNames = { 	UNIT_BARBARIAN_ARCHER = "TXT_KEY_GTAS_UNIT_BARBARIAN_ARCHER",
								UNIT_BARBARIAN_SPEARMAN = "TXT_KEY_GTAS_UNIT_BARBARIAN_SPEARMAN", 
								UNIT_BARBARIAN_SWORDSMAN = "TXT_KEY_GTAS_UNIT_BARBARIAN_SWORDSMAN" };
...
function GetUnitDescription(unit)
	if unit == nil then
		return Locale.ConvertTextKey("TXT_KEY_GTAS_UNIT_ERROR");
	end
