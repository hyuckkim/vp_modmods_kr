...
function BuildResources()
	...
	if MapData:HasResources() then
		...
		for index, resource in MapData:ResourceList() do
			...
			instance.ResourceRelaxedRules:LocalizeAndSetText(resource.relaxedRules and "TXT_KEY_YES_BUTTON" or "TXT_KEY_NO_BUTTON");
...
function GetResourceText(resources, id)
	...
	return Locale.ConvertTextKey("TXT_KEY_GTAS_RESOURCE_ERROR");
end
