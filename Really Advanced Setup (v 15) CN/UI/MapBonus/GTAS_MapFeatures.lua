...
function BuildFeatures()
	...
	if featureInfo ~= nil then
		...
		Controls.FeaturePulldown:GetButton():SetText("TXT_KEY_GTAS_FEATURE_ERROR");
	end
	...
	if MapData:HasFeatures() then
		...
		for index, feature in MapData:FeatureList() do
			...
			if info ~= nil then
				...
				instance.FeatureName:LocalizeAndSetText("TXT_KEY_GTAS_RANDOM_FEATURE");
			end
			...
			instance.FeatureReplace:LocalizeAndSetText(feature.replaceFeature and "TXT_KEY_YES_BUTTON" or "TXT_KEY_NO_BUTTON");
