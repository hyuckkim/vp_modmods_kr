...
local Descriptions = {
	[RESOURCE_GROUP_ALL]       = "TXT_KEY_GTAS_RESOURCE_GROUP_ALL",
	[RESOURCE_GROUP_BONUS]     = "TXT_KEY_GTAS_RESOURCE_GROUP_BONUS",
	[RESOURCE_GROUP_LUXURY]    = "TXT_KEY_GTAS_RESOURCE_GROUP_LUXURY",
	[RESOURCE_GROUP_STRATEGIC] = "TXT_KEY_GTAS_RESOURCE_GROUP_STRATEGIC",
};
...
function GetResourceGroupDescription(group)
	return Locale.ConvertTextKey(Descriptions[group]) or Locale.ConvertTextKey("TXT_KEY_GTAS_RESOURCE_GROUP_X");
end
