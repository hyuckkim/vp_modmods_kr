...
SELECT 'TXT_KEY_CSTRAIT_MINOR_CIV_KATHMANDU', 			'[COLOR_MAGENTA]고르카 왕국:[ENDCOLOR]우호적인 [ICON_CITY_STATE] 도시 국가마다 [ICON_PEACE] 신앙 +1, 동맹 [ICON_CITY_STATE] 도시 국가마다 [ICON_GREAT_GENERAL] 모든 도시의 위대한 장군 포인트 +1. [ICON_GOLD] 골드로 [COLOR_YIELD_GOLD]고르카[ENDCOLOR] 유닛 (고유 [COLOR_YIELD_GOLD]수발총병[ENDCOLOR]) 구매 가능.[NEWLINE]' UNION ALL
