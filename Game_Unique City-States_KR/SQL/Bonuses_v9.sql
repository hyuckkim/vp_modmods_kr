...
SELECT 'TXT_KEY_CSTRAIT_MINOR_CIV_DODOMA', '[COLOR_MAGENTA]황야의 항해:[ENDCOLOR] 해상 유닛 [ICON_STRENGTH]전투력 보너스 +5%, 해상 유닛 [ICON_MOVES]이동력 +1[NEWLINE]' UNION ALL
...
SELECT 'TXT_KEY_PROMOTION_DODOMA_HELP', 				'[ICON_STRENGTH]전투력 보너스 +5%, [ICON_MOVES]이동력 +1[NEWLINE]' UNION ALL
