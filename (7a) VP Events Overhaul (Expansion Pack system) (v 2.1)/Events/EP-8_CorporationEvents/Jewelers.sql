...
('PLAYER_EVENT_JEWELERS_INITIAL','EVENT_CLASS_NEUTRAL','TXT_KEY_PLAYER_EVENT_CORP1_DESCRIPTION','TXT_KEY_PLAYER_EVENT_JEWELERS_INITIAL_HELP',NULL,'AS2D_INTERFACE_BORDERS_EXPAND',20,10,'true','false','false','false',30,3,0,0,NULL,NULL,NULL,'false','false',NULL,0,'false',NULL,NULL,'false','false',NULL,NULL,NULL,'false',NULL,NULL,'false','BUILDINGCLASS_CIVILIZED_JEWELERS_HQ',NULL,'false','false','false','false','false','false','false'),

('PLAYER_EVENT_JEWELERS_FINAL','EVENT_CLASS_NEUTRAL','TXT_KEY_PLAYER_EVENT_CORP2_DESCRIPTION','TXT_KEY_PLAYER_EVENT_JEWELERS_FINAL_HELP',NULL,'AS2D_INTERFACE_BORDERS_EXPAND',20,10,'true','false','false','false',30,3,0,0,NULL,NULL,NULL,'false','false',NULL,0,'false',NULL,NULL,'false','false',NULL,NULL,NULL,'false',NULL,NULL,'false','BUILDINGCLASS_CIVILIZED_JEWELERS_HQ',NULL,'false','false','false','false','false','false','false');

INSERT INTO Event_ParentEvents(EventChoiceType,EventType) VALUES
('PLAYER_EVENT_JEWELERS_CHOICE_1','PLAYER_EVENT_JEWELERS_INITIAL'),
('PLAYER_EVENT_JEWELERS_CHOICE_2','PLAYER_EVENT_JEWELERS_INITIAL'),
('PLAYER_EVENT_JEWELERS_CHOICE_3','PLAYER_EVENT_JEWELERS_INITIAL'),
('PLAYER_EVENT_JEWELERS_CHOICE_1','PLAYER_EVENT_JEWELERS_FINAL'),
('PLAYER_EVENT_JEWELERS_CHOICE_2','PLAYER_EVENT_JEWELERS_FINAL'),
('PLAYER_EVENT_JEWELERS_CHOICE_4','PLAYER_EVENT_JEWELERS_FINAL');
...
('PLAYER_EVENT_JEWELERS_FINAL',NULL,'PLAYER_EVENT_JEWELERS_CHOICE_3',NULL,NULL,'false','true');
...
('PLAYER_EVENT_JEWELERS_CHOICE_1','BUILDINGCLASS_CIVILIZED_JEWELERS','YIELD_TOURISM',-2),
('PLAYER_EVENT_JEWELERS_CHOICE_1','BUILDINGCLASS_CIVILIZED_JEWELERS','YIELD_GOLDEN_AGE_POINTS',-4);
...
('PLAYER_EVENT_JEWELERS_CHOICE_1','RESOURCE_GOLD','YIELD_GOLD',6),
('PLAYER_EVENT_JEWELERS_CHOICE_1','RESOURCE_SILVER','YIELD_GOLD',6),
('PLAYER_EVENT_JEWELERS_CHOICE_1','RESOURCE_GEMS','YIELD_GOLD',6),
('PLAYER_EVENT_JEWELERS_CHOICE_1','RESOURCE_PEARLS','YIELD_GOLD',6),
('PLAYER_EVENT_JEWELERS_CHOICE_1','RESOURCE_AMBER','YIELD_GOLD',6);
...
('PLAYER_EVENT_JEWELERS_CHOICE_1','FLAVOR_GOLD',10),
('PLAYER_EVENT_JEWELERS_CHOICE_2','FLAVOR_GOLD',10);

--------------------------------------------------------------------------------------------------
-- Text for Player Level Events
--------------------------------------------------------------------------------------------------
INSERT INTO Language_en_US (Tag, Text) VALUES
('TXT_KEY_PLAYER_EVENT_JEWELERS_INITIAL_HELP', 'A large group of investors has reached out and asked for an opportunity to invest some of their resources into Civilized Jewelers. They are suggesting that their experience and business acumen will lead to a more efficient use of company resources and, ultimately, greater profits. Are you willing to let these investors assume control of Civilized Jewelers, under your watchful eye, of course?');

INSERT INTO Language_en_US (Tag, Text) VALUES
('TXT_KEY_PLAYER_EVENT_JEWELERS_FINAL_HELP', 'Those investors are back and still would like to invest some of their resources into Civilized Jewelers. They strongly believe that their experience and business acumen will lead to a more efficient use of company resources and, ultimately, greater profits. Are you willing to let these investors assume control of Civilized Jewelers, under your watchful eye, of course?');

INSERT INTO Language_en_US (Tag, Text) VALUES
('TXT_KEY_PLAYER_EVENT_JEWELERS_CHOICE_1_HELP', 'As a result of private investment, all resources associated with the Corporation gain +6 [ICON_GOLD] Gold; however, local corporate offices have 2 [ICON_TOURISM] Tourism and 4 [ICON_GOLDEN_AGE] Golden Age Points siphoned off for use by the investment team.');
...
('CITY_EVENT_JEWELERS_FIRST','EVENT_CLASS_GOOD',NULL,NULL,'naturalwonderpopup.dds','AS2D_EVENT_CHOICE',50,1,'true','false','false',30,1,0,0,NULL,NULL,NULL,'false','false',NULL,NULL,'false','false',NULL,NULL,'false',NULL,NULL,'false','BUILDINGCLASS_CIVILIZED_JEWELERS',NULL,'false','false',NULL,NULL,NULL,'false','false','false','false','false','false','false','false','false','false','false','false','false','false',NULL,'false','false','false','false','false','false','false','false','false'),

('CITY_EVENT_JEWELERS_SECOND','EVENT_CLASS_NEUTRAL','TXT_KEY_CITY_EVENT_CORP_SECOND_DESCRIPTION','TXT_KEY_CITY_EVENT_JEWELERS_SECOND_HELP','naturalwonderpopup.dds','AS2D_EVENT_CHOICE',50,1,'true','false','false',30,4,0,0,NULL,'ERA_POSTMODERN',NULL,'false','false',NULL,NULL,'false','false',NULL,NULL,'false',NULL,NULL,'false','BUILDINGCLASS_CIVILIZED_JEWELERS',NULL,'false','false',NULL,NULL,NULL,'false','false','false','false','false','false','false','false','false','false','false','false','false','false',NULL,'false','false','false','false','false','false','false','false','false'),

('CITY_EVENT_JEWELERS_THIRD_v1','EVENT_CLASS_NEUTRAL','TXT_KEY_CITY_EVENT_CORP_THIRD_DESCRIPTION','TXT_KEY_CITY_EVENT_JEWELERS_THIRD_HELP','naturalwonderpopup.dds','AS2D_EVENT_CHOICE',50,1,'true','false','false',30,2,0,0,NULL,'ERA_FUTURE',NULL,'false','false',NULL,NULL,'false','false',NULL,NULL,'false',NULL,NULL,'false','BUILDINGCLASS_CIVILIZED_JEWELERS',NULL,'false','false',NULL,NULL,NULL,'false','false','false','false','false','false','false','false','false','false','false','false','false','false',NULL,'false','false','false','false','false','false','false','false','false'),

('CITY_EVENT_JEWELERS_THIRD_v2','EVENT_CLASS_NEUTRAL','TXT_KEY_CITY_EVENT_CORP_THIRD_DESCRIPTION','TXT_KEY_CITY_EVENT_JEWELERS_THIRD_HELP','naturalwonderpopup.dds','AS2D_EVENT_CHOICE',50,1,'true','false','false',30,2,0,0,NULL,'ERA_FUTURE',NULL,'false','false',NULL,NULL,'false','false',NULL,NULL,'false',NULL,NULL,'false','BUILDINGCLASS_CIVILIZED_JEWELERS',NULL,'false','false',NULL,NULL,NULL,'false','false','false','false','false','false','false','false','false','false','false','false','false','false',NULL,'false','false','false','false','false','false','false','false','false'),

('CITY_EVENT_JEWELERS_THIRD_v3','EVENT_CLASS_NEUTRAL','TXT_KEY_CITY_EVENT_CORP_THIRD_DESCRIPTION','TXT_KEY_CITY_EVENT_JEWELERS_THIRD_HELP','naturalwonderpopup.dds','AS2D_EVENT_CHOICE',50,1,'true','false','false',30,2,0,0,NULL,'ERA_FUTURE',NULL,'false','false',NULL,NULL,'false','false',NULL,NULL,'false',NULL,NULL,'false','BUILDINGCLASS_CIVILIZED_JEWELERS',NULL,'false','false',NULL,NULL,NULL,'false','false','false','false','false','false','false','false','false','false','false','false','false','false',NULL,'false','false','false','false','false','false','false','false','false'),

('CITY_EVENT_JEWELERS_THISISBAD','EVENT_CLASS_BAD',NULL,NULL,'naturalwonderpopup.dds','AS2D_EVENT_CHOICE',15,0,'false','true','false',30,1,0,0,NULL,NULL,NULL,'false','false',NULL,NULL,'false','false',NULL,NULL,'false',NULL,NULL,'false','BUILDINGCLASS_CIVILIZED_JEWELERS',NULL,'false','false',NULL,NULL,NULL,'false','false','false','false','false','false','false','false','false','false','false','false','false','false',NULL,'false','false','false','false','false','false','false','false','false');

INSERT INTO CityEvent_ParentEvents(CityEventChoiceType,CityEventType) VALUES
('CITY_EVENT_JEWELERS_FIRST_CHOICE_1','CITY_EVENT_JEWELERS_FIRST'),
('CITY_EVENT_CORP_SECOND_CHOICE_1','CITY_EVENT_JEWELERS_SECOND'),
('CITY_EVENT_CORP_SECOND_CHOICE_2','CITY_EVENT_JEWELERS_SECOND'),
('CITY_EVENT_CORP_SECOND_CHOICE_3','CITY_EVENT_JEWELERS_SECOND'),
('CITY_EVENT_CORP_SECOND_CHOICE_4','CITY_EVENT_JEWELERS_SECOND'),
('CITY_EVENT_CORP_THIRD_CHOICE_1','CITY_EVENT_JEWELERS_THIRD_v1'),
('CITY_EVENT_CORP_THIRD_CHOICE_4','CITY_EVENT_JEWELERS_THIRD_v1'),
('CITY_EVENT_CORP_THIRD_CHOICE_2','CITY_EVENT_JEWELERS_THIRD_v2'),
('CITY_EVENT_CORP_THIRD_CHOICE_4','CITY_EVENT_JEWELERS_THIRD_v2'),
('CITY_EVENT_CORP_THIRD_CHOICE_3','CITY_EVENT_JEWELERS_THIRD_v3'),
('CITY_EVENT_CORP_THIRD_CHOICE_4','CITY_EVENT_JEWELERS_THIRD_v3'),
('CITY_EVENT_JEWELERS_THISISBAD_CHOICE_1','CITY_EVENT_JEWELERS_THISISBAD');

INSERT INTO CityEvent_MinimumStartYield(CityEventType,YieldType,Yield) VALUES 
('CITY_EVENT_JEWELERS_SECOND','YIELD_GOLD',1000),
('CITY_EVENT_JEWELERS_THIRD_v1','YIELD_GOLD',2500),
('CITY_EVENT_JEWELERS_THIRD_v2','YIELD_GOLD',2500),
('CITY_EVENT_JEWELERS_THIRD_v3','YIELD_GOLD',2500);

--------------------------------------------------------------------------------------------------
-- Dummy Building for Corporate City Event 1 
--------------------------------------------------------------------------------------------------
INSERT INTO BuildingClasses (Type,DefaultBuilding) VALUES 
('BUILDINGCLASS_CORP_JEWELERS_DUMMY','BUILDING_CORP_JEWELERS_DUMMY');
...
('BUILDING_CORP_JEWELERS_DUMMY','BUILDINGCLASS_CORP_JEWELERS_DUMMY','TXT_KEY_BUILDING_CORP_JEWELERS_DUMMY',-1,-1,1,-1,0,1,1);

INSERT INTO Building_SpecialistYieldChanges(BuildingType,SpecialistType,YieldType,Yield) VALUES
('BUILDING_CORP_JEWELERS_DUMMY','SPECIALIST_ARTIST','YIELD_GOLD',4),
('BUILDING_CORP_JEWELERS_DUMMY','SPECIALIST_MUSICIAN','YIELD_GOLD',4),
('BUILDING_CORP_JEWELERS_DUMMY','SPECIALIST_WRITER','YIELD_GOLD',4);

INSERT INTO Language_en_US (Tag, Text) VALUES 
('TXT_KEY_BUILDING_CORP_JEWELERS_DUMMY','Jewelers City Event 1 - Provides +4 [ICON_GOLD] Gold to local Artists, Musicians, and Writers');
--------------------------------------------------------------------------------------------------
-- End Dummy Buildings 
--------------------------------------------------------------------------------------------------
...
('CITY_EVENT_JEWELERS_FIRST_CHOICE_1','TXT_KEY_CITY_EVENT_CORP_FIRST_CHOICE_1','TXT_KEY_CITY_EVENT_JEWELERS_FIRST_CHOICE_1_HELP',NULL,'AS2D_EVENT_CHOICE',0,'false','false',30,'false',0,0,NULL,NULL,'false','false',NULL,NULL,NULL,'false','false',NULL,NULL,'false',NULL,NULL,'false',NULL,NULL,'false','false',NULL,NULL,NULL,'false','false','false','false','false','false','false','false','false','false','false','false','false','false',NULL,NULL,0,0,0,0,0,0,0,NULL,0,'false','false','false','false','false','false','false','false','false',0,0,0,0,0),

('CITY_EVENT_JEWELERS_THISISBAD_CHOICE_1','TXT_KEY_CITY_EVENT_CORP_THISISBAD_DESCRIPTION','TXT_KEY_CITY_EVENT_JEWELERS_THISISBAD_HELP',NULL,'AS2D_EVENT_CHOICE',0,'true','false',30,'false',0,0,NULL,NULL,'false','false',NULL,NULL,NULL,'false','false',NULL,NULL,'false',NULL,NULL,'false',NULL,NULL,'false','false',NULL,NULL,NULL,'false','false','false','false','false','false','false','false','false','false','false','false','false','false','BUILDINGCLASS_CIVILIZED_JEWELERS',NULL,0,0,0,0,0,0,0,NULL,0,'false','false','false','false','false','false','false','false','false',0,0,0,0,0);
...
('CITY_EVENT_JEWELERS_SECOND',NULL,NULL,'CITY_EVENT_JEWELERS_FIRST',NULL,'false','true','true'),
('CITY_EVENT_JEWELERS_THIRD_v1',NULL,NULL,NULL,'CITY_EVENT_CORP_SECOND_CHOICE_1','false','true','true'),
('CITY_EVENT_JEWELERS_THIRD_v2',NULL,NULL,NULL,'CITY_EVENT_CORP_SECOND_CHOICE_2','false','true','true'),
('CITY_EVENT_JEWELERS_THIRD_v3',NULL,NULL,NULL,'CITY_EVENT_CORP_SECOND_CHOICE_3','false','true','true'),
('CITY_EVENT_JEWELERS_THISISBAD',NULL,NULL,'CITY_EVENT_JEWELERS_THISISBAD',NULL,'false','false','true');
...
('CITY_EVENT_JEWELERS_THISISBAD_CHOICE_1','YIELD_GOLD', -500);
...
VALUES ('TXT_KEY_CITY_EVENT_JEWELERS_FIRST_CHOICE_1_HELP','Allowing investment into Civilized Jewelers has lead in a local increase in Company revenues. As a result, each local [ICON_VP_ARTIST] Artist, [ICON_VP_MUSICIAN] Musician, and [ICON_VP_WRITER] Writer worked by the City now provides an additional +4 [ICON_GOLD] Gold into the City coffers.');

INSERT INTO Language_en_US (Tag, Text)
VALUES ('TXT_KEY_CITY_EVENT_JEWELERS_SECOND_HELP','One of the investors in Civilized Jewelers thinks the Company would be better off if we really focused our local efforts on a particular strategic goal. The team has put together three different options: one focused on R&D, a second that is geared towards production efficiencies, and a third that should significantly increase our profit margins. What would you like to do?');

INSERT INTO Language_en_US (Tag, Text)
VALUES ('TXT_KEY_CITY_EVENT_JEWELERS_THIRD_HELP','The management team at the local Civilized Jewelers office has identified one of the assistants to the regional manager as having real potential. They are requesting permission create a new division in the Company and promote him into a leadership position.');

INSERT INTO Language_en_US (Tag, Text)
VALUES ('TXT_KEY_CITY_EVENT_JEWELERS_THISISBAD_HELP','A scandal at the local Civilized Jewelers branch has created a huge public backlash. Rioting has destroyed the local branch office, and the Company is being forced to pay major fines as restitution.');
