...
('PLAYER_EVENT_TWOKAY_INITIAL','EVENT_CLASS_NEUTRAL','TXT_KEY_PLAYER_EVENT_CORP1_DESCRIPTION','TXT_KEY_PLAYER_EVENT_TWOKAY_INITIAL_HELP',NULL,'AS2D_INTERFACE_BORDERS_EXPAND',20,10,'true','false','false','false',30,3,0,0,NULL,NULL,NULL,'false','false',NULL,0,'false',NULL,NULL,'false','false',NULL,NULL,NULL,'false',NULL,NULL,'false','BUILDINGCLASS_TWOKAY_FOODS_HQ',NULL,'false','false','false','false','false','false','false'),

('PLAYER_EVENT_TWOKAY_FINAL','EVENT_CLASS_NEUTRAL','TXT_KEY_PLAYER_EVENT_CORP2_DESCRIPTION','TXT_KEY_PLAYER_EVENT_TWOKAY_FINAL_HELP',NULL,'AS2D_INTERFACE_BORDERS_EXPAND',20,10,'true','false','false','false',30,3,0,0,NULL,NULL,NULL,'false','false',NULL,0,'false',NULL,NULL,'false','false',NULL,NULL,NULL,'false',NULL,NULL,'false','BUILDINGCLASS_TWOKAY_FOODS_HQ',NULL,'false','false','false','false','false','false','false');

INSERT INTO Event_ParentEvents(EventChoiceType,EventType) VALUES
('PLAYER_EVENT_TWOKAY_CHOICE_1','PLAYER_EVENT_TWOKAY_INITIAL'),
('PLAYER_EVENT_TWOKAY_CHOICE_2','PLAYER_EVENT_TWOKAY_INITIAL'),
('PLAYER_EVENT_TWOKAY_CHOICE_3','PLAYER_EVENT_TWOKAY_INITIAL'),
('PLAYER_EVENT_TWOKAY_CHOICE_1','PLAYER_EVENT_TWOKAY_FINAL'),
('PLAYER_EVENT_TWOKAY_CHOICE_2','PLAYER_EVENT_TWOKAY_FINAL'),
('PLAYER_EVENT_TWOKAY_CHOICE_4','PLAYER_EVENT_TWOKAY_FINAL');
...
('PLAYER_EVENT_TWOKAY_FINAL',NULL,'PLAYER_EVENT_TWOKAY_CHOICE_3',NULL,NULL,'false','true');
...
('PLAYER_EVENT_TWOKAY_CHOICE_1','TXT_KEY_PLAYER_EVENT_CORP_CHOICE_1_DESCRIPTION','TXT_KEY_PLAYER_EVENT_TWOKAY_CHOICE_1_HELP',NULL,'AS2D_EVENT_CHOICE','true',30,'false',0,'false',0,0,0,'false','false',NULL,NULL,NULL,'false','false',NULL,NULL,NULL,'false','false',NULL,NULL,NULL,'false',NULL,NULL,'false',NULL,NULL,'false','false','false','false',NULL,NULL,NULL,NULL,0,0,0,0,0,0,0,0,0,'false','false','false','false','false',0,0,0,0,0),

('PLAYER_EVENT_TWOKAY_CHOICE_2','TXT_KEY_PLAYER_EVENT_CORP_CHOICE_2_DESCRIPTION','TXT_KEY_PLAYER_EVENT_CORP_CHOICE_2_HELP',NULL,'AS2D_EVENT_CHOICE','true',30,'false',0,'false',0,0,0,'false','false',NULL,NULL,NULL,'false','false',NULL,NULL,NULL,'false','false',NULL,NULL,NULL,'false',NULL,NULL,'false',NULL,NULL,'false','false','false','false',NULL,NULL,NULL,NULL,0,0,0,0,0,0,0,0,0,'false','false','false','false','false',0,0,0,0,0),

('PLAYER_EVENT_TWOKAY_CHOICE_3','TXT_KEY_PLAYER_EVENT_CORP_CHOICE_3_DESCRIPTION','TXT_KEY_PLAYER_EVENT_CORP_CHOICE_3_HELP',NULL,'AS2D_EVENT_CHOICE','true',30,'false',0,'false',0,0,0,'false','false',NULL,NULL,NULL,'false','false',NULL,NULL,NULL,'false','false',NULL,NULL,NULL,'false',NULL,NULL,'false',NULL,NULL,'false','false','false','false',NULL,NULL,NULL,NULL,0,0,0,0,0,0,0,0,0,'false','false','false','false','false',0,0,0,0,0),

('PLAYER_EVENT_TWOKAY_CHOICE_4','TXT_KEY_PLAYER_EVENT_CORP_CHOICE_4_DESCRIPTION','TXT_KEY_PLAYER_EVENT_CORP_CHOICE_4_HELP',NULL,'AS2D_EVENT_CHOICE','true',30,'false',0,'false',0,0,0,'false','false',NULL,NULL,NULL,'false','false',NULL,NULL,NULL,'false','false',NULL,NULL,NULL,'false',NULL,NULL,'false',NULL,NULL,'false','false','false','false',NULL,NULL,NULL,NULL,0,0,0,0,0,0,0,0,0,'false','false','false','false','false',0,0,0,0,0);
...
('PLAYER_EVENT_TWOKAY_CHOICE_1','BUILDINGCLASS_TWOKAY_FOODS','YIELD_FOOD',-2),
('PLAYER_EVENT_TWOKAY_CHOICE_1','BUILDINGCLASS_TWOKAY_FOODS','YIELD_GOLD',-4);
...
('PLAYER_EVENT_TWOKAY_CHOICE_1','RESOURCE_WINE','YIELD_GOLD',6),
('PLAYER_EVENT_TWOKAY_CHOICE_1','RESOURCE_TRUFFLES','YIELD_GOLD',6),
('PLAYER_EVENT_TWOKAY_CHOICE_1','RESOURCE_CITRUS','YIELD_GOLD',6),
('PLAYER_EVENT_TWOKAY_CHOICE_1','RESOURCE_OLIVE','YIELD_GOLD',6),
('PLAYER_EVENT_TWOKAY_CHOICE_1','RESOURCE_COFFEE','YIELD_GOLD',6),
('PLAYER_EVENT_TWOKAY_CHOICE_1','RESOURCE_TEA','YIELD_GOLD',6);
...
('PLAYER_EVENT_TWOKAY_CHOICE_1','FLAVOR_GOLD',10),
('PLAYER_EVENT_TWOKAY_CHOICE_2','FLAVOR_GOLD',10);

--------------------------------------------------------------------------------------------------
-- Text for Player Level Events
--------------------------------------------------------------------------------------------------
INSERT INTO Language_en_US (Tag, Text) VALUES
('TXT_KEY_PLAYER_EVENT_TWOKAY_INITIAL_HELP', 'A large group of investors has reached out and asked for an opportunity to invest some of their resources into TwoKay Foods. They are suggesting that their experience and business acumen will lead to a more efficient use of company resources and, ultimately, greater profits. Are you willing to let these investors assume control of TwoKay Foods, under your watchful eye, of course?');

INSERT INTO Language_en_US (Tag, Text) VALUES
('TXT_KEY_PLAYER_EVENT_TWOKAY_FINAL_HELP', 'Those investors are back and still would like to invest some of their resources into TwoKay Foods. They strongly believe that their experience and business acumen will lead to a more efficient use of company resources and, ultimately, greater profits. Are you willing to let these investors assume control of TwoKay Foods, under your watchful eye, of course?');

INSERT INTO Language_en_US (Tag, Text) VALUES
('TXT_KEY_PLAYER_EVENT_TWOKAY_CHOICE_1_HELP', 'As a result of private investment, all resources associated with the Corporation gain +6 [ICON_GOLD] Gold; however, local corporate offices have 2 [ICON_FOOD] Food and 4 [ICON_GOLD] Gold siphoned off for use by the investment team.');
...
('CITY_EVENT_TWOKAY_FIRST','EVENT_CLASS_GOOD',NULL,NULL,'naturalwonderpopup.dds','AS2D_EVENT_CHOICE',50,1,'true','false','false',30,1,0,0,NULL,NULL,NULL,'false','false',NULL,NULL,'false','false',NULL,NULL,'false',NULL,NULL,'false','BUILDINGCLASS_TWOKAY_FOODS',NULL,'false','false',NULL,NULL,NULL,'false','false','false','false','false','false','false','false','false','false','false','false','false','false',NULL,'false','false','false','false','false','false','false','false','false'),

('CITY_EVENT_TWOKAY_SECOND','EVENT_CLASS_NEUTRAL','TXT_KEY_CITY_EVENT_CORP_SECOND_DESCRIPTION','TXT_KEY_CITY_EVENT_TWOKAY_SECOND_HELP','naturalwonderpopup.dds','AS2D_EVENT_CHOICE',50,1,'true','false','false',30,4,0,0,NULL,'ERA_POSTMODERN',NULL,'false','false',NULL,NULL,'false','false',NULL,NULL,'false',NULL,NULL,'false','BUILDINGCLASS_TWOKAY_FOODS',NULL,'false','false',NULL,NULL,NULL,'false','false','false','false','false','false','false','false','false','false','false','false','false','false',NULL,'false','false','false','false','false','false','false','false','false'),

('CITY_EVENT_TWOKAY_THIRD_v1','EVENT_CLASS_NEUTRAL','TXT_KEY_CITY_EVENT_CORP_THIRD_DESCRIPTION','TXT_KEY_CITY_EVENT_TWOKAY_THIRD_HELP','naturalwonderpopup.dds','AS2D_EVENT_CHOICE',50,1,'true','false','false',30,2,0,0,NULL,'ERA_FUTURE',NULL,'false','false',NULL,NULL,'false','false',NULL,NULL,'false',NULL,NULL,'false','BUILDINGCLASS_TWOKAY_FOODS',NULL,'false','false',NULL,NULL,NULL,'false','false','false','false','false','false','false','false','false','false','false','false','false','false',NULL,'false','false','false','false','false','false','false','false','false'),

('CITY_EVENT_TWOKAY_THIRD_v2','EVENT_CLASS_NEUTRAL','TXT_KEY_CITY_EVENT_CORP_THIRD_DESCRIPTION','TXT_KEY_CITY_EVENT_TWOKAY_THIRD_HELP','naturalwonderpopup.dds','AS2D_EVENT_CHOICE',50,1,'true','false','false',30,2,0,0,NULL,'ERA_FUTURE',NULL,'false','false',NULL,NULL,'false','false',NULL,NULL,'false',NULL,NULL,'false','BUILDINGCLASS_TWOKAY_FOODS',NULL,'false','false',NULL,NULL,NULL,'false','false','false','false','false','false','false','false','false','false','false','false','false','false',NULL,'false','false','false','false','false','false','false','false','false'),

('CITY_EVENT_TWOKAY_THIRD_v3','EVENT_CLASS_NEUTRAL','TXT_KEY_CITY_EVENT_CORP_THIRD_DESCRIPTION','TXT_KEY_CITY_EVENT_TWOKAY_THIRD_HELP','naturalwonderpopup.dds','AS2D_EVENT_CHOICE',50,1,'true','false','false',30,2,0,0,NULL,'ERA_FUTURE',NULL,'false','false',NULL,NULL,'false','false',NULL,NULL,'false',NULL,NULL,'false','BUILDINGCLASS_TWOKAY_FOODS',NULL,'false','false',NULL,NULL,NULL,'false','false','false','false','false','false','false','false','false','false','false','false','false','false',NULL,'false','false','false','false','false','false','false','false','false'),

('CITY_EVENT_TWOKAY_THISISBAD','EVENT_CLASS_BAD',NULL,NULL,'naturalwonderpopup.dds','AS2D_EVENT_CHOICE',15,0,'false','true','false',30,1,0,0,NULL,NULL,NULL,'false','false',NULL,NULL,'false','false',NULL,NULL,'false',NULL,NULL,'false','BUILDINGCLASS_TWOKAY_FOODS',NULL,'false','false',NULL,NULL,NULL,'false','false','false','false','false','false','false','false','false','false','false','false','false','false',NULL,'false','false','false','false','false','false','false','false','false');

INSERT INTO CityEvent_ParentEvents(CityEventChoiceType,CityEventType) VALUES
('CITY_EVENT_TWOKAY_FIRST_CHOICE_1','CITY_EVENT_TWOKAY_FIRST'),
('CITY_EVENT_CORP_SECOND_CHOICE_1','CITY_EVENT_TWOKAY_SECOND'),
('CITY_EVENT_CORP_SECOND_CHOICE_2','CITY_EVENT_TWOKAY_SECOND'),
('CITY_EVENT_CORP_SECOND_CHOICE_3','CITY_EVENT_TWOKAY_SECOND'),
('CITY_EVENT_CORP_SECOND_CHOICE_4','CITY_EVENT_TWOKAY_SECOND'),
('CITY_EVENT_CORP_THIRD_CHOICE_1','CITY_EVENT_TWOKAY_THIRD_v1'),
('CITY_EVENT_CORP_THIRD_CHOICE_4','CITY_EVENT_TWOKAY_THIRD_v1'),
('CITY_EVENT_CORP_THIRD_CHOICE_2','CITY_EVENT_TWOKAY_THIRD_v2'),
('CITY_EVENT_CORP_THIRD_CHOICE_4','CITY_EVENT_TWOKAY_THIRD_v2'),
('CITY_EVENT_CORP_THIRD_CHOICE_3','CITY_EVENT_TWOKAY_THIRD_v3'),
('CITY_EVENT_CORP_THIRD_CHOICE_4','CITY_EVENT_TWOKAY_THIRD_v3'),
('CITY_EVENT_TWOKAY_THISISBAD_CHOICE_1','CITY_EVENT_TWOKAY_THISISBAD');

INSERT INTO CityEvent_MinimumStartYield(CityEventType,YieldType,Yield) VALUES 
('CITY_EVENT_TWOKAY_SECOND','YIELD_GOLD',1000),
('CITY_EVENT_TWOKAY_THIRD_v1','YIELD_GOLD',2500),
('CITY_EVENT_TWOKAY_THIRD_v2','YIELD_GOLD',2500),
('CITY_EVENT_TWOKAY_THIRD_v3','YIELD_GOLD',2500);
...
('CITY_EVENT_TWOKAY_FIRST_CHOICE_1','TXT_KEY_CITY_EVENT_CORP_FIRST_CHOICE_1','TXT_KEY_CITY_EVENT_TWOKAY_FIRST_CHOICE_1_HELP',NULL,'AS2D_EVENT_CHOICE',0,'false','false',30,'false',0,0,NULL,NULL,'false','false',NULL,NULL,NULL,'false','false',NULL,NULL,'false',NULL,NULL,'false',NULL,NULL,'false','false',NULL,NULL,NULL,'false','false','false','false','false','false','false','false','false','false','false','false','false','false',NULL,NULL,0,0,0,0,0,0,0,NULL,0,'false','false','false','false','false','false','false','false','false',0,0,0,0,0),

('CITY_EVENT_TWOKAY_THISISBAD_CHOICE_1','TXT_KEY_CITY_EVENT_CORP_THISISBAD_DESCRIPTION','TXT_KEY_CITY_EVENT_TWOKAY_THISISBAD_HELP',NULL,'AS2D_EVENT_CHOICE',0,'true','false',30,'false',0,0,NULL,NULL,'false','false',NULL,NULL,NULL,'false','false',NULL,NULL,'false',NULL,NULL,'false',NULL,NULL,'false','false',NULL,NULL,NULL,'false','false','false','false','false','false','false','false','false','false','false','false','false','false','BUILDINGCLASS_TWOKAY_FOODS',NULL,0,0,0,0,0,0,0,NULL,0,'false','false','false','false','false','false','false','false','false',0,0,0,0,0);
...
('CITY_EVENT_TWOKAY_SECOND',NULL,NULL,'CITY_EVENT_TWOKAY_FIRST',NULL,'false','true','true'),
('CITY_EVENT_TWOKAY_THIRD_v1',NULL,NULL,NULL,'CITY_EVENT_CORP_SECOND_CHOICE_1','false','true','true'),
('CITY_EVENT_TWOKAY_THIRD_v2',NULL,NULL,NULL,'CITY_EVENT_CORP_SECOND_CHOICE_2','false','true','true'),
('CITY_EVENT_TWOKAY_THIRD_v3',NULL,NULL,NULL,'CITY_EVENT_CORP_SECOND_CHOICE_3','false','true','true'),
('CITY_EVENT_TWOKAY_THISISBAD',NULL,NULL,'CITY_EVENT_TWOKAY_THISISBAD',NULL,'false','false','true');
...
('CITY_EVENT_TWOKAY_THISISBAD_CHOICE_1','YIELD_GOLD', -500);
...
('CITY_EVENT_TWOKAY_FIRST_CHOICE_1','IMPROVEMENT_FARM','YIELD_GOLD',4);
...
VALUES ('TXT_KEY_CITY_EVENT_TWOKAY_FIRST_CHOICE_1_HELP','Allowing investment into TwoKay Foods has lead in a local increase in Company revenues. As a result, each local Farm worked by the City now provides an additional +4 [ICON_GOLD] Gold into the City coffers.');

INSERT INTO Language_en_US (Tag, Text)
VALUES ('TXT_KEY_CITY_EVENT_TWOKAY_SECOND_HELP','One of the investors in TwoKay Foods thinks the Company would be better off if we really focused our local efforts on a particular strategic goal. The team has put together three different options: one focused on R&D, a second that is geared towards production efficiencies, and a third that should significantly increase our profit margins. What would you like to do?');

INSERT INTO Language_en_US (Tag, Text)
VALUES ('TXT_KEY_CITY_EVENT_TWOKAY_THIRD_HELP','The management team at the local TwoKay Foods office has identified one of the assistants to the regional manager as having real potential. They are requesting permission create a new division in the Company and promote him into a leadership position.');

INSERT INTO Language_en_US (Tag, Text)
VALUES ('TXT_KEY_CITY_EVENT_TWOKAY_THISISBAD_HELP','A scandal at the local TwoKay Foods branch has created a huge public backlash. Rioting has destroyed the local branch office, and the Company is being forced to pay major fines as restitution.');
