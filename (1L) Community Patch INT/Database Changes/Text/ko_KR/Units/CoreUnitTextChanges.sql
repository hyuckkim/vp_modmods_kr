...
UPDATE Language_ko_KR
SET Text = '3 타일 밖에서 공격이 가능한 첫번째 공성 유닛입니다. 적 영토에서 이동 속도가 두 배 느려집니다.'
...
UPDATE Language_ko_KR
SET Text = '다연장 로켓포는 일반적인 대포보다도 훨씬 성능이 좋은 무시무시하게 강력한 공성 유닛입니다. 다연장 로켓포는 적 영토에서 이동력이 감소하지 않으므로 앞선 화포보다 훨씬 빠릅니다. 다연장 로켓포의 시야는 제한적이지만 볼 수 없는 목표도 곡사 능력으로 타격할 수 있습니다. (다른 아군으로 시야가 확보되었을 때만) 다른 대포처럼 다연장 로켓포는 보병이나 전차의 공격에 약하므로 적절히 유닛으로 보호해야 합니다.'
