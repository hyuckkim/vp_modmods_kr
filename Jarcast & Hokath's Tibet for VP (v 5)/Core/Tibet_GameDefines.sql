...
FROM Corporation_ResourceYieldChanges WHERE CorporationType='CORPORATION_LANDSEA_EXTRACTORS';
------------------------------
-- Corporation_ResourceMonopolyOrs
------------------------------
INSERT INTO Corporation_ResourceMonopolyOrs
		(CorporationType, 					ResourceType)
SELECT	'CORPORATION_LANDSEA_EXTRACTORS',	'RESOURCE_JAR_YAK';
------------------------------
...
UPDATE Language_en_US SET Text = REPLACE(Text,
'[NEWLINE]Nearby [ICON_RES_COW] Cattle: +2 [ICON_PRODUCTION] Production.',
'[NEWLINE]Nearby [ICON_RES_COW] Cattle: +2 [ICON_PRODUCTION] Production. [NEWLINE]Nearby [ICON_RES_JAR_YAK] Yak: +2 [ICON_PRODUCTION] Production.')
...
UPDATE Leaders SET Personality='PERSONALITY_EXPANSIONIST' WHERE Type='LEADER_JAR_SONGTSEN_GAMPO';
--==========================================================================================================================	
...
SELECT 'TXT_KEY_BUILDING_JAR_KUMBUM_HELP', 'Increases the City''s resistance to [ICON_RELIGION] Religious conversion by 15%. [NEWLINE]Gain 15% of the Cost of any [ICON_PEACE] Faith Purchase in this City as [ICON_GOLDEN_AGE] Golden Age Points. [NEWLINE]Land Units in this City heal 10 HP per turn whether or not they take an action. [NEWLINE][NEWLINE]'||Text
FROM Language_en_US WHERE Tag='TXT_KEY_BUILDING_TEMPLE_HELP';

UPDATE Language_en_US SET Text = REPLACE(Text, 'Generates +25% Religious Pressure.', 'Generates +50% Religious Pressure.')
WHERE Tag = 'TXT_KEY_BUILDING_JAR_KUMBUM_HELP';
--==========================================================================================================================		
--==========================================================================================================================