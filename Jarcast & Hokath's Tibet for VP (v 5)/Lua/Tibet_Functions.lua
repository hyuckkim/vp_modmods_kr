...
include("Cunt15_IteratorPack_v3.lua")
--==========================================================================================================================
-- GLOBALS
--==========================================================================================================================
----------------------------------------------------------------------------------------------------------------------------
...
--[[
function Jar_TibetUA_DzongFoodMountain(iPlayer, iUnit, iPlotX, iPlotY, iBuild)
	local pPlayer = Players[iPlayer]
...
if g_IsTraitActive then GameEvents.PlayerBuilt.Add(Jar_TibetUA_DzongFoodMountain) end]]
--==========================================================================================================================
-- UU1: DOB-DOB
--==========================================================================================================================
