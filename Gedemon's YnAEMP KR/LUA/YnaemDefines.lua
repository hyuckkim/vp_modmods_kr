...
-- else	
	g_MapList = { 	
		...
		[JAPAN_HUGE] = 					{ID = JAPAN_HUGE, 					File = "JapanHuge.Civ5Map", 							Name = "[COLOR_POSITIVE_TEXT]아시아:[ENDCOLOR] 일본 ([COLOR_CYAN]훨씬 거대[ENDCOLOR])", 						Description = "Lungora의 대한민국과 일본의 지도", 															Size = "WORLDSIZE_HUGE", 		Civs = 12, 	Minors = 24, 	TablePrefix = "JapanHuge" },
