...
VALUES		('ART_DEF_UNIT_JFD_SWISS_GUARD', 	'Unit', 	'sv_Swissguard.dds'),
			('ART_DEF_UNIT_DJ_APOCRISIARIUS',	'Unit',		'ApocrisiariusSV.dds');
------------------------------
-- ArtDefine_UnitInfos
------------------------------			
...
INSERT INTO ArtDefine_UnitInfos 
			(Type, 								DamageStates,	Formation)
SELECT		('ART_DEF_UNIT_DJ_APOCRISIARIUS'),	DamageStates, 	Formation
...
INSERT INTO ArtDefine_UnitInfoMemberInfos 	
			(UnitInfoType,						UnitMemberInfoType,							NumMembers)
SELECT		('ART_DEF_UNIT_DJ_APOCRISIARIUS'),	('ART_DEF_UNIT_MEMBER_DJ_APOCRISIARIUS'),	NumMembers
...
INSERT INTO ArtDefine_UnitMemberCombats 
			(UnitMemberType,							EnableActions, DisableActions, MoveRadius, ShortMoveRadius, ChargeRadius, AttackRadius, RangedAttackRadius, MoveRate, ShortMoveRate, TurnRateMin, TurnRateMax, TurnFacingRateMin, TurnFacingRateMax, RollRateMin, RollRateMax, PitchRateMin, PitchRateMax, LOSRadiusScale, TargetRadius, TargetHeight, HasShortRangedAttack, HasLongRangedAttack, HasLeftRightAttack, HasStationaryMelee, HasStationaryRangedAttack, HasRefaceAfterCombat, ReformBeforeCombat, HasIndependentWeaponFacing, HasOpponentTracking, HasCollisionAttack, AttackAltitude, AltitudeDecelerationDistance, OnlyTurnInMovementActions, RushAttackFormation)
SELECT		('ART_DEF_UNIT_MEMBER_DJ_APOCRISIARIUS'),	EnableActions, DisableActions, MoveRadius, ShortMoveRadius, ChargeRadius, AttackRadius, RangedAttackRadius, MoveRate, ShortMoveRate, TurnRateMin, TurnRateMax, TurnFacingRateMin, TurnFacingRateMax, RollRateMin, RollRateMax, PitchRateMin, PitchRateMax, LOSRadiusScale, TargetRadius, TargetHeight, HasShortRangedAttack, HasLongRangedAttack, HasLeftRightAttack, HasStationaryMelee, HasStationaryRangedAttack, HasRefaceAfterCombat, ReformBeforeCombat, HasIndependentWeaponFacing, HasOpponentTracking, HasCollisionAttack, AttackAltitude, AltitudeDecelerationDistance, OnlyTurnInMovementActions, RushAttackFormation
...
INSERT INTO ArtDefine_UnitMemberCombatWeapons	
			(UnitMemberType,							"Index", SubIndex, ID, VisKillStrengthMin, VisKillStrengthMax, ProjectileSpeed, ProjectileTurnRateMin, ProjectileTurnRateMax, HitEffect, HitEffectScale, HitRadius, ProjectileChildEffectScale, AreaDamageDelay, ContinuousFire, WaitForEffectCompletion, TargetGround, IsDropped, WeaponTypeTag, WeaponTypeSoundOverrideTag)
SELECT		('ART_DEF_UNIT_MEMBER_DJ_APOCRISIARIUS'),	"Index", SubIndex, ID, VisKillStrengthMin, VisKillStrengthMax, ProjectileSpeed, ProjectileTurnRateMin, ProjectileTurnRateMax, HitEffect, HitEffectScale, HitRadius, ProjectileChildEffectScale, AreaDamageDelay, ContinuousFire, WaitForEffectCompletion, TargetGround, IsDropped, WeaponTypeTag, WeaponTypeSoundOverrideTag
...
INSERT INTO ArtDefine_UnitMemberInfos 	
			(Type, 										Scale,  ZOffset, Domain, Model,				 		MaterialTypeTag, MaterialTypeSoundOverrideTag)
SELECT		('ART_DEF_UNIT_MEMBER_DJ_APOCRISIARIUS'),	Scale,	ZOffset, Domain, ('apocrisiarius.fxsxml'),	MaterialTypeTag, MaterialTypeSoundOverrideTag
...
VALUES		('JFD_PAPAL_STATES_ATLAS', 				256, 		'JFD_PapalStatesAtlas_256.dds',			3, 				3),
			...
			('UNIT_FLAG_DJ_APOCRISIARIUS_ATLAS',	32, 		'ApocrisiariusAlphaAtlas32.dds',		1, 				1),
			...
			('JFD_PAPAL_STATES_PI_ATLAS', 			256, 		'JFD_SWISS_GUARD_PI_256.dds',			1, 				1),
			('JFD_PAPAL_STATES_PI_ATLAS', 			64, 		'JFD_SWISS_GUARD_PI_064.dds',			1, 				1),
			('JFD_PAPAL_STATES_PI_ATLAS', 			45, 		'JFD_SWISS_GUARD_PI_045.dds',			1, 				1),
			('JFD_PAPAL_STATES_PI_ATLAS', 			32, 		'JFD_SWISS_GUARD_PI_032.dds',			1, 				1),
			('JFD_PAPAL_STATES_PI_ATLAS', 			16, 		'JFD_SWISS_GUARD_PI_016.dds',			1, 				1);
------------------------------	
-- Colors
------------------------------
INSERT INTO Colors 
		(Type, 										Red, 	Green, 	Blue, 	Alpha)
VALUES	('COLOR_PLAYER_JFD_PAPAL_STATES_ICON', 		0.949,	0.886,	0.756, 	1),
		('COLOR_PLAYER_JFD_PAPAL_STATES_BACKGROUND',0.737,	0.341,	0.125, 	1);
------------------------------	
-- PlayerColors
------------------------------				
...
VALUES		('SND_LEADER_MUSIC_JULIUS_II_PEACE', 'Pius_Peace',					'Streamed'),
			('SND_LEADER_MUSIC_JULIUS_II_WAR', 	'Pius_War', 					'Streamed');
------------------------------	
-- Audio_2DSounds
------------------------------		
INSERT INTO Audio_2DSounds 
			(ScriptID, 								SoundID, 							SoundType, 		MinVolume, 	MaxVolume,  IsMusic, Looping)
VALUES		('AS2D_LEADER_MUSIC_JULIUS_II_PEACE', 	'SND_LEADER_MUSIC_JULIUS_II_PEACE', 'GAME_MUSIC', 	60, 		60, 		1, 		 0),
			('AS2D_LEADER_MUSIC_JULIUS_II_WAR', 	'SND_LEADER_MUSIC_JULIUS_II_WAR', 	'GAME_MUSIC', 	60, 		60, 		1,		 0);
--==========================================================================================================================	
--==========================================================================================================================	
