...
UPDATE ArtDefine_Landmarks SET
	...
	Scale = 0.14,
	Tech = 'TECH_CHIVALRY'
WHERE ImprovementType = 'ART_DEF_IMPROVEMENT_CHATEAU_NEW';

INSERT INTO ArtDefine_Landmarks
		(Era, 		State,					Scale,	ImprovementType,					LayoutHandler,  ResourceType,			 Model,						TerrainContour,	Tech)
VALUES	('Ancient',	'UnderConstruction',	0.6,	'ART_DEF_IMPROVEMENT_CHATEAU_NEW',	'SNAPSHOT',		'ART_DEF_RESOURCE_ALL',  'HB_Norman_Fort.fxsxml',	1,				NULL),
		('Ancient',	'Constructed',			0.6,	'ART_DEF_IMPROVEMENT_CHATEAU_NEW',	'SNAPSHOT',		'ART_DEF_RESOURCE_ALL',  'Norman_Fort.fxsxml',		1,				NULL),
		('Ancient',	'Pillaged',				0.6,	'ART_DEF_IMPROVEMENT_CHATEAU_NEW',	'SNAPSHOT',		'ART_DEF_RESOURCE_ALL',  'PL_Norman_Fort.fxsxml',	1,				NULL);

INSERT INTO ArtDefine_Landmarks 
		(Era, 		State,					Scale,	ImprovementType,					LayoutHandler,  ResourceType,			 Model,					TerrainContour,	Tech)
VALUES	('Ancient',	'UnderConstruction',	0.7,	'ART_DEF_IMPROVEMENT_CHATEAU_NEW',	'SNAPSHOT',		'ART_DEF_RESOURCE_ALL',  'Chateau_HB.fxsxml',	0,				'TECH_ARCHITECTURE'),
		('Ancient',	'Constructed',			0.7,	'ART_DEF_IMPROVEMENT_CHATEAU_NEW',	'SNAPSHOT',		'ART_DEF_RESOURCE_ALL',  'Chateau.fxsxml',		0,				'TECH_ARCHITECTURE'),
		('Ancient',	'Pillaged',				0.7,	'ART_DEF_IMPROVEMENT_CHATEAU_NEW',	'SNAPSHOT',		'ART_DEF_RESOURCE_ALL',  'Chateau_PIL.fxsxml',	0,				'TECH_ARCHITECTURE');	