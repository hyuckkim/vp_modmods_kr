...
function UpdateDisplay()
    ...
    for city in pPlayer:Cities() do
       ...
       -- population
		...
		-- food tooltip
		local sFoodTooltip = iFoodPerTurn100 / 100 .. "[ICON_FOOD] 합계[NEWLINE][NEWLINE]"
		sFoodTooltip = sFoodTooltip .. "[COLOR_POSITIVE_TEXT]" .. iPopulation + 1 .. "[ICON_CITIZEN] 진행 상황[ENDCOLOR]"
		...
		-- culture tooltip
		local sCultureTooltip = iCulturePerTurn .. "[ICON_CULTURE] 합계[NEWLINE][NEWLINE]"
		sCultureTooltip = sCultureTooltip .. "[ICON_CULTURE_LOCAL]국경 성장[ENDCOLOR] 진행 상황"
...
function ProductionDetails(city, instance, sortEntry)
	...
	local sProductionTooltip = iProductionPerTurn100 / 100 .. "[ICON_PRODUCTION] 합계[NEWLINE][NEWLINE]"
	sProductionTooltip = sProductionTooltip .. " [COLOR_YIELD_FOOD]" .. Locale.ToUpper(sCityProductionName) .. "[ENDCOLOR] 진행 상황"
