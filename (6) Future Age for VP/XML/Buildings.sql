...
('BUILDING_FW_BIOFUEL_REFINERY',       'BUILDINGCLASS_FW_BIOFUEL_REFINERY',  'TECH_POWER_SYSTEMS',  2500, 'ART_DEF_BUILDING_LABORATORY',  45,'CIV_COLOR_ATLAS_FW_3',   'TXT_KEY_BUILDING_FW_BIOFUEL_REFINERY_HELP', 'TXT_KEY_BUILDING_FW_BIOFUEL_REFINERY',        'TXT_KEY_BUILDING_FW_BIOFUEL_REFINERY_PEDIA', 'TXT_KEY_BUILDING_FW_BIOFUEL_REFINERY_STRATEGY'),
('BUILDING_FW_BIOFUEL_REFINERY_RICE',  'BUILDINGCLASS_FW_BIOFUEL_REFINERY',  'TECH_POWER_SYSTEMS',  2500, 'ART_DEF_BUILDING_LABORATORY',  45,'CIV_COLOR_ATLAS_FW_3',   'TXT_KEY_BUILDING_FW_BIOFUEL_REFINERY_HELP', 'TXT_KEY_BUILDING_FW_BIOFUEL_REFINERY_RICE',   'TXT_KEY_BUILDING_FW_BIOFUEL_REFINERY_PEDIA', 'TXT_KEY_BUILDING_FW_BIOFUEL_REFINERY_STRATEGY'),
('BUILDING_FW_BIOFUEL_REFINERY_BANANA','BUILDINGCLASS_FW_BIOFUEL_REFINERY',  'TECH_POWER_SYSTEMS',  2500, 'ART_DEF_BUILDING_LABORATORY',  45,'CIV_COLOR_ATLAS_FW_3',   'TXT_KEY_BUILDING_FW_BIOFUEL_REFINERY_HELP', 'TXT_KEY_BUILDING_FW_BIOFUEL_REFINERY_BANANA', 'TXT_KEY_BUILDING_FW_BIOFUEL_REFINERY_PEDIA', 'TXT_KEY_BUILDING_FW_BIOFUEL_REFINERY_STRATEGY'),
('BUILDING_FW_BIOFUEL_REFINERY_MAIZE', 'BUILDINGCLASS_FW_BIOFUEL_REFINERY',  'TECH_POWER_SYSTEMS',  2500, 'ART_DEF_BUILDING_LABORATORY',  45,'CIV_COLOR_ATLAS_FW_3',   'TXT_KEY_BUILDING_FW_BIOFUEL_REFINERY_HELP', 'TXT_KEY_BUILDING_FW_BIOFUEL_REFINERY_MAIZE',  'TXT_KEY_BUILDING_FW_BIOFUEL_REFINERY_PEDIA', 'TXT_KEY_BUILDING_FW_BIOFUEL_REFINERY_STRATEGY'),
...
('BUILDING_FW_CYBERPOLICE', 			'TECH_GLOBALIZATION', 				3250, 'ART_DEF_BUILDING_LABORATORY',         57,'CIV_COLOR_ATLAS_FW_3'),
...
('BUILDING_FW_COMMERCE_SERVER', 		'TECH_SUPERCOMPUTERS', 				3500, 'ART_DEF_BUILDING_LABORATORY',         33,'CIV_COLOR_ATLAS_FW_2'),
...
('BUILDING_FW_ECOSANCTUARY', 			'TECH_FW_ECOTHEORY', 	            3500, 'ART_DEF_BUILDING_LABORATORY',         31,'CIV_COLOR_ATLAS_FW_2'),
...
('BUILDING_FW_VIRTUAL_MUSEUM', 			'TECH_MEMETICS', 					3500, 'ART_DEF_BUILDING_LABORATORY',         39,'CIV_COLOR_ATLAS_FW_2'),
...
('BUILDING_FW_BIOFACTORY', 				'TECH_ORGANICS', 				    4000, 'ART_DEF_BUILDING_LABORATORY',          2,'CIV_COLOR_ATLAS_FW_2'),
('BUILDING_FW_HYDROTHERMAL_FACTORY', 	'TECH_ORGANICS', 	     	    	4000, 'ART_DEF_BUILDING_LABORATORY',  	     57,'TCS_MOD_ICON_ATLAS'),
...
('BUILDING_FW_BOREHOLE', 				'TECH_POWER_SYSTEMS',               4000, 'ART_DEF_BUILDING_LABORATORY',         36,'CIV_COLOR_ATLAS_FW_2'),
('BUILDING_FW_GEOTHERMAL_FACTORY', 		'TECH_POWER_SYSTEMS', 		    	4000, 'ART_DEF_BUILDING_LABORATORY',         48,'CIV_COLOR_ATLAS_FW_2'),
('BUILDING_FW_ANTIMATTER_RESEARCH', 	'TECH_POWER_SYSTEMS', 		    	4000, 'ART_DEF_BUILDING_LABORATORY',         27,'CIV_COLOR_ATLAS_FW_3'),
...
('BUILDING_FW_HUMONOID_FORGE',   		'TECH_COGNITIVE_TECH',	 		    4250, 'ART_DEF_BUILDING_LABORATORY',          1,'CIV_COLOR_ATLAS_FW_2'),
...
('BUILDING_FW_SPACE_STATION', 			'TECH_ASTRODYNAMICS', 				4250, 'ART_DEF_BUILDING_LABORATORY',         43,'TCS_MOD_ICON_ATLAS'),
...
('BUILDING_FW_HIGHSPEED_RAIL', 			'TECH_SUPERCONDUCTIVITY', 			4500, 'ART_DEF_BUILDING_LABORATORY',          2,'CIV_COLOR_ATLAS_FW_3'),
('BUILDING_FW_COMM_MODULE', 			'TECH_SUPERCONDUCTIVITY', 		    4500, 'ART_DEF_BUILDING_LABORATORY',         19,'TCS_MOD_ICON_ATLAS'),
('BUILDING_FW_ENGINEERING_MODULE', 		'TECH_SUPERCONDUCTIVITY', 		    4500, 'ART_DEF_BUILDING_LABORATORY',         20,'TCS_MOD_ICON_ATLAS'),
('BUILDING_FW_RESEARCH_MODULE', 		'TECH_SUPERCONDUCTIVITY', 		    4500, 'ART_DEF_BUILDING_LABORATORY',         21,'TCS_MOD_ICON_ATLAS'),
('BUILDING_FW_ECTOGENESIS_POD', 		'TECH_GENGINEERING', 				4750, 'ART_DEF_BUILDING_LABORATORY',         22,'CIV_COLOR_ATLAS_FW_2'),
('BUILDING_FW_DIGITAL_POLICE', 			'TECH_AI', 		                	4750, 'ART_DEF_BUILDING_LABORATORY',         29,'TCS_MOD_ICON_ATLAS'),
('BUILDING_FW_ORBITAL_HABITAT', 		'TECH_ADAMANTIUM', 	                4750, 'ART_DEF_BUILDING_LABORATORY',         27,'TCS_MOD_ICON_ATLAS'),
...
('BUILDING_FW_MOON_BASE', 				'TECH_PROMETHEUS_PROGRAM', 			4750, 'ART_DEF_BUILDING_LABORATORY',         19,'CIV_COLOR_ATLAS_FW_3'),
...
('BUILDINGCLASS_FW_ASTEROID_MINING_1', 	     'BUILDING_FW_ASTEROID_MINING_1',       'TXT_KEY_BUILDING_FW_ASTEROID_MINING_1', 	1),
('BUILDINGCLASS_FW_ASTEROID_MINING_2', 	     'BUILDING_FW_ASTEROID_MINING_2', 	    'TXT_KEY_BUILDING_FW_ASTEROID_MINING_2', 	1),
...
-- ----------------------------------------------
UPDATE Buildings
SET GoldMaintenance = 12, SpecialistCount = 1, SpecialistType = 'SPECIALIST_SCIENTIST', IlliteracyFlatReduction = 2, IlliteracyFlatReduction = 1, NoUnhappfromXSpecialists = 1, MutuallyExclusiveGroup = 99801
...
-- ----------------------------------------------
UPDATE Buildings
SET GoldMaintenance = 14, SpecialistType = 'SPECIALIST_MUSICIAN', SpecialistCount = 1, GreatPeopleRateChange = 2, Happiness = 2, BoredomFlatReduction = 1,  NoUnhappfromXSpecialists = 1, MutuallyExclusiveGroup = 39993
...
-- ----------------------------------------------
UPDATE Buildings
SET GoldMaintenance = 16, SpecialistType = 'SPECIALIST_ENGINEER', SpecialistCount = 1, RequiresIndustrialCityConnection = 1, FinishLandTRTourism = 10, TradeRouteLandGoldBonus = 50, TradeRouteLandDistanceModifier = 25, BuildingProductionModifier = 15
...
-- ----------------------------------------------
-- -- Asteroid mining Project 1
-- ----------------------------------------------
UPDATE Buildings
SET NukeImmune = 1, NeverCapture = 1
WHERE Type = 'BUILDING_FW_ASTEROID_MINING_1';
-- ----------------------------------------------
-- -- Asteroid mining Project 2
-- ----------------------------------------------
UPDATE Buildings
SET NukeImmune = 1, NeverCapture = 1
...
VALUES
	...
	('BUILDING_FW_HYDROTHERMAL_FACTORY', 	'BUILDINGCLASS_HARBOR'),
	('BUILDING_FW_GENEJACK_FACILITY', 		'BUILDINGCLASS_FW_FUNGAL_AGRIGENOMICS'),
	('BUILDING_FW_GENEJACK_FACILITY', 		'BUILDINGCLASS_FW_GENE_LAB'),
	...
	('BUILDING_FW_HUMONOID_FORGE', 			'BUILDINGCLASS_FW_AUTOPLANT'),
	...
	('BUILDING_FW_BIOCOMPUTER',             'BUILDINGCLASS_FW_GENEJACK_FACILITY'),
	...
	('BUILDING_FW_DRONE_HIVE', 				'BUILDINGCLASS_FW_HUMONOID_FORGE'),
	...
	('BUILDING_FW_CYBERCLINIC', 			'BUILDINGCLASS_FW_BIOCOMPUTER'),
	('BUILDING_FW_CYBERCLINIC', 			'BUILDINGCLASS_FW_TELEPRESENCE_HUB'),
...
('BUILDING_FW_COMMERCE_SERVER',  	    'YIELD_GOLD', 		4),
...
('BUILDING_FW_HYDROTHERMAL_FACTORY',    'YIELD_SCIENCE', 	3),
...
('BUILDING_FW_SPACE_STATION', 		    'YIELD_PRODUCTION', 5),
('BUILDING_FW_SPACE_STATION', 		    'YIELD_SCIENCE', 	5),
('BUILDING_FW_RESEARCH_MODULE',  	    'YIELD_SCIENCE', 	4),
...
('BUILDING_FW_TERRAFORMING_STATION',    'YIELD_SCIENCE',    4),
('BUILDING_FW_TERRAFORMING_STATION',    'YIELD_PRODUCTION', 4),
...
('BUILDING_FW_IMPLANT_CLINIC',  		'YIELD_FOOD',   	10),
('BUILDING_FW_IMPLANT_CLINIC',  		'YIELD_FAITH', 		10),
...
VALUES
	...
	('BUILDING_FW_BIOFACTORY',           'BUILDINGCLASS_FW_HYDROTHERMAL_FACTORY', 'YIELD_SCIENCE',    1),
	('BUILDING_FW_HYDROTHERMAL_FACTORY', 'BUILDINGCLASS_FW_BIOFACTORY',           'YIELD_FOOD',       1),
	('BUILDING_FW_HYDROTHERMAL_FACTORY', 'BUILDINGCLASS_FW_HYDROTHERMAL_FACTORY', 'YIELD_SCIENCE',    1),
	...
	('BUILDING_FW_IMPLANT_CLINIC',       'BUILDINGCLASS_FW_VR_TRAINING',          'YIELD_PRODUCTION', 1),
	...
	('BUILDING_FW_CYBERCLINIC',          'BUILDINGCLASS_FW_TELEPRESENCE_HUB',     'YIELD_PRODUCTION', 1),
	('BUILDING_FW_CYBERCLINIC',          'BUILDINGCLASS_FW_TELEPRESENCE_HUB',     'YIELD_SCIENCE',    1),
	('BUILDING_FW_CYBERCLINIC',          'BUILDINGCLASS_FW_TELEPRESENCE_HUB',     'YIELD_CULTURE',    1),
	('BUILDING_FW_CYBERCLINIC',          'BUILDINGCLASS_FW_BIOCOMPUTER',          'YIELD_SCIENCE',    4),
...
VALUES
	...
	('BUILDING_FW_RESEARCH_MODULE', 	'SPECIALIST_SCIENTIST', 'YIELD_SCIENCE',	3),
	('BUILDING_FW_ENGINEERING_MODULE', 	'SPECIALIST_ENGINEER', 	'YIELD_PRODUCTION',	3),
	('BUILDING_FW_COMM_MODULE', 		'SPECIALIST_MERCHANT', 	'YIELD_GOLD',		3),
...
VALUES	('BUILDING_FW_AQUACULTURE_LAB',		'RESOURCE_FISH',		1		, 1),
		...
		('BUILDING_FW_PHOTOSYSTEMS',		'RESOURCE_ADN_FUNGUS',	1		, 4);
...
VALUES
    ...
    ('BUILDING_FW_CLONE_LAB',              'RESOURCE_ADN_FUNGUS',  1),
    ...
    ('BUILDING_FW_ENRICHMENT_FACILITY',    'RESOURCE_NANOMAT',     2),
	('BUILDING_FW_MOON_BASE',              'RESOURCE_IRON',        2),
    ('BUILDING_FW_MOON_BASE',              'RESOURCE_NANOMAT',     2),
	...
	('BUILDING_FW_ASTEROID_MINING_2', 	   'RESOURCE_ALUMINUM',    4),
	('BUILDING_FW_ASTEROID_MINING_2', 	   'RESOURCE_NANOMAT', 	   3),
	('BUILDING_FW_ASTEROID_MINING_2', 	   'RESOURCE_URANIUM', 	   1),
	('BUILDING_FW_ASTEROID_MINING_1', 	   'RESOURCE_COAL',        3),
	('BUILDING_FW_ASTEROID_MINING_1', 	   'RESOURCE_IRON', 	   6),
...
VALUES
    ...
    ('BUILDING_FW_BIOMOD_TANK',       'RESOURCE_ADN_FUNGUS', 1),
    ('BUILDING_FW_MASS_DIGESTER',     'RESOURCE_ADN_FUNGUS', 1),
    ('BUILDING_FW_CYBERCLINIC',       'RESOURCE_NANOMAT',    1),
...
VALUES
	...
	('BUILDING_FW_NANOFORGE', 			 'IMPROVEMENT_FW_INDUSTRIAL_COMPLEX',       'YIELD_PRODUCTION', 1),
	('BUILDING_FW_NANOFORGE', 			 'IMPROVEMENT_FW_INDUSTRIAL_COMPLEX',       'YIELD_GOLD', 		1),
	...
	('BUILDING_FW_NETWORK_BACKBONE',     'IMPROVEMENT_FW_GENERATOR',                'YIELD_GOLD',       1), 
	('BUILDING_FW_NETWORK_BACKBONE',     'IMPROVEMENT_FW_GENERATOR_WATER',          'YIELD_GOLD',       1), 
	('BUILDING_FW_NETWORK_BACKBONE',     'IMPROVEMENT_FW_COMM_ARRAY',               'YIELD_GOLD',       1), 
	('BUILDING_FW_BOREHOLE', 			 'IMPROVEMENT_MINE', 					    'YIELD_PRODUCTION', 1),
	('BUILDING_FW_BOREHOLE', 			 'IMPROVEMENT_QUARRY', 					    'YIELD_PRODUCTION', 1),
	('BUILDING_FW_BOREHOLE', 			 'IMPROVEMENT_WELL', 					    'YIELD_PRODUCTION', 1),
...
VALUES
	...
	('BUILDING_FW_IMPLANT_CLINIC',        'UNITCOMBAT_GUN',        15),
	...
	('BUILDING_FW_CYBERCLINIC',           'UNITCOMBAT_NAVALMELEE', 15),
	('BUILDING_FW_CYBERCLINIC',           'UNITCOMBAT_NAVALRANGED',15),
	('BUILDING_FW_CYBERCLINIC',           'UNITCOMBAT_SUBMARINE',  15),
	('BUILDING_FW_DRONE_HIVE',            'UNITCOMBAT_ARCHER',     15),
	('BUILDING_FW_COMM_MODULE',           'UNITCOMBAT_FIGHTER',    15),
	('BUILDING_FW_COMM_MODULE',           'UNITCOMBAT_BOMBER',     15),
	('BUILDING_FW_ENGINEERING_MODULE',    'UNITCOMBAT_FIGHTER',    15),
	('BUILDING_FW_ENGINEERING_MODULE',    'UNITCOMBAT_BOMBER',     15),
	('BUILDING_FW_RESEARCH_MODULE',       'UNITCOMBAT_FIGHTER',    15),
	('BUILDING_FW_RESEARCH_MODULE',       'UNITCOMBAT_BOMBER',     15),
	('BUILDING_FW_DIGITAL_POLICE',        'UNITCOMBAT_ARCHER',     15),
	...
	('BUILDING_FW_FUSION_PLANT',          'UNITCOMBAT_FIGHTER',    15),
	('BUILDING_FW_FUSION_PLANT',          'UNITCOMBAT_BOMBER',     15),
	('BUILDING_FW_MOON_BASE',             'UNITCOMBAT_GUN',        15),
	('BUILDING_FW_MOON_BASE',             'UNITCOMBAT_RECON',      15),
...
('BUILDING_FW_CYBERPOLICE', 		     'FLAVOR_HAPPINESS',            20),
('BUILDING_FW_CYBERPOLICE', 		     'FLAVOR_ESPIONAGE',            25),
('BUILDING_FW_CYBERPOLICE', 		     'FLAVOR_DIPLOMACY',            25),
...
('BUILDING_FW_BIOFLESH_INDUSTRY',        'FLAVOR_PRODUCTION', 		    10),
('BUILDING_FW_BIOFLESH_INDUSTRY', 	     'FLAVOR_OFFENSE', 			    25),
...
('BUILDING_FW_HYDROTHERMAL_FACTORY',     'FLAVOR_SCIENCE', 		    	25),
('BUILDING_FW_HYDROTHERMAL_FACTORY',     'FLAVOR_PRODUCTION', 	    	25),
...
('BUILDING_FW_GENEJACK_FACILITY',        'FLAVOR_TILE_IMPROVEMENT',     15),
('BUILDING_FW_GENEJACK_FACILITY', 	     'FLAVOR_OFFENSE', 			    10),
('BUILDING_FW_IMPLANT_CLINIC',           'FLAVOR_HAPPINESS',            10),
('BUILDING_FW_IMPLANT_CLINIC', 	         'FLAVOR_OFFENSE',              30),
('BUILDING_FW_IMPLANT_CLINIC', 	         'FLAVOR_MILITARY_TRAINING',    45),
('BUILDING_FW_IMPLANT_CLINIC',           'FLAVOR_RELIGION',             10),
('BUILDING_FW_IMPLANT_CLINIC',           'FLAVOR_GROWTH',               10),
...
('BUILDING_FW_ENRICHMENT_FACILITY',      'FLAVOR_PRODUCTION',           20),
...
('BUILDING_FW_SPACE_STATION',            'FLAVOR_HAPPINESS', 		     5),
...
('BUILDING_FW_COMM_MODULE', 		     'FLAVOR_HAPPINESS', 		     10),
('BUILDING_FW_COMM_MODULE', 		     'FLAVOR_AIR', 		             15),
('BUILDING_FW_RESEARCH_MODULE', 	     'FLAVOR_SCIENCE', 	        	 50),
('BUILDING_FW_RESEARCH_MODULE', 	     'FLAVOR_HAPPINESS', 	         10),
('BUILDING_FW_RESEARCH_MODULE', 	     'FLAVOR_AIR', 	                 15),
('BUILDING_FW_ENGINEERING_MODULE',       'FLAVOR_PRODUCTION',       	 50),
('BUILDING_FW_ENGINEERING_MODULE',       'FLAVOR_HAPPINESS',        	 10),
('BUILDING_FW_ENGINEERING_MODULE',       'FLAVOR_AIR',        	         15),
...
('BUILDING_FW_CYBERCLINIC', 		     'FLAVOR_CULTURE',               10),
('BUILDING_FW_CYBERCLINIC', 		     'FLAVOR_NAVAL',                 20),
('BUILDING_FW_CYBERCLINIC', 		     'FLAVOR_HAPPINESS',             20),
('BUILDING_FW_DIGITAL_POLICE', 		     'FLAVOR_HAPPINESS',             50),
('BUILDING_FW_DIGITAL_POLICE', 		     'FLAVOR_ESPIONAGE',             30),
('BUILDING_FW_DIGITAL_POLICE', 		     'FLAVOR_DEFENSE',               30),
('BUILDING_FW_DIGITAL_POLICE', 		     'FLAVOR_DIPLOMACY',             30),
...
('BUILDING_FW_MOON_BASE', 			     'FLAVOR_GOLD',                  40),
('BUILDING_FW_MOON_BASE', 			     'FLAVOR_EXPANSION',             10),
('BUILDING_FW_MOON_BASE', 			     'FLAVOR_HAPPINESS',             10),
('BUILDING_FW_MOON_BASE', 			     'FLAVOR_EXPANSION',             15),
('BUILDING_FW_MOON_BASE', 			     'FLAVOR_SPACESHIP',             15),
...
('BUILDING_FW_TERRAFORMING_STATION', 	 'FLAVOR_PRODUCTION', 		     20),
...
('BUILDING_FW_ASTEROID_MINING_1', 	     'FLAVOR_EXPANSION',             10),
('BUILDING_FW_ASTEROID_MINING_1', 	     'FLAVOR_SPACESHIP',             5),
('BUILDING_FW_ASTEROID_MINING_2', 	     'FLAVOR_EXPANSION',             10),
('BUILDING_FW_ASTEROID_MINING_2', 	     'FLAVOR_SPACESHIP',             30),
('BUILDING_FW_ASTEROID_MINING_2', 	     'FLAVOR_OFFENSE',               20),
('BUILDING_FW_ASTEROID_MINING_2', 	     'FLAVOR_DEFENSE',               20);
