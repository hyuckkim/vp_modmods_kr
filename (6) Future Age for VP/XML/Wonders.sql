...
('BUILDING_FW_GENE_VAULT2', 			'TECH_ARTIFICIAL_ENVIRONMENTS',       3500, 'ART_DEF_BUILDING_LABORATORY',  51,'TCS_MOD_ICON_ATLAS',    	1, 28, 		'MiapolisCT_Splash.dds',		 	'L,T'),
('BUILDING_FW_APEX_CENTRE',     	 	'TECH_IMPLANTS',                      4000, 'ART_DEF_BUILDING_LABORATORY',  39,'CIV_COLOR_ATLAS_FW_3',  	1, 28, 		'ApexCentre_Splash.dds', 			'L,T'),
('BUILDING_FW_DATA_HAVEN', 	  	  	 	'TECH_MECHATRONICS',                  3500, 'ART_DEF_BUILDING_LABORATORY',   3,'CIV_COLOR_ATLAS_FW_2',  	1, 29, 		'DataHaven_Splash.dds', 			'R,B'),
('BUILDING_FW_JURASSIC_PARK',     	 	'TECH_CLONING',                       4250, 'ART_DEF_BUILDING_LABORATORY',   5,'CIV_COLOR_ATLAS_FW_3',  	1, 29, 		'JurassicPark_Splash.dds', 			'L,T'),
('BUILDING_FW_ENRICHMENT_CENTRE', 		'TECH_NUCLEAR_ENRICHMENT',            4250, 'ART_DEF_BUILDING_LABORATORY',   7,'CIV_COLOR_ATLAS_FW_3',  	1, 28, 		'EnrichmentCentre_Splash.dds',		'L,T'),
('BUILDING_FW_HELIOS', 					'TECH_ASTRODYNAMICS',                 4250, 'ART_DEF_BUILDING_LABORATORY',  23,'CIV_COLOR_ATLAS_FW_3',  	1, 29, 		'Helios_Splash.dds',		 		'L,T'),
...
('BUILDING_FW_SKYCITY', 	  	  	 	'TECH_TERRAFORMING',                  5000, 'ART_DEF_BUILDING_LABORATORY',  38,'TCS_MOD_ICON_ATLAS', 	    1, 32, 		'KingdomTowerCT_Splash.dds', 		'R,T'),
...
-- Move Hubble
UPDATE Buildings
SET PrereqTech = 'TECH_ORBITAL_DEV', Cost = 3250
...
----------------------------------------------
UPDATE Buildings
SET SpecialistType = 'SPECIALIST_MUSICIAN', SpecialistCount = 2, GreatPeopleRateChange = 1, Happiness = 1, GreatWorkSlotType = 'GREAT_WORK_SLOT_MUSIC', GreatWorkCount = 2, GreatWorksTourismModifier = 50, CultureRateModifier = 10, ThemingBonusHelp = 'TXT_KEY_THEMING_BONUS_FW_VIRTUAL_IDOL_HELP'
...
----------------------------------------------
UPDATE Buildings
SET SpecialistType = 'SPECIALIST_SCIENTIST', SpecialistCount = 2, GreatPeopleRateChange = 1
WHERE Type = 'BUILDING_FW_ENRICHMENT_CENTRE';
----------------------------------------------
-- Helios
----------------------------------------------
UPDATE Buildings
SET SpecialistType = 'SPECIALIST_ENGINEER', GreatPeopleRateChange = 2, FreeBuildingThisCity = 'BUILDINGCLASS_FW_SPACE_STATION'
...
----------------------------------------------
UPDATE Buildings
SET SpecialistType = 'SPECIALIST_ENGINEER', GreatPeopleRateChange = 2, DistressFlatReduction = 1, NoUnhappfromXSpecialists = 1, FreePromotion = 'PROMOTION_FW_SPACESPECIALIST', FreeBuildingThisCity = 'BUILDINGCLASS_FW_METROPLEX_HUB', MutuallyExclusiveGroup = 23497
...
----------------------------------------------
UPDATE Buildings
SET SpecialistType = 'SPECIALIST_MUSICIAN', SpecialistCount = 2, GreatPeopleRateChange = 2, GreatWorkSlotType = 'GREAT_WORK_SLOT_MUSIC', GreatWorkCount = 2, ThemingBonusHelp = 'TXT_KEY_SKYCITY_THEMING_BONUS_HELP', Happiness = 7
...
VALUES 
	...
	('BUILDING_FW_GENE_VAULT2',  'TXT_KEY_THEMING_BONUS_GENE_VAULT2',   	 8, 1, 5, 0, 0),
...
('BUILDING_FW_HELIOS', 				            	'YIELD_PRODUCTION',	10),
('BUILDING_FW_SKYCITY',  					        'YIELD_FAITH', 		50),
('BUILDING_FW_SKYCITY',  					        'YIELD_CULTURE', 	50),
...
VALUES
	...
	('BUILDING_FW_GENOME_PROJECT',				'SPECIALIST_CIVIL_SERVANT',	'YIELD_CULTURE',			2),
	('BUILDING_FW_GENOME_PROJECT',				'SPECIALIST_ARTIST',		'YIELD_CULTURE',			2),
	('BUILDING_FW_GENOME_PROJECT',				'SPECIALIST_WRITER',		'YIELD_CULTURE',			2),
	('BUILDING_FW_GENOME_PROJECT',				'SPECIALIST_MUSICIAN',		'YIELD_CULTURE',			2),
	('BUILDING_FW_GENOME_PROJECT',				'SPECIALIST_SCIENTIST',		'YIELD_SCIENCE',			2),
	('BUILDING_FW_GENOME_PROJECT',				'SPECIALIST_MERCHANT',		'YIELD_GOLD',				2),
	('BUILDING_FW_GENOME_PROJECT',				'SPECIALIST_ENGINEER',		'YIELD_PRODUCTION',			2);
...
VALUES
	...
	('PROMOTION_FW_PREDATOR', 	       'UNITCOMBAT_HOVER'),
...
VALUES
	...
	('BUILDING_FW_FLOATINGISLANDS', 'UNITCOMBAT_FIGHTER', 25),
	('BUILDING_FW_FLOATINGISLANDS', 'UNITCOMBAT_BOMBER',  25);
...
VALUES		
	...
	('BUILDING_FW_GENE_VAULT2', 	    'IMPROVEMENT_FW_HYDROPONICS_DOME',      	'YIELD_GOLD', 				1),
	('BUILDING_FW_GENE_VAULT2', 	    'IMPROVEMENT_FW_HERC',      	            'YIELD_PRODUCTION',    		1),
	...
	('BUILDING_FW_DATA_HAVEN', 	        'IMPROVEMENT_FW_INDUSTRIAL_COMPLEX',        'YIELD_PRODUCTION', 		1),
	('BUILDING_FW_PHOLUS_MUTAGEN', 	    'IMPROVEMENT_FW_GENOCENTRE',                'YIELD_FAITH',      		1),
	('BUILDING_FW_PHOLUS_MUTAGEN', 	    'IMPROVEMENT_FW_GENOCENTRE',                'YIELD_CULTURE',    		1),
	('BUILDING_FW_PHOLUS_MUTAGEN', 	    'IMPROVEMENT_FW_WATER_GENOCENTRE',          'YIELD_FAITH',      		1),
	('BUILDING_FW_PHOLUS_MUTAGEN', 	    'IMPROVEMENT_FW_WATER_GENOCENTRE',          'YIELD_CULTURE',    		1),
	('BUILDING_FW_SHIMIZUMCP', 	        'IMPROVEMENT_FW_CORE',                      'YIELD_FOOD',    		    1),
	('BUILDING_FW_SHIMIZUMCP', 	        'IMPROVEMENT_FW_CORE',                      'YIELD_PRODUCTION',    		1),
	('BUILDING_FW_SHIMIZUMCP', 	        'IMPROVEMENT_FW_WATER_CORE',                'YIELD_FOOD',    		    1),
	('BUILDING_FW_SHIMIZUMCP', 	        'IMPROVEMENT_FW_WATER_CORE',                'YIELD_PRODUCTION',    		1);

INSERT INTO Building_ImprovementYieldChangesGlobal	
	(BuildingType, 						ImprovementType,							YieldType,					Yield)
VALUES		
	('BUILDING_FW_FLOATINGISLANDS',     'IMPROVEMENT_FW_ARCOLOGY',                  'YIELD_SCIENCE',    		1),
	('BUILDING_FW_FLOATINGISLANDS',     'IMPROVEMENT_FW_ARCOLOGY',                  'YIELD_GOLD',    		    1),
	('BUILDING_FW_FLOATINGISLANDS',     'IMPROVEMENT_FW_WATER_ARCOLOGY',            'YIELD_SCIENCE',    		1),
	('BUILDING_FW_FLOATINGISLANDS',     'IMPROVEMENT_FW_WATER_ARCOLOGY',            'YIELD_GOLD',    		    1);
...
VALUES
	...
	('BUILDING_FW_NEPHILIM_GENE_TEMPLATE2', 'RESOURCE_ADN_FUNGUS', 	1),
	('BUILDING_FW_MNEMOSYNE', 	        	'RESOURCE_NANOMAT', 	1),
	('BUILDING_FW_MNEMOSYNE2', 	        	'RESOURCE_NANOMAT', 	1),
	('BUILDING_FW_MNEMOSYNE2', 		        'RESOURCE_URANIUM', 	1),
	('BUILDING_FW_SKYCITY', 				'RESOURCE_ADN_FUNGUS', 	1),
	('BUILDING_FW_NEPHILIM_GENE_TEMPLATE', 	'RESOURCE_ADN_FUNGUS', 	1),
...
VALUES
	...
	('BUILDING_FW_MNEMOSYNE2', 'BUILDINGCLASS_FW_FUSION_PLANT', 1);
...
VALUES
	...
	('BUILDING_FW_HELIOS',          	'RESOURCE_ALUMINUM', 		6),
...
VALUES
	...
	('BUILDING_FW_GENE_VAULT', 	 	  	    'BUILDINGCLASS_FW_HYDROTHERMAL_FACTORY',   'YIELD_PRODUCTION',        2),
	('BUILDING_FW_GENE_VAULT2', 	 	    'BUILDINGCLASS_FW_VERTICAL_FARM',  	       'YIELD_GOLD', 	          2),
	('BUILDING_FW_GENE_VAULT2', 	 	    'BUILDINGCLASS_FW_GEOTHERMAL_FACTORY',     'YIELD_GOLD',              2),
	('BUILDING_FW_GENE_VAULT2', 	 	    'BUILDINGCLASS_FW_BOREHOLE',               'YIELD_GOLD',              2),
	('BUILDING_FW_DATA_HAVEN', 		 	    'BUILDINGCLASS_FW_SERVER_HUB', 	           'YIELD_GOLD',			  2),
	('BUILDING_FW_JURASSIC_PARK', 	  	    'BUILDINGCLASS_THEATRE',  		           'YIELD_GOLD', 			  2),
	...
	('BUILDING_FW_HELIOS', 	         	    'BUILDINGCLASS_FW_LAUNCH_FACILITY',        'YIELD_GOLD', 		      4),
	('BUILDING_FW_HELIOS', 	            	'BUILDINGCLASS_FW_LAUNCH_FACILITY',        'YIELD_TOURISM', 		  2),
	('BUILDING_FW_SPACE_STATION', 		    'BUILDINGCLASS_FW_FLOATINGISLANDS_DUMMY',  'YIELD_CULTURE',    		  2),
	('BUILDING_FW_SPACE_STATION', 		    'BUILDINGCLASS_FW_FLOATINGISLANDS_DUMMY',  'YIELD_SCIENCE',    		  2),
	('BUILDING_FW_SPACE_STATION', 		    'BUILDINGCLASS_FW_FLOATINGISLANDS_DUMMY',  'YIELD_PRODUCTION',    	  2),
	('BUILDING_FW_SPACE_STATION', 		    'BUILDINGCLASS_FW_FLOATINGISLANDS_DUMMY',  'YIELD_GOLD',    		  2),
	('BUILDING_FW_NEPHILIM_GENE_TEMPLATE2', 'BUILDINGCLASS_FW_FUNGAL_AGRIGENOMICS',    'YIELD_FOOD', 		      1),
	('BUILDING_FW_NEPHILIM_GENE_TEMPLATE2', 'BUILDINGCLASS_FW_FUNGAL_AGRIGENOMICS',    'YIELD_CULTURE', 		  1),
	('BUILDING_FW_NEPHILIM_GENE_TEMPLATE2', 'BUILDINGCLASS_FW_TRANSGENIC_NURSERY',     'YIELD_FOOD', 		      1),
	('BUILDING_FW_NEPHILIM_GENE_TEMPLATE2', 'BUILDINGCLASS_FW_TRANSGENIC_NURSERY',     'YIELD_CULTURE', 		  1),
	('BUILDING_FW_SKYNET',                  'BUILDINGCLASS_FW_DRONE_HIVE',             'YIELD_SCIENCE', 		  1),
	('BUILDING_FW_SKYNET',                  'BUILDINGCLASS_FW_DRONE_HIVE',             'YIELD_FAITH', 		      1),
	('BUILDING_FW_SKYNET',                  'BUILDINGCLASS_FW_CYBERPOLICE',            'YIELD_SCIENCE', 		  1),
	('BUILDING_FW_SKYNET',                  'BUILDINGCLASS_FW_CYBERPOLICE',            'YIELD_FAITH', 		      1),
	...
	('BUILDING_FW_ORBITAL_REFINERY', 	    'BUILDINGCLASS_FW_AEROSPACE_COMPLEX', 	   'YIELD_GOLD',			  1),
	('BUILDING_FW_ORBITAL_REFINERY', 	    'BUILDINGCLASS_FW_AEROSPACE_COMPLEX', 	   'YIELD_PRODUCTION',		  1),
	...
	('BUILDING_FW_AI_SINGULARITY',          'BUILDINGCLASS_FW_COMMERCE_SERVER',        'YIELD_GOLD',              6),
	('BUILDING_FW_AI_SINGULARITY',          'BUILDINGCLASS_FW_ENTERTAINMENT_SERVER',   'YIELD_CULTURE',           6),
	('BUILDING_FW_AI_SINGULARITY',          'BUILDINGCLASS_FW_CLOUD_COMPUTING',        'YIELD_PRODUCTION',        6),
	('BUILDING_FW_AI_SINGULARITY',          'BUILDINGCLASS_FW_RESEARCH_SERVER',        'YIELD_SCIENCE',           6),
	('BUILDING_FW_ASTEROID_MINING',         'BUILDINGCLASS_FW_NANOFORGE',              'YIELD_PRODUCTION',        6),
	('BUILDING_FW_ASTEROID_MINING',         'BUILDINGCLASS_FW_NANOFORGE',              'YIELD_SCIENCE',           6);

INSERT INTO Building_SpecificGreatPersonRateModifier 
	(BuildingType, SpecialistType, Modifier) 
VALUES
	('BUILDING_FW_GENE_VAULT', 			'SPECIALIST_WRITER', 		25),
	('BUILDING_FW_GENE_VAULT2', 		'SPECIALIST_SCIENTIST', 	15),
...
VALUES	
	...
	('BUILDING_FW_SKYCITY', 			'UNIT_MUSICIAN',			1),
...
('BUILDING_FW_GENE_VAULT2',  			'FLAVOR_WONDER',      		25),
('BUILDING_FW_GENE_VAULT2',  			'FLAVOR_GREAT_PEOPLE',      25),
('BUILDING_FW_GENE_VAULT2',  			'FLAVOR_PRODUCTION',      	15),
('BUILDING_FW_GENE_VAULT2',  			'FLAVOR_GROWTH',      		15),
('BUILDING_FW_GENE_VAULT2',  			'FLAVOR_HAPPINESS',      	15),
('BUILDING_FW_GENE_VAULT2',  			'FLAVOR_TILE_IMPROVEMENT',  15),
('BUILDING_FW_GENE_VAULT2',  			'FLAVOR_CULTURE',      		50),
...
('BUILDING_FW_HELIOS',  		        'FLAVOR_SPACESHIP',      	25),
...
('BUILDING_FW_FLOATINGISLANDS', 		'FLAVOR_CITY_DEFENSE', 		30),
...
('BUILDING_FW_FLOATINGISLANDS',        	'FLAVOR_AIR',      	    	50),
('BUILDING_FW_NEPHILIM_GENE_TEMPLATE2', 'FLAVOR_WONDER',      		25),
('BUILDING_FW_NEPHILIM_GENE_TEMPLATE2', 'FLAVOR_GREAT_PEOPLE',      20),
('BUILDING_FW_NEPHILIM_GENE_TEMPLATE2', 'FLAVOR_GROWTH',            10),
('BUILDING_FW_NEPHILIM_GENE_TEMPLATE2', 'FLAVOR_CULTURE',        	10),
('BUILDING_FW_NEPHILIM_GENE_TEMPLATE2', 'FLAVOR_OFFENSE', 			10),
('BUILDING_FW_NEPHILIM_GENE_TEMPLATE2', 'FLAVOR_PRODUCTION', 		30),
('BUILDING_FW_NEPHILIM_GENE_TEMPLATE2', 'FLAVOR_MILITARY_TRAINING', 60),
...
('BUILDING_FW_MNEMOSYNE2',  			'FLAVOR_WONDER',      		25),
('BUILDING_FW_MNEMOSYNE2',  			'FLAVOR_PRODUCTION',      	50),
('BUILDING_FW_MNEMOSYNE2',  			'FLAVOR_DIPLOMACY',         80),
...
('BUILDING_FW_SKYCITY',        			'FLAVOR_CULTURE',      		40),
('BUILDING_FW_SKYCITY',        			'FLAVOR_WONDER',      		25),
('BUILDING_FW_SKYCITY',        			'FLAVOR_RELIGION',      	40),
...
('BUILDING_FW_AI_SINGULARITY',  		'FLAVOR_WONDER',      		25),
('BUILDING_FW_AI_SINGULARITY',  		'FLAVOR_GROWTH',      		40),
('BUILDING_FW_AI_SINGULARITY',  		'FLAVOR_CULTURE',      		25),
('BUILDING_FW_AI_SINGULARITY',  		'FLAVOR_PRODUCTION',   		25),
('BUILDING_FW_AI_SINGULARITY',  		'FLAVOR_GOLD',   	    	25),
('BUILDING_FW_AI_SINGULARITY',  		'FLAVOR_GREAT_PEOPLE',      30),
('BUILDING_FW_AI_SINGULARITY',  		'FLAVOR_SCIENCE',      		50);