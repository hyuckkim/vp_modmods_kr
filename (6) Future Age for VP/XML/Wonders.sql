...
VALUES
	('UNIT_FW_BIOINFANTRY', 		       'BUILDING_FW_NEPHILIM_GENE_TEMPLATE2', 10),
	('UNIT_FW_CLONETROOPER', 		       'BUILDING_FW_NEPHILIM_GENE_TEMPLATE2', 10),
	('UNIT_FW_BIOTROOPER', 		           'BUILDING_FW_NEPHILIM_GENE_TEMPLATE2', 10),
	('UNIT_FW_SUPERSOLDIERS', 		       'BUILDING_FW_NEPHILIM_GENE_TEMPLATE2', 10),
	('UNIT_FW_SWARM', 				       'BUILDING_FW_NEPHILIM_GENE_TEMPLATE2', 10),
	('UNIT_FW_HYBRID_DRONE', 			   'BUILDING_FW_NEPHILIM_GENE_TEMPLATE2', 10),
	('UNIT_FW_BIODRONE', 			       'BUILDING_FW_NEPHILIM_GENE_TEMPLATE2', 10),
	('UNIT_FW_CHIMERA', 		           'BUILDING_FW_NEPHILIM_GENE_TEMPLATE2', 10),
	('UNIT_FW_MUTANT', 				       'BUILDING_FW_NEPHILIM_GENE_TEMPLATE2', 10),
	('UNIT_FW_HYDRA', 				       'BUILDING_FW_NEPHILIM_GENE_TEMPLATE2', 10),
...
VALUES		
	...
	('BUILDING_FW_GENE_VAULT2', 	    'IMPROVEMENT_FW_HERC',      	            'YIELD_PRODUCTION',    		2),
	...
	('BUILDING_FW_FLOATINGISLANDS',     'IMPROVEMENT_FW_ARCOLOGY',                  'YIELD_GOLD',    	    	2),
	('BUILDING_FW_FLOATINGISLANDS',     'IMPROVEMENT_FW_ARCOLOGY',                  'YIELD_PRODUCTION',    	    1),
	('BUILDING_FW_FLOATINGISLANDS',     'IMPROVEMENT_FW_WATER_ARCOLOGY',            'YIELD_GOLD',    	    	2),
	('BUILDING_FW_FLOATINGISLANDS',     'IMPROVEMENT_FW_WATER_ARCOLOGY',            'YIELD_PRODUCTION',    		1);
...
VALUES
	...
	('BUILDING_FW_HELIOS', 	            	'BUILDINGCLASS_FW_LAUNCH_FACILITY',        'YIELD_CULTURE', 		  4),
	...
	('BUILDING_FW_NEPHILIM_GENE_TEMPLATE2', 'BUILDINGCLASS_FW_CLONE_LAB',              'YIELD_FOOD', 		      2),
	('BUILDING_FW_NEPHILIM_GENE_TEMPLATE2', 'BUILDINGCLASS_FW_CLONE_LAB',              'YIELD_CULTURE', 		  2),
	('BUILDING_FW_NEPHILIM_GENE_TEMPLATE2', 'BUILDINGCLASS_FW_CLONE_LAB',              'YIELD_FAITH', 		      2),
	('BUILDING_FW_NEPHILIM_GENE_TEMPLATE2', 'BUILDINGCLASS_FW_TRANSGENIC_NURSERY',     'YIELD_FOOD', 		      2),
	('BUILDING_FW_NEPHILIM_GENE_TEMPLATE2', 'BUILDINGCLASS_FW_TRANSGENIC_NURSERY',     'YIELD_CULTURE', 		  2),
	('BUILDING_FW_NEPHILIM_GENE_TEMPLATE2', 'BUILDINGCLASS_FW_TRANSGENIC_NURSERY',     'YIELD_FAITH', 		      2),
	...
	('BUILDING_FW_ORBITAL_REFINERY',        'BUILDINGCLASS_FW_SPACE_STATION',          'YIELD_PRODUCTION',        2),
	('BUILDING_FW_ORBITAL_REFINERY',        'BUILDINGCLASS_FW_SPACE_STATION',          'YIELD_GOLD',              2),
	('BUILDING_FW_ORBITAL_REFINERY',        'BUILDINGCLASS_FW_SPACE_STATION',          'YIELD_SCIENCE',           2),
	...
	('BUILDING_FW_AI_SINGULARITY',          'BUILDINGCLASS_FW_COMMERCE_SERVER',        'YIELD_GOLD',              8),
	('BUILDING_FW_AI_SINGULARITY',          'BUILDINGCLASS_FW_ENTERTAINMENT_SERVER',   'YIELD_CULTURE',           8),
	('BUILDING_FW_AI_SINGULARITY',          'BUILDINGCLASS_FW_CLOUD_COMPUTING',        'YIELD_PRODUCTION',        8),
	('BUILDING_FW_AI_SINGULARITY',          'BUILDINGCLASS_FW_RESEARCH_SERVER',        'YIELD_SCIENCE',           8),
	('BUILDING_FW_ASTEROID_MINING',         'BUILDINGCLASS_FW_NANOFORGE',              'YIELD_PRODUCTION',        4),
	('BUILDING_FW_ASTEROID_MINING',         'BUILDINGCLASS_FW_NANOFORGE',              'YIELD_SCIENCE',           4);
...
('BUILDING_FW_SHANGHAI_WFC',  			'FLAVOR_TILE_IMPROVEMENT',   5),
...
('BUILDING_FW_GENE_VAULT2',  			'FLAVOR_GOLD',          	15),
...
('BUILDING_FW_HELIOS',  				'FLAVOR_CULTURE',      		15),
...
('BUILDING_FW_FLOATINGISLANDS',        	'FLAVOR_SCIENCE',      		30),
('BUILDING_FW_FLOATINGISLANDS',        	'FLAVOR_WONDER',      		25),
('BUILDING_FW_FLOATINGISLANDS',        	'FLAVOR_GREAT_PEOPLE',      15),
('BUILDING_FW_FLOATINGISLANDS', 		'FLAVOR_CITY_DEFENSE', 		30),
('BUILDING_FW_FLOATINGISLANDS', 		'FLAVOR_DEFENSE', 			35),
('BUILDING_FW_FLOATINGISLANDS',        	'FLAVOR_CULTURE',      		30),
('BUILDING_FW_FLOATINGISLANDS',        	'FLAVOR_GOLD',      		30),
('BUILDING_FW_FLOATINGISLANDS',        	'FLAVOR_AIR',      	    	30),
('BUILDING_FW_NEPHILIM_GENE_TEMPLATE2', 'FLAVOR_WONDER',      		25),
('BUILDING_FW_NEPHILIM_GENE_TEMPLATE2', 'FLAVOR_GREAT_PEOPLE',      20),
('BUILDING_FW_NEPHILIM_GENE_TEMPLATE2', 'FLAVOR_GROWTH',            40),
('BUILDING_FW_NEPHILIM_GENE_TEMPLATE2', 'FLAVOR_CULTURE',        	20),
('BUILDING_FW_NEPHILIM_GENE_TEMPLATE2', 'FLAVOR_RELIGION',        	20),
('BUILDING_FW_NEPHILIM_GENE_TEMPLATE2', 'FLAVOR_OFFENSE', 			20),
('BUILDING_FW_NEPHILIM_GENE_TEMPLATE2', 'FLAVOR_PRODUCTION', 		50),
('BUILDING_FW_NEPHILIM_GENE_TEMPLATE2', 'FLAVOR_OFFENSE', 			10),
('BUILDING_FW_NEPHILIM_GENE_TEMPLATE2', 'FLAVOR_MILITARY_TRAINING', 50),
...
('BUILDING_FW_MNEMOSYNE2',  			'FLAVOR_HAPPINESS',         40),
('BUILDING_FW_MNEMOSYNE2',  			'FLAVOR_GREAT_PEOPLE',      40),
...
('BUILDING_FW_AI_SINGULARITY',  		'FLAVOR_GREAT_PEOPLE',      60),
('BUILDING_FW_AI_SINGULARITY',  		'FLAVOR_SCIENCE',      		50),
('BUILDING_FW_ASTEROID_MINING',  		'FLAVOR_WONDER',      		25),
('BUILDING_FW_ASTEROID_MINING',  		'FLAVOR_SCIENCE',      		20),
('BUILDING_FW_ASTEROID_MINING',  		'FLAVOR_PRODUCTION',      	20),
('BUILDING_FW_ASTEROID_MINING',  		'FLAVOR_GREAT_PEOPLE',      60),
('BUILDING_FW_ASTEROID_MINING',        	'FLAVOR_MILITARY_TRAINING', 25),
('BUILDING_FW_ASTEROID_MINING',        	'FLAVOR_OFFENSE', 			20),
('BUILDING_FW_ASTEROID_MINING',        	'FLAVOR_DEFENSE', 			20);