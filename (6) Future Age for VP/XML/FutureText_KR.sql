...
UPDATE Language_ko_KR
SET Text = '모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]수직형 농장[ENDCOLOR]의 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. 농장, 재배지, 계단식 농장, 간척지 및 수경재배지구의 [ICON_FOOD]식량이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. 매턴 도시의 [ICON_FOOD]식량의 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR]만큼의 [ICON_RESEARCH]과학을 제공합니다.[NEWLINE][NEWLINE][ICON_RESEARCH]문맹, [ICON_URBANIZATION]도시화에서 오는 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 감소합니다. [NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]약국[ENDCOLOR]이 있어야 하고 [COLOR_NEGATIVE_TEXT]제노포자 배양 연구소[ENDCOLOR]가 없어야 건설할 수 있습니다.'
