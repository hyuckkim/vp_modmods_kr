...
INSERT INTO Language_ko_KR (Tag, Text) VALUES
-- 게놈프로젝트
('TXT_KEY_PROCESS_FW_GENOME_PROJECT','생명 유전자 지도 네트워크'),
...
('TXT_KEY_WONDER_FW_GENOME_PROJECT_HELP','도시의 모든 전문가들의 산출량이 +1 증가합니다.'),
...
('TXT_KEY_RESOLUTION_FW_GENOME_PROJECT','생명 유전자 지도 네트워크'),
...
('TXT_KEY_WONDER_FW_AI_SINGULARITY_HELP','모든 도시의 [COLOR_POSITIVE_TEXT]전자상거래 서버, 엔터테인먼트, 클라우드 서버, 연구서버[ENDCOLOR]의 관련 산출량이 [COLOR_POSITIVE_TEXT]6[ENDCOLOR] 증가합니다. 즉시 원하는 [ICON_GREAT_PEOPLE][COLOR_YELLOW]위인[ENDCOLOR] 1명이 출현합니다.'),
...
('TXT_KEY_WONDER_FW_ASTEROID_MINING_HELP','[ICON_GREAT_ENGINEER][COLOR_YELLOW]위대한 기술자[ENDCOLOR]가 1명 출현합니다. 모든 [COLOR_POSITIVE_TEXT]나노물질 군수공장[ENDCOLOR]의 [ICON_PRODUCTION]생산과 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]6[ENDCOLOR] 증가합니다.'),
('TXT_KEY_LEAGUE_PROJECT_REWARD_FW_ASTEROID_MINING_1','심층 금속 매장지'),
('TXT_KEY_LEAGUE_PROJECT_REWARD_FW_ASTEROID_MINING_1_HELP','[ICON_RES_IRON]철 [COLOR_POSITIVE_TEXT]6개[ENDCOLOR]와 [ICON_RES_COAL]석탄 [COLOR_POSITIVE_TEXT]3개[ENDCOLOR]를 제공합니다.'),
