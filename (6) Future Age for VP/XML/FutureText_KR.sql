...
('TXT_KEY_BUILDING_FW_INTERPOL_PEDIA', '인터폴(국제형사경찰기구)은 국경을 초월하여 범죄와 맞서기 위해 설립된 국제 조직입니다. 사이버 범죄, 테러리즘, 금융 사기, 마약 밀매 등 다양한 범죄에 대해 회원국 간 협력을 조율하며, 전 세계 경찰 기관 간의 정보 공유와 공조 수사를 가능하게 합니다. 사이버 시대에 들어서는 첨단 네트워크 보안 기술과 데이터 분석 기법을 활용해 해킹, 사이버 금융 사기, 개인정보 침해 같은 새로운 위협에도 대응합니다. 인터폴은 전문 수사관, 과학 수사 전문가, 그리고 디지털 보안 전문가들로 구성되어 있으며, 범죄 예방과 국제적 법질서 유지를 위해 실시간 모니터링 시스템을 운영합니다. 또한 각국에 교육·훈련 프로그램을 제공하고, 새로운 형태의 범죄에 대비하는 국제적 규약과 기술적 대응 방안을 마련하는 것을 중요한 임무로 삼습니다.'),
...
UPDATE Language_ko_KR
SET Text = '공중정찰유닛'
WHERE Tag = 'TXT_KEY_UNIT_HELICOPTER_COMBAT';
...
-- [[비행 교역 유닛]]  -----------------------------------------------------------------------------------------------------------------------------------
-- 헬류 대상 비행선
('TXT_KEY_UNIT_CARAVAN_BLIMP', 'Helium Caravan Airship'),
('TXT_KEY_UNIT_CARAVAN_BLIMP_HELP', 'Helium Caravan Airship'),
('TXT_KEY_UNIT_CARAVAN_BLIMP_STRATEGY', 'Helium Caravan Airship'),
('TXT_KEY_UNIT_CARAVAN_BLIMP_TEXT', 'Helium Caravan Airship'),
-- 헬류 대상 비행선
('TXT_KEY_UNIT_CARGO_SHIP_BLIMP', 'Helium Caravan Airship'),
('TXT_KEY_UNIT_CARGO_SHIP_BLIMP_HELP', 'Helium Caravan Airship'),
('TXT_KEY_UNIT_CARGO_SHIP_BLIMP_STRATEGY', 'Helium Caravan Airship'),
('TXT_KEY_UNIT_CARGO_SHIP_BLIMP_TEXT', 'Helium Caravan Airship'),
-- [[개척자]]  -----------------------------------------------------------------------------------------------------------------------------------
-- Modern Colonist
...
-- WWI Zeppelin
('TXT_KEY_UNIT_WWI_ZEPPELIN',               '내연비행선'),
('TXT_KEY_UNIT_WWI_ZEPPELIN_TEXT',          '체펠린 비행선이 등장하기이전, 일부 선구자들은 보일러와 증기기관으로 프로펠러를 돌려 기류를 거슬러 비행하려 했습니다. 1852년 앙리 기프하르는 석유를 연료로 써 화재 위험을 줄이고, 길쭉한 가스 포낭과 꼬리날개, 증기기관(약 3마력)로 추진하는 “유도 기구”를 선보였습니다. 이 증기-전기모터비행선들은 기존의 증기열기구보다 조종성이 좋았지만, 무거운 기관과 연료, 수소 가스와 화염이 공존하는 위험 때문에 항속과 안전성에 한계가 있었다. 그럼에도 이 기술은 이후 전기·내연기관형 유도 비행선과 강구조(체펠린)로 이어지는 과도기의 중요한 디딤돌이 되었습니다.'),
('TXT_KEY_UNIT_WWI_ZEPPELIN_STRATEGY',      '내연비행선은 현대 시대의 강력한 공중정찰유닛으로, 도시 공격에도 유용합니다. 국경을 감시하고 해상 정찰을 수행하거나, 방어가 약한 적 도시를 기습하세요.'),
('TXT_KEY_UNIT_WWI_ZEPPELIN_HELP',          '현대시대 공중정찰유닛으로 국경을 감시할 수 있습니다. 산악과 해양타일 위에 떠있을 수 있습니다.'),
--CAS fighter
('TXT_KEY_UNIT_PREDATOR_DRONE',             '근접항공지원기(CAS)'),
...
('TXT_KEY_UNIT_PREDATOR_DRONE_STRATEGY',    'CAS 근접항공지원기는 지상 유닛에 강한 정보화 시대의 공중정찰유닛입니다. 전선 근처로 재배치해 전차·포병을 우선 제거하고, 정찰/레이더와 연계해 안전한 타격 루트를 확보하세요. 대공망과 요격기에 취약하므로 제공권과 SEAD 이후 운용이 효율적입니다.'),
