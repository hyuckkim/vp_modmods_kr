...
UPDATE Language_ko_KR
SET Text = '[COLOR_YELLOW]프로메테우스 우주 계획[ENDCOLOR]은 지구의 고갈되는 자원에서 새로운 무대로 옮기는 시작을 알립니다. [NEWLINE][NEWLINE]당신의 문명이 처음으로 프로젝트를 완료했다면 [ICON_CAPITAL]수도 근처에 [ICON_GREAT_SCIENTIST][COLOR_YELLOW]위대한 과학자[ENDCOLOR]가 1명 출현하고, 문명이 즉시 [ICON_GOLDEN_AGE]황금기가 시작됩니다.'
...
UPDATE Language_ko_KR
SET Text = '인류의 탐험욕구와 지적 호기심은 그들을 지구를 넘어 우주로 이끌었습니다. 프로메테우스 우주계획은 이러한 인류의 우주 탐험 본능을 대표하는 핵심적인 기관입니다. 이 계획은 우리의 태양계와 가장 가까운 별, 알파 센타우리로의 항성간 여행을 꿈꾸는 인류의 결실입니다. 프로메테우스 프로그램은 그러한 목표를 실현하기 위해 연구, 기술개발, 우주선 제작 등 다양한 분야에서 활동을 진행하며 인류의 우주 진출을 선도하고 있습니다.이 탄생 배경은 20세기 중반부터 시작된 우주 경쟁에서 시작되었습니다. 이 시기, 각 나라는 자신들의 국력을 과시하고 기술력을 확보하기 위해 우주 연구에 힘을 쏟았습니다. 그리고 이러한 연구의 결과로 우리는 달에 인간을 보내고, 화성을 탐사하며, 가장 가까운 별인 알파 센타우리로 우주선을 보내는 기술을 개발을 도전하게 되었습니다.그러나, 이런 기술 개발이 순전히 과학적인 목표를 위한 것만은 아니었습니다. 기후 변화, 자원 부족, 인구 과밀 등 지구상의 여러 문제들로 인해 우리의 생존 공간을 넓히는 것도 중요한 목표가 되었습니다. 프로메테우스 우주계획은 이러한 목표를 실현하기 위한 중요한 단계로, 인류의 우주 진출을 이끌고 있습니다.오늘날, 항성간 여행의 가능성을 연구하고, 인류의 우주 존재를 확장하는 데 필요한 기술을 개발하며, 알파 센타우리로의 첫 항성간 여행을 준비하는 등의 중요한 역할을 수행하고 있습니다. 이러한 노력은 우리의 지식을 넓히고, 새로운 가능성을 탐구하며, 결국은 인류의 우주 진출을 가능하게 할 것입니다.'
...
('TXT_KEY_TECH_FW_SPACE_EXPLORE_TITLE','우주 탐사'),
('TXT_KEY_TECH_FW_SPACE_EXPLORE_DESC','인류는 마침내 대기의 한계를 넘어 우주로 향했습니다. 궤도에 올려진 거대한 망원경들은 지구에서는 결코 볼 수 없었던 은하와 성운, 그리고 우주의 탄생 흔적까지 포착하기 시작했습니다. 이 시기 우주 탐사는 단순한 경쟁을 넘어 새로운 지식의 전환점을 만들었으며, 인류는 우주라는 미지의 장막을 하나씩 걷어내기 시작했습니다.[NEWLINE]각국 정부는 여전히 우주 탐사에 막대한 자원을 투입하며 주도권을 유지하고 있지만, 상업 기업들 역시 점차 우주 산업에 뛰어들어 인공위성 통신, 소형 탐사선, 상업 발사체 같은 새로운 분야를 개척하고 있습니다. 이로써 궤도 위에서의 복잡한 통신망이 구축되고, 미세중력 환경을 활용한 연구와 산업 생산의 가능성도 열리게 되었습니다.[NEWLINE]무엇보다 중요한 것은, 인류가 이제 처음으로 우주의 비밀을 과학적으로 밝혀내기 시작했다는 점입니다. 과거 신화와 상상 속에서만 존재하던 우주가 점차 현실의 탐사와 관측 속에서 그 모습을 드러내고 있는 것입니다.'),
('TXT_KEY_TECH_FW_SPACE_EXPLORE_HELP','미래시대 개척자를 생산할 수 있습니다. 우주선 공장과 허블 망원경을 건설하여 우주 개발을 할 수 있습니다. 우주선 발사과정에서 얻은 기술로 탄도미사일과 집속탄 미사일 유닛을 생산할 수 있습니다. '),
('TXT_KEY_TECH_FW_SPACE_EXPLORE_QUOTE','[NEWLINE][TAB][TAB]"달 및 기타 천체를 포함한 우주 공간의 탐사 및 사용은 경제 또는 과학 발전 정도에 관계없이 모든 국가의 이익과 이익을 위해 수행되어야 합니다. , 그리고 모든 인류의 영역이 될 것입니다."[NEWLINE][TAB][TAB] - 달 및 기타 천체를 포함한 우주 공간의 탐사 및 사용에 관한 국가 활동을 규율하는 원칙에 관한 조약 제1조[ NEWLINE][TAB]'),
...
('TXT_KEY_TECH_FW_METAVERSE_TITLE','가상 시뮬레이션'),
('TXT_KEY_TECH_FW_METAVERSE_DESC','가상 시뮬레이션 기술은 현실의 복잡한 현상을 안전하고 정밀하게 재현할 수 있는 환경을 제공합니다. 이를 통해 과학 연구, 군사 훈련, 산업 설계 등에서 실제 실험의 한계와 위험을 극복하며, 미래 시나리오를 미리 검증하고 최적화할 수 있는 길을 열어줍니다.'),
('TXT_KEY_TECH_FW_METAVERSE_HELP','가상훈련장을 건설하여 군사유닛의 경험치를 빠르게 향상시킬 수 있습니다. 메타버스 박물관을 건설하여 문화와 관광의 산출을 올릴 수 있습니다. 가상 아이돌을 건설할 수 있습니다.'),
('TXT_KEY_TECH_FW_METAVERSE_QUOTE','[NEWLINE][TAB][TAB]"우리는 시뮬레이션을 통해 불가능한 것을 가능하게 하고, 위험한 것을 안전하게 만들며, 미래를 미리 경험할 수 있습니다."[NEWLINE][TAB][TAB]- Ivan Sutherland[NEWLINE][TAB]'),

('TXT_KEY_TECH_FW_DATA_SCIENCE_TITLE','데이터 과학'),
('TXT_KEY_TECH_FW_DATA_SCIENCE_DESC','데이터 과학은 인류가 생성하는 방대한 양의 데이터를 수집·저장·분석하여 새로운 가치를 창출하는 기술입니다.[NEWLINE][NEWLINE]인터넷, IoT 센서, 위성, 유전자 분석 등에서 쏟아지는 데이터는 전통적인 방법으로는 처리할 수 없을 만큼 방대해졌으며, 이를 분석하고 해석하기 위해 빅데이터 알고리즘과 인공지능이 결합된 새로운 패러다임이 등장했습니다.[NEWLINE][NEWLINE]이 기술을 통해 질병 확산 예측, 기후 변화 분석, 도시 에너지 효율화, 교통 흐름 최적화, 실시간 경제 동향 파악 등 과거에는 불가능했던 복잡한 문제들을 해결할 수 있습니다. 미래에는 데이터 기반의 예측 모델이 과학, 산업, 행정, 국방 등 사회 전 영역의 의사결정을 혁신적으로 변화시킬 것입니다.'),
('TXT_KEY_TECH_FW_DATA_SCIENCE_HELP','도시에 테마별 데이터 서버를 건설하여 과학, 문화, 골드, 생산 산출량을 증가시킬 수 있습니다. 추가로 발전기를 건설하여 데이터 인프라를 구축할 수 있습니다.'),
('TXT_KEY_TECH_FW_DATA_SCIENCE_QUOTE','[NEWLINE][TAB][TAB]"데이터 없이는 이론도, 과학도, 혁신도 존재할 수 없습니다."[NEWLINE][TAB][TAB]- Peter Norvig[NEWLINE][TAB]'),

('TXT_KEY_TECH_FW_NANOMATERIALS_TITLE','나노물질 공학'),
('TXT_KEY_TECH_FW_NANOMATERIALS_DESC','나노물질 공학은 미세 가공 연구와 재료 합성 기술의 발전을 바탕으로, 기존의 석탄·석유·철광석과 같은 산업 자원을 단순 연료나 원료로 소비하는 데 그치지 않고, 그 속에 남아 있는 탄소 구조와 미량 광물 성분을 활용하여 기능성 나노구조를 합성할 수 있는 가능성을 열었습니다.[NEWLINE]이러한 과정을 통해 얻어진 초미세 구조의 재료들은 독특한 광학적, 전자적, 기계적 성질을 제공하며, 미래의 에너지 시스템, 우주 탐사 장비, 생명공학 연구소와 같은 과학 시설들의 성능을 획기적으로 향상시킬 수 있습니다.[NEWLINE]궁극적으로 나노물질 공학은 전통 자원의 활용 방식을 혁신적으로 전환시켜, 고갈 위기에 직면한 산업 자원에 새로운 생명을 불어넣고, 인류가 직면한 에너지·환경 문제의 해결책을 제시하는 미래 기술의 핵심으로 자리 잡게 될 것입니다.'),
('TXT_KEY_TECH_FW_NANOMATERIALS_HELP','나노물질 제조소에서 얻은 재료와 추출 기술덕에 나노물질을 가공할 수 있는 나노물질 공장과 석탄, 석유,  건설할 수 있습니다. 나노공학 연구센터를 건설 할 수 있습니다.'),
...
('TXT_KEY_TECH_FW_ARTIFICIAL_ENVIRONMENTS_HELP','수직형 농장을 건설하여 식량 생산과 과학 산출량을 증가시킬 수 있습니다. 연안을 경비하는 고속정과 방어를 하기위한 미래시대 보병을 양산할 수 있습니다. 농장 타일을 개선하는 수경재배지구를 건설할 수 있습니다. 이든프로젝트를 건설할 수 있습니다.'),
...
('TXT_KEY_TECH_FW_BIOTECHNOLOGY_TITLE','생명기술공학'),
('TXT_KEY_TECH_FW_BIOTECHNOLOGY_DESC','생명기술공학은 점점 더 정교한 생명공학적 기법을 활용하여 유기물질의 구조와 기능을 분자 단위에서 조작하는 기술로 발전하고 있습니다. 특히 해양 생태계에서 발견되는 다양한 생체 유래 물질과 미세생물의 대사 과정을 분석하면서, 이들이 무기질과 상호작용할 때 나타나는 독특한 화학·물리적 특성이 주목받고 있습니다.[NEWLINE]이러한 연구는 특정 금속 이온이나 광물 성분이 단백질·핵산·지질 등 유기 분자와 결합해 새로운 촉매 구조를 형성하거나, 에너지 전환 반응을 가속화하는 원리를 밝혀내고 있습니다. 나아가 해양 미생물과 무기질의 공생적 대사 경로를 모사하거나 인공적으로 설계함으로써, 환경 친화적 에너지 생산·오염 물질 분해·신소재 합성 같은 분야에서 혁신적인 응용 가능성이 열리고 있습니다.[NEWLINE]궁극적으로 바이오공학과 재료과학의 융합은 생명체의 유기적 복잡성과 무기질의 물리·화학적 안정성을 결합하여, 미래 생명과학 기술과 산업 전반의 획기적 변화를 이끌 핵심 기반으로 자리 잡고 있습니다.'),
('TXT_KEY_TECH_FW_BIOTECHNOLOGY_HELP','탄도미사일잠수함을 양산할 수 있습니다. 바이오공장이나 해양바이오 산업단지를 건설하여 도시의 생산력을 올릴 수 있습니다. 첨단바이오연구소를 개발하여 도시의 산출을 증가시킬 수 있으며, 제노포자 배양지를 건설할 수 있습니다.'),
('TXT_KEY_TECH_FW_BIOTECHNOLOGY_QUOTE','[NEWLINE][TAB][TAB]"바이오기술이 일상적으로 널리 퍼지면, 우리는 다윈적 진화를 넘어 설 수 있는 시대에 들어서게 됩니다. 금속 추출 능력을 지닌 해양 생물처럼, 새로운 생명 형태가 화석 연료 대신 환경적 순환을 가능하게 할 수 있습니다."[NEWLINE][TAB][TAB]- Freeman Dyson[NEWLINE][TAB]'),

('TXT_KEY_TECH_FW_BIOMEDICAL_TITLE','의생명공학'),
('TXT_KEY_TECH_FW_BIOMEDICAL_DESC','의생명공학은 배아줄기세포 연구와 정밀 유전자 편집 기술의 발전을 바탕으로, 손상된 조직과 장기를 유전적으로 재설계하여 맞춤형 치료와 장기 재생을 가능하게 하는 미래 의생명공학입니다. CRISPR-Cas9과 같은 유전자 편집 도구와 줄기세포 배양 기술을 결합함으로써, 특정 질환에 저항성을 가진 세포를 설계하거나, 맞춤형 장기를 실험실에서 배양해 이식하는 것이 현실화되고 있습니다. 이러한 연구는 유전자 치료뿐만 아니라 인간의 질병 취약성을 근본적으로 줄이고, 유전적 특성을 개선하는 데까지 확장되고 있습니다. 이 기술은 단순한 치료를 넘어 인간 생물학의 한계를 재설계하는 새로운 시대를 열어가고 있습니다.'),
('TXT_KEY_TECH_FW_BIOMEDICAL_HELP','의생명공학 기술을 통해 유전자 편집 연구소와 배아줄기세포 재생 센터를 이용한 생체강화센터를 건설할 수 있으며, 맞춤형 치료를 위한 고급 의료 유닛과 특수 연구 시설을 생산할 수 있습니다. 이를 통해 도시의 식량 산출량증대로 인구 성장에 이점을 제공할 수 있습니다.'),
('TXT_KEY_TECH_FW_BIOMEDICAL_QUOTE','[NEWLINE][TAB][TAB]"우리는 더 이상 자연 선택의 수동적 산물이 아니라, 생명을 설계하는 능동적 주체가 되고 있습니다."[NEWLINE][TAB][TAB] - Jennifer Doudna[NEWLINE][TAB]'),

('TXT_KEY_TECH_FW_GENERATIVE_AI_TITLE','AI: 생성형'),
('TXT_KEY_TECH_FW_GENERATIVE_AI_DESC','생성형 AI는 지식·언어·시각·코드를 실시간으로 생성·결합해 연구와 산업의 개발 주기를 대폭 단축합니다. 사람은 AI와 협업하여 기억력·분석력·창작력이 확장되고, 소수의 팀도 대규모 조직에 맞먹는 생산성을 발휘합니다. 데이터와 모델이 상호강화되는 가속 루프는 신소재 설계, 신약 탐색, 도시 운영, 외교 분석 등 전 영역의 의사결정을 고도화하며, 이를 선점한 문명은 혁신의 속도 자체로 우위를 확보합니다.'),
('TXT_KEY_TECH_FW_GENERATIVE_AI_HELP','생성형 AI를 통해 네트워크 중심지와 데이터 타워를 건설할 수 있으며, 모든 산출량을 동시에 증가시킵니다. 또한 AI 기반 행정 시스템을 구축하여 도시의 생산성과 외교적 영향력을 높일 수 있습니다. 해양타일에 해상발전기를 건설할 수 있습니다.'),
('TXT_KEY_TECH_FW_GENERATIVE_AI_QUOTE','[NEWLINE][TAB][TAB]"AI는 인류가 만든 가장 강력한 도구이자, 우리가 스스로를 이해하는 방식을 바꾸는 열쇠입니다."[NEWLINE][TAB][TAB]- Geoffrey Hinton[NEWLINE][TAB]'),

('TXT_KEY_TECH_FW_FUTURE_BALLISTICS_TITLE','미래형 탄도학'),
('TXT_KEY_TECH_FW_FUTURE_BALLISTICS_DESC','미래형 탄도학은 단순한 로켓 공학을 넘어, 우주와 전장을 아우르는 첨단 무기 체계를 가능하게 하는 핵심 기술입니다. 이 단계에서는 극초음속 미사일 체계가 개발되어 마하 10을 넘는 속도로 전 세계 어디든 수 분 내 타격할 수 있습니다. 또한 재사용 가능한 우주 발사체 기술은 준궤도 폭격기와 궤도 폭격 시스템을 현실화하여, 지구 저궤도에서 직접적인 전력 투사가 가능해집니다. 이 모든 기술은 미래형 전쟁 양상을 근본적으로 바꾸는 전략적 전환점을 제공합니다.'),
('TXT_KEY_TECH_FW_FUTURE_BALLISTICS_HELP','미래형 탄도학을 통해 극초음속 미사일, 스텔스 무인 전투기, 준궤도 폭격기 같은 첨단 유닛을 생산할 수 있습니다. 재사용 발사체 기술은 우주 시설 건설 속도를 가속화하며, 도시의 생산력과 군사 작전 능력을 동시에 향상시킵니다. 정찰유닛의 GPS 보정에 따른 능력 상승을 얻게됩니다.'),
...
('TXT_KEY_TECH_FW_GEO_ENERGY_TITLE','지구에너지공학'),
('TXT_KEY_TECH_FW_GEO_ENERGY_DESC','지구에너지공학은 심층 시추공을 통해 지구 내부의 열에너지와 광물 자원을 직접 탐사·활용하고, 기존의 식물 기반 바이오연료 생산 기술을 고도화하여 지속 가능한 에너지 체계를 구축하는 학문입니다. 첨단 지구물리 연구소에서는 지각·맨틀의 지열 데이터와 지구화학적 분석을 바탕으로 새로운 에너지원을 개발하고, 심층 채굴 기술은 고온·고압 환경에서도 안정적인 자원 확보를 가능하게 합니다. 이 기술은 기존의 화석 연료 의존도를 줄이고, 바이오연료와 지구 내부 에너지를 융합하여 미래 도시와 산업의 전력 수요를 충족시키는 핵심 기반이 됩니다.'),
('TXT_KEY_TECH_FW_GEO_ENERGY_HELP','지구에너지공학을 통해 심층 시추공과 지구물리 연구소를 건설하여 도시의 에너지 산출량을 대폭 향상시킬 수 있습니다. 또한 첨단 바이오연료 정제공장을 운영하여 식물 자원과 광물 자원을 고효율 에너지원으로 전환할 수 있습니다.'),
('TXT_KEY_TECH_FW_GEO_ENERGY_QUOTE','[NEWLINE][TAB][TAB]"지열 에너지는 세 가지 자원을 제공합니다: 난방·냉방·발전을 위한 에너지원, 저장 자원, 그리고 광물 자원입니다."  [NEWLINE][TAB][TAB]- Amanda Kolker, 미국 국립재생에너지연구소(NREL)[NEWLINE][TAB]'),

('TXT_KEY_TECH_FW_SYNTHETIC_BIOLOGY_TITLE','합성생물학'),
('TXT_KEY_TECH_FW_SYNTHETIC_BIOLOGY_DESC','합성생물학은 세포 유전자 조작을 넘어 멸종된 생물의 형질을 부분적으로 복원할 수 있는 미래 기술로 발전했습니다. 현대의 유전자 편집과 DNA 합성 기술은 고대 생물의 DNA가 온전히 남아 있지 않더라도, 가까운 현생 종(예: 조류)의 게놈을 기반으로 결손 부위를 역코딩·재구성하여 고대 생물의 유전자 지도를 추정할 수 있게 합니다. 이러한 방식은 ‘치킨 사우루스(Chickenosaurus)’ 연구처럼 발달 유전자를 조절해 원시적 형질을 되살리는 접근과 유사합니다. 실험실에서 인공 배아를 배양하는 과정을 통해 잃어버린 형질을 되살리거나 새로운 개체를 창출할 수 있으며, 이 연구는 단순 복제를 넘어 멸종 생물 복원, 유전자 개량, 생태계 복원으로까지 확장되며 생명공학과 생태 보전의 경계를 허무는 혁신적 전환점이 되고 있습니다.'),
('TXT_KEY_TECH_FW_SYNTHETIC_BIOLOGY_HELP','쥬라기 공원을 건설하여 공룡 유닛과 복원된 고대 생물을 생산할 수 있습니다. 복제연구소를 건설하여 군사 한도를 증가시키고, 도시의 문화와 과학 산출량을 향상시킬 수 있습니다.'),
('TXT_KEY_TECH_FW_SYNTHETIC_BIOLOGY_QUOTE','[NEWLINE][TAB][TAB]"생명은 길을 찾아낸다." [NEWLINE][TAB][TAB]- Ian Malcolm, Jurassic Park[NEWLINE][TAB]'),

('TXT_KEY_TECH_FW_BIO_HYBRID_TITLE','생체하이브리드공학'),
('TXT_KEY_TECH_FW_BIO_HYBRID_DESC','생체의공학과 바이오공학의 발전은 오랫동안 해결되지 않았던 바이오 물질과 금속 사이의 근본적 간극을 메우기 시작했습니다. 초기 연구에서는 세포 기반 조직과 합성 금속 구조가 서로 다른 물리·화학적 특성 때문에 면역 거부 반응을 유발하거나 기능적 결합이 제한되는 문제가 있었습니다. 그러나 생체 적합성 코팅, 유전자 수준의 조직 재설계, 그리고 나노 단위 금속-세포 결합 기술의 융합은 마침내 이 장벽을 허물고 양측 물질을 자유롭게 변환·결합할 수 있는 특이점을 열어 주었습니다. 이러한 기술적 도약은 단순한 보철 장치를 넘어, 신체 조직 내에 거부반응 없이 통합되는 생체기계적 신체 개조와 자가 재생 장치 개발의 길을 열게 되었습니다.'),
('TXT_KEY_TECH_FW_BIO_HYBRID_HELP','생체하이브리드공학을 통해 도시에서 바이오-금속 융합 배양소/추출소를 건설할 수 있습니다. 이 건물은 미래형 전략 자원을 기존 자원에서 추출할 수 있게 합니다. 하이브리드 유닛으로 진화한 공중정찰 유닛 생산이 가능합니다.'),
...
('TXT_KEY_TECH_FW_INTEGRATED_AI_TITLE','AI: 통합형'),
('TXT_KEY_TECH_FW_INTEGRATED_AI_DESC','통합형 AI는 시각을 넘어 청각·촉각·후각·미각 등 오감 정보를 고정밀 센서로 데이터화하고, 이를 다중모달 모델이 통합·추론하여 현실 환경을 맥락적으로 이해하는 기술입니다. 인지–계획–제어가 하나의 폐루프로 결합되어 실시간 대응과 예측적 제어가 가능해지며, 생성형 AI의 표현력을 실세계 피드백과 결합해 안전성·정확성·적응성이 지속적으로 향상됩니다.'),
('TXT_KEY_TECH_FW_INTEGRATED_AI_HELP','통합형 AI를 통해 발전한 기술에 의해 휴모노이드 로봇 공장을 건설할 수 있으며, 그에 따른 원격허브 시스템이 강화됩니다.'),
('TXT_KEY_TECH_FW_INTEGRATED_AI_QUOTE','[NEWLINE][TAB][TAB]"우리는 이제 단순히 생각하는 기계가 아니라 세상을 경험하고 해석하는 지능을 만들고 있다."[NEWLINE][TAB][TAB]- Rodney Brooks[NEWLINE][TAB]'),

('TXT_KEY_TECH_FW_ADVANCED_MATERIALS_TITLE','고에너지 신소재공학'),
('TXT_KEY_TECH_FW_ADVANCED_MATERIALS_DESC','고에너지 신소재공학은 초정밀 레이저, 극저온 냉각, 고압 고온 환경 시뮬레이션을 결합하여 상온 초전도체의 실현에 박차를 가하는 기술 분야입니다. 상온 초전도체는 저항 없는 전력 전송, 극한 자기장 제어, 에너지 효율 극대화 등 미래형 에너지 시스템의 핵심 기반으로 여겨지며, 이를 통해 실리콘 한계를 뛰어넘는 초고속 컴퓨팅 및 자기부상 교통망 구축이 가능해집니다. 이 기술 개발에는 신소재와 원자단위의 조립 연구가 필수입니다. 초고농축 레이저를 통해 핵광자를 연구하여 새로운 차폐막, 냉각장치 등을 개발할 수 있습니다.'),
('TXT_KEY_TECH_FW_ADVANCED_MATERIALS_HELP','정밀 소재 연구소를 건설하여 나노물질과 우라늄을 확보할 수 있습니다. 도시의 과학 산출과 에너지 효율이 향상되고, 애퍼처 사이언스센터를 건설할 수 있습니다.'),
('TXT_KEY_TECH_FW_ADVANCED_MATERIALS_QUOTE','[NEWLINE][TAB][TAB]"상온에서 작동하는 초전도체를 개발하는 것은 진정한 꿈입니다... 이러한 물질은 전자 기반 산업 전부를 혁신할 것이며, 컴퓨팅과 의료, 에너지 생산, 수송까지 완전히 바꿔 놓을 것입니다."[NEWLINE][TAB][TAB]- Dean[NEWLINE][TAB]'),
...
('TXT_KEY_TECH_FW_ASTRODYNAMICS_HELP','궤도역학을 통해 우주 전력위성, 스카이훅 발사 시설를 통해 궤도 감시 네트워크를 건설할 수 있으며, 도시의 생산과 과학 산출량이 증가합니다.'),
...
('TXT_KEY_TECH_FW_TRANSGENICS_DESC','제노포자(Xeno fungus)는 처음에는 정체를 알 수 없는 생물학적 미스터리로 여겨졌습니다. 그러나 유전공학의 발전과 정밀 분석 기술의 발달을 통해 과학자들은 마침내 제노포자 내부에서 고도로 반응적인 돌연변이 촉진 물질, 즉 폴루스 돌연변이원(Pholus Mutagen)을 발견하게 되었습니다. 이 돌연변이원은 후성유전적 경로를 자극해 세포 발현 패턴을 재구성하고, 생물체에 급격하면서도 적응적인 변화를 유도할 수 있음을 보여주었습니다. 인류는 이 물질을 통해 맞춤형 유전자 개조, 고속 진화 시뮬레이션, 그리고 생태계 설계에 이르는 새로운 시대를 열게 되었습니다.'),
('TXT_KEY_TECH_FW_TRANSGENICS_HELP','생명공학센터를 건설해 [ICON_RES_XENO_FUNGUS]제노포자와 폴루스 돌연변이원을 추가로 얻을 수 있습니다. 도시의 과학·식량·생산 산출량이 증가하고, 돌연변이 승급을 지닌 특수 유전자 개조 유닛을 생산할 수 있게 됩니다.'),
...
('TXT_KEY_TECH_FW_NEURAL_INTERFACE_TITLE','뇌신경 인터페이스'),
...
('TXT_KEY_TECH_FW_NEURAL_INTERFACE_HELP','바이오 컴퓨터를 건설하여 도시의 과학을 비약적으로 발전시키고 생명과학과 AI 과학을 융합할 수 있으며, 해상지구 개발과 뉴로SAM발사대, 뉴로순양함, 뉴로구축함 생산을 가능하게 합니다.  도시의 과학과 생산 산출량이 증가합니다.'),
...
('TXT_KEY_TECH_FW_PLASMA_ENERGY_TITLE','초전도-플라즈마 에너지 역학'),
('TXT_KEY_TECH_FW_PLASMA_ENERGY_DESC','초전도-플라즈마 에너지 역학은 초전도체의 무저항 전류 전송 능력과 고온 플라즈마 제어 기술을 결합하여 차세대 에너지 시스템을 가능케 한 융합 학문입니다. 초전도체는 강력한 자기장을 손실 없이 유지할 수 있어, 핵융합로 내부의 초고온 플라즈마를 안정적으로 가두는 데 필수적인 역할을 합니다. 이를 통해 안전하고 지속 가능한 핵융합 발전이 실현되었으며, 나아가 고출력 에너지 저장 장치, 자기부상 교통망, 전자기 추진체계 등으로 응용이 확장되었습니다.[NEWLINE]궁극적으로 이 기술은 플라즈마 에너지 응용과 초전도 기반 양자 회로를 연결하여, 우주항공·국방·첨단 산업 전반에 걸쳐 혁신적인 변화를 일으킬 것으로 전망됩니다.'),
('TXT_KEY_TECH_FW_PLASMA_ENERGY_HELP','초전도-플라즈마 에너지 역학을 통해 자기부상 초고속 철도를 건설할 수 있으며, 플라즈마 폭격기와 첨단 전투기를 생산할 수 있습니다. 또한 우주 정거장에 고성능 에너지 모듈을 추가해 장기적 우주 탐사의 기반을 마련할 수 있습니다.'),
('TXT_KEY_TECH_FW_PLASMA_ENERGY_QUOTE','[NEWLINE][TAB][TAB]"물리학은 예언이 정확할 뿐만 아니라 일상적인 일을 하는 유일한 직업입니다."[NEWLINE][TAB][TAB]- 닐 디그래스 타이슨[NEWLINE][TAB]'),
...
('TXT_KEY_TECH_FW_GENGINEERING_HELP','바이오생명체 관련 시설을 건설하여 바이오생명체 유닛을 강화시킬 수 있습니다. 전략자원이 안 드는 유전자 변형충을 대량 생산할 수 있습니다. 하이브 불가사의를 건설하여 문명의 전투능력을 향상 시킬 수 있습니다.'),
...
('TXT_KEY_TECH_FW_BIOMODIFICATION_HELP','무기폐기물을 재활용하여서 유기물로 전환하는 식량을 비약적으로 증가시킬 수 있는 무기폐기물 재활용소를 건설할 수 있습니다. 바이오 강화센터를 건설하여 화약유닛의 능력을 비약적으로 향상 시킬 수 있습니다.'),
...
('TXT_KEY_TECH_FW_QUANTUM_SYNC_TITLE','양자원격동기화'),
('TXT_KEY_TECH_FW_QUANTUM_SYNC_DESC','양자원격동기화는 인간의 신경계와 원격 장치 간의 실시간 감각·운동 신호를 동기화하는 첨단 기술입니다. 양자 얽힘 기반 전송과 초저지연 신경 인터페이스 덕분에 조종자는 수천 km 떨어진 로봇이나 탐사 드론을 마치 자신의 신체처럼 느끼고 조작할 수 있습니다. 이 기술은 군사 정찰·심해 탐사·우주 임무에서 인간의 감각과 판단력을 원격 시스템에 그대로 확장시키며, 인간과 기계의 경계를 더욱 희미하게 만듭니다.'),
('TXT_KEY_TECH_FW_QUANTUM_SYNC_HELP','기갑유닛에 대한 파괴력과 빠른 이동력이 장점인 호버탱크와 바다의 조용한 암살자인 레비아탄을 생산할 수 있습니다. 양자접속기와 므네모시네 시설을 건설하여 빠른 승급을 위한 경험치 증가 승급을 얻을 수 있습니다.'),
('TXT_KEY_TECH_FW_QUANTUM_SYNC_QUOTE','[NEWLINE][TAB][TAB]"미래의 세계는 로봇 노예의 시중을 받기 위해 누울 수 있는 편안한 해먹이 아니라 지능의 한계에 맞서 훨씬 더 힘든 투쟁이 될 것입니다." - 노버트 와이너[NEWLINE][TAB]'),

('TXT_KEY_TECH_FW_AGI_TITLE','AGI: 강인공지능'),
('TXT_KEY_TECH_FW_AGI_DESC','범용 인공지능(AGI)은 특정 업무에 한정된 기존 AI를 넘어, 인간 수준의 종합적 지능과 자기 인식을 갖춘 시스템을 의미합니다. AGI는 단순한 데이터 분석이나 패턴 인식에 머무르지 않고, 새로운 문제에 대한 자율적 학습, 추론, 창의적 해결 능력을 발휘합니다. 이 기술은 언어 이해, 감각 통합, 장기적 계획 수립까지 인간 사고의 전 영역을 기계적으로 재현하며, 인류 역사상 처음으로 인간과 대등하거나 그 이상의 지능을 지닌 존재의 등장을 예고합니다. 그러나 이와 동시에, AGI가 인류의 조력자가 될지, 혹은 잠재적 경쟁자가 될지에 대한 철학적·윤리적 논쟁 역시 불가피하게 제기되고 있습니다.'),
('TXT_KEY_TECH_FW_AGI_HELP','스카이넷 세계 불가사의를 건설하여 로봇유닛을 강화할 수 있습니다. 빅브라더 관제소를 건설하여 스파이에 대한 저항을 증가시킵니다. 로봇군단을 생산할 수 있습니다. '),
('TXT_KEY_TECH_FW_AGI_QUOTE','[NEWLINE][TAB][TAB]"나는 생각한다, 고로 나는 존재한다."[NEWLINE][TAB][TAB]- 르네 데카르트[NEWLINE][TAB]'),

('TXT_KEY_TECH_FW_PLANETARY_MIGRATION_TITLE', '행성 이주 계획'),
('TXT_KEY_TECH_FW_PLANETARY_MIGRATION_DESC', '행성 이주 계획은 인류가 태양계를 넘어 알파 센타우리와 같은 외계 항성계로 이주하여 새로운 거주지를 개척하려는 장기적인 프로젝트입니다. 이 계획은 지구의 한계를 뛰어넘어 우주 문명의 기틀을 마련하고, 자원 고갈과 환경 위기를 넘어서는 해답을 제시합니다. 알파 센타우리 탐사와 이주 준비는 나노물질과 같은 차세대 자원의 활용, 스페이스마린 및 거대 기계병기 건담의 운용, 그리고 프로메테우스 프로그램으로 인류의 기원에 대한 연구에 더 근본적인 해결을 할 수 있을지도 모릅니다.'),
('TXT_KEY_TECH_FW_PLANETARY_MIGRATION_HELP', '소행성 채굴 기지를 건설하여 나노물질을 얻으십시오. 아주 강력한 방어유닛인 건담과 정찰유닛인 X-COM을 생산할 수 있습니다. 프로메테우스 프로그램을 통해 과학 승리에 다가갑니다.'),
('TXT_KEY_TECH_FW_PLANETARY_MIGRATION_QUOTE', '[NEWLINE][NEWLINE]"화성은 지구에서 충분히 멀리 떨어져 있어서 (전쟁 시) 달 기지보다 생존 가능성이 높기 때문에 화성에서 자립형 기지를 확보하는 것이 중요합니다. 화성에서 자립형 도시를 이루지 못한다면 내 생에 그것을 실패로 여길 것이다." [NEWLINE][NEWLINE]-엘론 머스크[NEWLINE][NEWLINE]'),

('TXT_KEY_TECH_FW_SPACE_HABITATS_TITLE','궤도 거주'),
('TXT_KEY_TECH_FW_SPACE_HABITATS_DESC','궤도 건축공학은 라그랑주 거점과 궤도 링, 아그리돔을 표준화해 지상 의존 없이 거주·생산·연구를 수행하는 초대형 복합 단지를 구현합니다. 무대류·무오염의 미세중력 환경은 초고순도 소재, 단결정 합금, 바이오 배양 등 지상보다 우월한 공정을 가능하게 하며, 태양발전 위성·궤도 정제소·수경재배지구와 연결된 인공환경도시에서 자급자족형 생태 순환을 이룹니다. 소행성 포획 및 벨트 물류망과 연동해 원료를 안정적으로 공급받으며, 궤도 거점은 군사·행정·상업의 허브로 기능합니다.'),
('TXT_KEY_TECH_FW_SPACE_HABITATS_HELP','이 기술을 연구하면 궤도에 거주에 필요한 궤도 식량재배시설을 건축하여 [ICON_RESEARCH]과학·[ICON_FOOD]식량·[ICON_PRODUCTION]생산 산출을 향상시킬 수 있습니다. 또한 세계 불가사의인  **우주궤도정제소**를 건설할 수 있습니다. 고순도 정제와 궤도 식량 재배를 통해 [ICON_RES_NANOMAT]나노물질을 얻을 수 있습니다. 도시를 공격하는 적에게 신의 지팡이로 보복을 할 수 있습니다.)'),
('TXT_KEY_TECH_FW_SPACE_HABITATS_QUOTE','[NEWLINE][TAB][TAB]"공룡은 우주 계획이 없었기에 멸종했다. 그리고 우리가 우주 계획이 없어서 멸종한다면, 그건 당연한 일이다."[NEWLINE][TAB][TAB]- 래리 니븐[NEWLINE][TAB]'),

('TXT_KEY_TECH_FW_GENETIC_ACCELERATION_TITLE','유전자 가속'),
('TXT_KEY_TECH_FW_GENETIC_ACCELERATION_DESC','유전자 가속은 진화와 적응 과정을 분자 수준에서 인위적으로 단축하는 차세대 생명과학 기술입니다. 정밀 유전자 편집과 발현 조절, 인공 선택을 결합해 종의 적응 속도를 높이거나 새로운 생물형을 설계하는 데 활용됩니다. 응용 분야는 크게 두 가지로 나뉩니다. 첫째, ‘유전자 강화’를 통해 기존 생명체의 체력·반응·인지 능력을 개선할 수 있으며, 둘째, ‘유전자 창조’를 통해 특정 임무에 특화된 신생 개체를 설계·배양할 수 있습니다.'),
('TXT_KEY_TECH_FW_GENETIC_ACCELERATION_HELP','이동력이 빠르고 상대방을 괴롭히는 키메라와 궁극의 정찰 유닛인 바이오드론을 생산할 수 있습니다.'),
('TXT_KEY_TECH_FW_GENETIC_ACCELERATION_QUOTE','[NEWLINE][TAB][TAB]"인간은 이 생명의 그물을 짜는 것이 아닙니다. 그는 단지 그것의 한 가닥일 뿐입니다. 그가 거미줄에 무엇을 하든지 그는 자신에게 하는 것입니다."[NEWLINE][TAB][TAB] - 시애틀 추장[NEWLINE][TAB]'),
...
('TXT_KEY_TECH_FW_HUMAN_AUGMENTATION_DESC','유전적 생체 변형과 양자원격동기화의 발전으로 인간 증강의 스펙트럼이 크게 확장되었습니다. 인체의 거의 모든 구성 요소는 배양 조직이나 사이버네틱 대체품으로 보완될 수 있습니다. 동시에 인간 게놈 자체의 한계를 인지하고, 보다 안정된 ‘개선형 게놈’ 설계를 모색하는 실험도 진행되고 있습니다.'),
...
('TXT_KEY_TECH_FW_DIGITAL_SOCIETY_DESC','인공지능의 확산과 양자컴퓨터의 발달로 마음-기계 인터페이스와 원격조종이 일상화되면서 정체성과 존재 방식은 물리적 신체를 넘어 디지털 공간으로 확장되고 있습니다. 사람들은 네트워크를 통해 원격 현존감을 구현하거나 인공 환경을 체감할 수 있으며, 전자적 상호작용이 사회 구조를 재편하는 단계에 이르렀습니다.'),
...
('TXT_KEY_TECH_FW_HOMO_SUPERIOR_HELP','외교승리를 위한 외교관을 얻을 수 있습니다'),
...
('TXT_KEY_TECH_FW_COMPUTRONIUM_HELP','과학 승리에 필요한 부품을 생산할 수 있습니다. .문화 승리에 필요한  세계 시민의정서 프로젝트를 건설할 수 있습니다. '),
...
INSERT INTO Language_ko_KR (Tag, Text) VALUES
-- XENO_FUNGUS
('TXT_KEY_RESOURCE_XENO_FUNGUS', '제노포자'),
('TXT_KEY_RESOURCE_XENO_FUNGUS_HELP', '강력한 미래 시대 유전자유닛, 바이오강화 유닛에 쓰이는 자원입니다. 특정 건물이 있는 도시에서 타일이 생성이 되거나 초원, 평원에서 발견할 수 있습니다.[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]전략 자원 독점 보너스 (25%):[ENDCOLOR] 유닛 추가 경험치 +2.[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]글로벌 독점 보너스 (50%):[ENDCOLOR]전략 자원 타일의 [ICON_RESEARCH]과학 +1, [ICON_CULTURE]문화 +1.'),
('TXT_KEY_RESOURCE_XENO_FUNGUS_TEXT', '**제노포자(Xeno-fungus)**는 지구 토양·식생에서 드물게 발견되는 포자성 복합체입니다. 극한 환경(건조, 금속 이온, 저산소)에 반응해 **후성유전 조절(메틸화/전사 조절)**과 모바일 유전요소 활성을 유도하여, 생물의 비치명적·적응적 변이 확률을 높입니다. 근대 유전공학의 축적 덕분에 이 물질의 작용이 규명되었고, 오늘날 표현형 가속·재생·특수 생체공학에 응용됩니다. [NEWLINE] 제노포자는 외부 스트레스(금속 이온, pH, 산소 농도 등)에 반응해 **세포외 소포(엑소좀)**와 이온 결합 펩타이드를 분비하고, DNA 절단 없이 유전자 발현 프로그램을 재설정합니다. 이 과정은 후성유전 재구성과 트랜스포존 재배치를 통해 적응적 표현형 다양성을 증가시키며, 장기적으로는 종수준 진화 압력을 강화합니다.[NEWLINE]제노포자는 지구에서 발생한 고유의 스트레스 매개체로 보이며, 지질시대의 극심한 환경 변화기에 진화의 불씨로 작동했을 가능성이 제기됩니다. 지구의 급작스런 기후변화로 인해 최근에 증가하는 경향이 있습니다. 높은 농도·장기 노출은 생태계 교란을 유발할 수 있어 엄격한 관리가 필요합니다.'),
-- Nanomaterial
...
INSERT INTO Language_ko_KR (Tag, Text) VALUES
-- 해저터널
('TXT_KEY_UNDERSEA_TUNNEL', '해저터널'),
('TXT_KEY_UNDERSEA_TUNNEL_HELP', '지상 유닛이 이 해안 타일을 횡단할 수 있습니다. 2개 이상의 육지 타일이 인접한 해안 타일에만 건설할 수 있습니다. 2개 또는 3개의 인접한 대지 타일이 있는 타일의 경우 대지 타일이 인접하지 않을 수 있습니다. 노동자에 의해 건설됩니다.[NEWLINE][NEWLINE] 터널을 이용하여 육지로 도시를 연결할 수 있지만, [COLOR_NEGATIVE_TEXT]육상교역로는 연결이 되지 않습니다.[ENDCOLOR]'),
('TXT_KEY_UNDERSEA_TUNNEL_TEXT', '지상유닛이 해저터널을 이용하여 연안타일을 가로질러 빠르고 안전하게 다른 지역으로 이동이 가능합니다.'),
('TXT_KEY_BUILD_UNDERSEA_TUNNEL', '[LINK=IMPROVEMENT_UNDERSEA_TUNNEL]해저터널[/LINK] 건설'),
('TXT_KEY_BUILD_UNDERSEA_TUNNEL_REC', '지상 유닛이 약간의 전투 패널티로 이 타일을 횡단할 수 있게 합니다.'),
('TXT_KEY_BUILD_UNDERSEA_TUNNEL_HELP', '지상 유닛이 이 해안 타일을 횡단할 수 있습니다. 2개 이상의 육지 타일이 인접한 해안 타일에만 건설할 수 있습니다. 2개 또는 3개의 인접한 대지 타일이 있는 타일의 경우 대지 타일이 인접하지 않을 수 있습니다. 노동자에 의해 건설됩니다.[NEWLINE][NEWLINE] 터널을 이용하여 육지로 도시를 연결할 수 있지만, [COLOR_NEGATIVE_TEXT]육상교역로는 연결이 되지 않습니다.[ENDCOLOR]'),
-- 제노포자 배양지
...
('TXT_KEY_BUILD_FW_PRESERVE_HELP','인접한 자연보호구역, 야영지, 제재소, 브라질소방목 벌목장, 간척지에 [ICON_CULTURE]문화가 추가로 +1 증가합니다.이 타일에 주둔하는 유닛의 방어력이 [COLOR_POSITIVE_TEXT]20%[ENDCOLOR] 증가합니다.'),
...
('TXT_KEY_IMPROVEMENT_FW_COMM_ARRAY_HELP','해당 타일의 [ICON_RESEARCH]과학, [ICON_GOLD]골드, [ICON_CULTURE]문화가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. 언덕에 건설하면 [ICON_RESEARCH]과학과 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 추가로 증가합니다. [NEWLINE][NEWLINE]해당 타일에 인접한 마을, 성지, 랜드마크, 고유타일시설에 [ICON_GOLDEN_AGE]황금기 점수가 추가로 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다.[NEWLINE][NEWLINE][COLOR_NEGATIVE_TEXT]서로 인접해서 건설할 수 없습니다.[ENDCOLOR]'),
('TXT_KEY_BUILD_FW_COMM_ARRAY','통신기지국 건설'),
('TXT_KEY_BUILD_FW_COMM_ARRAY_HELP','언덕에 건설하면 [ICON_RESEARCH]과학과 [ICON_GOLD]골드가 +1 증가합니다. 인접한 마을, 성지, 랜드마크, 문명의 특수타일의 [ICON_GOLDEN_AGE]황금기 점수가 +1증가합니다.'),
...
('TXT_KEY_IMPROVEMENT_FW_GENERATOR_TEXT','점점 더 많은 산업이 자동화됨에 따라, 그들은 이용 가능한 발전소와 발전기에 대한 전력 수요를 증가했습니다. 가장 고도로 산업화된 자동화된 지역은 산업에 전력을 공급하는 데 도움이 되는 수많은 보조 발전기를 개발하기 시작했습니다.[NEWLINE][NEWLINE]인접한 소도시, 산업단지, 연구단지, 생명공학센터, 지원중계기, 인공환경도시 시설의 [ICON_GOLD]골드가 +1 증가합니다.'),
('TXT_KEY_IMPROVEMENT_FW_GENERATOR_HELP','해당 타일의 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]5[ENDCOLOR], [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. [NEWLINE][NEWLINE] 인접한 소도시, 연구단지, 산업단지, 생명공학센터, 지원중계기, 인공환경도시의 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다.'),
('TXT_KEY_BUILD_FW_GENERATOR','발전기 건설'),
('TXT_KEY_BUILD_FW_GENERATOR_HELP','인접한 소도시, 연구단지, 산업단지, 생명공학센터, 지원중계기, 인공환경도시의 [ICON_GOLD]골드가 +1 증가합니다.'),
('TXT_KEY_BUILD_FW_GENERATOR_REC','인접한 소도시, 연구단지, 산업단지, 생명공학센터, 지원중계기, 인공환경도시의[ICON_GOLD]골드가 +1 증가합니다.'),
-- 해상발전기
...
('TXT_KEY_IMPROVEMENT_FW_GENERATOR_WATER_HELP','해당 타일의 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]5[ENDCOLOR], [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. [NEWLINE][NEWLINE] 인접한 소도시, 연구단지, 산업단지, 생명공학센터, 지원중계기, 인공환경도시의 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다.'),
('TXT_KEY_BUILD_FW_GENERATOR_WATER','발전기 건설'),
('TXT_KEY_BUILD_FW_GENERATOR_WATER_HELP','인접한 소도시, 연구단지, 산업단지, 생명공학센터, 지원중계기, 인공환경도시의 [ICON_GOLD]골드가 +1 증가합니다.'),
('TXT_KEY_BUILD_FW_GENERATOR_WATER_REC','인접한 소도시, 연구단지, 산업단지, 생명공학센터, 지원중계기, 인공환경도시의[ICON_GOLD]골드가 +1 증가합니다.'),
-- 수경재배지구
...
-- Spaceship factory
UPDATE Language_ko_KR
SET Text = '도시의 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]25%[ENDCOLOR] 증가합니다. [NEWLINE][NEWLINE]우주선 부품을 생산할 때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]35%[ENDCOLOR] 제공합니다.  [NEWLINE][NEWLINE][ICON_RES_ALUMINUM]알루미늄 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]가 필요합니다.'
WHERE Tag = 'TXT_KEY_BUILDING_SPACESHIP_FACTORY_HELP' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='MUCfVP-CAYM' AND Value= 2);

UPDATE Language_ko_KR
SET Text = '도시의 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]25%[ENDCOLOR] 증가합니다. [NEWLINE][NEWLINE]우주선 부품을 생산할 때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]35%[ENDCOLOR] 제공합니다.  도시에서 공중유닛을 생산할 때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR]제공하고, [COLOR_PLAYER_PURPLE]우주선[ENDCOLOR]승급을 부여합니다. [NEWLINE][NEWLINE][ICON_RES_ALUMINUM]알루미늄 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]가 필요합니다.'
WHERE Tag = 'TXT_KEY_BUILDING_SPACESHIP_FACTORY_HELP' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='MUCfVP-CAYM' AND Value= 1);

INSERT INTO Language_ko_KR (Tag, Text) VALUES
-- Aquaculture Lab
('TXT_KEY_BUILDING_FW_AQUACULTURE_LAB', '수산양식 연구소'),
('TXT_KEY_BUILDING_FW_AQUACULTURE_LAB_HELP', '도시 근처에  [ICON_RES_FISH] 물고기가 출현합니다. 도시 주변 해양타일의 [ICON_FOOD]식량이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR], 해양자원의 [ICON_GOLD]골드 및 [ICON_FOOD]식량이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. [NEWLINE][NEWLINE][ICON_FOOD]/[ICON_PRODUCTION]낙후에서 오는 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 감소합니다. [NEWLINE][NEWLINE][COLOR_YELLOW]해안도시[ENDCOLOR]에만 건설할 수 있습니다. [COLOR_PLAYER_NETHERLANDS_BACKGROUND]항만[ENDCOLOR]이 있어야 하고 [COLOR_NEGATIVE_TEXT]해저 채굴 플랫폼, 인공산호초[ENDCOLOR]가 없어야 건설할 수 있습니다.[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]투케이 푸드 기업을 설립하면[ENDCOLOR] [ICON_FOOD]식량이 [COLOR_POSITIVE_TEXT]3[ENDCOLOR] 증가합니다.'),
...
('TXT_KEY_BUILDING_FW_FUNGAL_AGRIGENOMICS_HELP', '도시 근처에 [ICON_RES_XENO_FUNGUS]제노포자 [COLOR_POSITIVE_TEXT]5개[ENDCOLOR]가 있는 타일이 출현합니다. [COLOR_YELLOW]배양지[ENDCOLOR]를 건설하면 자원을 얻을 수 있습니다. [NEWLINE][NEWLINE][COLOR_PLAYER_NETHERLANDS_BACKGROUND]연구소[ENDCOLOR]가 있어야 건설할 수 있습니다.'),  
('TXT_KEY_BUILDING_FW_FUNGAL_AGRIGENOMICS_STRATEGY', '도시에 [ICON_RESEARCH]과학이 +4 ,  [ICON_CULTURE]문화가 +4추가됩니다. 연구소를 건설하여 [ICON_RES_XENO_FUNGUS]제노포자를 얻을 수 있습니다.'),
('TXT_KEY_BUILDING_FW_FUNGAL_AGRIGENOMICS_PEDIA', '제노포자 배양 연구소 또는 제노포자 유전학 연구소는 기능적 유전체학 접근 방식을 사용하여 산업 및 환경 응용 분야를 위한 곰팡이 효소를 식별합니다. 극한 환경에서 성장할 수 있는 능력과 알려진 생분해, 생물정화 및 생촉매 능력에 따라 선택된 진화적으로 다양한 진균 종에 대한 대규모 유전자 발견 프로그램입니다. 농업 유전학(agricultural genomics) 또는 농업 유전체학(농업에 유전학을 적용하는 것)은 지속 가능한 생산성을 지속적으로 추진하고 있으며, 전 세계 인구를 먹여 살리고 생명의 진화, 유전적 돌연변이의 미스터리를 해결하는 점증하는 문제에 대한 솔루션을 제공하고 있습니다. 현대 기술을 사용하여 농부, 육종가 및 연구원은 원하는 특성과 연결된 유전적 마커를 쉽게 식별하여 재배 및 육종 결정을 알릴 수 있습니다.'),

-- Genemod Lab
('TXT_KEY_BUILDING_FW_GENE_LAB', '유전자공학 연구소'),
('TXT_KEY_BUILDING_FW_GENE_LAB_HELP', '모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]유전자공학 연구소[ENDCOLOR]의 [ICON_FOOD]식량이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. [ICON_CITIZEN]시민이 증가할 때 사용한 [ICON_FOOD]식량의 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR]를 저장합니다. [NEWLINE][NEWLINE][ICON_FOOD]/[ICON_PRODUCTION]낙후에서 오는 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 감소합니다. [NEWLINE][NEWLINE][ICON_RES_HORSE]말:[ICON_FOOD]식량 +2[NEWLINE][ICON_RES_COW]소:[ICON_FOOD]식량 +2[NEWLINE][ICON_RES_SHEEP]양:[ICON_FOOD]식량 +2[NEWLINE][ICON_RES_DEER]사슴:[ICON_FOOD]식량 +2[NEWLINE][ICON_RES_BISON]들소:[ICON_FOOD]식량 +2[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]연구소[ENDCOLOR]가 있어야 건설할 수 있습니다.[NEWLINE][NEWLINE][ICON_RES_HORSE]말이 [COLOR_NEGATIVE_TEXT]1마리[ENDCOLOR] 필요합니다. '),
...
-- WORLD_SECURITY
('TXT_KEY_BUILDING_FW_WORLD_SECURITY', '국제치안국'),
...
('TXT_KEY_BUILDING_FW_AUTOPLANT_HELP', '[ICON_CITIZEN]시민 5명마다 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]자동생산시설[ENDCOLOR]의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. [NEWLINE][NEWLINE][ICON_FOOD]/[ICON_PRODUCTION]낙후, [ICON_URBANIZATION]도시화에서 오는 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]씩 감소합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]공장[ENDCOLOR]이 있어야 건설할 수 있습니다.[NEWLINE][NEWLINE][ICON_RES_OIL]석유가 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR] 필요합니다.'),
('TXT_KEY_BUILDING_FW_AUTOPLANT_STRATEGY', '고전적인 공장의 업그레이드 된 자동생산시설은 [ICON_PRODUCTION]생산량을 크게 증가시킵니다.'),
...
('TXT_KEY_BUILDING_FW_NANOMAT_PLANT_STRATEGY', '석탄, 석유, 철을 이용하여 나노물질을 추출이 가능하게 되는 나노물질 추출공장을 설립하기 위한 기반 시설을 건설하며, 나노물질을 제공합니다.'),
('TXT_KEY_BUILDING_FW_NANOMAT_PLANT_PEDIA', '나노물질 제조소는 희토류 원소를 비롯한 특수 자원에서 필수 원소를 추출 및 정제하여 미래 건물 및 첨단 장비에 필요한 복잡한 나노 크기의 구조물을 합성하는 시설입니다. 이 제조소는 단순한 탄소 기반 공정을 넘어, 희토류 등의 신소재의 고유한 전자적 및 광학적 특성을 활용하여 고성능 나노소재의 대량 생산을 가능하게 합니다. 따라서 나노물질 제조소는 단순한 생산 시설을 넘어 미래 문명의 기반으로 전환하는 핵심 허브로 평가받고 있습니다.'),

-- Ecosanctuary
('TXT_KEY_BUILDING_FW_ECOSANCTUARY', '생태친화시설'),
('TXT_KEY_BUILDING_FW_ECOSANCTUARY_HELP', '야영지, 브라질 소방목 벌목장, 제재소, 자연보호구역 및 친환경마을의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. 모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]생태친화시설[ENDCOLOR]의 [ICON_CULTURE]문화가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. 매턴 도시의 [ICON_PRODUCTION]생산의 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR]만큼의 [ICON_CULTURE]문화로 전환합니다. 도시의 [ICON_TOURISM]관광이 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 증가합니다.[NEWLINE][NEWLINE][ICON_CULTURE]무료, [ICON_RELIGION]종교 분쟁에서 오는 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]씩 감소합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]식료품 상점[ENDCOLOR]이 있어야 하고 [COLOR_NEGATIVE_TEXT]수직형 농장[ENDCOLOR]이 없어야 건설할 수 있습니다.'),
...
('TXT_KEY_BUILDING_FW_CRYPTOBANK_HELP', '[ICON_CITIZEN]시민 5명마다 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. 모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]암호화폐 거래소[ENDCOLOR]의 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. 마을의 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. [NEWLINE][NEWLINE][ICON_GOLD]골드로 유닛을 구매하거나 건물 건설에 투자하는 비용이 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 감소합니다. [NEWLINE][NEWLINE][ICON_GOLD]빈곤에서 오는 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 감소합니다. [NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]서버 허브[ENDCOLOR]와 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]증권 거래소[ENDCOLOR]가 있어야 건설할 수 있습니다.[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]시드 무역 주식회사를 설립하면[ENDCOLOR] [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]3[ENDCOLOR] 증가합니다.'),
...
('TXT_KEY_BUILDING_FW_VR_TRAINING_HELP', '통신기지국의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가하고, 생산하는 모든 유닛의 경험치가 [COLOR_POSITIVE_TEXT]25[ENDCOLOR]증가합니다. [ICON_WAR] 지역 군사 보급 한도가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. [NEWLINE][NEWLINE][ICON_CULTURE]무료에서 오는 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 감소합니다.[NEWLINE][ICON_FOOD]/[ICON_PRODUCTION]낙후에서 오는 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 감소합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]사관학교[ENDCOLOR]와 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]서버 허브[ENDCOLOR]가 있어야[ENDCOLOR] 건설할 수 있습니다.'),
...
('TXT_KEY_BUILDING_FW_VIRTUAL_MUSEUM_HELP', '[ICON_CITIZEN]시민 4명마다 [ICON_CULTURE]문화와 [ICON_TOURISM]관광이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]메타버스 박물관[ENDCOLOR]의 [ICON_CULTURE]문화가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. 도시의 [ICON_GREAT_WORK]걸작에서 오는 [ICON_CULTURE]문화 및 [ICON_TOURISM]관광이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. [ICON_GREAT_WORK]걸작 예술품 또는 유물 슬롯 [COLOR_POSITIVE_TEXT]2개[ENDCOLOR]를 포함합니다.[NEWLINE][NEWLINE][ICON_CULTURE]무료에서 오는 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 감소합니다. [NEWLINE][NEWLINE][ICON_GREAT_ARTIST]위대한 예술가의 출현율이 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 증가합니다. [NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]테마[ENDCOLOR]보너스: [ICON_CULTURE]문화 + 6[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]박물관[ENDCOLOR]과 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]서버 허브[ENDCOLOR]가 있어야[ENDCOLOR] 건설할 수 있습니다.[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]조르지오 아르미에 기업을 설립하면[ENDCOLOR] [ICON_CULTURE]문화가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다.'),
...
('TXT_KEY_BUILDING_FW_COMMERCE_SERVER_HELP', '[ICON_CITIZEN]시민 2명마다 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. [NEWLINE][ICON_GREAT_MERCHANT]위대한 상인의 출현율이 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 증가합니다.  [NEWLINE][NEWLINE][ICON_GOLD]빈곤, [ICON_URBANIZATION]도시화에서 오는 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]씩 감소합니다. [NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]서버 허브[ENDCOLOR]와 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]증권거래소[ENDCOLOR]가 있어야 하고 [COLOR_NEGATIVE_TEXT]연구 서버, 클라우드 서버, 엔터테인먼트 서버[ENDCOLOR]가 없어야 건설할 수 있습니다.'),
...
('TXT_KEY_BUILDING_FW_NANOFORGE_HELP', '산업단지의 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. 모든 군사유닛을 생산할 때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR]제공합니다. [ICON_WAR] 지역 군사 보급 한도가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]나노물질제조소[ENDCOLOR]가 있어야 합니다. [NEWLINE][NEWLINE][ICON_RES_NANOMAT]나노물질 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]가 필요합니다.'),
('TXT_KEY_BUILDING_FW_NANOFORGE_STRATEGY', '나노물질 군수공장을 건설하여 군사유닛 생산을 빠르게 할 수 있습니다.[COLOR_POSITIVE_TEXT]산업 단지[ENDCOLOR]에 혜택을 줍니다(산업 단지는 근처 제조소에 [ICON_PRODUCTION]생산 보너스를 추가합니다).'),
...
('TXT_KEY_BUILDING_FW_PARTICLE_ACCELERATOR_HELP', '[ICON_CITIZEN]시민 5명마다 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]증가합니다. 모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]입자 가속기[ENDCOLOR]의 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR]증가합니다. 연구단지의 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. [NEWLINE][NEWLINE][ICON_RESEARCH]문맹에서 오는 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR]감소합니다. [NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]연구소[ENDCOLOR]가 있어야 건설할 수 있습니다. [NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]파이락사이트 소재 [ENDCOLOR]기업을 설립하면 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]3[ENDCOLOR] 증가합니다. '),
...
('TXT_KEY_BUILDING_FW_VERTICAL_FARM_HELP', '농장, 재배지, 계단식 농장, 간척지 및 수경재배지구의 [ICON_FOOD]식량이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. 모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]수직형 농장[ENDCOLOR]의 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. 매턴 도시의 [ICON_FOOD]식량의 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR]만큼의 [ICON_RESEARCH]과학을 제공합니다.[NEWLINE][NEWLINE][ICON_RESEARCH]문맹, [ICON_URBANIZATION]도시화에서 오는 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 감소합니다. [NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]식료품 상점[ENDCOLOR]이 있어야 하고 [COLOR_NEGATIVE_TEXT]제노포자 배양 연구소[ENDCOLOR]가 없어야 건설할 수 있습니다.'),
...
('TXT_KEY_BUILDING_FW_BIOFACTORY_HELP', '도시 주변 초원과 평원 타일의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]바이오 공장[ENDCOLOR]의 [ICON_FOOD]식량[ENDCOLOR]이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR], [COLOR_PLAYER_NETHERLANDS_BACKGROUND]해양 바이오 산업단지[ENDCOLOR]의 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. 매턴 [ICON_PRODUCTION]생산의 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR]를 [ICON_FOOD]식량으로 전환합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]공장[ENDCOLOR]이 있어야 하고 [COLOR_NEGATIVE_TEXT]심층시추공, 지열발전소, 해양바이오산업단지[ENDCOLOR]가 없어야 건설할 수 있습니다. [COLOR_NEGATIVE_TEXT]설원[ENDCOLOR]에는 건설할 수 없습니다.'),
...
('TXT_KEY_BUILDING_FW_OCEAN_BIOHUB', '해양 바이오 산업단지'),
('TXT_KEY_BUILDING_FW_OCEAN_BIOHUB_HELP', '도시 주변 연안 및 대양 타일의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다.모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]바이오 공장[ENDCOLOR]의 [ICON_FOOD]식량[ENDCOLOR]이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR]증가하고, 해양 바이오 산업단지[ENDCOLOR]의 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. 매턴 [ICON_PRODUCTION]생산의 [COLOR_POSITIVE_TEXT]5%[ENDCOLOR]를 [ICON_FOOD]식량과 [ICON_RESEARCH]과학으로 전환합니다.[NEWLINE][NEWLINE][COLOR_YELLOW]해안도시[ENDCOLOR]에만 건설할 수 있습니다. [COLOR_PLAYER_NETHERLANDS_BACKGROUND]항만[ENDCOLOR]이 있어야 하고 [COLOR_NEGATIVE_TEXT]심층시추공, 지열발전소, 바이오공장[ENDCOLOR]이 없어야 건설할 수 있습니다.'),
('TXT_KEY_BUILDING_FW_OCEAN_BIOHUB_STRATEGY', '공장 기반의 해양 공정 허브로, 연안 타일의 생산 효율을 끌어올리며 생산 일부를 식량·과학으로 전환해 장기 성장을 견인합니다. 해양 탐사선과 시험부두에서 축적한 데이터는 제노포자–금속 계면 연구로 이어지며, 후속 Xen–Al(제노–알루) 공정과 바이오-양자 주조소의 발판이 됩니다. 이 건물은 바이오 공장과 인프라·규정이 충돌하므로 서로 배타적입니다.'),
('TXT_KEY_BUILDING_FW_OCEAN_BIOHUB_PEDIA', '해양 바이오 산업단지는 연안·해양에서 확보한 미세조류, 해조류, 해양 미생물의 대사 산물을 산업 규모로 발굴·배양·정제하는 복합 거점입니다. 포토바이오리액터와 발효 라인, 막여과·크로마토그래피 기반의 다운스트림 공정, 화장품·식품용 GMP/HACCP 생산시설을 한곳에 통합하여 시제품부터 양산까지의 파이프라인을 구축합니다. 이곳에서 생산되는 핵심 품목은 기능성 화장품 원료(푸코이단·알긴산·카라기난, 항산화·항염 성분, 마이코스포린계 아미노산의 자외선 차단 모듈), 건강기능식품·영양소(EPA·DHA 등 오메가-3, 해양 폴리페놀), 의약·진단용 효소와 극한효소(저·고온 활성), 친환경 계면활성제와 항오염 생물막 제어소재 등이며, 파일럿 검증–표준화–품질관리 체계를 통해 글로벌 공급망에 연계합니다.[NEWLINE]동시에 단지는 신소재 개발의 전진기지로서 해양 유래 바이오폴리머(PHA/PHB 등 생분해성 플라스틱), 키틴/키토산과 해조류 셀룰로스, 알긴산 에어로젤, 홍합접착단백질 모사 바이오접착제, 저독성 방오 코팅을 비롯한 차세대 바이오매터리얼을 개발·상용화합니다. 영양염 회수·재순환, 이산화탄소 포집·이용, 무방류(Zero-Liquid-Discharge) 공정과 더불어 잘피·해조 ‘묘목장’ 조성 등 블루카본 복원 사업을 병행하여 지속가능성을 확보합니다. 학·연·산 협력과 표준·인증 체계를 통해 지역 경제와 수출 기반을 확장하며, 축적된 데이터와 공정 노하우는 차후의 고도 바이오공정과 첨단 소재 산업을 견인합니다.'),

-- Genejack Facility
('TXT_KEY_BUILDING_FW_BIOTECH_CENTER', '첨단 바이오 연구소'),
('TXT_KEY_BUILDING_FW_BIOTECH_CENTER_HELP', '도시 근처에 [ICON_RES_XENO_FUNGUS]제노포자 [COLOR_POSITIVE_TEXT]2개[ENDCOLOR]가 있는 타일이 출현합니다.[NEWLINE][NEWLINE]도시 주변 평원 타일의 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR], 초원 타일의 [ICON_FOOD]식량 [COLOR_POSITIVE_TEXT]1[ENDCOLOR], 사막, 설원, 툰드라 타일의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]제노포자배양연구소[ENDCOLOR]와 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]유전자공학 연구소[ENDCOLOR]가 있어야 하고 [COLOR_NEGATIVE_TEXT]지구심층 물리연구소[ENDCOLOR]가 없어야 합니다.'),
('TXT_KEY_BUILDING_FW_BIOTECH_CENTER_STRATEGY', 'GMO 식량 재배가 좋은 기후가 있는 지역(초원과 평원)에 산출량을 증가시킵니다. '),
('TXT_KEY_BUILDING_FW_BIOTECH_CENTER_PEDIA', '첨단 바이오연구소는 되었습니다. 토양과 생명체의 관계를 인위적으로 재설계하려는 시도에서 비롯되었습니다. 초기에는 단순히 토양 속 유기체와 미생물을 유전적으로 강화하여 혹독한 환경에서도 영양순환을 촉진하고, 평원·초원·사막·설원·툰드라 같은 다양한 지형에서 산출량을 높이는 데 목적이 있었습니다.[NEWLINE]그러나 연구가 진전되면서 토양 깊숙한 층위에서 나타나는 예상치 못한 반응과 특이한 광물-생체 상호작용이 보고되기 시작했습니다. 일부 학자들은 이를 단순한 돌연변이 가속 현상으로 해석했지만, 다른 이들은 아직 알려지지 않은 근본적 변환 과정이 개입하고 있다고 주장합니다.[NEWLINE]이 과정에서 토양 생태계는 특정 지형의 한계를 넘어 모든 환경에서 그 고유한 성질을 더욱 강화하는 결과를 낳았습니다. 이러한 현상은 여전히 논란이 많지만, 연구소는 토양 개량과 자원 증대에서 뚜렷한 성과를 거두며 각국의 관심을 끌고 있습니다. 동시에 연구자들은 토양 속 미시적 결합 구조에서 생명의 양자적 특성이 물질과 미묘하게 얽혀 있다는 정황을 발견했으며, 이는 앞으로 전혀 새로운 발전 가능성을 열어줄 수 있음을 시사합니다.'),

-- Bio-augmentation Clinic
('TXT_KEY_BUILDING_FW_BIO_AUG_CLINIC', '생체강화센터'),
('TXT_KEY_BUILDING_FW_BIO_AUG_CLINIC_HELP', '[ICON_CITIZEN]시민 10명마다 [ICON_FOOD]식량 및 [ICON_PEACE]신앙이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]VR 훈련장[ENDCOLOR]의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. [NEWLINE]정찰유닛과 화약유닛을 생산할 때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 제공합니다. 도시에서 생산하는 화약유닛에 [COLOR_PLAYER_PURPLE]임플란트[ENDCOLOR]승급을 부여합니다. [ICON_WAR] 군사 유닛 보급 한도가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. [NEWLINE][NEWLINE][ICON_FOOD]/[ICON_PRODUCTION]낙후에서 오는 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 감소합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]병원[ENDCOLOR]이 있어야 하고 [COLOR_NEGATIVE_TEXT]우주선 발사센터[ENDCOLOR]가 없어야 건설할 수 있습니다.'),
('TXT_KEY_BUILDING_FW_BIO_AUG_CLINIC_STRATEGY', '새로이 생산하는 유기체 유닛(클론 트루퍼, 돌연변이, 생체강화 보병, 슈퍼솔져, 바이오 트루퍼)에 생산이 빨라지고, 화약유닛에게 전투력이 증대되는 임플란트 승급을 부여합니다. 도시에 우주선 발사 시설이 있으면 건설할 수 없습니다.'),
('TXT_KEY_BUILDING_FW_BIO_AUG_CLINIC_PEDIA', '생체강화 기술이 급속도로 발전함에 따라, 급속히 성장하는 시장의 요구에 부응하는 전문 서비스를 제공하는 임플란트 클리닉이 빠르게 늘어나고 있습니다. 이러한 시설은 기존의 치과 또는 관절 임플란트를 넘어 심장, 폐, 신장, 간과 같은 인공 장기 이식과 정밀 생체 보철물까지 제공합니다. 훗날 개발되는 신경 인터페이스와 나노 크기의 소재가 통합됨에 따라 생체강화센터는 더 이상 손상된 기능을 회복하는 데 국한되지 않고 인간의 능력을 적극적으로 향상시킬 수 있습니다. 이러한 발전을 통해 사람들은 노화되거나 손상된 신체 부위를 대체하여 더욱 건강하고 장수할 수 있게 되었습니다. 경우에 따라 군사 또는 전문 분야에 특화된 임플란트가 개발되어 개인에게 탁월한 신체적 또는 인지적 능력을 부여하기도 했습니다. 이처럼 임플란트 클리닉은 단순한 의료 시설을 넘어 미래 사회의 장수, 신체 강화, 그리고 생물의학 혁신을 향한 초석으로 자리매김하고 있습니다.'),

-- Network center
('TXT_KEY_BUILDING_FW_NETWORK_BACKBONE', '네트워크 중심지'),
('TXT_KEY_BUILDING_FW_NETWORK_BACKBONE_HELP', '문명의 고유타일시설, 발전기의 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다.[NEWLINE]모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]연구 서버[ENDCOLOR]의 [ICON_RESEARCH]과학, [COLOR_PLAYER_NETHERLANDS_BACKGROUND]엔터테인먼트 서버[ENDCOLOR]의 [ICON_CULTURE]문화, [COLOR_PLAYER_NETHERLANDS_BACKGROUND]전자상거래 서버[ENDCOLOR]의 [ICON_GOLD]골드, [COLOR_PLAYER_NETHERLANDS_BACKGROUND]클라우드 서버[ENDCOLOR]의 [ICON_PRODUCTION]생산이 각각 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. 매턴 [ICON_CULTURE]문화의 [COLOR_POSITIVE_TEXT]5%[ENDCOLOR]를 [ICON_GOLD]골드 및 [ICON_TOURISM]관광으로 전환합니다.[NEWLINE][NEWLINE][ICON_FOOD]/[ICON_PRODUCTION]낙후, [ICON_GOLD]빈곤에서 오는 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 감소합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]서버 허브[ENDCOLOR]가 있어야 건설할 수 있습니다.'),
...
('TXT_KEY_BUILDING_FW_LAUNCH_FACILITY_HELP', '[ICON_CITIZEN]시민 10명마다 [ICON_GOLD]골드 및 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]우주선 공장[ENDCOLOR]의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. [NEWLINE]정찰유닛과 화약유닛을 생산할 때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 제공합니다. 이 도시에서 생산하는 정찰유닛에게 [COLOR_PLAYER_PURPLE]궤도정찰[ENDCOLOR]승급을 부여합니다. 도시의 공중 유닛 정원이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다.[NEWLINE][NEWLINE][ICON_FOOD]/[ICON_PRODUCTION]낙후, [ICON_URBANIZATION]도시화에서 오는 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]감소합니다. [NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]공장[ENDCOLOR]이 있어야 하고, [COLOR_NEGATIVE_TEXT]생체강화센터[ENDCOLOR]가 없어야 건설할 수 있습니다.'),
('TXT_KEY_BUILDING_FW_LAUNCH_FACILITY_STRATEGY', '도시의 생산과 과학 산출량이 증가합니다.'),
('TXT_KEY_BUILDING_FW_LAUNCH_FACILITY_PEDIA', '초창기 로켓은 단순히 대기권 가장자리에 소형 물체를 올리는 수준에 불과했으나, 사람과 대량의 물자를 안정적으로 궤도에 올리기 위해서는 훨씬 더 정교한 시설이 필요했습니다. 우주선 발사센터는 거대한 조립동, 정비·연료·추진체 시스템을 갖춘 복합 단지로, 각국의 과학자와 기술자들이 총동원되는 전략적 거점이었습니다.[NEWLINE]시간이 흐르면서 이러한 발사시설은 진화를 거듭했습니다. 재사용 가능한 발사 플랫폼은 우주 접근 비용을 획기적으로 낮췄고, 고회전 발사체와 전자기 가속기 같은 실험적 기술은 지상에서의 발사 방식을 다변화했습니다. 또한 수직 발사대 외에도 해상·이동식 플랫폼이 운용되며, 우주 발사의 패러다임은 더 이상 국가의 독점적 영역이 아닌 산업 전반으로 확장되었습니다.[NEWLINE]오늘날 우주선 발사센터은 단순한 로켓 발사 기지를 넘어, 항공우주 산업과 과학 연구, 도시 산업 기반까지 동시에 끌어올리는 복합 혁신 거점으로 자리잡았습니다. 이는 인류가 지구 중력의 족쇄를 벗어나 본격적인 우주 문명으로 이행하는 과정에서 반드시 거쳐야 하는 관문이 되었습니다..'),
...
('TXT_KEY_BUILDING_FW_BIOFUEL_REFINERY_HELP', '도시의 해당된 [ICON_RES_WHEAT]밀, [ICON_RES_RICE]쌀, [ICON_RES_BANANA]바나나, [ICON_RES_MAIZE]옥수수 타일의 [ICON_FOOD]식량이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR]증가합니다. 도시의 [ICON_FOOD]식량이 [COLOR_NEGATIVE_TEXT]4[ENDCOLOR] 감소합니다. [NEWLINE][NEWLINE][ICON_RES_OIL]석유 [COLOR_POSITIVE_TEXT]4개[ENDCOLOR]를 제공합니다.[NEWLINE][NEWLINE]도시에 적어도 하나 이상의 개발된 [COLOR_YELLOW][ICON_RES_WHEAT]밀[ENDCOLOR], [COLOR_YELLOW][ICON_RES_RICE]쌀[ENDCOLOR], [COLOR_YELLOW][ICON_RES_BANANA]바나나[ENDCOLOR],[COLOR_YELLOW][ICON_RES_MAIZE]옥수수[ENDCOLOR]타일이 있어야 건설할 수 있습니다.[NEWLINE][NEWLINE]이 건물은 문명당 [COLOR_YELLOW]최대 3개[ENDCOLOR]까지 건설할 수 있습니다.'),
...
-- Geothermal Factory
('TXT_KEY_BUILDING_FW_GEOTHERMAL_FACTORY', '지열발전소'),
('TXT_KEY_BUILDING_FW_GEOTHERMAL_FACTORY_HELP', '이 건물이 지어진 도시 3타일 이내의 산 1개마다 [ICON_PRODUCTION]생산과 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]증가합니다. 언덕 타일의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]이 증가합니다. 모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]심층시추공[ENDCOLOR]의 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR], 모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]지열발전소[ENDCOLOR]의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR]증가합니다. 매턴 [ICON_PRODUCTION]생산의 [COLOR_POSITIVE_TEXT]5%[ENDCOLOR]를 [ICON_GOLD]골드와 [ICON_PRODUCTION]생산으로 전환합니다.[NEWLINE][NEWLINE]도시 주변 [COLOR_YELLOW]2 타일 이내에 산[ENDCOLOR]이 있어야 건설할 수 있습니다. 도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]공장[ENDCOLOR]이 있어야 하고 [COLOR_NEGATIVE_TEXT]심층 시추공[ENDCOLOR]이나 [COLOR_NEGATIVE_TEXT]바이오공장[ENDCOLOR]이 없어야 건설할 수 있습니다.'),
...
('TXT_KEY_BUILDING_FW_BOREHOLE_HELP', '광산, 유정 및 채석장의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]심층 시추공[ENDCOLOR]의 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR], 모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]지열발전소[ENDCOLOR]의 [ICON_PRODUCTION]생산[ENDCOLOR]이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. 매턴 [ICON_PRODUCTION]생산의 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR]를 [ICON_GOLD]골드로 전환합니다. [NEWLINE][NEWLINE]도시에 [COLOR_NEGATIVE_TEXT]산이 없어야[ENDCOLOR] 하고, [COLOR_NEGATIVE_TEXT]바이오공장[ENDCOLOR]이나 [COLOR_NEGATIVE_TEXT]지열발전소[ENDCOLOR]이 없어야 건설할 수 있습니다.'),
...
('TXT_KEY_BUILDING_FW_CLONE_LAB_HELP', '무료 [COLOR_YELLOW]클론 트루퍼[ENDCOLOR] 1명 출현합니다. 건설을 완료하면 [ICON_CITIZEN]시민이 [COLOR_POSITIVE_TEXT]2명[ENDCOLOR] 즉시 증가합니다. [ICON_SILVER_FIST]군사 유닛 보급 한도가 [ICON_CITIZEN]시민의 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR]만큼 증가합니다. [NEWLINE][NEWLINE][ICON_GREAT_PEOPLE]위인 출현율이 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR] 증가합니다. [NEWLINE][NEWLINE][ICON_RES_XENO_FUNGUS]제노포자 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]개를 제공합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]유전자공학 연구소[ENDCOLOR]가 있어야 합니다.'),
...
('TXT_KEY_BUILDING_FW_FEEDSITE_HUB_HELP', '성지, 랜드마크, 자연보호구역 및 통신기지국의 [ICON_CULTURE]문화가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR], [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]  증가합니다.도시의 [ICON_VP_WRITER] 작가, [ICON_VP_ARTIST] 음악가,  [ICON_VP_MUSICIAN] 예술가의 [ICON_CULTURE]문화가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. [NEWLINE][NEWLINE][ICON_CULTURE]무료, [ICON_URBANIZATION]도시화에서 오는 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]씩 감소합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]서버 허브[ENDCOLOR]가 있어야 하고 [COLOR_NEGATIVE_TEXT]유통 허브, 복합도시 허브, 가상현실 허브[ENDCOLOR]가 없어야 건설할 수 있습니다.[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]조르지오 아르미에 기업을 설립하면[ENDCOLOR] [ICON_CULTURE]문화가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다.'),
...
('TXT_KEY_BUILDING_FW_SIMULATION_HUB_HELP', '아카데미 및 연구단지의 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR], [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]  증가합니다. 도시의 [ICON_VP_SCIENTIST] 과학자의 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다.[NEWLINE][NEWLINE][ICON_RESEARCH]문맹, [ICON_URBANIZATION]도시화에서 오는 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]씩 감소합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]서버 허브[ENDCOLOR]가 있어야 하고 [COLOR_NEGATIVE_TEXT]정보관리 허브, 복합도시 허브, 유통 허브[ENDCOLOR]가 없어야 건설할 수 있습니다. '),
...
('TXT_KEY_BUILDING_FW_BIOCONVERTER_NANO_HELP',  "[ICON_RES_NANOMAT]나노물질 [COLOR_POSITIVE_TEXT]4개[ENDCOLOR]를 제공합니다. [NEWLINE][NEWLINE][ICON_RES_XENO_FUNGUS]제노포자 [COLOR_NEGATIVE_TEXT]5개[ENDCOLOR] 와 [ICON_RES_OIL]석유 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]가 필요합니다."),
...
('TXT_KEY_BUILDING_FW_BIOCONVERTER_NANO2_HELP', "[ICON_RES_NANOMAT]나노물질 [COLOR_POSITIVE_TEXT]2개[ENDCOLOR]를 제공합니다. [NEWLINE][NEWLINE][ICON_RES_XENO_FUNGUS]제노포자 [COLOR_NEGATIVE_TEXT]4개[ENDCOLOR]와 [ICON_RES_COAL]석탄 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]가 필요합니다."),
...
-- Bioconverter (Xeno Fungus)
('TXT_KEY_BUILDING_FW_BIOCONVERTER_ADNF', '합성 제노포자 제조소'),
('TXT_KEY_BUILDING_FW_BIOCONVERTER_ADNF_HELP', "[ICON_RES_XENO_FUNGUS]제노포자 [COLOR_POSITIVE_TEXT]5개[ENDCOLOR]를 제공합니다. [NEWLINE][NEWLINE][ICON_RES_NANOMAT]나노물질 [COLOR_NEGATIVE_TEXT]5개[ENDCOLOR]와 [ICON_RES_ALUMINUM]알루미늄 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]가 필요합니다."),
...
-- 로봇생산기지
('TXT_KEY_BUILDING_FW_HUMONOID_FORGE','휴머노이드 로봇 공장'),
('TXT_KEY_BUILDING_FW_HUMONOID_FORGE_HELP','[ICON_CITIZEN]시민 10명마다 [ICON_PRODUCTION]생산 및 [ICON_CULTURE]문화가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]나노물질 군수공장[ENDCOLOR]의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR]증가합니다.[NEWLINE]기갑유닛과 공성유닛을 생산할 때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 제공합니다. [NEWLINE][NEWLINE]전문가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR]명이 더이상 [ICON_URBANIZATION]도시화에서 오는 [ICON_HAPPINESS_3]불행을 증가시키지 않습니다. [NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]나노물질 군수공장[ENDCOLOR]이 있어야 건설할 수 있습니다.'),
('TXT_KEY_BUILDING_FW_HUMONOID_FORGE_STRATEGY','로봇생산에 따른 유닛의 생산력을 올려주는 강력한 미래형 건물입니다.'),
('TXT_KEY_BUILDING_FW_HUMONOID_FORGE_PEDIA','표준화된 휴머노이드 양산 거점도시는 자동생산시설과 나노물질 군수공장에서 넘어온 합금 프레임·고토크 액추에이터·합성 표피를 이곳에서 완성형으로 조립합니다. 관절·전원·감각 모듈은 공통 규격으로 설계되어 바디 교체와 개량이 손쉬우며, 소프트웨어는 데이터 타워를 통해 OTA로 갱신됩니다.[NEWLINE] 각 개체의 보행·조작·균형 알고리즘을 즉시 검증하고, 시뮬레이터 홀에서는 도시별 임무 팩(물류, 유지보수, 재난 대응, 경계)이 탑재됩니다. 생산된 유닛은 인간 작업자와 충돌하지 않도록 안전 규약과 우선순위 규칙을 기본 장착하며, 전개 지역의 환경 맵과 문화 자산도 함께 학습합니다.[NEWLINE][NEWLINE]휴머노이드 로봇 공장은 단순한 인력 대체가 아니라, 인간-로봇 협업을 전제로 공정과 생활권을 재설계하는 인프라입니다. 표준 플랫폼의 대량 보급은 도시 문화와 공공 서비스의 질을 끌어올리고, 중장비와 공성 장비의 조작·정비를 자동화해 전장 투입 속도를 가속합니다.'),
...
('TXT_KEY_BUILDING_FW_DISTRIBUTION_HUB_HELP', '제조소 및 산업단지의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR], [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 도시의 [ICON_VP_ENGINEER] 기술자의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. [NEWLINE][NEWLINE] 도시에 건물을 건설할때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR]제공합니다.[NEWLINE][NEWLINE][ICON_FOOD]/[ICON_PRODUCTION]낙후, [ICON_URBANIZATION]도시화에서 오는 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]씩 감소합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]서버 허브[ENDCOLOR]가 있어야 하고 [COLOR_NEGATIVE_TEXT]정보관리 허브, 복합도시 허브, 가상현실 허브[ENDCOLOR]가 없어야 건설할 수 있습니다.'),
...
('TXT_KEY_BUILDING_FW_METROPLEX_HUB_HELP', '소도시 및 마을의 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]3[ENDCOLOR] 증가합니다. 도시의 [ICON_VP_MERCHANT] 상인의 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다.[NEWLINE][NEWLINE][ICON_GOLD]골드로 유닛을 구매하거나 건물 건설에 투자하는 비용이 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 감소합니다.[NEWLINE][NEWLINE][ICON_GOLD]빈곤, [ICON_URBANIZATION]도시화에서 오는 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]씩 감소합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]서버 허브[ENDCOLOR]가 있어야 하고  [COLOR_NEGATIVE_TEXT]정보관리 허브, 유통 허브, 가상현실 허브[ENDCOLOR]가 없어야 건설할 수 있습니다. [NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]시드 무역 주식회사를 설립하면[ENDCOLOR] [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]3[ENDCOLOR] 증가합니다.'),
...
-- Enrichment Facility
('TXT_KEY_BUILDING_FW_METAMATERIALS_CENTER', '고에너지 신소재연구소'),
('TXT_KEY_BUILDING_FW_METAMATERIALS_CENTER_HELP', '[ICON_RES_URANIUM]우라늄 [COLOR_POSITIVE_TEXT]2개[ENDCOLOR]와 [ICON_RES_NANOMAT]나노물질 [COLOR_POSITIVE_TEXT]1개[ENDCOLOR]를 제공합니다.[NEWLINE][NEWLINE]문명의 [ICON_CITIZEN]시민이 최소 [COLOR_POSITIVE_TEXT]125[ENDCOLOR]명 이상이어야 합니다.[NEWLINE]이 건물은 문명당 [COLOR_YELLOW]최대 3[ENDCOLOR]개까지 건설할 수 있습니다.'),
('TXT_KEY_BUILDING_FW_METAMATERIALS_CENTER_STRATEGY', '우라늄 2개와 나노물질 1개를 제공합니다. 최대 3개까지 지을 수 있습니다. 핵 연료 재처리시설을 건설하려면 문명에 최소 125명의 국가 인구가 필요합니다.'),
...
-- Setellite
('TXT_KEY_BUILDING_FW_SOLAR_REFLECTOR', '우주반사판 전력위성'),
('TXT_KEY_BUILDING_FW_SOLAR_REFLECTOR_HELP', '건설을 완성하면 [COLOR_POSITIVE_TEXT]15턴[ENDCOLOR]동안 "국왕경축일"을 맞이합니다. 도시를 공습하는 공중 유닛에게 주는 [ICON_STRENGTH]피해가 [COLOR_POSITIVE_TEXT]5[ENDCOLOR] 증가합니다. [NEWLINE][NEWLINE]전문가 [COLOR_POSITIVE_TEXT]1명[ENDCOLOR]이 더이상 [ICON_URBANIZATION]도시화에서 오는 [ICON_HAPPINESS_3]불행을 증가시키지 않습니다.[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]핵무기로 파괴되지 않는 건물입니다.[ENDCOLOR] 도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]우주선 발사센터[ENDCOLOR]가 있어야 건설할 수 있습니다.'),
('TXT_KEY_BUILDING_FW_SOLAR_REFLECTOR_STRATEGY', '우주반사판 전력위성은 랑그라주 상업지구, 공업단지, 연구단지와 함께 설치하여 과학, 생산 또는 골드를 높일 수 있습니다.'),
('TXT_KEY_BUILDING_FW_SOLAR_REFLECTOR_PEDIA', '우주반사판 전력위성은 대형 전개식 거울(반사막)과 집광·지향 제어 장치를 갖춘 궤도 플랫폼으로, 태양광을 지상 수광지대로 반사해 일사량을 보강하거나(겨울·야간·피크 시간대 보정), 궤도 내 발전 모듈에서 전력을 생산해 지상 레크테나로 무선 송전하는 하이브리드 체계를 말합니다. 위성은 태양동기·정지궤도 등에서 목표 지역을 따라 빔을 스케줄링하며, 반사밀도·고도·조사 시간대를 미세 조정해 농업·도시·산업 단지의 수요에 맞추어 에너지를 공급합니다. [NEWLINE][NEWLINE]전개형 반사막과 방열 패널, 위상 배열 지향기, 광학 안전 규약(항공/천문 블라인드 존, 생태 조사 한계치)이 표준으로 포함되며, 도시의 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]우주선 발사센터[ENDCOLOR]·네트워크와 연동되어 운영됩니다. 또한 모듈 확장에 따라 재료·열관리 연구(과학), 궤도 제조·정비(생산), 상업 송전·관광(골드) 등 다양한 역할을 수행해 지상의 전력망을 보조하고 에너지 안보와 회복력을 크게 높입니다.'),

-- Transgenic Nursery
('TXT_KEY_BUILDING_FW_TRANSGENIC_NURSERY', '유전자개조 연구소'),
('TXT_KEY_BUILDING_FW_TRANSGENIC_NURSERY_HELP', '[ICON_CITIZEN]시민이 증가할 때 사용한 [ICON_FOOD]식량의 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR]를 저장합니다. 친환경 마을의 [ICON_FOOD]식량과 [ICON_PEACE]신앙이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 근접, 기마, 공중정찰유닛을 생산할 때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 제공합니다.[NEWLINE][NEWLINE]도시에서 생산하는 [COLOR_POSITIVE_TEXT]생명체계열[ENDCOLOR][COLOR:105:105:105:255](근접유닛, 기마유닛, 화약유닛, 공중정찰유닛)[ENDCOLOR] 유닛에 [COLOR_PLAYER_PURPLE]유전자강화[ENDCOLOR] 승급을 부여합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]제노포자 배양 연구소, 유전자공학 연구소[ENDCOLOR]가 있어야하고, [COLOR_NEGATIVE_TEXT]무인관리기지, 항공우주 복합시설[ENDCOLOR]이 없어야 건설할 수 있습니다.'),
...
('TXT_KEY_BUILDING_FW_BIOCOMPUTER_HELP', "도시의 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]25%[ENDCOLOR] 증가합니다. [NEWLINE][NEWLINE]모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]바이오 컴퓨터[ENDCOLOR]의 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]5[ENDCOLOR]증가합니다. 도시의 [ICON_FOOD]식량이 [COLOR_NEGATIVE_TEXT]6[ENDCOLOR]감소합니다.[NEWLINE][NEWLINE][ICON_RESEARCH]문맹에서 오는 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR]감소합니다. [NEWLINE][NEWLINE][ICON_RES_XENO_FUNGUS]제노포자, [ICON_RES_ALUMINUM]알루미늄, [ICON_RES_NANOMAT]나노물질 각 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]씩 필요합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]첨단바이오연구소[ENDCOLOR]가 있어야 합니다."),
...
('TXT_KEY_BUILDING_FW_TIDAL_PORT_HELP', '도시 주변 해양 타일의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR], [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. [NEWLINE][NEWLINE][ICON_CARGO_SHIP]해상 교역로의 길이가 [COLOR_POSITIVE_TEXT]50%[ENDCOLOR] 증가하고, [ICON_INTERNATIONAL_TRADE]교역로의 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. 항공모함을 제외한 해상유닛울 생산할 때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 제공합니다. [ICON_WAR] 지역 군사 보급 한도가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. [NEWLINE][NEWLINE]이 도시에서 다른 문명으로 출발하는 [ICON_CARGO_SHIP]해상 교역로가 완료되면 현재 [ICON_CULTURE]문화와 [ICON_TOURISM]관광 산출량에 기반한 [ICON_TOURISM] 관광을 제공합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]항구[ENDCOLOR]가 있어야 건설할 수 있습니다.[NEWLINE][NEWLINE][ICON_RES_NANOMAT]나노물질 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]가 필요합니다. [NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]센타우리 개발 주식회사를 설립하면[ENDCOLOR] [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다.'),
('TXT_KEY_BUILDING_FW_TIDAL_PORT_STRATEGY', '해상 지구는 항구가 필요한 미래 시대 건물입니다. 해상 교역로의 범위와 골드 산출량을 개선하고 해상 타일과 자원의 가치를 높입니다. 또한 해군 유닛의 생산이 증가하고 군사 유닛 보급 한도가 증가합니다.'),
...
('TXT_KEY_BUILDING_FW_DEFENSE_FIELD_HELP', '도시의 체력이 [COLOR_POSITIVE_TEXT]125[ENDCOLOR] 증가하고, [ICON_STRENGTH]방어력이 [COLOR_POSITIVE_TEXT]20[ENDCOLOR]증가합니다. 핵 공격으로 인한 인구 피해를 [COLOR_POSITIVE_TEXT]20%[ENDCOLOR] 감소시킵니다. [NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]군사 기지[ENDCOLOR]와 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]전략적 방어시스템[ENDCOLOR]이 있어야 건설할 수 있습니다. [COLOR_NEGATIVE_TEXT]해안 도시[ENDCOLOR]는 건설할 수 없습니다.[NEWLINE][NEWLINE][ICON_RES_NANOMAT]나노물질 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]가 필요합니다.'),
...
('TXT_KEY_BUILDING_FW_NANOMINES_FIELD_HELP', '도시의 체력이 [COLOR_POSITIVE_TEXT]50[ENDCOLOR] 증가하고, [ICON_STRENGTH]방어력이 [COLOR_POSITIVE_TEXT]10[ENDCOLOR]증가합니다. [NEWLINE][NEWLINE]적 해상 유닛 및 승선 유닛이 이 도시의 물 타일에 들어오면 행동력을 모두 소모합니다. 이 도시의 대양 타일에서 턴을 마친 적 유닛은 [COLOR_NEGATIVE_TEXT]5의 피해[ENDCOLOR]를 입으며, 지뢰밭이 있다면 총 [COLOR_NEGATIVE_TEXT]10의 피해를[ENDCOLOR] 받습니다.[COLOR:105:105:105:255](연안 타일은 적용되지 않음)[ENDCOLOR][NEWLINE][NEWLINE][ICON_RES_NANOMAT][COLOR_YELLOW]해안 도시[ENDCOLOR]에만 건설할 수 있습니다. [NEWLINE][NEWLINE][ICON_RES_NANOMAT]나노물질 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]가 필요합니다. '),
...
('TXT_KEY_BUILDING_FW_DRONE_HIVE_HELP', '발전기의 [ICON_PRODUCTION]생산과 [ICON_CULTURE]문화가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 건물을 건설할 때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 제공합니다. 원거리 유닛을 생산할 때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 제공합니다.[NEWLINE][NEWLINE]도시에서 생산하는 [COLOR_POSITIVE_TEXT]로봇 계열 유닛[ENDCOLOR][COLOR:105:105:105:255](원거리 유닛, 기갑, 공성, 잠수함유닛)[ENDCOLOR]에 [COLOR_PLAYER_PURPLE]자동 수리[ENDCOLOR] 승급을 부여합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]자동생산시설[ENDCOLOR]이 있어야하고, 도시에 [COLOR_NEGATIVE_TEXT]유전자개조 연구소, 항공우주 복합시설[ENDCOLOR]이 없어야 건설할 수 있습니다.'),
...
('TXT_KEY_BUILDING_FW_SKYRAIL_HUB', '스카이레일 허브'),
('TXT_KEY_BUILDING_FW_SKYRAIL_HUB_HELP', ' 소도시 및 마을의 [ICON_CULTURE]문화와 [ICON_TOURISM]관광이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다.[NEWLINE][NEWLINE]이 도시에서 출발하는 국내 [ICON_INTERNATIONAL_TRADE]교역로의 [ICON_FOOD]식량이 [COLOR_POSITIVE_TEXT]8[ENDCOLOR], [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. [ICON_CARAVAN]육상 교역로의 길이가 [COLOR_POSITIVE_TEXT]25%[ENDCOLOR] 증가합니다. 전투기 유닛과 폭격기 유닛을 생산할 때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 제공합니다.[NEWLINE][NEWLINE]이 도시에서 다른 문명으로 출발하는 [ICON_CARAVAN]육상 교역로가 완료되면 현재 [ICON_CULTURE]문화와 [ICON_TOURISM]관광 산출량에 기반한 [ICON_TOURISM]관광을 제공합니다.[NEWLINE][NEWLINE][ICON_CAPITAL][ICON_INDUSTRIAL_CONNECTED]수도와 산업 도시 연결이 있어야하고, [COLOR_PLAYER_NETHERLANDS_BACKGROUND]석탄 저장소[ENDCOLOR]와 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]공항[ENDCOLOR]이 있어야 건설할 수 있습니다. [NEWLINE][NEWLINE][ICON_RES_NANOMAT]나노물질 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]가 필요합니다.[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]시빌 보석 주식회사를 설립하면[ENDCOLOR] [ICON_GOLDEN_AGE]황금기 점수가 [COLOR_POSITIVE_TEXT]4[ENDCOLOR] 증가합니다.'),
('TXT_KEY_BUILDING_FW_SKYRAIL_HUB_STRATEGY', '미래 시대에 도시 생산력과 골드를 크게 향상시킵니다. 건설하기 전에 수도에 철로 타일이 있는 직접적인 철도 연결이 필요하므로 이 건물의 이점을 거두기 전에 철도 인프라에 투자해야 합니다! 석탄저장소가 필요합니다.'),
('TXT_KEY_BUILDING_FW_SKYRAIL_HUB_PEDIA', '스카이레일 허브는 자기부상 열차망과 항공 네트워크를 유기적으로 연결해, 공항과 도심 간 이동을 거의 지체 없이 처리하는 초고속 환승 거점입니다. 전자기 부상과 선형 모터 추진 기술 덕분에 열차는 소음과 진동을 최소화하면서도 시속 500km 이상으로 도심–공항을 왕복합니다.[NEWLINE][NEWLINE]이 허브를 중심으로 항공편과 자기부상 열차가 수 분 단위로 촘촘히 연계되며, 화물·여객 교통이 거대한 파이프라인처럼 흐릅니다. 결과적으로 공항 수용력이 수배로 확장되고, 도시 간 교역과 인적 자원의 순환 속도가 혁명적으로 향상됩니다. [NEWLINE][NEWLINE]건설 비용은 막대하지만, 일단 가동되면 항공–철도 복합망의 효율성과 경제적 파급력은 기존 교통 인프라를 압도하며, 도시를 세계 무역과 관광의 초밀도 중심축으로 탈바꿈시킵니다.'),

-- Research Module
('TXT_KEY_BUILDING_FW_LAGRANGE_RESEARCH', '라그랑주-연구단지'),
('TXT_KEY_BUILDING_FW_LAGRANGE_RESEARCH_HELP', '무료 [COLOR_YELLOW][ICON_GREAT_SCIENTIST]위대한 과학자[ENDCOLOR]가 1명 출현합니다. [NEWLINE] 도시의 [ICON_VP_SCIENTIST] 과학자의 [ICON_RESEARCH]과학이[COLOR_POSITIVE_TEXT]3[ENDCOLOR] 증가합니다.[NEWLINE][NEWLINE][ICON_RESEARCH]문맹, [ICON_URBANIZATION]도시화에서 오는 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]씩 감소합니다. [NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]핵무기로 파괴되지 않는 건물입니다.[ENDCOLOR] 도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]우주반사판 전력위성[ENDCOLOR]이 있어야 하고 [COLOR_NEGATIVE_TEXT]라그랑주-공학단지, 라그랑주-상업지구[ENDCOLOR]가 없어야건설할 수 있습니다.[NEWLINE][NEWLINE][ICON_RES_NANOMAT]나노물질 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]가 필요합니다. '),
('TXT_KEY_BUILDING_FW_LAGRANGE_RESEARCH_STRATEGY', '도시의 과학을 향상시키기 위한 연구단지를 건설하십시오.'),
('TXT_KEY_BUILDING_FW_LAGRANGE_RESEARCH_PEDIA', '우주여행과 준궤도 생활권이 상시 운영되자, 라그랑주-연구단지는 지상 규제·기후 리스크에서 벗어난 “궤도 연구 특구”로 자리 잡았습니다. 미세중력·초청정 진공·급격한 열환경을 실험 변수로 활용해 단백질 결정화, 초전도/양자 재료, 복합재 경계면, 방사선 생물학 등 지상에서 구현하기 어려운 시험을 수행합니다. 모듈은 검역·생물안전 구획과 자동화 합성 라인을 갖추고, 지상 연구단지와 실시간 데이터 동기화를 유지합니다.[NEWLINE][NEWLINE]이러한 궤도 연구 특구는 전염병·분쟁·환경오염·재난 정전의 영향을 최소화하며, 궤도 전력·열관리 설비 및 물류 도킹을 통해 24시간 연속 실험이 가능해집니다.'),

-- Engineering Module
('TXT_KEY_BUILDING_FW_LAGRANGE_INDUSTRIAL', '라그랑주-공학단지'),
('TXT_KEY_BUILDING_FW_LAGRANGE_INDUSTRIAL_HELP', '무료 [COLOR_YELLOW][ICON_GREAT_ENGINEER]위대한 기술자[ENDCOLOR]가 1명 출현합니다. [NEWLINE] 도시의 [ICON_VP_ENGINEER] 기술자의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]3[ENDCOLOR] 증가합니다.[NEWLINE][NEWLINE][ICON_FOOD]/[ICON_PRODUCTION]낙후, [ICON_URBANIZATION]도시화에서 오는 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]씩 감소합니다.[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]핵무기로 파괴되지 않는 건물입니다.[ENDCOLOR] 도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]우주반사판 전력위성[ENDCOLOR]이 있어야 하고 [COLOR_NEGATIVE_TEXT]라그랑주-상업지구, 라그랑주-연구단지[ENDCOLOR]가 없어야 건설할 수 있습니다.[NEWLINE][NEWLINE][ICON_RES_NANOMAT]나노물질 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]가 필요합니다. '),
('TXT_KEY_BUILDING_FW_LAGRANGE_INDUSTRIAL_STRATEGY', '도시의 생산 산출량을 늘리기 위한 공학단지를 건설하십시오.'),
...
('TXT_KEY_BUILDING_FW_AEROSPACE_COMPLEX_HELP', '수경재배지구의 [ICON_RESEARCH]과학 및 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 도시의 공중 유닛 정원이 [COLOR_POSITIVE_TEXT]4기[ENDCOLOR] 증가합니다. 도시를 공습하는 공중 유닛에게 주는 [ICON_STRENGTH]피해가 [COLOR_POSITIVE_TEXT]10[ENDCOLOR] 증가합니다. 궤도미사일, 항공모함, 우주선 부품을 생산할 때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR]제공합니다. [NEWLINE][NEWLINE]도시에서 생산하는 지상유닛에게 [COLOR_PLAYER_PURPLE]공습부대[ENDCOLOR] 승급을 부여합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]공항[ENDCOLOR]과 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]우주선 발사센터[ENDCOLOR]가 있어야하고, 도시에 [COLOR_NEGATIVE_TEXT]무인관리기지, 유전자개조 연구소[ENDCOLOR]가 없어야 건설할 수 있습니다.'),
...
('TXT_KEY_BUILDING_FW_ECTOGENESIS_POD_HELP', '문명의 총 군사유닛 10개마다 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]증가합니다.[COLOR:105:105:105:255](상한 200 유닛)[ENDCOLOR][NEWLINE]도시에서 근접, 기마, 공중정찰 유닛을 생산할 때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR]제공합니다. 이 도시에서 생산하는 근접, 기마, 공중정찰 유닛에 [COLOR_PLAYER_PURPLE]유전자개조 승급[ENDCOLOR]을 부여합니다.[NEWLINE][NEWLINE][ICON_FOOD]/[ICON_PRODUCTION]낙후에서 오는 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR]감소합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]유전자개조 연구소[ENDCOLOR]가 있어야 건설할 수 있습니다.[NEWLINE][NEWLINE][ICON_RES_XENO_FUNGUS]제노포자 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]가 필요합니다. '),
...
('TXT_KEY_BUILDING_FW_MASS_DIGESTER_HELP', '[ICON_CITIZEN]시민 2명마다 [ICON_FOOD]식량 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]이 증가합니다. 도시의 타일마다 [ICON_FOOD]식량이 증가합니다. [NEWLINE][NEWLINE]도시의 전문가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR]명이 더 이상 [ICON_URBANIZATION]도시화로 인한 불행을 [ICON_HAPPINESS_3] 유발하지 않습니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]첨단바이오연구소[ENDCOLOR]가 있어야 건설할 수 있습니다.[NEWLINE][NEWLINE][ICON_RES_XENO_FUNGUS]제노포자 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]가 필요합니다. '),
...
('TXT_KEY_BUILDING_FW_BIOMOD_TANK_HELP', '문명의 총 군사유닛 10개마다 [ICON_GREAT_GENERAL]위대한 장군, [ICON_GREAT_ADMIRAL]위대한제독의 점수가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR], [ICON_GOLDEN_AGE]황금기 점수가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR]씩 증가합니다.[COLOR:105:105:105:255](상한 200 유닛)[ENDCOLOR][NEWLINE]정찰, 화약, 근접해상, 원거리해상 유닛을 생산할 때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 제공합니다. 도시에서 생산하는 화약유닛에 [COLOR_PLAYER_PURPLE]바이오모드 승급[ENDCOLOR]을 부여합니다.[NEWLINE][NEWLINE][ICON_CULTURE]무료에서 오는 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 감소합니다. [NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]생체강화센터[ENDCOLOR]와 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]제노포자 배양 연구소[ENDCOLOR]가 있어야 건설할 수 있습니다.[NEWLINE][NEWLINE][ICON_RES_XENO_FUNGUS]제노포자 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]가 필요합니다.'),
('TXT_KEY_BUILDING_FW_BIOMOD_TANK_STRATEGY', '클론트루퍼, 생체강화 보병, 바이오트루퍼, 슈퍼솔져의 생산을 증가시킵니다. 근접, 기마, 화약, 정찰 유닛은 바이오모드 승급을 부여받습니다. 생체강화센터가 필요합니다.'),
('TXT_KEY_BUILDING_FW_BIOMOD_TANK_PEDIA', '생체강화센터는 어느 정도의 생체 변형을 허용했지만 더 광범위한 적응에는 더 정교한 장비가 필요했습니다. 바이오 강화 시설은 더 광범위한 인체 변형을 수행했으며, 일반적으로 대상을 서스펜션 탱크에 담그어 더 복잡한 임플란트 및 전신 변형을 수행할 수 있도록 했습니다. 일반적인 바이오 모드에는 단기 재생 기능을 제공하는 자극제와 전투 능력을 향상시키는 강화 모드가 포함됩니다.'),
('TXT_KEY_BUILDING_DUMMY_BIOMOD_POP_DUMMY', '바이오모드 인구(더미)'),

-- Cyberclinic
('TXT_KEY_BUILDING_FW_QUANTUM_LINK', '양자동기화 접속기'),
('TXT_KEY_BUILDING_FW_QUANTUM_LINK_HELP', '모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]원격현실허브[ENDCOLOR]의 [ICON_PRODUCTION]생산, [ICON_RESEARCH]과학, [ICON_CULTURE]문화가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]씩 증가하고 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]바이오 컴퓨터[ENDCOLOR]의 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]4[ENDCOLOR] 증가합니다. 전역 [ICON_HAPPINESS_1]행복이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다.잠수함유닛을 생산할 때 [ICON_PRODUCTION]생산 보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 제공합니다.[NEWLINE][NEWLINE][ICON_GREAT_SCIENTIST]위대한 과학자의 출현율이 [COLOR_POSITIVE_TEXT]25%[ENDCOLOR] 증가합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]원격현실 허브[ENDCOLOR]와 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]바이오 컴퓨터[ENDCOLOR]가 있어야 건설할 수 있습니다.[NEWLINE][NEWLINE][ICON_RES_NANOMAT]나노물질 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]가 필요합니다.'),
('TXT_KEY_BUILDING_FW_QUANTUM_LINK_STRATEGY', '양자동기화 접속기는 인체 뇌파를 양자 스캔해 안드로이드 분신으로 전송, 사용자가 직접 원격 아바타처럼 활동할 수 있게 합니다. 사이버 유닛과 해상 병력(항공모함 제외)의 생산 효율을 높이며, 과학 연구와 사회적 역량을 동시에 강화합니다.'),
('TXT_KEY_BUILDING_FW_QUANTUM_LINK_PEDIA', '양자동기화 접속기는 발전된 MRI 기술, 뇌파 분석기술이 양자적 정밀도로 뇌 신호를 스캔하면서 탄생했습니다. 사용자의 의식 패턴은 실시간으로 동기화되어, 아바타와 같은 안드로이드 분신을 통해 물리적 제약 없이 활동할 수 있습니다.[NEWLINE][NEWLINE]다만 방대한 양자 정보가 필요해, 현재로서는 지구권 통신 범위 안에서만 안정적인 동기화가 가능합니다. 이 한계에도 불구하고, 사람들은 이제 새로운 육체를 빌려 사회와 모험에 참여할 수 있으며, 이는 노동·연구·군사·일상 전반에서 인류 활동의 지평을 넓혀 주고 있습니다.'),

-- Digital Police
('TXT_KEY_BUILDING_FW_BIGBROTHER_CONTROL', '빅브라더 관제소'),
('TXT_KEY_BUILDING_FW_BIGBROTHER_CONTROL_HELP', '[ICON_SPY] 도시 보안이 +20 증가합니다. [NEWLINE]원거리 유닛을 생산할 때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 제공합니다.[NEWLINE][NEWLINE][ICON_FOOD]/[ICON_PRODUCTION]낙후, [ICON_GOLD] 빈곤, [ICON_RESEARCH] 문맹, [ICON_CULTURE]무료에서 오는 [ICON_HAPPINESS_3]불행이 각각 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 감소하고, [ICON_URBANIZATION]도시화에서 오는 불행이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR]감소합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]국제치안국[ENDCOLOR]이 있어야 건설할 수 있습니다.'),
('TXT_KEY_BUILDING_FW_BIGBROTHER_CONTROL_STRATEGY', '빅브라더 관제소(디지털 치안 시스템)는 적 스파이가 도시를 해칠 수 있는 속도를 늦춥니다. 빅브라더 관제소(디지털 치안 시스템)을 구축하기 위해서는 도시에 국제형사경찰기구가 있어야 합니다.'),
('TXT_KEY_BUILDING_FW_BIGBROTHER_CONTROL_PEDIA', '빅브라더 관제소(디지털 치안 시스템)는 가상세계의 특수한 공간으로, 인공지능과 인간 사용자 모두의 데이터를 보호하는 역할을 하는 고도로 진화된 보안 시스템입니다. 이 건물은 일반적인 경찰서를 넘어서, 물리적 세계와 디지털 세계 양쪽 모두에서 범죄를 예방하고 처벌하는 기능을 수행합니다. 빅브라더 관제소의 핵심 기능은 두 가지입니다. 첫째, 고급 인공지능 기술을 이용하여 가상 세계에서의 프로그램 해킹을 막습니다. 이를 통해 인공지능이나 프로그램의 부정적인 조작을 방지하고, 사용자가 가상 세계에서 안전하게 활동할 수 있도록 보장합니다. 둘째, 디지털 경찰서는 인간 사용자의 개인정보 보호에도 특화되어 있습니다. 가상 세계에 연결된 사용자의 정보가 노출되거나 불법적으로 사용되는 것을 방지하기 위해, 다양한 보안 방법을 사용하여 사용자의 데이터를 안전하게 보호합니다. 이러한 보안 방법에는 강력한 암호화, 실시간 모니터링, 그리고 사용자의 정보를 위협하는 활동을 자동으로 탐지하고 차단하는 고급 시스템이 포함됩니다. 빅브라더 감시국은 그 자체로도 훌륭한 보안 시스템이지만, 더불어 사용자들이 자신의 데이터를 안전하게 관리하고 보호하는 데 필요한 교육도 제공합니다. 사용자가 자신의 정보를 어떻게 안전하게 유지할 수 있는지, 해킹 시도를 어떻게 인식하고 대응할 수 있는지에 대한 지식을 배울 수 있는 프로그램이 구비되어 있습니다.'),

-- Fusion Reactor
('TXT_KEY_BUILDING_FW_FUSION_PLANT', '핵융합 반응로'),
('TXT_KEY_BUILDING_FW_FUSION_PLANT_HELP', '도시의 모든 전문가들의 [ICON_PRODUCTION]생산, [ICON_GOLD]골드, [ICON_RESEARCH]과학, [ICON_CULTURE]문화 산출량이 각각 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 도시의 [ICON_PRODUCTION]생산을 다른 산출량으로 전환할 때의 효율성이 [COLOR_POSITIVE_TEXT]20%[ENDCOLOR] 증가합니다. 기갑유닛과 공성유닛을 생산할 때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR]제공합니다. [NEWLINE][NEWLINE]도시의 [ICON_GREAT_PEOPLE]위인 출현율이 [COLOR_POSITIVE_TEXT]25%[ENDCOLOR] 증가합니다. [NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]공장[ENDCOLOR]과 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]지구심층 물리연구소[ENDCOLOR]가 있어야 건설할 수 있습니다. [NEWLINE][NEWLINE][ICON_RES_URANIUM]우라늄 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]와 [ICON_RES_NANOMAT]나노물질 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]가 필요합니다.[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]헥손 정유 기업을 설립하면[ENDCOLOR] [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]3[ENDCOLOR] 증가합니다.'),
...
-- Moon Base
('TXT_KEY_BUILDING_FW_ORBITAL_MINING', '소행성 채굴기지'),
('TXT_KEY_BUILDING_FW_ORBITAL_MINING_HELP', '[ICON_CITIZEN]시민 10명 마다 [ICON_PRODUCTION]생산, [ICON_GOLD]골드, [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]씩 증가합니다. [NEWLINE]정찰, 화약, 전투기, 폭격기유닛을 생산할 때 [ICONN_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR]제공합니다. [NEWLINE][NEWLINE]도시의 전문가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR]명이 더 이상 [ICON_URBANIZATION]도시화로 인한 불행을 [ICON_HAPPINESS_3] 유발하지 않습니다. [NEWLINE][NEWLINE][ICON_RES_IRON]철과 [ICON_RES_NANOMAT]나노물질 [COLOR_POSITIVE_TEXT]2개[ENDCOLOR]를 제공합니다.[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]핵무기로 파괴되지 않는 건물입니다.[ENDCOLOR] 도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]우주반사판 전력위성[ENDCOLOR]이 있어야 건설할 수 있습니다.'),
('TXT_KEY_BUILDING_FW_ORBITAL_MINING_STRATEGY', '우주 기반 채굴 인프라를 갖추면 자원 수급이 원활해져 장기적인 생산·경제·연구 효율이 개선됩니다. 전자·에너지·우주 라인의 도시와 궁합이 좋습니다.'),
('TXT_KEY_BUILDING_FW_ORBITAL_MINING_PEDIA', '소행성 채굴은 지구 밖에서 직접 자원을 조달하는 인류의 첫 산업 중 하나로, 철·니켈·백금군 금속과 공학용 휘소 물질을 안정적으로 확보해 줍니다. 궤도 정거장·운반선·재처리 모듈로 구성된 채굴 기지는 도시 경제를 다변화하고, 고부가가치 우주 산업의 기반을 제공하며, 장기적으로는 행성 간 확장 전략의 교두보 역할을 합니다.'),

-- Orbital Habitat
('TXT_KEY_BUILDING_FW_ORBITAL_HABITAT', '우주궤도 식량재배시설'),
('TXT_KEY_BUILDING_FW_ORBITAL_HABITAT_HELP', '[ICON_VP_SCIENTIST] 과학자, [ICON_VP_ENGINEER] 기술자, [ICON_VP_MERCHANT] 상인 1명마다 [ICON_FOOD]식량이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]씩 증가합니다. 라그랑주-연구단지의 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR], 공학단지의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR], 상업지구의 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR]씩 증가합니다.[ICON_CITIZEN]시민이 증가할 때 현재[ICON_PRODUCTION]생산 산출량의 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR]를 즉시 제공합니다. [NEWLINE]궤도미사일과 항공모함 유닛을 생산할 때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR]제공합니다. [NEWLINE][NEWLINE]전문가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR]명이 더이상 [ICON_URBANIZATION]도시화에서 오는 [ICON_HAPPINESS_3]불행을 증가시키지 않습니다.[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]핵무기로 파괴되지 않는 건물입니다. [COLOR_PLAYER_NETHERLANDS_BACKGROUND]항공우주 복합시설[ENDCOLOR]이 있어야 건설할 수 있습니다. [NEWLINE][NEWLINE][ICON_RES_NANOMAT]나노물질 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]가 필요합니다.'),
...
('TXT_KEY_BUILDING_FW_GENETIC_EVOLUTION', '유전자 가속 센터'),
('TXT_KEY_BUILDING_FW_GENETIC_EVOLUTION_HELP', '생명공학센터의 [ICON_RESEARCH]과학과 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR]증가합니다.[NEWLINE][NEWLINE][ICON_RES_XENO_FUNGUS]제노포자[COLOR_POSITIVE_TEXT]3개[ENDCOLOR]를 제공합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]유전자개조 연구소[ENDCOLOR]가 있어야하고, [COLOR_NEGATIVE_TEXT]중앙 통제 센터, AI네트워크[ENDCOLOR]가 없어야 건설할 수 있습니다.'),
('TXT_KEY_BUILDING_FW_GENETIC_EVOLUTION_STRATEGY', '생명공학센터의 산출량을 증가시킵니다. 도시 주변 타일에 제노포자가 출현합니다.'),
('TXT_KEY_BUILDING_FW_GENETIC_EVOLUTION_PEDIA', '유전자 가속 센터는 유전자 연구를 집중적으로 수행하고, 그 결과를 활용하여 다양한 생명공학 및 유전학 프로젝트를 가속화하는 공간입니다. 이 건물은 최첨단의 연구 설비와 훌륭한 과학자들을 포함하여, 게임 내에서 유전자 연구를 돕는 데 필요한 모든 자원을 제공합니다. 유전자 가속 센터의 핵심 기능 중 하나는 유전자 시퀀싱과 분석입니다. 이 곳에서, 과학자들은 다양한 생명체의 유전체를 해독하고, 이를 통해 새로운 유전자를 찾아내거나, 이미 알려진 유전자의 기능을 더 깊게 이해하는 데 도움을 줍니다. 이런 정보는 새로운 생명공학 기술의 개발이나, 질병의 원인과 치료법을 찾는 데 매우 중요합니다.또한, 유전자 가속 센터에서는 유전자 수정 기술도 연구합니다. 이 기술을 통해, 과학자들은 생명체의 유전자를 편집하여 특정 특성을 강화하거나, 원치 않는 특성을 제거할 수 있습니다. 이러한 유전자 수정은 식물이나 동물을 개량하거나, 질병을 치료하는 데 활용될 수 있습니다.[NEWLINE][NEWLINE]유전자 가속 센터는 유전자 연구를 향상시키는 데 도움을 주는 중추적인 역할을 합니다. 그것은 연구를 수행하는데 필요한 기계와 장비, 그리고 유전자 연구에 특화된 전문적인 인력을 제공함으로써, 유전자 연구의 진척을 촉진하고, 그 결과를 게임 내 다른 활동에 활용할 수 있도록 합니다. 유전자 가속 센터는 유전학의 가장 앞선 연구를 수행하고, 이를 통해 게임 내의 생명과 과학의 이해를 향상시키는 역할을 수행합니다.'),

-- Photosystems
('TXT_KEY_BUILDING_FW_PHOTOSYSTEMS', '광화학반응'),
('TXT_KEY_BUILDING_FW_PHOTOSYSTEMS_HELP', '도시 근처에 [ICON_RES_XENO_FUNGUS]제노포자 [COLOR_POSITIVE_TEXT]4개[ENDCOLOR]가 있는 타일이 출현합니다. [NEWLINE][NEWLINE]숲 타일의 [ICON_FOOD]식량이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR], 정글 타일의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 습지 타일의 [ICON_FOOD]식량 및 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다.'),
...
('TXT_KEY_BUILDING_FW_BIRTHING_PODS_HELP', '건설을 완료하면 [ICON_CITIZEN]시민이 [COLOR_POSITIVE_TEXT]3명[ENDCOLOR] 즉시 증가합니다. [ICON_CITIZEN]시민이 증가할 때 사용한 [ICON_FOOD]식량의 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR]를 저장합니다. 전역 [ICON_HAPPINESS_1]행복이 [COLOR_POSITIVE_TEXT]3[ENDCOLOR]증가합니다. [NEWLINE][NEWLINE]전문가 [COLOR_POSITIVE_TEXT]1명[ENDCOLOR]이 더이상 [ICON_URBANIZATION]도시화에서 오는 [ICON_HAPPINESS_3]불행을 증가시키지 않습니다.[NEWLINE][NEWLINE] 도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]유전자공학 연구소[ENDCOLOR]와 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]병원[ENDCOLOR]이 있어야 건설할 수 있습니다.'),
...
('TXT_KEY_BUILDING_FW_AI_NETWORK_STRATEGY', '도시의 방어와 관련된 모든 시설을 개선합니다. 도시 HP/방어 및 행복을 향상시킵니다.'),
...
('TXT_KEY_BUILDING_FW_BRAIN_UPLOADING_HELP', '[ICON_CITIZEN]시민 중 많은 이들이 업로드됩니다. 업로드된 [ICON_CITIZEN]시민들은 더이상 전문가 슬롯이나 타일에 배치할 수 없으나, 남은 [ICON_CITIZEN]시민 1명마다 [ICON_PRODUCTION]생산, [ICON_RESEARCH]과학, [ICON_GOLD]골드, [ICON_CULTURE]문화 산출량이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]씩 증가합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]양자동기화 접속기[ENDCOLOR]가 있어야 건설할 수 있습니다.[NEWLINE][NEWLINE][ICON_RES_NANOMAT]나노물질 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]가 필요합니다.'),
...
('TXT_KEY_BUILDING_FW_GENOME_PROJECT_1_PEDIA', '생명 유전자 지도 네트워크에 적은 양의 시간과 자원만 기여한 문명은 그 결과 정보와 기술의 교환으로 여전히 이익을 얻었습니다. 연구소는 개발된 신기술의 혜택을 받았고 의학 연구소는 질병 및 기타 질병을 보다 효과적으로 치료할 수 있었습니다.'),
...
('TXT_KEY_BUILDING_FW_GENOME_PROJECT_2_PEDIA', '생명 유전자 지도 네트워크에 더 광범위하게 참여하면 그렇게 하기로 선택한 문명에 더 큰 보상이 주어집니다. 인간 게놈에 대한 지식이 늘어남에 따라 특정 질병과 만성 질환을 훨씬 쉽게 치료할 수 있게 되어 삶의 질이 크게 향상되었습니다.'),

-- Global netowrk
('TXT_KEY_BUILDING_FW_AI_DATANETWORK_1', '광 통신망'),
...
-- Global data center
('TXT_KEY_BUILDING_FW_AI_DATANETWORK_2', '데이터 센터'),
...
('TXT_KEY_BUILDING_FW_DEEP_RESOURCE_1', '심층 금속 매장지'),
('TXT_KEY_BUILDING_FW_DEEP_RESOURCE_1_HELP', '[ICON_RES_IRON]철 [COLOR_POSITIVE_TEXT]6개[ENDCOLOR], [ICON_RES_COAL]석탄 [COLOR_POSITIVE_TEXT]3개[ENDCOLOR], [ICON_RES_NANOMAT]나노물질 [COLOR_POSITIVE_TEXT]1개[ENDCOLOR]를 제공합니다.'),
('TXT_KEY_BUILDING_FW_DEEP_RESOURCE_1_STRATEGY', '문명에 [ICON_RES_IRON]철, [ICON_RES_COAL]석탄 같은 기본 산업 자원을 안정적으로 공급합니다.'),
('TXT_KEY_BUILDING_FW_DEEP_RESOURCE_1_PEDIA', '심층 금속 매장지는 지구 지각 깊은 곳에 매장된 철과 석탄 자원을 체계적으로 채굴하기 위한 시설입니다. 첨단 굴착 장비와 고온·고압 환경 제어 기술을 통해 이전에는 접근할 수 없었던 광물 자원을 확보할 수 있습니다. 이러한 자원은 산업과 군수 분야 모두에서 필수적인 기반을 제공합니다.'),

-- S-Type Asteroid → 희귀 자원 채굴
('TXT_KEY_BUILDING_FW_DEEP_RESOURCE_2', '희귀 합금소재'),
('TXT_KEY_BUILDING_FW_DEEP_RESOURCE_2_HELP', '[ICON_RES_ALUMINUM]알루미늄 [COLOR_POSITIVE_TEXT]4개[ENDCOLOR]와 [ICON_RES_NANOMAT]나노물질 [COLOR_POSITIVE_TEXT]3개[ENDCOLOR], [ICON_RES_URANIUM]우라늄 [COLOR_POSITIVE_TEXT]1개[ENDCOLOR]를 제공합니다.'),
('TXT_KEY_BUILDING_FW_DEEP_RESOURCE_2_STRATEGY', '문명에 [ICON_RES_ALUMINUM]알루미늄, [ICON_RES_NANOMAT]나노물질, [ICON_RES_URANIUM]우라늄 같은 희귀 자원을 제공합니다.'),
('TXT_KEY_BUILDING_FW_DEEP_RESOURCE_2_PEDIA', '희귀 자원 채굴은 알루미늄, 나노물질, 우라늄과 같은 고부가가치 자원을 지하 깊은 곳이나 극한 환경에서 추출하는 기술을 의미합니다. 이러한 자원은 첨단 산업, 원자력, 그리고 나노공학 분야에서 핵심적 역할을 하며, 국제적인 경쟁과 협력의 중심에 서 있습니다.');

UPDATE Language_ko_KR
SET Text = '야영지, 브라질 소방목 벌목장, 제재소, 자연보호구역 및 친환경마을의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. 모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]생태친화시설[ENDCOLOR]의 [ICON_CULTURE]문화가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 매턴 도시의 [ICON_PRODUCTION]생산의 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR]만큼의 [ICON_CULTURE]문화로 전환합니다. 도시의 [ICON_TOURISM]관광이 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 증가합니다.[NEWLINE][NEWLINE][ICON_CULTURE]무료, [ICON_RELIGION]종교 분쟁에서 오는 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]씩 감소합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]약국[ENDCOLOR]이 있어야 하고 [COLOR_NEGATIVE_TEXT]수직형 농장[ENDCOLOR]이 없어야 건설할 수 있습니다.'
WHERE Tag = 'TXT_KEY_BUILDING_FW_ECOSANCTUARY_HELP' AND EXISTS (SELECT * FROM Units WHERE TYPE = 'UNIT_EE_SKIRMISHER');

UPDATE Language_ko_KR
SET Text = '농장, 재배지, 계단식 농장, 간척지 및 수경재배지구의 [ICON_FOOD]식량이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. 모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]수직형 농장[ENDCOLOR]의 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 매턴 도시의 [ICON_FOOD]식량의 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR]만큼의 [ICON_RESEARCH]과학을 제공합니다.[NEWLINE][NEWLINE][ICON_RESEARCH]문맹, [ICON_URBANIZATION]도시화에서 오는 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 감소합니다. [NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]약국[ENDCOLOR]이 있어야 하고 [COLOR_NEGATIVE_TEXT]제노포자 배양 연구소[ENDCOLOR]가 없어야 건설할 수 있습니다.'
WHERE Tag = 'TXT_KEY_BUILDING_FW_VERTICAL_FARM_HELP' AND EXISTS (SELECT * FROM Units WHERE TYPE = 'UNIT_EE_SKIRMISHER');
...
INSERT INTO Language_ko_KR (Tag, Text) VALUES
-- 게놈프로젝트
('TXT_KEY_PROCESS_FW_GENOME_PROJECT','게놈 진화 프로젝트'),
('TXT_KEY_PROCESS_FW_GENOME_PROJECT_HELP','이 도시의 [ICON_PRODUCTION]생산을 게놈 진화 프로젝트 공헌에 사용합니다.'),
('TXT_KEY_LEAGUE_PROJECT_FW_GENOME_PROJECT','게놈 진화 프로젝트'),
('TXT_KEY_WONDER_FW_GENOME_PROJECT_HELP','도시의 모든 전문가들의 관련 산출량이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다.'),
('TXT_KEY_LEAGUE_PROJECT_FW_GENOME_PROJECT_SPLASH','게놈 진화 프로젝트는 자연선택에 의존하지 않고, 과학적 개입을 통해 인류의 진화를 가속하려는 시도의 일환입니다.'),
('TXT_KEY_LEAGUE_PROJECT_REWARD_FW_GENOME_PROJECT_1','연구 교환'),
('TXT_KEY_LEAGUE_PROJECT_REWARD_FW_GENOME_PROJECT_1_HELP','모든 도시의 연구소의 과학이 +2 증가하고, 의학 연구소의 [ICON_FOOD]식량이 +3 증가합니다.'),
('TXT_KEY_LEAGUE_PROJECT_REWARD_FW_GENOME_PROJECT_2','유전자 치료'),
('TXT_KEY_LEAGUE_PROJECT_REWARD_FW_GENOME_PROJECT_2_HELP','모든 도시의 [ICON_CITIZEN]시민이 +1 즉시 증가하고, 유전자공학 연구소의 [ICON_RESEARCH]과학이 +2 증가합니다.'),
('TXT_KEY_LEAGUE_PROJECT_REWARD_FW_GENOME_PROJECT_3','응용 유전체학'),
('TXT_KEY_LEAGUE_PROJECT_REWARD_FW_GENOME_PROJECT_3_HELP','[ICON_CAPITAL]수도에 [COLOR_POSITIVE_TEXT]게놈 혁신 센터[ENDCOLOR] 불가사의가 출현합니다. ({TXT_KEY_WONDER_FW_GENOME_PROJECT_HELP})'),
('TXT_KEY_RESOLUTION_FW_GENOME_PROJECT','게놈 진화 프로젝트'),
('TXT_KEY_RESOLUTION_FW_GENOME_PROJECT_HELP','[COLOR_POSITIVE_TEXT]게놈 진화 프로젝트[ENDCOLOR]를 시작합니다. 프로젝트가 시작되면 도시의 생산 목록에서 해당 프로젝트를 선택해 프로젝트에 기여할 수 있습니다. 프로젝트가 완료되면, 프로젝트에 참여한 문명은 기여한 [ICON_PRODUCTION]생산에 따라 보너스를 받게 됩니다.[NEWLINE][NEWLINE][ICON_TROPHY_GOLD]: {TXT_KEY_LEAGUE_PROJECT_REWARD_FW_GENOME_PROJECT_3_HELP}[NEWLINE][ICON_TROPHY_SILVER]: {TXT_KEY_LEAGUE_PROJECT_REWARD_FW_GENOME_PROJECT_2_HELP}[NEWLINE][ICON_TROPHY_BRONZE]: {TXT_KEY_LEAGUE_PROJECT_REWARD_FW_GENOME_PROJECT_1_HELP}[NEWLINE][NEWLINE][COLOR_RESEARCH_STORED]생명기술 공학[ENDCOLOR]을 연구한 문명이 있어야 안건으로 채택할 수 있습니다.'),

-- AI 데이터센터 네트워크
('TXT_KEY_PROCESS_FW_AI_DATANETWORK','데이터 네트워크'),
('TXT_KEY_PROCESS_FW_AI_DATANETWORK_HELP','이 도시의 [ICON_PRODUCTION]생산을 데이터 네트워크 프로젝트 공헌에 사용합니다.'),
('TXT_KEY_LEAGUE_PROJECT_FW_AI_DATANETWORK','데이터 네트워크'),
('TXT_KEY_LEAGUE_PROJECT_FW_AI_DATANETWORK_SPLASH','데이터 네트워크는 전 세계 데이터 인프라를 상호 연결하여 연산·저장·전송 자원을 효율적으로 분배하기 위한 국제 협력 프로젝트입니다. 각 도시는 서버 허브와 네트워크 중심지를 통해 참여하며, 축적된 기여도에 따라 보상을 받습니다.'),
('TXT_KEY_WONDER_FW_AI_DATANETWORK_HELP','무료 [COLOR_YELLOW]원하는 [ICON_GREAT_PEOPLE]위인[ENDCOLOR] 1명이 출현합니다. 모든 도시의 전자상거래 서버, 엔터테인먼트, 클라우드 서버, 연구 서버의 관련 산출량이 [COLOR_POSITIVE_TEXT]8[ENDCOLOR] 증가합니다.'),
('TXT_KEY_LEAGUE_PROJECT_REWARD_FW_AI_DATANETWORK_1','광통신망'),
...
('TXT_KEY_LEAGUE_PROJECT_REWARD_FW_AI_DATANETWORK_2','데이터 센터'),
('TXT_KEY_LEAGUE_PROJECT_REWARD_FW_AI_DATANETWORK_2_HELP','모든 네트워크 중심지의 [ICON_RESEARCH]과학, [ICON_CULTURE]문화, [ICON_GOLD]골드가 각각 +2 증가합니다. 또한 모든 도시의 [ICON_GREAT_PEOPLE]위인 출현률이 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR] 증가합니다.'),
('TXT_KEY_LEAGUE_PROJECT_REWARD_FW_AI_DATANETWORK_3','기술의 특이점'),
('TXT_KEY_LEAGUE_PROJECT_REWARD_FW_AI_DATANETWORK_3_HELP','[ICON_CAPITAL]수도에 [COLOR_POSITIVE_TEXT]Chat GPT[ENDCOLOR] 불가사의가 출현합니다. ({TXT_KEY_WONDER_FW_AI_DATANETWORK_HELP})'),
('TXT_KEY_RESOLUTION_FW_AI_DATANETWORK','데이터 네트워크'),
('TXT_KEY_RESOLUTION_FW_AI_DATANETWORK_HELP','[COLOR_POSITIVE_TEXT]데이터 네트워크[ENDCOLOR] 프로젝트를 시작합니다. 도시의 생산 목록에서 선택해 기여할 수 있으며, 완료 시 기여한 [ICON_PRODUCTION]생산량에 따라 보상을 받게 됩니다.[NEWLINE][NEWLINE][ICON_TROPHY_GOLD]: {TXT_KEY_LEAGUE_PROJECT_REWARD_FW_AI_DATANETWORK_3_HELP}[NEWLINE][ICON_TROPHY_SILVER]: {TXT_KEY_LEAGUE_PROJECT_REWARD_FW_AI_DATANETWORK_2_HELP}[NEWLINE][ICON_TROPHY_BRONZE]: {TXT_KEY_LEAGUE_PROJECT_REWARD_FW_AI_DATANETWORK_1_HELP}[NEWLINE][NEWLINE][COLOR_RESEARCH_STORED]AI: 생성형[ENDCOLOR] 기술을 연구한 문명이 있어야 안건으로 제안할 수 있습니다.'),

-- 맨틀 탐사 프로젝트
('TXT_KEY_PROCESS_FW_DEEP_RESOURCE','맨틀 탐사 프로젝트'),
('TXT_KEY_PROCESS_FW_DEEP_RESOURCE_HELP','이 도시의 [ICON_PRODUCTION]생산을 맨틀 탐사 프로젝트에 기여합니다.'),
('TXT_KEY_LEAGUE_PROJECT_FW_DEEP_RESOURCE','맨틀 탐사 프로젝트'),
('TXT_KEY_LEAGUE_PROJECT_FW_DEEP_RESOURCE_SPLASH','맨틀 탐사 프로젝트는 지구 심층부와 해저에 매장된 희귀 금속과 차세대 나노 소재를 탐사·관리하기 위한 국제 협력 프로젝트입니다. 초고강도 나노 드릴, 자율 채굴 AI, 지능형 분배망을 통해 자원 불균형을 해소하고, 미래 산업에 필요한 핵심 소재를 확보합니다.'),
('TXT_KEY_WONDER_FW_DEEP_RESOURCE_HELP','무료 [ICON_GREAT_ENGINEER][COLOR_YELLOW]위대한 기술자[ENDCOLOR]가 1명 출현합니다. 모든 나노물질 군수공장의 [ICON_PRODUCTION]생산과 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]4[ENDCOLOR] 증가합니다.'),
('TXT_KEY_LEAGUE_PROJECT_REWARD_FW_DEEP_RESOURCE_1','심층 금속 매장지'),
('TXT_KEY_LEAGUE_PROJECT_REWARD_FW_DEEP_RESOURCE_1_HELP','[ICON_RES_IRON]철 [COLOR_POSITIVE_TEXT]6개[ENDCOLOR], [ICON_RES_COAL]석탄 [COLOR_POSITIVE_TEXT]3개[ENDCOLOR], [ICON_RES_NANOMAT]나노물질 [COLOR_POSITIVE_TEXT]1개[ENDCOLOR]를 확보합니다.'),
('TXT_KEY_LEAGUE_PROJECT_REWARD_FW_DEEP_RESOURCE_2','희귀 합금 소재'),
('TXT_KEY_LEAGUE_PROJECT_REWARD_FW_DEEP_RESOURCE_2_HELP','[ICON_RES_ALUMINUM]알루미늄 [COLOR_POSITIVE_TEXT]4개[ENDCOLOR], [ICON_RES_NANOMAT]나노물질 [COLOR_POSITIVE_TEXT]3개[ENDCOLOR], [ICON_RES_URANIUM]우라늄 [COLOR_POSITIVE_TEXT]1개[ENDCOLOR]를 확보합니다.'),
('TXT_KEY_LEAGUE_PROJECT_REWARD_FW_DEEP_RESOURCE_3','나노 합금 주조'),
('TXT_KEY_LEAGUE_PROJECT_REWARD_FW_DEEP_RESOURCE_3_HELP','[ICON_CAPITAL]수도에 [COLOR_POSITIVE_TEXT]나노 합금 제조소[ENDCOLOR] 불가사의가 출현합니다. ({TXT_KEY_WONDER_FW_DEEP_RESOURCE_HELP})'),
('TXT_KEY_RESOLUTION_FW_DEEP_RESOURCE','맨틀 탐사 프로젝트'),
('TXT_KEY_RESOLUTION_FW_DEEP_RESOURCE_HELP','[COLOR_POSITIVE_TEXT]맨틀 탐사 프로젝트[ENDCOLOR]를 시작합니다. 도시의 생산 목록에서 프로젝트를 선택해 기여할 수 있으며, 완료 시 기여한 [ICON_PRODUCTION]생산량에 따라 보상을 받습니다.[NEWLINE][NEWLINE][ICON_TROPHY_GOLD]: {TXT_KEY_LEAGUE_PROJECT_REWARD_FW_DEEP_RESOURCE_3_HELP}[NEWLINE][ICON_TROPHY_SILVER]: {TXT_KEY_LEAGUE_PROJECT_REWARD_FW_DEEP_RESOURCE_2_HELP}[NEWLINE][ICON_TROPHY_BRONZE]: {TXT_KEY_LEAGUE_PROJECT_REWARD_FW_DEEP_RESOURCE_1_HELP}[NEWLINE][NEWLINE][COLOR_RESEARCH_STORED]지구 에너지 공학[ENDCOLOR]을 연구한 문명이 있어야 안건으로 제안할 수 있습니다.');
...
INSERT OR REPLACE INTO LocalizedText
	(Language, Tag, Text)
VALUES
 ('ko_KR','TXT_KEY_BUILDING_CERN_HELP', '[COLOR_RESEARCH_STORED]무료 기술[ENDCOLOR]을 [COLOR_POSITIVE_TEXT]2개[ENDCOLOR] 제공합니다. 모든 [ICON_CITY_STATE]도시 국가에 대한 [ICON_INFLUENCE]영향력을 [COLOR_POSITIVE_TEXT]30[ENDCOLOR] 제공합니다.  [NEWLINE][NEWLINE]이 불가사의는 전 세계에서 하나만 건설할 수 있는 [COLOR_POSITIVE_TEXT]세계 불가사의[ENDCOLOR]입니다.');


INSERT INTO Language_ko_KR (Tag, Text) VALUES
-- Tokyo Skytree
('TXT_KEY_BUILDING_FW_SKYTREE', '도쿄 스카이트리'),
('TXT_KEY_BUILDING_FW_SKYTREE_HELP', '모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]방송탑[ENDCOLOR]의 [ICON_CULTURE]문화와 [ICON_GOLDEN_AGE]황금기 점수가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 문명의 모든 [COLOR_POSITIVE_TEXT]통신기지국[ENDCOLOR]의 [ICON_RESEARCH]과학, [ICON_GOLD]골드, [ICON_GOLDEN_AGE]황금기 점수가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]씩 증가합니다. 전역 [ICON_HAPPINESS_1]행복이 [COLOR_POSITIVE_TEXT]3[ENDCOLOR] 증가합니다.  [NEWLINE][NEWLINE]이 불가사의는 전 세계에서 하나만 건설할 수 있는 [COLOR_POSITIVE_TEXT]세계 불가사의[ENDCOLOR]입니다.'),
...
('TXT_KEY_BUILDING_FW_GENE_VAULT_PEDIA', '21세기 말에 접어들면서 멸종 수준의 증가와 기후 변화의 가능성에 대한 우려로 인해 다양한 유전자 샘플을 보관하는 유전자 은행의 수가 증가하고 있습니다. 이 중 가장 주목할 만한 것은 백두대간 글로벌 시드볼트로 2015년에 완공되었습니다. 완전히 자급자족할 수 있도록 첨단 ''녹색'' 기술을 활용하여 유전자 샘플의 중앙 저장소이자 네트워크로 연결된 연구 시설의 역할을 했습니다. 전 세계 유전학 연구소와 정보를 공유합니다.'),
...
('TXT_KEY_BUILDING_FW_SHANGHAI_WFC_HELP', '이 불가사의가 지어지면 [ICON_GOLD]골드를 [COLOR_POSITIVE_TEXT]15000[ENDCOLOR] 일시불로 획득하고, 알려진 모든 문명에 [ICON_TOURISM]관광을 [COLOR_POSITIVE_TEXT]10000[ENDCOLOR] 일시불로 획득합니다. [NEWLINE]이 도시에서 다른 문명으로 출발하는 [ICON_INTERNATIONAL_TRADE]교역로가 완료되면 현재 [ICON_CULTURE]문화 및 [ICON_TOURISM]관광 산출량의 [COLOR_POSITIVE_TEXT]5%[ENDCOLOR]만큼의 [ICON_TOURISM]관광을 일시불로 제공합니다.[NEWLINE][NEWLINE][ICON_GOLD]빈곤에서 오는 [ICON_HAPPINESS_3]불행이 전역 [COLOR_POSITIVE_TEXT]5[ENDCOLOR] 감소합니다. [NEWLINE][NEWLINE]이 불가사의는 전 세계에서 하나만 건설할 수 있는 [COLOR_POSITIVE_TEXT]세계 불가사의[ENDCOLOR]입니다.'),
...
-- Virtual Idol
('TXT_KEY_BUILDING_FW_VIRTUAL_IDOL', '가상 아이돌'),
('TXT_KEY_BUILDING_FW_VIRTUAL_IDOL_HELP', '[COLOR_YELLOW][ICON_GREAT_PEOPLE]위대한 음악가[ENDCOLOR] 1명이 출현합니다. 도시의 [ICON_CULTURE]문화 산출량이 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR] 증가하고, [ICON_GREAT_WORK]걸작에서 오는 [ICON_TOURISM]관광이 [COLOR_POSITIVE_TEXT]50%[ENDCOLOR] 증가합니다. 전역 [ICON_HAPPINESS_1]행복이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR]증가합니다. [NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]테마[ENDCOLOR]보너스: [ICON_CULTURE]문화 +8 [NEWLINE][NEWLINE]이 불가사의는 전 세계에서 하나만 건설할 수 있는 [COLOR_POSITIVE_TEXT]세계 불가사의[ENDCOLOR]입니다.'),
...
-- Nano Institute
('TXT_KEY_BUILDING_FW_NANO_INSTITUTE', '나노공학 연구센터'),
...
('TXT_KEY_BUILDING_FW_NANO_INSTITUTE_PEDIA', '나노공학 연구센터는 첨단 반도체와 희토류 소재를 정밀 가공하는 거대한 산업 복합체가 있는 미래시대의 시설입니다. 이곳에서는 2나노 공정과 같은 초미세 반도체 제조 기술이 구현되어, 나노 단위 구조체를 안정적으로 대량 생산할 수 있습니다. 이러한 구조체는 초고성능 반도체, 양자 컴퓨터, 우주선 차폐 소재, 차세대 무기 체계에까지 쓰이며, 인류의 과학기술을 한 차원 끌어올립니다. 희토류와 나노물질을 통합적으로 다루는 이 시설은 전략 자원의 병목을 해소하고, 경제·국방·우주공학 전반에서 압도적인 우위를 제공하는 핵심 기반이 됩니다.'),
-- Utsäde Gene Vault2
('TXT_KEY_BUILDING_FW_EDEN_PROJECT', '이든프로젝트'),
('TXT_KEY_BUILDING_FW_EDEN_PROJECT_HELP', '문명의 모든 [COLOR_POSITIVE_TEXT]연구단지[ENDCOLOR]의 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR], [COLOR_POSITIVE_TEXT]수경재배지구[ENDCOLOR]의 [ICON_FOOD]식량이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 문명의 모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]수직형농장, 지열발전소, 심층시추공[ENDCOLOR]의 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. 전역 [ICON_HAPPINESS_1]행복이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. [NEWLINE][NEWLINE]도시의 [ICON_GREAT_SCIENTIST]위대한 과학자 출현율이 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 증가합니다. 해당 불가사의가 있는 도시의 국가 불가사의, 세계 불가사의 및 타일 시설이 제공하는 [ICON_CULTURE]문화의 [COLOR_POSITIVE_TEXT]50%[ENDCOLOR]가 도시의 [ICON_TOURISM]관광에 추가됩니다. [ICON_GREAT_WORK]걸작 예술품 또는 유물슬롯 2개를 포함합니다.[NEWLINE][NEWLINE]테마보너스: [ICON_RESEARCH]과학: +4, [ICON_GOLDEN_AGE]황금기 점수: +4  [NEWLINE][NEWLINE]이 불가사의는 전 세계에서 하나만 건설할 수 있는 [COLOR_POSITIVE_TEXT]세계 불가사의[ENDCOLOR]입니다.'),
('TXT_KEY_BUILDING_FW_EDEN_PROJECT_QUOTE', '[NEWLINE]''프로그램에 의해 결정되는 씨앗 안에 포함된 세계''[NEWLINE] - Dejan Stojanovic, ''Circling: 1978-1987''[NEWLINE]'),
('TXT_KEY_BUILDING_FW_EDEN_PROJECT_PEDIA', '도시 한복판에 자연을 이식하겠다는 발상에서 출발한 이든 프로젝트는, 밀폐형 바이오돔과 수직농장, 재활용 수경 시스템, 그리고 지열·심층시추를 이용한 에너지 회수 설비를 통합한 거대 복합체입니다. 이곳의 생태계는 완전 제어되는 기후 아래에서 작동하며, 토양 없이도 작물을 키우고 물과 영양분을 순환시켜 도시의 식량과 연구를 동시에 떠받칩니다. 자연 보호구역을 확장하는 대신 인공 생태를 구축·복제하는 데 초점을 맞추었고, 세계 각지의 연구단지와 연결되어 유전·생명공학 데이터와 표본을 표준화된 프로토콜로 공유합니다.[NEWLINE][NEWLINE]학술 투어와 대중 전시를 통해 시민들은 미래의 도시 생태를 직접 체험하며, 이 설비는 혹독한 환경에서도 인류가 스스로의 ‘에덴’을 만들 수 있음을 보여 주는 상징이 되었습니다.'),
...
('TXT_KEY_BUILDING_FW_APEX_CENTRE_HELP', '무료 [COLOR_YELLOW][ICON_DIPLOMAT]위대한 외교관[ENDCOLOR]이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]명 출현합니다. [NEWLINE][NEWLINE]도시의 [ICON_SPY]보안 레벨이 [COLOR_POSITIVE_TEXT]25%[ENDCOLOR] 증가합니다. 적[ICON_SPY]스파이가 이 도시에서 사망하면 [ICON_PEACE]신앙을 [COLOR:105:105:105:255](시대 및 살해된 스파이의 레벨에 따라 보정)[ENDCOLOR] 제공합니다.[NEWLINE][NEWLINE][ICON_RES_PAPER]종이를 [COLOR_POSITIVE_TEXT]3개[ENDCOLOR] 제공합니다.[NEWLINE][NEWLINE]이 불가사의는 전 세계에서 하나만 건설할 수 있는 [COLOR_POSITIVE_TEXT]세계 불가사의[ENDCOLOR]입니다.'),
...
('TXT_KEY_BUILDING_FW_JURASSIC_PARK_HELP', '이 불가사의가 지어지면 도시 바깥에 공룡 유닛이 출현합니다. [COLOR_PLAYER_NETHERLANDS_BACKGROUND]복제 연구소[ENDCOLOR]를 무료로 제공합니다. 모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]동물원[ENDCOLOR]의 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]4[ENDCOLOR], [COLOR_PLAYER_NETHERLANDS_BACKGROUND]복제 연구소[ENDCOLOR]의 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]4[ENDCOLOR] 증가합니다. 전역 [ICON_HAPPINESS_1]행복이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR], [ICON_TOURISM]관광이 [COLOR_POSITIVE_TEXT]3[ENDCOLOR] 증가합니다. [NEWLINE][NEWLINE]도시의 [ICON_STRENGTH]방어력을 증가시키고, 적의 [ICON_MOVES]이동력을 떨어뜨립니다. [NEWLINE][NEWLINE]도시 근처에 [COLOR_YELLOW]숲이나 정글이 있어야[ENDCOLOR] 건설할 수 있습니다. 이 불가사의는 전 세계에서 하나만 건설할 수 있는 [COLOR_POSITIVE_TEXT]세계 불가사의[ENDCOLOR]입니다.'),
...
('TXT_KEY_BUILDING_FW_ENRICHMENT_CENTRE_HELP', '[ICON_CITIZEN]시민 10명마다 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 문명의 모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]입자가속기[ENDCOLOR]의 [ICON_RESEARCH]과학와 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]4[ENDCOLOR] 증가합니다.[NEWLINE][NEWLINE][ICON_RES_NANOMAT]나노물질 [COLOR_POSITIVE_TEXT]4개[ENDCOLOR]와 [ICON_RES_URANIUM]우라늄 [COLOR_POSITIVE_TEXT]4개[ENDCOLOR]를 제공합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]원자력발전소[ENDCOLOR]가 있어야 합니다.'),
...
('TXT_KEY_BUILDING_FW_SKYHOOK', '스카이훅 궤도 정거장'),
('TXT_KEY_BUILDING_FW_SKYHOOK_HELP', '[COLOR_PLAYER_NETHERLANDS_BACKGROUND]우주반사판 전력위성[ENDCOLOR]을 무료로 제공합니다. [ICON_CITIZEN]시민 10명마다 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]우주선 발사센터[ENDCOLOR]의 [ICON_GOLD]골드와 [ICON_CULTURE]문화가 [COLOR_POSITIVE_TEXT]4[ENDCOLOR]증가합니다.[NEWLINE][NEWLINE][ICON_RES_ALUMINUM]알루미늄 [COLOR_POSITIVE_TEXT]6개[ENDCOLOR]를 제공합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]우주선 발사센터[ENDCOLOR]가 있어야 합니다. 이 불가사의는 전 세계에서 하나만 건설할 수 있는 [COLOR_POSITIVE_TEXT]세계 불가사의[ENDCOLOR]입니다.'),
('TXT_KEY_BUILDING_FW_SKYHOOK_QUOTE', '[NEWLINE]우주 엘리베이터는 모두가 더 이상 비웃지 않게 된 지 약 50년 후에 건설될 것이다.[NEWLINE] - 아서 C. 클라크[NEWLINE]'),
('TXT_KEY_BUILDING_FW_SKYHOOK_PEDIA', '스카이훅(Skyhook)은 지구 저궤도에 고정된 정거장과 성층권 상공을 가로지르는 초경량 나노 케이블로 구성된 미래형 궤도 엘리베이터 개념입니다. 대기권에서 직접 궤도로 화물과 인력을 수송할 수 있어, 전통적인 로켓 발사 방식보다 비용을 획기적으로 절감할 수 있습니다. 21세기 후반, 궤도역학 연구의 돌파구와 초경량 나노물질의 개발 덕분에 스카이훅은 상용화에 성공했고, 인류는 이 시설을 통해 우주 채굴, 궤도 정거장 건설, 심우주 탐사에 필요한 자원을 안정적으로 공급할 수 있게 되었습니다. 궤도 정거장의 제어 AI는 물류 효율을 극대화하면서도 보안 기능을 갖추고 있어, 궤도상 화물선을 자동 조종하고 지구-궤도 간 수송망을 실시간으로 최적화합니다. 이는 단순한 운송 시설을 넘어, 인류의 다행성 문명을 향한 첫 관문으로 평가받습니다.'),
-- Pholus Mutagen
('TXT_KEY_BUILDING_FW_PHOLUS_MUTAGEN', '폴루스 돌연변이원'),
('TXT_KEY_BUILDING_FW_PHOLUS_MUTAGEN_HELP', '도시 근처에 [ICON_RES_XENO_FUNGUS]제노포자[COLOR_POSITIVE_TEXT]3개[ENDCOLOR]가 있는 타일 [COLOR_POSITIVE_TEXT]4개[ENDCOLOR]가 출현합니다. [NEWLINE]문명의 모든 [COLOR_POSITIVE_TEXT]생명공학센터[ENDCOLOR]의 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR], [ICON_PEACE]신앙이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]씩 증가합니다. [NEWLINE][NEWLINE]이 불가사의가 지어진 도시에서 생산하는 모든 유닛에 [COLOR_PLAYER_PURPLE]돌연변이[ENDCOLOR] 승급을 부여합니다. [NEWLINE][NEWLINE]이 불가사의는 전 세계에서 하나만 건설할 수 있는 [COLOR_POSITIVE_TEXT]세계 불가사의[ENDCOLOR]입니다.'),
...
('TXT_KEY_BUILDING_FW_SHIMIZUMCP_HELP', '모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]자동생산시설[ENDCOLOR]의 전역 [ICON_HAPPINESS_1]행복이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 문명의 모든 [COLOR_POSITIVE_TEXT]지원중계기[ENDCOLOR]의 [ICON_FOOD]식량이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR], [ICON_CULTURE]문화가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]씩 증가합니다. 도시의 체력이 [COLOR_POSITIVE_TEXT]150[ENDCOLOR]증가하고, [ICON_STRENGTH]방어력이 [COLOR_POSITIVE_TEXT]20[ENDCOLOR] 증가합니다. [NEWLINE][NEWLINE] 이 도시의 대양 타일에서 턴을 마친 적 유닛은 [COLOR_NEGATIVE_TEXT]5의 피해[ENDCOLOR]의 피해를 입으며, 지뢰밭이 있다면 [COLOR_NEGATIVE_TEXT]10의 피해[ENDCOLOR], 나노지뢰밭이 추가로 있다면 총 [COLOR_NEGATIVE_TEXT]15의 피해[ENDCOLOR]를 받습니다. [COLOR:105:105:105:255](연안 타일은 적용되지 않음)[ENDCOLOR][NEWLINE][NEWLINE][COLOR_YELLOW]해안 도시[ENDCOLOR]에만 건설할 수 있습니다. 이 불가사의는 전 세계에서 하나만 건설할 수 있는 [COLOR_POSITIVE_TEXT]세계 불가사의[ENDCOLOR]입니다.[NEWLINE][NEWLINE][ICON_RES_NANOMAT]나노물질 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]가 필요합니다.'),
...
-- Floating Islands
('TXT_KEY_BUILDING_FW_LAPUTA', '천공의 성, 라퓨타'),
('TXT_KEY_BUILDING_FW_LAPUTA_HELP', '문명의 모든 [COLOR_POSITIVE_TEXT]인공환경도시[ENDCOLOR] 타일의 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR], [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]씩 증가합니다.  [COLOR_PLAYER_NETHERLANDS_BACKGROUND]우주반사판 전력위성[ENDCOLOR]당 [ICON_CULTURE]문화, [ICON_GOLD]골드, [ICON_PRODUCTION]생산, [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR]씩 증가합니다.[COLOR:105:105:105:255](상한 15개)[ENDCOLOR][NEWLINE]모든 [COLOR_YELLOW] 도시[ENDCOLOR]의 체력이 [COLOR_POSITIVE_TEXT]50[ENDCOLOR]증가하고, [ICON_STRENGTH]방어력이 [COLOR_POSITIVE_TEXT]10[ENDCOLOR], [ICON_WAR] 군사 유닛 보급 한도가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. [NEWLINE][NEWLINE]이 불가사의는 전 세계에서 하나만 건설할 수 있는 [COLOR_POSITIVE_TEXT]세계 불가사의[ENDCOLOR]입니다. [NEWLINE][NEWLINE][ICON_RES_NANOMAT]나노물질 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]개가 필요합니다.'),
('TXT_KEY_BUILDING_FW_LAPUTA_QUOTE', '[NEWLINE]비판할 수 없다면 그다지 놀라운 일이 아닐 것입니다. 비판이 없는 것에 전념하고 있습니까?[NEWLINE]'),
('TXT_KEY_BUILDING_FW_LAPUTA_PEDIA', '라퓨타는 성층권 상에 부양·정착지화된 상온초전도 기반 플랫폼 군도입니다. 상온 초전도체가 등장했어도 전 지구를 잇는 초전도 전력망은 냉각·진동·지질·해저 구간 등 공학적 병목으로 실현 비용이 막대합니다. 또한 핵융합 상용화를 위해서는 장시간 플라즈마 연속 운전, 중성자에 의한 재료 열화, 열관리·삼중수소 연계 등 수많은 전단계가 필요합니다. 이에 핵심 도시 시설을 성층권의 저난류·저오염 ‘안전 구역’으로 올리고, 우주반사판 전력위성과 직접 결합하는 방식을 채택했습니다. 낮에는 위성에서 반사·집광된 에너지를 거의 무손실로 수광·저장하고, 밤과 피크 시간대에는 지상 레크테나·케이블로 가변 송전을 수행해 부하를 평준화합니다.[NEWLINE][NEWLINE]초전도 전력전자와 고밀도 ESS의 발전은 라퓨타의 에너지 버퍼를 기존 대비 대폭 소형화·경량화했고, 성층권의 저온·건조 환경과 복사 방열을 활용해 냉각 효율을 높였습니다. 고도 분리로 물리적·사이버 보안 위험이 낮아지고, 재난·홍수·폭염·정전의 영향을 거의 받지 않습니다. 라퓨타는 전력망 안정화(주파수 제어·피크 컷), 우주반사판 전력위성 운용, 핵융합 전단계 연구(플라즈마·재료·열관리)를 한데 묶는 ‘상공 에너지 수도’로 기능하며, 지상 도시의 탄소중립과 에너지 안보를 동시에 견인하는 혁신적 해법으로 자리매김했습니다.'),
('TXT_KEY_BUILDING_FW_LAPUTA_DUMMY', '라퓨타 도시'),
-- Nephilim Gene Template → HIVE (bio-drone wonder)
('TXT_KEY_BUILDING_FW_HIVE', '하이브'),
('TXT_KEY_BUILDING_FW_HIVE_HELP', '[COLOR_PLAYER_NETHERLANDS_BACKGROUND]유통 허브[ENDCOLOR]를 무료로 제공합니다. [COLOR_PLAYER_NETHERLANDS_BACKGROUND]복제 연구소[ENDCOLOR]와 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]유전자개조 연구소[ENDCOLOR]의 [ICON_FOOD]식량, [ICON_CULTURE]문화, [ICON_PEACE]신앙이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR]씩 증가합니다. 전역 [ICON_HAPPINESS_1]행복이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR]증가합니다. [NEWLINE][NEWLINE]이 불가사의가 지어진 도시에서 [COLOR_POSITIVE_TEXT]유전자 계열 유닛[ENDCOLOR][COLOR:105:105:105:255](근접, 화약, 기마, 공중정찰, 근접해상, 원거리해상 유닛)[ENDCOLOR]을 생산할 때 [ICON_PRODUCTION]생산 보너스를 얻고, [COLOR_PLAYER_PURPLE]포식 본능[ENDCOLOR] 승급을 부여합니다.[NEWLINE][NEWLINE]도시에 [COLOR_NEGATIVE_TEXT]스카이넷[ENDCOLOR], [COLOR_NEGATIVE_TEXT]우주궤도 정제소[ENDCOLOR]가 없어야 건설할 수 있습니다. 이 불가사의는 전 세계에서 하나만 건설할 수 있는 [COLOR_POSITIVE_TEXT]세계 불가사의[ENDCOLOR]입니다.  [NEWLINE][NEWLINE][ICON_RES_XENO_FUNGUS]제노포자 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]가 필요합니다.'),
('TXT_KEY_BUILDING_FW_HIVE_QUOTE', '[NEWLINE]''우리는 벌과 개미의 법칙을 읽고, 그 질서를 설계했다. 한 개체는 약하지만, 군락은 문명을 움직인다.''[NEWLINE] - 하이브 설계 노트[NEWLINE]'),
('TXT_KEY_BUILDING_FW_HIVE_PEDIA', '하이브는 사회성 곤충의 유전 회로를 벤치마크해 인간 산업에 이식한 최초의 바이오-산업 시설입니다. 여왕/일개미/병정의 역할 분화를 모사한 유전자 모형과 페로몬 기반의 분산 지휘 체계가 결합되어, 도시 물류를 담당하는 수많은 ‘‘바이오 드론’’이 자율 편대와 경로 학습을 수행합니다. 평시에는 창고·항만·철도·상가를 잇는 군락형 운송망을 구축해 체류 시간을 극단적으로 줄이고, 위기 시에는 ‘‘훈련화’’ 프로토콜을 통해 개체를 짧은 주기로 재조정하여 정찰·제압·수색처럼 특화된 전략 임무로 전환합니다. 이 템플릿의 핵심은 ‘‘포식 본능’’ 유전자군입니다. 지정된 자극(표지 페로몬·음향 신호·전기 펄스) 하에서만 각성되며, 각성 중에는 추적·협동·피해 복원 능력이 비선형적으로 향상됩니다. 결과적으로 하이브는 도시 운영을 혁신하는 물류 인프라이자, 필요할 때 군집 자체가 병력이 되는 이중 용도의 플랫폼으로 자리 잡았습니다.'),
-- Mnemosyne Facility
...
('TXT_KEY_BUILDING_FW_SKYNET_HELP', '[COLOR_PLAYER_NETHERLANDS_BACKGROUND]가상현실 허브[ENDCOLOR]를 무료로 제공합니다. 도시의 체력이 [COLOR_POSITIVE_TEXT]150[ENDCOLOR]증가하고, [ICON_STRENGTH]방어력이 [COLOR_POSITIVE_TEXT]30[ENDCOLOR] 증가합니다. [COLOR_PLAYER_NETHERLANDS_BACKGROUND]휴머노이드 로봇 공장[ENDCOLOR]과 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]무인관리기지[ENDCOLOR]의 [ICON_FOOD]식량, [ICON_CULTURE]문화, [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다.[NEWLINE][NEWLINE]이 불가사의가 지어진 도시에서 로봇 계열 유닛[COLOR:105:105:105:255](원거리 유닛, 기갑, 공성, 잠수함유닛)[ENDCOLOR]을 생산할 때 [ICON_PRODUCTION]생산보너스를 제공하고 [COLOR_PLAYER_PURPLE]스카이넷과 연결[ENDCOLOR] 승급을 부여합니다.[NEWLINE][NEWLINE]도시에 [COLOR_NEGATIVE_TEXT]하이브, 우주궤도 정제소[ENDCOLOR]가 없어야 건설할 수 있습니다. 이 불가사의는 전 세계에서 하나만 건설할 수 있는 [COLOR_POSITIVE_TEXT]세계 불가사의[ENDCOLOR]입니다.'),
...
('TXT_KEY_BUILDING_FW_GLOBAL_POWERGRID', '핵융합 초전도 전력망'),
('TXT_KEY_BUILDING_FW_GLOBAL_POWERGRID_HELP', '[COLOR_PLAYER_NETHERLANDS_BACKGROUND]핵융합 반응로[ENDCOLOR]를 무료로 제공합니다. 모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]핵융합 반응로[ENDCOLOR]의 전역 [ICON_HAPPINESS_1]행복이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. [ICON_CITY_STATE]도시 국가에 대한 [ICON_INFLUENCE]영향력을 [COLOR_POSITIVE_TEXT]100[ENDCOLOR] 제공합니다. [NEWLINE][NEWLINE][ICON_RES_URANIUM]우라늄 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]와 [ICON_RES_NANOMAT]나노물질 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]가 필요합니다. [NEWLINE][NEWLINE]이 불가사의는 전 세계에서 하나만 건설할 수 있는 [COLOR_POSITIVE_TEXT]세계 불가사의[ENDCOLOR]입니다.'),
('TXT_KEY_BUILDING_FW_GLOBAL_POWERGRID_QUOTE', '[NEWLINE]''머지않아 인류의 기계는 우주의 어디에서나 얻을 수 있는 힘으로 움직이게 될 것이다.''[NEWLINE] - 니콜라 테슬라[NEWLINE]'),
('TXT_KEY_BUILDING_FW_GLOBAL_POWERGRID_PEDIA', '핵융합이 상용화되자 인류는 전력을 생산하는 문제에서 전력을 나르는 문제로 관심을 옮겼습니다. 고온 초전도체(HTS) 케이블과 극저온 순환 루프를 묶은 대륙 간 주간(主幹)망은 선로 손실을 사실상 무시할 수 있는 수준으로 낮추었고, 해저와 사막을 가로지르는 전력 고속도로는 시간대가 다른 지역의 수요를 평준화합니다. 대형 핵융합 플랜트의 여열은 지역 난방과 산업 공정에 재활용되고, 잉여 전력은 담수화·전해 수소·전기화물차 충전에 쓰입니다. 전력 빈곤이 사라진 도시들은 조명·정수·냉난방·데이터 센터를 안정적으로 운영할 수 있게 되었고, 국경을 넘는 전력 교환은 외교와 무역의 새로운 인프라가 되었습니다. 이 전력망의 완성은 단일 도시의 사업이 아니라, 문명 전체의 생활 방식을 바꾸는 결정적 전환점으로 기록됩니다.'),
-- Orbital Refinery
('TXT_KEY_BUILDING_FW_ORBITAL_REFINERY', '우주궤도 정제소'),
('TXT_KEY_BUILDING_FW_ORBITAL_REFINERY_HELP', '[COLOR_PLAYER_NETHERLANDS_BACKGROUND]복합도시 허브[ENDCOLOR]를 무료로 제공합니다. 모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]우주반사판 전력위성[ENDCOLOR]와 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]항공우주 복합시설[ENDCOLOR]의 [ICON_PRODUCTION]생산, [ICON_GOLD]골드, [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR]씩 증가합니다.[NEWLINE]이 불가사의가 지어진 도시에서 우주 전문화 계열 유닛[COLOR:105:105:105:255](정찰, 화약, 전투기, 폭격기, 항공모함)[ENDCOLOR]을 생산할 때 [ICON_PRODUCTION]생산보너스를 제공하고 [COLOR_PLAYER_PURPLE]우주전문가[ENDCOLOR] 승급을 부여합니다. [NEWLINE][NEWLINE][ICON_RES_NANOMAT]나노물질을 [COLOR_POSITIVE_TEXT]12개[ENDCOLOR] 제공합니다. [NEWLINE][NEWLINE][ICON_FOOD]/[ICON_PRODUCTION]낙후, [ICON_URBANIZATION]도시화에서 오는 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]씩 감소합니다. [NEWLINE][NEWLINE]도시에 [COLOR_NEGATIVE_TEXT]하이브, 스카이넷[ENDCOLOR]이 없어야 건설할 수 있습니다. 이 불가사의는 전 세계에서 하나만 건설할 수 있는 [COLOR_POSITIVE_TEXT]세계 불가사의[ENDCOLOR]입니다.'),
...
('TXT_KEY_BUILDING_FW_CREATION_ORATORIUM', '창세 오라토리움'),
('TXT_KEY_BUILDING_FW_CREATION_ORATORIUM_HELP', '[COLOR_YELLOW][ICON_GREAT_WRITER]위대한 음악가[ENDCOLOR]1명이 출현합니다. [NEWLINE][ICON_CITIZEN]시민 [COLOR_POSITIVE_TEXT]2[ENDCOLOR]명마다 [ICON_CULTURE]문화와 [ICON_RELIGION]신앙이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 총 [ICON_CULTURE]문화의 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR]를 [ICON_GOLD]골드와 [ICON_TOURISM]관광으로 전환합니다.전역 [ICON_HAPPINESS_1]행복이 [COLOR_POSITIVE_TEXT]7[ENDCOLOR] 증가합니다. [NEWLINE][NEWLINE]테마보너스: [ICON_PEACE]신앙 [COLOR_POSITIVE_TEXT]5[ENDCOLOR], [ICON_GOLDEN_AGE]황금기 점수 [COLOR_POSITIVE_TEXT]5[ENDCOLOR].[NEWLINE][NEWLINE]이 불가사의는 전 세계에서 하나만 건설할 수 있는 [COLOR_POSITIVE_TEXT]세계 불가사의[ENDCOLOR]입니다. [NEWLINE][NEWLINE][ICON_RES_XENO_FUNGUS]제노포자 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]가 필요합니다.'),
('TXT_KEY_BUILDING_FW_CREATION_ORATORIUM_QUOTE', '[NEWLINE]''우리는 흙으로 숨을 빚고, 음으로 생명을 세운다. 이제 합창은 우리 자신을 찬송하리라.''[NEWLINE] - 창세 성가집 中[NEWLINE]'),
('TXT_KEY_BUILDING_FW_CREATION_ORATORIUM_PEDIA', '창세 오라토리움은 인간이 스스로의 손으로 “새 생명”을 만들었다고 믿기 시작한 시대의 성전입니다. 합성 성대와 생체 공진실, 음향 메타물질로 직조된 돔 아래에서, 생성형 지성은 미발표 성가를 즉시 작곡하고, 공학적 성악수행자와 인간 합창이 함께 노래합니다. 무대는 유전자 라이브러리와 인공 자궁, 디지털 원형질의 이미지로 장식되어, 탄생의 의식을 예술과 공학의 언어로 재연합니다.[NEWLINE][NEWLINE]이전 세대의 AI가 글과 그림의 비서를 자처했다면, 오라토리움은 육체·목소리·감정까지 합성하여 “창조의 순간”을 무대 위에 구현합니다. 도시는 이곳에서 새로운 존재를 축복처럼 찬송하고, 그 찬송은 곧 인간 스스로를 향합니다. 일부는 이를 오만이라 부르고, 일부는 성취라 부른다. 그러나 한 가지 사실만은 분명합니다. 이 홀에서 울리는 합창은, 더 이상 신을 기다리지 않는다—우리는 우리 자신을 신의 자리에 앉혔기 때문입니다.'),
('TXT_KEY_THEMING_BONUS_CREATION_ORATORIUM', '창세 성가 모음'),
('TXT_KEY_CREATION_ORATORIUM_THEMING_BONUS_HELP', '보너스를 극대화하려면 모든 걸작 슬롯을 같은 시대에 [COLOR_POSITIVE_TEXT]같은 시대[ENDCOLOR] [COLOR_POSITIVE_TEXT]같은 문명[ENDCOLOR]이 만든 [COLOR_YELLOW]음악[ENDCOLOR]으로 채우십시오.'),
-- Nephilim Gene Template
('TXT_KEY_BUILDING_FW_NEPHILIM_GENE_TEMPLATE', '네필림 유전자 모형'),
('TXT_KEY_BUILDING_FW_NEPHILIM_GENE_TEMPLATE_HELP', "[COLOR_PLAYER_NETHERLANDS_BACKGROUND]인공 출산 시설[ENDCOLOR]을 무료로 제공합니다. [ICON_CITIZEN]시민 [COLOR_POSITIVE_TEXT]2[ENDCOLOR]명마다 [ICON_PRODUCTION]생산과 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 전역 [ICON_HAPPINESS_1]행복이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다.[NEWLINE][NEWLINE]이 불가사의는 전 세계에서 하나만 건설할 수 있는 [COLOR_POSITIVE_TEXT]세계 불가사의[ENDCOLOR]입니다.  [NEWLINE][NEWLINE][ICON_RES_XENO_FUNGUS]제노포자 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]가 필요합니다."),
...
('TXT_KEY_BUILDING_FW_CITADEL_STATION_HELP', '공무원 전문가의 산출량이 [ICON_RESEARCH]과학, [ICON_PRODUCTION]생산, [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR]씩 증가합니다. 도시의 전문가의 관련 산출량이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. [NEWLINE][NEWLINE][ICON_DIPLOMAT] 위대한 외교관의 출현율이 [COLOR_POSITIVE_TEXT]50%[ENDCOLOR] 증가합니다. [NEWLINE][NEWLINE]추가 [ICON_SPY]스파이를 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]명 또는 그 이상 제공하고 존재하는 모든 [ICON_SPY]스파이의 레벨이 상승합니다. 문명 전체의 보안 등급이 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 증가합니다.[NEWLINE][NEWLINE][ICON_CITY_STATE]도시 국가에서 임무를 성공하거나 적 스파이를 처치할 때마다 [ICON_GOLD]골드와 [ICON_RESEARCH]과학을 [COLOR_POSITIVE_TEXT]100[ENDCOLOR][COLOR:105:105:105:255](시대별 보정, 고급 첩보 활동은 추가 [ICON_GOLD]/[ICON_RESEARCH] 25)[ENDCOLOR]씩 제공합니다.[NEWLINE][NEWLINE]이 불가사의는 전 세계에서 하나만 건설할 수 있는 [COLOR_POSITIVE_TEXT]세계 불가사의[ENDCOLOR]입니다.[NEWLINE][NEWLINE][ICON_RES_NANOMAT]나노물질 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]가 필요합니다.'),
...
('TXT_KEY_BUILDING_FW_ULTIMATOWER_HELP', '무료 [COLOR_YELLOW][ICON_GREAT_ENGINEER]위대한 기술자[ENDCOLOR]1명 출현합니다. 도시의 전문가들의 [ICON_FOOD]식량과 [ICON_PRODUCTION]과학 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. [NEWLINE]총 [ICON_PRODUCTION]생산의 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR]를 [ICON_GOLD]골드와 [ICON_TOURISM]관광으로 전환합니다. [NEWLINE][NEWLINE][ICON_GREAT_ENGINEER]위대한 기술자의 출현율이 [COLOR_POSITIVE_TEXT]50%[ENDCOLOR] 증가합니다.[NEWLINE][NEWLINE][COLOR_MAGENTA]제국주의[ENDCOLOR] 정책을 완성해야 건설할 수 있습니다. 이 불가사의는 전 세계에서 하나만 건설할 수 있는 [COLOR_POSITIVE_TEXT]세계 불가사의[ENDCOLOR]입니다.[NEWLINE][NEWLINE][ICON_RES_NANOMAT]나노물질 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]가 필요합니다. '),
...
('TXT_KEY_BUILDING_FW_BIONICTOWER_HELP', '무료 [COLOR_YELLOW][ICON_GREAT_SCIENTIST]위대한 과학자[ENDCOLOR] 1명이 출현합니다. 도시의 전문가들의 [ICON_FOOD]식량과 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. 총 [ICON_RESEARCH]과학의 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR]를 [ICON_GOLD]골드와 [ICON_TOURISM]관광으로 전환합니다. [NEWLINE][NEWLINE][ICON_GREAT_SCIENTIST]위대한 과학자의 출현율이 [COLOR_POSITIVE_TEXT]50%[ENDCOLOR] 증가합니다.[NEWLINE][NEWLINE][COLOR_MAGENTA]합리[ENDCOLOR] 정책을 완성해야 건설할 수 있습니다. 이 불가사의는 전 세계에서 하나만 건설할 수 있는 [COLOR_POSITIVE_TEXT]세계 불가사의[ENDCOLOR]입니다.[NEWLINE][NEWLINE][ICON_RES_NANOMAT]나노물질 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]가 필요합니다.'),
...
('TXT_KEY_BUILDING_FW_BUENOSAIRESFORUM_HELP', '무료 [COLOR_YELLOW][ICON_GREAT_MERCHANT]위대한 상인[ENDCOLOR] 1명이 출현합니다. 건설 완료시 [ICON_GOLDEN_AGE]황금기가 시작되며, [ICON_GOLDEN_AGE]황금기의 길이가 [COLOR_POSITIVE_TEXT]50% [ENDCOLOR]증가합니다. 도시의 모든 전문가들의 [ICON_GOLD]골드와 [ICON_GOLDEN_AGE]황금기 점수가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. 총 [ICON_GOLD]골드의 10%를 [ICON_TOURISM]관광으로 전환하고, 이 도시에서 건물에 [ICON_GOLD]투자하는 비용이 [COLOR_POSITIVE_TEXT]50%[ENDCOLOR] 감소합니다. [NEWLINE][NEWLINE][ICON_GREAT_MERCHANT]위대한 상인의 출현율이 [COLOR_POSITIVE_TEXT]50%[ENDCOLOR] 증가합니다.[NEWLINE][NEWLINE][COLOR_MAGENTA]산업[ENDCOLOR] 정책을 완성해야 건설할 수 있습니다. 이 불가사의는 전 세계에서 하나만 건설할 수 있는 [COLOR_POSITIVE_TEXT]세계 불가사의[ENDCOLOR]입니다.[NEWLINE][NEWLINE][ICON_RES_NANOMAT]나노물질 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]가 필요합니다. '),
...
-- 게놈 혁신 센터
('TXT_KEY_BUILDING_FW_GENOME_PROJECT', '게놈 혁신 센터'),
...
('TXT_KEY_BUILDING_FW_GENOME_PROJECT_PEDIA', '게놈 혁신 센터는 인간 게놈 프로젝트의 성과를 넘어, 전 세계 연구자들이 협력하여 유전체 편집, 합성, 그리고 응용 유전체학을 집대성한 미래적 연구 허브입니다. 이곳에서 축적된 기술은 암과 희귀질환의 정밀 치료뿐 아니라, 맞춤형 의학·수명 연장·능력 강화로 이어지며, 생명과학을 넘어 인류 진화의 새로운 국면을 여는 혁신의 중심지가 되었습니다.'),
-- AI Singularity Center
('TXT_KEY_BUILDING_FW_AI_DATANETWORK', 'chat GPT'),
('TXT_KEY_BUILDING_FW_AI_DATANETWORK_HELP', '무료 [COLOR_YELLOW]원하는 [ICON_GREAT_PEOPLE]위인[ENDCOLOR] 1명이 출현합니다. 모든 도시의 [COLOR_POSITIVE_TEXT]전자상거래 서버, 엔터테인먼트, 클라우드 서버, 연구서버[ENDCOLOR]의 관련 산출량이 [COLOR_POSITIVE_TEXT]8[ENDCOLOR] 증가합니다. [NEWLINE][NEWLINE][COLOR_YELLOW]세계 의회 결의안[ENDCOLOR]으로 비준되어야만 건설할 수 있습니다.'),
('TXT_KEY_BUILDING_FW_AI_DATANETWORK_QUOTE', '[NEWLINE][TAB][TAB]“기계가 인간 지성을 초월하는 순간, 우리는 인류 역사에서 새로운 장을 맞이할 것이다. 그것은 끝이 아니라, 또 다른 시작이다.” [NEWLINE][TAB][TAB] — 미래학자 레이 커즈와일[NEWLINE][TAB]'),
('TXT_KEY_BUILDING_FW_AI_DATANETWORK_PEDIA', 'chat GPT는 전 세계의 데이터와 지식을 통합하여 인공지능이 인류 문명을 새로운 국면으로 이끄는 전환점을 상징합니다. 이 불가사의는 연구와 창조 활동을 가속하며, 인류와 AI가 공존하는 미래를 열어갑니다.'),
-- Deep Resource Hub
('TXT_KEY_BUILDING_FW_DEEP_RESOURCE', '나노 합금 제조소'),
('TXT_KEY_BUILDING_FW_DEEP_RESOURCE_HELP','무료 [ICON_GREAT_ENGINEER][COLOR_YELLOW]위대한 기술자[ENDCOLOR]가 1명 출현합니다. 모든 [COLOR_POSITIVE_TEXT]나노물질 공장[ENDCOLOR]의 [ICON_PRODUCTION]생산과 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]4[ENDCOLOR] 증가합니다.[NEWLINE][NEWLINE][COLOR_YELLOW]세계 의회 결의안[ENDCOLOR]으로 비준되어야만 건설할 수 있습니다.'),
('TXT_KEY_BUILDING_FW_DEEP_RESOURCE_QUOTE',  '[NEWLINE][TAB][TAB]''콜라 초심층 시추공은 1989년에 깊이 12,262m에 도달해, 인류가 파낸 가장 깊은 시추 기록으로 남았다.''[NEWLINE][TAB][TAB]— 심부 지질 시추 기록[NEWLINE][TAB]'),
('TXT_KEY_BUILDING_FW_DEEP_RESOURCE_PEDIA', '맨틀 탐사 프로젝트에 따라 설립된 초대형 채굴·연구 복합 시설입니다. 이 시설은 해저와 지각 심부의 희귀 금속 자원을 안정적으로 확보하도록 지원하며, 나노물질과 같은 첨단 소재를 대규모로 가공·분배해 미래 산업의 기반을 마련합니다.');
...
-- Units
--===========================
-- Mobile SAM → 비호복합 자주대공포 (K30 비호 복합)
UPDATE Language_ko_KR
SET Text = '비호복합 자주대공포'
WHERE Tag = 'TXT_KEY_UNIT_MOBILE_SAM';

UPDATE Language_ko_KR
SET Text = '비호복합 자주대공포는 전진하는 지상군을 보호하는 단거리 방공(SHORAD) 전력입니다. 4타일 내 적 항공기의 폭격을 턴당 1회 요격하며, 헬리콥터·저고도 전투기·무인기 대응에 특화되어 있습니다. 지상 유닛의 직접 공격에는 취약하므로 보병·기갑의 호위를 받도록 운용하십시오.'
WHERE Tag = 'TXT_KEY_UNIT_MOBILE_SAM_STRATEGY';

UPDATE Language_ko_KR
SET Text = '사거리 4 내 폭격·공습을 시도하는 적 항공기를 턴당 1회 요격합니다. 지상 공격에는 취약합니다.'
WHERE Tag = 'TXT_KEY_UNIT_MOBILE_SAM_HELP';

UPDATE Language_ko_KR
SET Text = '비호복합 자주대공포는 30mm 연장포와 단거리 지대공 미사일을 결합한 자주식 대공 무기 체계입니다. 전자광학/레이더 추적과 기동성을 바탕으로 전선 상공의 저고도 표적을 신속히 제압하며, 지상 기동부대를 근거리에서 방어하는 역할을 수행합니다. 도시·전선의 항공 위협을 억제합니다.'
WHERE Tag = 'TXT_KEY_UNIT_MOBILE_SAM_PEDIA';

-- Rocket Artillery → K9 자주포
UPDATE Language_ko_KR
SET Text = '자주포'
WHERE Tag = 'TXT_KEY_UNIT_ROCKET_ARTILLERY';

UPDATE Language_ko_KR
SET Text = '자주포는 155mm 52구경장 포를 탑재한 고기동 공성 유닛입니다. 적 영토에서도 이동 페널티 없이 운용되며, 시야 밖 목표도 곡사로 타격합니다. 도시 공략·방어선 제압에 탁월하지만 보병·전차의 직접 공격에는 약하므로 엄호가 필요합니다.'
...
UPDATE Language_ko_KR
SET Text = '자주포는 155mm 52구경장 포, 자동 장전 보조, 디지털 사격통제(C4I)를 갖춘 궤도형 자주포 체계입니다. 고속 연속사격과 MRSI(다중탄 동시탄착) 운용이 가능하며, 사격 후 신속 이탈(Shoot-and-Scoot)로 반격을 회피합니다. 도시 포격과 진지 파괴의 주력 화력으로 전장을 준비사격으로 제압합니다.'
...
--------------
INSERT INTO Language_ko_KR (Tag, Text) VALUES
('TXT_KEY_SPECIALUNIT_SPACEAIRSHIP', '우주비행선');
...
('TXT_KEY_UNIT_FW_SPACE_COLONIST_HELP', '개척자의 최종 업그레이드 유닛입니다. [COLOR_PLAYER_PURPLE]낙하부대[ENDCOLOR] 승급을 가집니다.[NEWLINE]추가 인프라 및 시민을 갖춘 도시를 세울 수 있습니다.[NEWLINE][NEWLINE]유닛을 생산하는 동안 도시의 [ICON_FOOD]성장이 멈춥니다. 유닛 생산을 완료하면 도시의 [ICON_CITIZEN]시민이 [COLOR_NEGATIVE_TEXT]1명[ENDCOLOR] 감소합니다.[NEWLINE][NEWLINE][COLOR_NEGATIVE_TEXT]국경 바로 근처에 인접했거나 제국이 [ICON_HAPPINESS_3]불행하면 도시를 세울 수 없습니다[ENDCOLOR].'),
...
('TXT_KEY_UNIT_FW_CLUSTER_MISSILE_TEXT','집속탄은 하나의 탄체 안에 여러 개의 작은 자탄을 담아, 넓은 지역에 피해를 주기 위해 고안된 무기입니다. 원래는 전투기에서 투하하는 항공 폭탄 형태가 일반적이지만, 포병의 화포나 다연장 로켓, 미사일을 통해 발사되는 것으로 발전하게 되었습니다.투하된 집속탄은 지면에 직접 충돌하여 폭발하지 않고, 공중에서 탄체가 열리면서 다수의 자탄을 흩뿌린다. 자탄들은 광범위하게 퍼져 지상에 떨어져 폭발하며, 대규모 살상과 장비 파괴 효과를 노린다. 걸프 전쟁 당시, 미군의 다연장 로켓에서 발사된 자탄은 "강철 비"라 불리며 그 위력을 과시했다. 또한 전투기에 탑재 가능한 소형 발사 장치인 ‘디스펜서 폭탄’도 개발되어, 수백 개의 자탄을 한 번에 살포할 수 있었습니다.집속탄은 제2차 세계 대전 시기 독일 공군이 사용한 초기 모델에서 비롯되었으며, 이후 현대전에 이르기까지 적 진형 제압과 넓은 지역 공격을 위한 대표적 화기로 발전해왔습니다. '),
('TXT_KEY_UNIT_FW_CLUSTER_MISSILE_STRATEGY','집결한 적 부대를 상대로 매우 효율적인 공격 미사일입니다. 적의 무리가 너무나 많은 경우에는 적은 비용으로 큰 효과를 노릴 수 있습니다.'),
('TXT_KEY_UNIT_FW_CLUSTER_MISSILE_HELP','포탄을 발산하는 유닛 기준으로 3칸까지 모두에게 손상시키는 데 한번 사용될 수 있는 유닛입니다. 범위가 멀어질수록 효과가 감소합니다. [COLOR_POSITIVE_TEXT]군사 유닛 보급 한도를 차지하지 않습니다.[ENDCOLOR][NEWLINE][NEWLINE][ICON_RES_IRON]철 [COLOR_POSTITIVE_TEXT]1개[ENDCOLOR]가 필요합니다.'),
-- 플라즈마탄
...
('TXT_KEY_UNIT_FW_HYPERMISSILE_HELP','포탄을 발산하는 유닛 기준으로 3칸까지 모두에게 손상시키는 데 한번 사용될 수 있는 유닛입니다. 범위가 멀어질수록 효과가 감소합니다. [COLOR_POSITIVE_TEXT]군사 유닛 보급 한도를 차지하지 않습니다.[ENDCOLOR][NEWLINE][NEWLINE][ICON_RES_IRON]철 [COLOR_POSTITIVE_TEXT]1개[ENDCOLOR]가 필요합니다.'),
-- 고열압탄 (플라즈마탄 상위 업그레이드)
...
('TXT_KEY_UNIT_FW_THERMOMISSILE_HELP','포탄을 발산하는 유닛 기준으로 3칸까지 모두에게 손상시키는 데 한번 사용될 수 있는 유닛입니다. 범위가 멀어질수록 효과가 감소합니다. [COLOR_POSITIVE_TEXT]군사 유닛 보급 한도를 차지하지 않습니다.[ENDCOLOR][NEWLINE][NEWLINE][ICON_RES_IRON]철 [COLOR_POSTITIVE_TEXT]1개[ENDCOLOR]가 필요합니다.'),
--탄도미사일
('TXT_KEY_UNIT_FW_ADVANCED_MISSILE_GUIDED','탄도 미사일'),
('TXT_KEY_UNIT_FW_ADVANCED_MISSILE_GUIDED_TEXT','ICBM(대륙간 탄도미사일)은 사거리 5,500km 이상의 탄도미사일을 말한다. 탄도미사일은 보통 사거리로 구분하며, SRBM(300~1,000km), MRBM(1,000~3,000km), IRBM(3,000~5,500km), **ICBM(≥5,500km)**으로 분류합니다.MIRV(다탄두 개별목표 재돌입체)는 한 발의 미사일이 여러 독립 표적을 동시에 노릴 수 있게 해 주는 탑재 방식입니다.초기 ICBM은 정확도가 낮아 대도시 같은 대형 표적에 적합했으나, 유도기술 발달로 **원형공산오차(CEP)**가 크게 줄어 정밀 타격이 가능해졌습니다.SLBM(잠수함발사 탄도미사일)은 잠수함에서 발사되며, 은밀성과 기동성 때문에 핵 삼위일체(지상 ICBM · 해상 SLBM · 전략폭격기) 중 생존성이 가장 높다고 평가됩니다. 전략폭격기는 여전히 핵 억제의 한 축으로 삼위일체를 구성합니다.'),
('TXT_KEY_UNIT_FW_ADVANCED_MISSILE_GUIDED_STRATEGY','세상의 어떤 부분을 만질 수 있는 힘을 갖고 싶을 때 사용해야 할 도구입니다.'),
('TXT_KEY_UNIT_FW_ADVANCED_MISSILE_GUIDED_HELP','적 유닛 또는 도시에 주둔한 유닛을 손상시키는 데 한번 사용될 수 있는 유닛입니다. [COLOR_POSITIVE_TEXT]군사 유닛 보급 한도를 차지하지 않습니다.[ENDCOLOR][NEWLINE][NEWLINE][ICON_RES_OIL]석유 [COLOR_POSTITIVE_TEXT]1개[ENDCOLOR]가 필요합니다.'),
-- 극초음속 미사일
...
('TXT_KEY_UNIT_FW_RAILGUN_MISSILE_HELP','적 유닛 또는 도시에 주둔한 유닛을 손상시키는 데 한번 사용될 수 있는 유닛입니다. [COLOR_POSITIVE_TEXT]군사 유닛 보급 한도를 차지하지 않습니다.[ENDCOLOR][NEWLINE][NEWLINE][ICON_RES_OIL]철 [COLOR_POSITIVE_TEXT]1개[ENDCOLOR]가 필요합니다.'),
-- 신의 지팡이 (God Rod)
('TXT_KEY_UNIT_FW_GOD_ROD','신의 지팡이'),
('TXT_KEY_UNIT_FW_GOD_ROD_TEXT','신의 지팡이는 궤도에서 고밀도 금속 로드(텅스텐/철 합금)를 감속 장치 없이 투하시켜, 폭약 없이도 순수 운동에너지로 목표를 꿰뚫는 장거리 타격 수단입니다. 궤도 버스가 투하 각·속도를 계산하고, 대기권 돌입 후 짧은 구간만 종말 유도를 수행하여 방공망이 반응하기 전에 핵심 표적을 파괴합니다. 강화 구조물·지하시설·진지에 효과적이며, 전력위성·항법망과 연동되어 신속한 타격 창을 생성합니다.'),
('TXT_KEY_UNIT_FW_GOD_ROD_STRATEGY','장거리 단발성 궤도 투하 무기입니다. 폭발물 없이 운동에너지로 관통/제압하며, 궤도 협약으로 도시 직접 타격은 불가합니다.'),
('TXT_KEY_UNIT_FW_GOD_ROD_HELP','적 유닛을 장거리에서 한 번 사용해 타격합니다. 주변의 1타일의 적은 [COLOR_NEGATIVE_TEXT]40[ENDCOLOR]의 피해를 받습니다. [COLOR_POSITIVE_TEXT]군사 유닛 보급 한도를 차지하지 않습니다.[ENDCOLOR][NEWLINE][NEWLINE][ICON_RES_IRON]철 [COLOR_POSITIVE_TEXT]1개[ENDCOLOR]와 [ICON_RES_NANOMAT]나노물질 [COLOR_POSTITIVE_TEXT]1개[ENDCOLOR]가 필요합니다.'),
-- 신의 지팡이 (업그레이드)
...
('TXT_KEY_UNIT_FW_GOD_ROD2_STRATEGY','장거리 단발성 궤도 투하 무기의 개량형. [COLOR_PLAYER_PURPLE]폭약 없이 운동에너지로 관``통/제압[ENDCOLOR]하며, 강화 구조물·지하시설에 추가로 강합니다. (도시 직접 타격 금지)'),
('TXT_KEY_UNIT_FW_GOD_ROD2_HELP','적 유닛을 장거리에서 한 번 사용해 타격합니다. 주변 1타일의 적 유닛은 [COLOR_NEGATIVE_TEXT]50[ENDCOLOR]의 추가 피해를 받습니다. [COLOR_POSITIVE_TEXT]군사 유닛 보급 한도를 차지하지 않습니다.[ENDCOLOR][NEWLINE][NEWLINE][ICON_RES_IRON]철 [COLOR_POSITIVE_TEXT]1개[ENDCOLOR]와 [ICON_RES_NANOMAT]나노물질 [COLOR_POSTITIVE_TEXT]1개[ENDCOLOR]가 필요합니다.'),
-- HYDROGEN BOMB
('TXT_KEY_UNIT_FW_HYDROGEN_BOMB', '수소 융합 핵폭탄'),
('TXT_KEY_UNIT_FW_HYDROGEN_BOMB_TEXT', '순수 핵융합 열핵폭탄은 핵융합 열핵 무기에 사용되는 두 개의 무거운 수소 동위원소인 중수소와 삼중수소의 융합을 발화하기 위해 핵분열 1차 폭발물이 필요하지 않은 수소 폭탄 설계입니다. 그러한 무기는 핵분열성 물질을 필요로 하지 않으므로 기존 무기보다 비밀리에 개발하기가 훨씬 더 쉬울 것입니다. 무기급 우라늄(U-235) 또는 증식 플루토늄(Pu-239)을 분리하려면 상당하고 은폐하기 어려운 산업 투자가 필요하며 필요한 기계의 판매 및 이전을 차단하는 것이 핵 확산을 제어하는 주요 메커니즘이었습니다..수소 핵융합 폭탄, 또는 열핵 폭탄은 원자핵이 합쳐져서 더 무거운 원자핵을 형성하며 방출되는 에너지를 이용한 폭탄이다. 일반적인 원자 폭탄에 비해 훨씬 더 많은 파괴력을 가지며, 이는 데우터륨과 트리튬 같은 무거운 수소 동위 원소들의 핵융합 반응에서 나오는 에너지 때문이다. 이러한 폭탄은 대량 살상 무기에 속하며, 그 사용은 국제법에 의해 엄격히 규제되어 있다.'),
('TXT_KEY_UNIT_FW_HYDROGEN_BOMB_HELP', '적에게 지옥의 맛을 보여주십시오. 도시와 유닛에 막심한 피해를 줍니다. [NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]맨해튼 프로젝트[ENDCOLOR]와 1개의 [ICON_RES_URANIUM]우라늄이 필요합니다'),
('TXT_KEY_UNIT_FW_HYDROGEN_BOMB_STRATEGY', '적에게 지옥의 맛을 보여주십시오. 미사일 기술의 발전의 효과로 요격 회피율이 강화되었습니다. 도시와 유닛에 막심한 피해를 줍니다. [NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]맨해튼 프로젝트[ENDCOLOR]와 1개의 [ICON_RES_URANIUM]우라늄이 필요합니다.'),
-- 마이크로 핵융합 핵폭탄
('TXT_KEY_UNIT_FW_THERMONUCLEAR_BOMB','마이크로 핵융합 핵폭탄'),
('TXT_KEY_UNIT_FW_THERMONUCLEAR_BOMB_TEXT','마이크로 핵융합 폭탄은 현재의 과학 및 기술 원칙을 뛰어넘는 무기입니다. 이 무기는 나노촉매 물질의 상호 작용에 의해 발생하는 엄청난 에너지를 활용하며, 이를 핵융합과 결합함으로써 그 파괴력을 한층 더 강화시킵니다. 이 무기의 기본 원리는 우라늄과 결합하는 나노물질을 이용하여 초고온 및 초고압 환경을 생성하고, 이로 인해 수소 동위원소들이 융합하는 것입니다. 이는 핵탄두의 기폭장치를 매우 작게 만들 수 있는 이점이 있었습니다.'),
...
('TXT_KEY_UNIT_FW_THERMONUCLEAR_BOMB_HELP','적에게 궁극의 파괴를 퍼부으십시오. 경량화한 핵탄두의 신기술 덕분에 우주궤도에 투하가 가능합니다. 도시에 막대한 피해를 주고 폭발 반경에 있는 모든 유닛을 죽입니다.[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]맨해튼 프로젝트[ENDCOLOR]를 수행해야 생산할 수 있습니다.[NEWLINE][ICON_RES_URANIUM] 우라늄 [COLOR_POSTITIVE_TEXT]1개[ENDCOLOR]와 [ICON_RES_NANOMAT]나노물질 [COLOR_POSTITIVE_TEXT]1개[ENDCOLOR]가 필요합니다.'),
-- [[탱크]]  -----------------------------------------------------------------------------------------------------------------------------------
-- 레일건 전차
...
('TXT_KEY_UNIT_FW_ZEKE_STRATEGY','지크는 강력한 이족보행의 로봇입니다. 강을 건널 수 있습니다. 공격 후 이동이 가능합니다.'),
...
('TXT_KEY_UNIT_FW_MODERN_DRONE_HELP', '정보화 시대의 강력한 정찰 유닛입니다. 국경을 감시하며 잠수함을 탐지하고 기갑유닛과 싸우는 데 특화되어있습니다. 산악과 해양타일 위에 떠있을 수 있습니다.'),
('TXT_KEY_UNIT_FW_MODERN_DRONE_STRATEGY', 'UAV는 잠수함을 탐지할 수 있는 최고의 정찰 유닛입니다. 전장에서 UAV를 눈으로 사용하십시오.'),
...
('TXT_KEY_UNIT_FW_HYBRID_DRONE_HELP','미래 시대의 공중정찰유닛입니다. 잠수함을 탐지하고 기갑유닛과 싸우는데 특화되었습니다. 매턴 스스로 이동하며 체력 회복이 가능합니다. 산악과 해안 타일 위에 떠 있을 수 있습니다.'),
-- 바이오 드론
...
('TXT_KEY_UNIT_FW_BIODRONE_HELP','매우 강력한 공중정찰유닛입니다. 매턴 스스로 체력을 회복하며, 빠르게 이동이 가능합니다. 잠수함을 탐지하고 기갑유닛과 싸우는데 특화되었습니다. 산악과 해양타일 위에 떠 있을 수 있습니다.'),
-- [[헬리콥터]]
('TXT_KEY_UNIT_FW_APACHE','앨리게이터'),
('TXT_KEY_UNIT_FW_APACHE_HELP','정보화시대 기갑과 전차를 전문으로 상대하는 최신 공격헬기입니다. 산악과 해안 타일 위에 떠 있을 수 있습니다.'),
...
('TXT_KEY_UNIT_FW_VERTOL_HELP','현대 전차와 레일건 전차와 싸우는데 특화된 대전차 유닛입니다. 산악과 해양타일 위에 떠있을 수 있습니다.'),
-- 호버탱크
...
('TXT_KEY_UNIT_FW_HOVERTANK_HELP','레일건 전차와 대학살 로봇을 상대하는데 특화된 대전차 유닛입니다. 산악과 해양타일 위에 떠있을 수 있습니다.'),
-- [[SAM]]  -----------------------------------------------------------------------------------------------------------------------------------
-- 이동식 SAM 발사대
...
('TXT_KEY_UNIT_FW_CRAWLER_STRATEGY','크롤러 SAM은 미사일 유닛 4개를 탑재할 수 있는 대공 유닛입니다. 매턴 25%의 확률로 유도미사일이 자동으로 생성됩니다. (전략자원 소모)[NEWLINE][NEWLINE][COLOR_YELLOW]문명당 4개로 제한됩니다.[ENDCOLOR]'),
('TXT_KEY_UNIT_FW_CRAWLER_HELP','4개의 미사일이 탑재가능하고 한턴에 4번 연속 공격이 가능한 미래 시대의 대공 유닛입니다. [NEWLINE][NEWLINE][COLOR_YELLOW]문명당 4개[ENDCOLOR]로 제한됩니다.[ENDCOLOR]'),
-- [[공성무기]]
-- 이동식 다연장 로켓포
...
('TXT_KEY_UNIT_FW_HIMARS_HELP','미래시대의 초기 공성 유닛입니다. 1개의 미사일이 탑재가 가능합니다.'),
-- 보행형 자주포
...
('TXT_KEY_UNIT_FW_MECH_ARTILLERY_HELP','미래 시대의 강력한 포병 유닛입니다. 1개의 미사일이 탑재가 가능합니다.'),
-- 엔젤
...
('TXT_KEY_UNIT_FW_ANGEL_STRATEGY','엔젤은 미사일 유닛 1개를 탑재할 수 있는 공성 유닛입니다. 매턴 25%의 확률로 고열압탄이 자동으로 생성됩니다. (전략자원 소모) 최대 4기만 보유할 수 있습니다.'),
('TXT_KEY_UNIT_FW_ANGEL_HELP','미래 시대의 매우 강력한 극강의 공성 유닛입니다. 1개의 미사일이 탑재가 가능합니다. [COLOR_YELLOW]문명당 4개[ENDCOLOR]로 제한됩니다.'),
-- [[강화보병]]  -----------------------------------------------------------------------------------------------------------------------------------
-- 파워아마보병
...
('TXT_KEY_UNIT_FW_GUNDAM_HELP','건담은 강력한 방어형 로봇형태의 무기입니다. 기마유닛을 물리치는 데 효과적입니다. 강을 건널 수 있습니다. 시야가 증가합니다.[NEWLINE][NEWLINE][COLOR_CYAN]바람이 잠잠하니까 괜찮아'),
-- [[바이오계열 보병]]  -----------------------------------------------------------------------------------------------------------------------------------
-- 생체강화 보병
...
('TXT_KEY_UNIT_FW_CLONETROOPER_STRATEGY','클론 트루퍼는 미래시대의 보병 유닛입니다. 매턴 스스로 체력을 회복합니다.'),
('TXT_KEY_UNIT_FW_CLONETROOPER_HELP','미래시대 제노포자로 생산이 가능한 유닛입니다. 매턴 스스로 체력을 회복합니다.'),
-- 바이오트루퍼
...
('TXT_KEY_UNIT_FW_BIOTROOPER_HELP','미래 시대의 정예 보병 유닛입니다.적영토에 침입하여 적을 방해할 수 있습니다.[NEWLINE][NEWLINE][COLOR:255:173:69:255]끝까지 너와 함께 할 거야!'),
-- 슈퍼솔져
...
('TXT_KEY_UNIT_FW_SUPERSOLDIERS_HELP','슈퍼솔져는 적영토에 진입 할 수 있는 중요한 게릴라 침투부대입니다. [COLOR_PLAYER_PURPLE]유전자개조: 광형태적위장[ENDCOLOR] 승급이 있어, 적에게 탐지당하지 않습니다. 공격을 하거나, 탐지가 가능한 유닛 시야에 있거나, 다른 유닛 바로 옆에 인접하면 탐지당합니다. 적영토에 침입하여 적을 방해할 수 있습니다. [NEWLINE][NEWLINE][COLOR:255:173:69:255]이거 하루 종일 할 수 있어!'),
-- [[용병계열]]  -----------------------------------------------------------------------------------------------------------------------------------
--용병
('TXT_KEY_UNIT_CAYM_PMC','프로 용병'),
('TXT_KEY_UNIT_FW_ELITE_MERCENARIES','유전자 선별 용병'),
('TXT_KEY_UNIT_FW_ORGANIC_MERCENARIES','생체강화 용병'),
('TXT_KEY_UNIT_FW_ENHANCED_MERCENARIES','생체강화 용병'),
...
('TXT_KEY_UNIT_FW_AUTOMATON_STRATEGY','모이면 모일수록 강해지는 저렴하면서도 강력한 미래 유닛입니다. 자동생산시설과 무인관리기지가 있는 도시에서 더욱 빠르게 생산이 가능합니다.'),
('TXT_KEY_UNIT_FW_AUTOMATON_HELP','저렴하고 대량 생산이 가능한 미래시대의 원거리 유닛입니다.모일수록 전투력이 강화됩니다.'),
-- 로봇군단
...
('TXT_KEY_UNIT_FW_ROBOT_INFANTRY_HELP','오토마타 보다 강력한 원거리 미래시대의 유닛입니다. 집단 배치 시 더욱 강해집니다. [NEWLINE][NEWLINE][COLOR_YELLOW]나는 돌아온다!'),
-- 콜로서스
('TXT_KEY_UNIT_FW_COLOSSUS','콜로서스'),
('TXT_KEY_UNIT_FW_COLOSSUS_TEXT','콜로서스는 고출력 플라즈마 포와 중층 방호를 갖춘 거대 플랫폼이자, Cognitive Neuroelectronic Defense Registry(CNDR) 의 중앙 결절입니다. CNDR는 드론·자주포·기갑 전력을 실시간으로 묶어 지정 축선에 화력을 집중하도록 우선순위를 조정하고, 교란·탈취가 발생한 노드는 즉시 격리·우회하여 지휘망을 안정화합니다. 그 결과 콜로서스 주변에는 동기화된 일제타가 형성되며, 필요 시 현장에서 지휘권을 강제 위임/회수해 군단 전체의 타격 타이밍을 한 박자로 맞춥니다. 요약하면, 콜로서스는 “많이, 빠르게, 한곳에”를 구현하는 로봇군단의 구심점입니다.'),
('TXT_KEY_UNIT_FW_COLOSSUS_STRATEGY','콜로서스는 발사기에 플라즈마포를 장착한 강력한 원거리 로봇 유닛입니다. 강력하고 견고한 방어용 원거리 궁수 유닛입니다.'),
('TXT_KEY_UNIT_FW_COLOSSUS_HELP','강력한 플라즈마포를 탑재한 거대 로봇 유닛입니다. 집단 지휘의 중심으로 방어와 화력이 우수합니다. 공격 후 이동이 가능합니다. [NEWLINE][NEWLINE][COLOR_YELLOW]너의 존재는 이미 예견되었고, 저항군은 곧 무너진다.'),
-- [[공병유닛]]   -----------------------------------------------------------------------------------------------------------------------------------
--공정부대
...
('TXT_KEY_UNIT_FW_SPACEMARINES_HELP','우호 영토로부터 공중투하가 가능한 강력한 정찰 지상 유닛입니다. 강하 후에도 이동 및 약탈을 할 수 있지만 다음턴까지 전투를 할 수 없습니다.[NEWLINE][NEWLINE][COLOR_CYAN]그의 힘과 영원한 전쟁으로 우리를 인도하소서.'),
...
('TXT_KEY_UNIT_FW_SWARM_HELP','이동력이 있지만 약한 미래시대 지상 유닛입니다. 전략자원이 필요하지 않습니다.[NEWLINE][NEWLINE][COLOR_PLAYER_ORANGE]공격시 3턴동안 효과가 지속되는 강력한 신경독을 퍼뜨립니다.'),
...
('TXT_KEY_UNIT_FW_CHIMERA_HELP','빠른 이동력을 지닌 지상 유닛입니다. 매턴 스스로 회복이 가능합니다. [NEWLINE][NEWLINE][COLOR_PLAYER_ORANGE]공격시 3턴동안 효과가 지속되는 강력한 신경독을 퍼뜨립니다.'),
-- [[공룡]]  -------------------------------------------------------------------------------------------------------------------------------------------
-- 티라노사우루스
...
('TXT_KEY_UNIT_FW_GUNBOAT_HELP', '이동력이 좋은 원거리 해군 유닛입니다. 잠수함을 탐지하는것이 가능하며, [COLOR_PLAYER_PURPLE]공격 후 이동[ENDCOLOR] 승급과 [COLOR_PLAYER_PURPLE]낙하부대[ENDCOLOR] 승급을 가지고 있습니다. 대양에서는 느려집니다. [NEWLINE][NEWLINE]한 번에 [COLOR_YELLOW]4기[ENDCOLOR]만 보유할 수 있습니다'),
...
('TXT_KEY_UNIT_FW_ADV_GUNBOAT_HELP', '이동력이 매우 좋은 원거리 해군 유닛입니다. 잠수함을 탐지하는것이 가능하며, [COLOR_PLAYER_PURPLE]공격 후 이동[ENDCOLOR] 승급과 [COLOR_PLAYER_PURPLE]궤도강하[ENDCOLOR] 승급을 가지고 있습니다. 대양에서는 느려집니다. [NEWLINE][NEWLINE]한 번에 [COLOR_YELLOW]4기[ENDCOLOR]만 보유할 수 있습니다'),
...
('TXT_KEY_UNIT_FW_BIO_DESTROYER_HELP',' 미래시대의 최후의 마지막 강력한 근접 해상 유닛입니다. 매턴 스스로 체력을 회복하며, 잠수함 탐지가 가능합니다. 이동이 가능합니다. 미사일 4개를 탑재할 수 있습니다.'),
-- [[순양함류]]  -----------------------------------------------------------------------------------------------------------------------------------
-- 아스널 쉽
...
-- 뉴로 레일건 순양함
('TXT_KEY_UNIT_FW_RAILGUN_CRUISER','뉴로 레일건 순양함'),
...
('TXT_KEY_UNIT_FW_RAILGUN_CRUISER_HELP',' 미래시대의 강력한 원거리 해상 유닛입니다. 미사일 4개를 탑재할 수 있습니다.'),
-- 바이오 순양함
...
('TXT_KEY_UNIT_FW_BIO_CRUISER_HELP',' 미래시대의 최후의 마지막 강력한 원거리 해상 유닛입니다. 매턴 스스로 체력을 회복합니다. 미사일 4개를 탑재할 수 있습니다.'),
...
('TXT_KEY_UNIT_FW_MECHASUB_PEDIA',' 탄도 미사일 잠수함은 핵탄두가 장착된 잠수함 발사 탄도 미사일을 배치할 수 있는 잠수함입니다. 탄도 미사일 잠수함에 대한 미국 해군의 선체 분류 기호는 SSB 및 SSBN입니다. SS는 잠수함(또는 잠수정), B는 탄도 미사일, N은 원자력 잠수함을 나타냅니다.[NEWLINE][NEWLINE]이는 잠수함은 핵 억지력 때문에 냉전의 주요 무기 체계가 되었습니다. 그들은 목표물로부터 수천 킬로미터 떨어진 곳에서 미사일을 발사할 수 있고 소음이 적기 때문에 탐지하기 어렵기 때문에 선제 공격 시 생존 가능한 억지력이 되고 핵 억지력의 상호 확증 파괴 정책의 핵심 요소가 됩니다. 그들의 배치는 미국과 소련/러시아에 의해 지배되었으며 프랑스, 영국, 중국 및 인도와 함께 적은 수의 서비스를 제공했습니다.'),
('TXT_KEY_UNIT_FW_MECHASUB_HELP','구축함과 다른 잠수함을 제외한 모든 유닛에게 보이지 않습니다.  2개의 미사일을 탑재할 수 있으며 다른 해상 유닛을 공격하는데 특화되어 있습니다. [ICON_RES_URANIUM] 우라늄이 필요합니다.'),
-- 레비아탄
...
('TXT_KEY_UNIT_FW_CYBERSUB_HELP','구축함과 다른 잠수함을 제외한 모든 유닛에게 보이지 않습니다.  2개의 미사일을 탑재할 수 있으며 다른 해상 유닛을 공격하는데 특화되어 있습니다.'),
-- [[항모]]  -----------------------------------------------------------------------------------------------------------------------------------
-- 이지스 항공모함
...
-- [[전투기]]  -----------------------------------------------------------------------------------------------------------------------------------
--  스텔스무인전투기
('TXT_KEY_UNIT_FW_DRONE_FIGHTER_2','스텔스무인전투기 편대'),
('TXT_KEY_UNIT_FW_DRONE_FIGHTER_2_TEXT','스텔스 무인 전투기 편대는 유인 기체와 다수의 저피탐 무인기들이 하나의 전술 팀으로 행동하도록 설계된 차세대 공중전력입니다. 편대의 무인기들은 자율 임무 분담(정찰·전자전·교란·정밀 타격)을 수행하며, 유인기는 센서 융합과 교전 지휘에 집중합니다. 무인기는 내부무장창과 고도화된 전자전 장비, 분산 센서 네트워크를 통해 탐지-비탐지 전환과 분산 킬체인을 구현합니다. 전술 데이터링크와 실시간 협동 알고리즘으로 한 조종사가 **여러 기체(2~6기 내외)**를 통제하며, 통신이 끊겨도 자율 교전 규칙에 따라 임무를 지속합니다. 고비용 유인기를 위험 구역 밖에 두고, 무인기가 전방 침투·SEAD/DEAD·유인호위를 담당함으로써, 전장은 저피탐·고민첩·다중 축 압박이라는 새로운 공중 우위 패턴으로 재편됩니다.'),
('TXT_KEY_UNIT_FW_DRONE_FIGHTER_2_STRATEGY','스텔스 무인 전투기 편대는 미래형 공중 유닛입니다.'),
...
('TXT_KEY_UNIT_FW_HELICARRIER_STRATEGY','헬리캐리어는 지상으로 호버링이 가능한 미래형 지원 유닛입니다. 문명 내에 헬리캐리어를 2개 이상 소유할 수 없습니다.'),
('TXT_KEY_UNIT_FW_HELICARRIER_HELP','미래 시대의 보조형 유닛으로 지상으로 호버링이 가능하며, 기본 6대의 항공기가 탑재가능합니다.  [NEWLINE][NEWLINE][COLOR_YELLOW]문명당 2개[ENDCOLOR]로 제한 됩니다.'),
-- 넥서스
...
('TXT_KEY_UNIT_FW_NEXUS_STRATEGY','넥서스는 아군 유닛을 치료하는 동시에 전투력을 감소시키고 매 턴 인접한 적 유닛에게 피해를 주는 미래형 지원 유닛입니다. 문명 내에 넥서스를 2개 이상 소유할 수 없습니다.'),
('TXT_KEY_UNIT_FW_NEXUS_HELP','미래 시대의 보조형 유닛으로 우호 유닛의 체력을 매턴 회복시키는 반면, 인접한 적 유닛에 피해를 주고 전투력도 떨어뜨립니다. 기본 10대의 항공기가 탑재가능합니다. [NEWLINE][NEWLINE][COLOR_YELLOW]문명당 2개[ENDCOLOR]로 제한 됩니다.'),
-- 더미유닛
...
-- UFO
('TXT_KEY_PROMOTION_FW_MOVE_ALL_TERRAIN','UFO 유닛'),
('TXT_KEY_PROMOTION_FW_MOVE_ALL_TERRAIN_HELP','산 타일 상공 통과 가능, 승선 없이 물 타일 통과 가능 해양타일에서 [COLOR_POSITIVE_TEXT]공격 가능[ENDCOLOR]'),
-- 전투 네트워크
('TXT_KEY_PROMOTION_FW_NETWORKED','전투 네트워크'),
('TXT_KEY_PROMOTION_FW_NETWORKED_HELP','우호 유닛과 인접 시 [ICON_STRENGTH]전투력 보너스 [COLOR_POSITIVE_TEXT]+15%[ENDCOLOR]'),
-- 소형원자로
...
('TXT_KEY_PROMOTION_FW_NEXUS_HELP','2 타일 내의 적 유닛의 [ICON_STRENGTH]전투력 [COLOR_POSITIVE_TEXT]-20%[ENDCOLOR]'),
-- 므네모시네 학습
...
-- 스카이넷 링크
('TXT_KEY_PROMOTION_FW_SKYNET_LINK','스카이넷'),
...
-- 공습부대
('TXT_KEY_PROMOTION_FW_AEROPLEX_DROP','공습부대'),
('TXT_KEY_PROMOTION_FW_AEROPLEX_DROP_HELP','[COLOR_POSITIVE_TEXT]42 타일 바깥[ENDCOLOR]까지 공중 강하 가능'),
-- 유전자개조
('TXT_KEY_PROMOTION_FW_GENGINEERED','유전자개조'),
('TXT_KEY_PROMOTION_FW_GENGINEERED_HELP','유전자개조 승급 선택권 가능'),
-- 유전자개조: 아드레날린
...
-- 유전자개조: 사냥본능 강화
('TXT_KEY_PROMOTION_FW_PREDATOR_INSTINCT','유전자개조: 사냥본능 강화'),
...
('TXT_KEY_PROMOTION_FW_CHAMELEON_HELP','보이지 않음(은신)'),
-- 바이오모드
('TXT_KEY_PROMOTION_FW_BIOMODS','바이오모드'),
('TXT_KEY_PROMOTION_FW_BIOMODS_HELP','바이오모드 승급 선택 가능'),
-- 바이오모드: 충격파 모드
...
-- 바이오모드: 인공폐 모드
('TXT_KEY_PROMOTION_FW_SYNTHETIC_LUNGS_MOD','바이오모드: 인공 폐 모드'),
('TXT_KEY_PROMOTION_FW_SYNTHETIC_LUNGS_MOD_HELP','산을 건널 수 있고, 언덕 위에서 이동력 2배'),
-- 바이오모드: 반사신경 강화 모드
('TXT_KEY_PROMOTION_FW_REFLEX_MOD','바이오모드: 반사신경 강화 모드'),
('TXT_KEY_PROMOTION_FW_REFLEX_MOD_HELP','근접 전투 시 후퇴 확률 [COLOR_POSITIVE_TEXT]+20%[ENDCOLOR]'),
-- 바이오모드: 약점노출 강화 모드
('TXT_KEY_PROMOTION_FW_VISION_ENHANCEMENT_MOD','바이오모드: 약점노출 강화 모드'),
('TXT_KEY_PROMOTION_FW_VISION_ENHANCEMENT_MOD_HELP','부상 유닛 공격 시 [ICON_STRENGTH]전투력 보너스 [COLOR_POSITIVE_TEXT]+15%[ENDCOLOR]'),
-- 바이오모드: 독성 모드
...
('TXT_KEY_PROMOTION_SUBORBITAL_EVASION_HELP','요격을 회피할 확률 [COLOR_POSITIVE_TEXT]25%[ENDCOLOR]'),
-- 플라즈막 폭격
('TXT_KEY_PROMOTION_PLASMA_EVASION','플라즈마 폭격'),
('TXT_KEY_PROMOTION_PLASMA_EVASION_HELP','플라즈마 엔진 출력으로 요격을 회피할 확률 [COLOR_POSITIVE_TEXT]35%[ENDCOLOR]'),
-- 우주궤도 폭격
('TXT_KEY_PROMOTION_SPACE_EVASION','우주궤도 폭격'),
('TXT_KEY_PROMOTION_SPACE_EVASION_HELP','지구탈출속도의 요격을 회피할 확률 [COLOR_POSITIVE_TEXT]45%[ENDCOLOR]'),
-- 우월종
...
('TXT_KEY_PROMOTION_FW_SPACESHIP_HELP', '전투기, 폭격기 유닛 [ICON_STRENGTH]전투력 +15%'),
-- 임플란트
('TXT_KEY_PROMOTION_FW_IMPLANTS', '임플란트'),
('TXT_KEY_PROMOTION_FW_IMPLANTS_HELP', '[ICON_STRENGTH]전투력 +10%'),
-- 궤도정찰
('TXT_KEY_PROMOTION_FW_GPSASSIST', '궤도강하'),
('TXT_KEY_PROMOTION_FW_GPSASSIST_HELP', '[ICON_STRENGTH]전투력 +10%'),
-- 향상된 전략
...
-- 지원중계기 수호
('TXT_KEY_PROMOTION_FW_HEALING_CORE','지원중계기 수호'),
