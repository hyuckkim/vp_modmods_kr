...
('TXT_KEY_TECH_FW_METAVERSE_HELP','가상훈련장을 건설하여 군사 유닛의 경험치를 빠르게 향상시킬 수 있습니다. 메타버스 박물관을 건설하여 문화와 관광의 산출을 올릴 수 있습니다. 가상 아이돌을 건설할 수 있습니다.'),
...
-- Spaceship factory
UPDATE Language_ko_KR
SET Text = '우주선 부품을 생산할 때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]35%[ENDCOLOR] 제공합니다.  [NEWLINE][NEWLINE][ICON_RES_ALUMINUM]알루미늄 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]가 필요합니다.'
WHERE Tag = 'TXT_KEY_BUILDING_SPACESHIP_FACTORY_HELP' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='MUCfVP-CAYM' AND Value= 2);

UPDATE Language_ko_KR
SET Text = '우주선 부품을 생산할 때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]35%[ENDCOLOR] 제공합니다.  도시에서 공중유닛을 생산할 때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR]제공하고, [COLOR_PLAYER_PURPLE]우주선[ENDCOLOR]승급을 부여합니다. [NEWLINE][NEWLINE][ICON_RES_ALUMINUM]알루미늄 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]가 필요합니다.'
...
('TXT_KEY_BUILDING_FW_FUNGAL_AGRIGENOMICS_HELP', '도시 근처에 [ICON_RES_XENO_FUNGUS]제노포자 [COLOR_POSITIVE_TEXT]5개[ENDCOLOR]가 있는 타일이 출현합니다. 배양지를 건설하면 자원을 얻을 수 있습니다. [NEWLINE][NEWLINE][COLOR_PLAYER_NETHERLANDS_BACKGROUND]연구소[ENDCOLOR]가 있어야 건설할 수 있습니다.'),  
...
('TXT_KEY_BUILDING_FW_CRYPTOBANK_HELP', '도시의 [ICON_CITIZEN]시민 5명마다 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]암호화폐 거래소[ENDCOLOR]의 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 도시에서 작업하는 마을의 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. [NEWLINE][NEWLINE][ICON_GOLD]골드로 유닛을 구매하거나 건물 건설에 투자하는 비용이 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 감소합니다. [NEWLINE][NEWLINE][ICON_GOLD]빈곤에서 오는 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 감소합니다. [NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]서버 허브[ENDCOLOR]와 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]증권 거래소[ENDCOLOR]가 있어야 건설할 수 있습니다.[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]시드 무역 주식회사를 설립하면[ENDCOLOR] [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]3[ENDCOLOR] 증가합니다.'),
...
('TXT_KEY_BUILDING_FW_NANOFORGE_HELP', '도시에서 작업하는 산업단지의 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. 모든 군사 유닛을 생산할 때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR]제공합니다. [ICON_SILVER_FIST]군사 유닛 보급한도가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]나노물질제조소[ENDCOLOR]가 있어야 합니다. [NEWLINE][NEWLINE][ICON_RES_NANOMAT]나노물질 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]가 필요합니다.'),
...
('TXT_KEY_BUILDING_FW_BIOFACTORY_HELP', '초원과 평원 타일의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]바이오 공장[ENDCOLOR]의 [ICON_FOOD]식량[ENDCOLOR]이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR], [COLOR_PLAYER_NETHERLANDS_BACKGROUND]해양 바이오 산업단지[ENDCOLOR]의 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 매턴 도시의 [ICON_PRODUCTION]생산의 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR]를 [ICON_FOOD]식량으로 전환합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]공장[ENDCOLOR]이 있어야 하고 [COLOR_NEGATIVE_TEXT]심층시추공, 지열발전소, 해양바이오산업단지[ENDCOLOR]가 없어야 건설할 수 있습니다. [COLOR_NEGATIVE_TEXT]설원[ENDCOLOR]에는 건설할 수 없습니다.'),
...
('TXT_KEY_BUILDING_FW_OCEAN_BIOHUB_HELP', '연안 및 대양 타일의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다.모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]바이오 공장[ENDCOLOR]의 [ICON_FOOD]식량[ENDCOLOR]이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]증가하고, 해양 바이오 산업단지[ENDCOLOR]의 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 매턴 도시의 [ICON_PRODUCTION]생산의 [COLOR_POSITIVE_TEXT]5%[ENDCOLOR]는 [ICON_FOOD]식량과 [ICON_RESEARCH]과학으로 각각 전환됩니다.[NEWLINE][NEWLINE][COLOR_YELLOW]해안도시[ENDCOLOR]에만 건설할 수 있습니다. [COLOR_PLAYER_NETHERLANDS_BACKGROUND]항만[ENDCOLOR]이 있어야 하고 [COLOR_NEGATIVE_TEXT]심층시추공, 지열발전소, 바이오공장[ENDCOLOR]이 없어야 건설할 수 있습니다.'),
...
('TXT_KEY_BUILDING_FW_BIOTECH_CENTER_HELP', '도시 근처에 [ICON_RES_XENO_FUNGUS]제노포자 [COLOR_POSITIVE_TEXT]2개[ENDCOLOR]가 있는 타일이 출현합니다.[NEWLINE][NEWLINE]평원 타일의 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR], 초원 타일의 [ICON_FOOD]식량 [COLOR_POSITIVE_TEXT]1[ENDCOLOR], 사막, 설원, 툰드라 타일의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]제노포자배양연구소[ENDCOLOR]와 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]유전자공학 연구소[ENDCOLOR]가 있어야 하고 [COLOR_NEGATIVE_TEXT]지구심층 물리연구소[ENDCOLOR]가 없어야 합니다.'),
...
('TXT_KEY_BUILDING_FW_BIO_AUG_CLINIC_HELP', '도시의 [ICON_CITIZEN]시민 10명마다 [ICON_FOOD]식량과 [ICON_PEACE]신앙이 각각 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]VR 훈련장[ENDCOLOR]의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. [NEWLINE]정찰유닛과 화약유닛을 생산할 때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 제공하고, 화약유닛에게 [COLOR_PLAYER_PURPLE]임플란트[ENDCOLOR]승급을 부여합니다. . [ICON_SILVER_FIST]군사 유닛 보급한도가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. [NEWLINE][NEWLINE][ICON_FOOD]/[ICON_PRODUCTION]낙후에서 오는 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 감소합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]병원[ENDCOLOR]이 있어야 하고 [COLOR_NEGATIVE_TEXT]우주선 발사센터[ENDCOLOR]가 없어야 건설할 수 있습니다.'),
...
('TXT_KEY_BUILDING_FW_LAUNCH_FACILITY_HELP', '도시의 [ICON_CITIZEN]시민 10명마다 [ICON_GOLD]골드와 [ICON_RESEARCH]과학이 각각 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]우주선 공장[ENDCOLOR]의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. [NEWLINE]정찰유닛과 화약유닛을 생산할 때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 제공하고, 정찰유닛에게 [COLOR_PLAYER_PURPLE]궤도정찰[ENDCOLOR]승급을 부여합니다. 도시의 공중 유닛 정원이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다.[NEWLINE][NEWLINE][ICON_FOOD]/[ICON_PRODUCTION]낙후, [ICON_URBANIZATION]도시화에서 오는 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]감소합니다. [NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]공장[ENDCOLOR]이 있어야 하고, [COLOR_NEGATIVE_TEXT]생체강화센터[ENDCOLOR]가 없어야 건설할 수 있습니다.'),
...
('TXT_KEY_BUILDING_FW_GEOTHERMAL_FACTORY_HELP', '이 건물이 지어진 도시 3타일 이내의 산 1개마다 [ICON_PRODUCTION]생산과 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]증가합니다. 언덕 타일의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]이 증가합니다. 모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]심층시추공[ENDCOLOR]의 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR], 모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]지열발전소[ENDCOLOR]의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]증가합니다. 매턴 [ICON_PRODUCTION]생산의 [COLOR_POSITIVE_TEXT]5%[ENDCOLOR]는 [ICON_GOLD]골드와 [ICON_PRODUCTION]생산으로 전환합니다.[NEWLINE][NEWLINE]도시 주변 [COLOR_YELLOW]2 타일 이내에 산[ENDCOLOR]이 있어야 건설할 수 있습니다. 도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]공장[ENDCOLOR]이 있어야 하고 [COLOR_NEGATIVE_TEXT]심층 시추공[ENDCOLOR]이나 [COLOR_NEGATIVE_TEXT]바이오공장[ENDCOLOR]이 없어야 건설할 수 있습니다.'),
...
('TXT_KEY_BUILDING_FW_BOREHOLE_HELP', '광산, 유정과 채석장의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]심층 시추공[ENDCOLOR]의 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR], 모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]지열발전소[ENDCOLOR]의 [ICON_PRODUCTION]생산[ENDCOLOR]이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 매턴 [ICON_PRODUCTION]생산의 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR]가 [ICON_GOLD]골드로 전환합니다. [NEWLINE][NEWLINE]도시에 [COLOR_NEGATIVE_TEXT]산이 없어야[ENDCOLOR] 하고, [COLOR_NEGATIVE_TEXT]바이오공장[ENDCOLOR]이나 [COLOR_NEGATIVE_TEXT]지열발전소[ENDCOLOR]이 없어야 건설할 수 있습니다.'),
...
('TXT_KEY_BUILDING_FW_CLONE_LAB_HELP', '[ICON_RES_XENO_FUNGUS]제노포자 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]개를 제공합니다. 무료 [COLOR_YELLOW]클론 트루퍼[ENDCOLOR] 1명 출현합니다. 건설 완료시 도시의 [ICON_CITIZEN]시민이 [COLOR_POSITIVE_TEXT]2명[ENDCOLOR] 즉시 늘어납니다. [NEWLINE][ICON_SILVER_FIST]군사 유닛 보급 한도가 [ICON_CITIZEN]시민의 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR]만큼 증가합니다. [NEWLINE][NEWLINE]도시의 [ICON_GREAT_PEOPLE]위인 출현율이 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR] 증가합니다. [NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]유전자공학 연구소[ENDCOLOR]가 있어야 합니다.'),
...
('TXT_KEY_BUILDING_FW_HUMONOID_FORGE_HELP','도시의 [ICON_CITIZEN]시민 10명마다 [ICON_PRODUCTION]생산과 [ICON_CULTURE]문화가 각각 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]나노물질 군수공장[ENDCOLOR]의 [ICON_PRODUCTION]생산이 추가로 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]증가합니다.[NEWLINE]기갑유닛과 공성유닛을 생산할 때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 제공합니다. [NEWLINE][NEWLINE]전문가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR]명이 더이상 [ICON_URBANIZATION]도시화에서 오는 [ICON_HAPPINESS_3]불행을 증가시키지 않습니다. [NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]나노물질 군수공장[ENDCOLOR]이 있어야 건설할 수 있습니다.'),
...
('TXT_KEY_BUILDING_FW_TIDAL_PORT_HELP', '해양 타일의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 및 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. [NEWLINE][NEWLINE] 해상 [ICON_INTERNATIONAL_TRADE]교역로의 길이가 [COLOR_POSITIVE_TEXT]50%[ENDCOLOR] 증가하고 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. 군사 유닛 보급한도가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가하고, 항공모함을 제외한 해상유닛울 생산할 때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 제공합니다.[NEWLINE][NEWLINE]이 도시에서 다른 문명으로 출발하는 [ICON_INTERNATIONAL_TRADE]해상 교역로가 완료되면 현재 [ICON_CULTURE]문화 및 [ICON_TOURISM]관광 산출량에 기반한 [ICON_TOURISM] 관광을 제공합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]항구[ENDCOLOR]가 있어야 건설할 수 있습니다.[NEWLINE][NEWLINE][ICON_RES_NANOMAT]나노물질 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]가 필요합니다. [NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]센타우리 개발 주식회사를 설립하면[ENDCOLOR] [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다.'),
...
('TXT_KEY_BUILDING_FW_DRONE_HIVE_HELP', '도시에서 작업하는 발전기마다 [ICON_PRODUCTION]생산과 [ICON_CULTURE]문화가 각각 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 건물을 건설할 때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 제공합니다. [NEWLINE]궁수유닛, 헬리콥터유닛을 생산할 때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 제공합니다.[NEWLINE][NEWLINE]도시에서 생산하는 [COLOR_POSITIVE_TEXT]로봇 계열 유닛[ENDCOLOR][COLOR:105:105:105:255](궁수, 헬리콥터, 기갑, 공성유닛)[ENDCOLOR]에 [COLOR_PLAYER_PURPLE]자동 수리[ENDCOLOR] 승급을 부여합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]자동생산시설[ENDCOLOR]이 있어야하고, 도시에 [COLOR_NEGATIVE_TEXT]유전자개조 연구소, 항공우주 복합시설[ENDCOLOR]이 없어야 건설할 수 있습니다.'),
...
('TXT_KEY_BUILDING_FW_SKYRAIL_HUB_HELP', ' [NEWLINE]도시의 마을과 소도시의 [ICON_CULTURE]문화와 [ICON_TOURISM]관광이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 이 도시에서 출발하는 국내 [ICON_INTERNATIONAL_TRADE]교역로의 [ICON_FOOD]식량이 [COLOR_POSITIVE_TEXT]8[ENDCOLOR], [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. 육상 교역로의 길이가 [COLOR_POSITIVE_TEXT]25%[ENDCOLOR] 증가합니다. 전투기 유닛과 폭격기 유닛을 생산할 때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 제공합니다.[NEWLINE][NEWLINE]이 도시에서 다른 문명으로 출발하는 [ICON_INTERNATIONAL_TRADE]육상 교역로가 완료되면 현재 [ICON_CULTURE]문화 및 [ICON_TOURISM]관광 산출량에 기반한 [ICON_TOURISM]관광을 제공합니다.[NEWLINE][NEWLINE][ICON_CAPITAL][ICON_INDUSTRIAL_CONNECTED]수도와 산업 도시 연결이 있어야하고, [COLOR_PLAYER_NETHERLANDS_BACKGROUND]석탄 저장소[ENDCOLOR]와 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]공항[ENDCOLOR]이 있어야 건설할 수 있습니다. [NEWLINE][NEWLINE][ICON_RES_NANOMAT]나노물질 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]가 필요합니다.[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]시빌 보석 주식회사를 설립하면[ENDCOLOR] [ICON_GOLDEN_AGE]황금기 점수가 [COLOR_POSITIVE_TEXT]4[ENDCOLOR] 증가합니다.'),
...
('TXT_KEY_BUILDING_FW_AEROSPACE_COMPLEX_HELP', '도시에서 작업하는 수경재배지구마다 [ICON_RESEARCH]과학과 [ICON_GOLD]골드가 각각 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 궤도미사일, 항공모함, 우주선 부품을 생산할 때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR]제공합니다. [NEWLINE][NEWLINE]도시에서 생산하는 지상유닛에게 [COLOR_PLAYER_PURPLE]공습부대[ENDCOLOR] 승급을 부여합니다. [NEWLINE][NEWLINE]도시의 공중 유닛 정원이 [COLOR_POSITIVE_TEXT]4기[ENDCOLOR] 증가합니다. 도시를 공습하는 공중 유닛에게 주는 [ICON_STRENGTH]피해가 [COLOR_POSITIVE_TEXT]10[ENDCOLOR] 증가합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]공항[ENDCOLOR]과 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]우주선 발사센터[ENDCOLOR]가 있어야하고, 도시에 [COLOR_NEGATIVE_TEXT]무인관리기지, 유전자개조 연구소[ENDCOLOR]가 없어야 건설할 수 있습니다.'),
...
('TXT_KEY_BUILDING_FW_ECTOGENESIS_POD_HELP', '문명의 총 군사 유닛 10개마다 도시의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]증가합니다.[COLOR:105:105:105:255](상한 200 유닛)[ENDCOLOR][NEWLINE]도시에서 근접, 기마 및 공중정찰 유닛을 생산할 때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR]제공하고, [COLOR_PLAYER_PURPLE]유전자개조 승급[ENDCOLOR]을 부여합니다.[NEWLINE][NEWLINE][ICON_FOOD]/[ICON_PRODUCTION]낙후에서 오는 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR]감소합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]유전자개조 연구소[ENDCOLOR]가 있어야 건설할 수 있습니다.[NEWLINE][NEWLINE][ICON_RES_XENO_FUNGUS]제노포자 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]가 필요합니다. '),
...
('TXT_KEY_BUILDING_FW_BIOMOD_TANK_HELP', '문명의 총 군사 유닛 10개마다 [ICON_GREAT_GENERAL]위대한 장군, [ICON_GREAT_ADMIRAL]위대한제독의 점수가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR], [ICON_GOLDEN_AGE]황금기 점수가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR]씩 증가합니다.[COLOR:105:105:105:255](상한 200 유닛)[ENDCOLOR][NEWLINE]도시에서 정찰, 화약, 근접해상, 원거리해상 유닛을 생산할 때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 제공하고, [COLOR_PLAYER_PURPLE]바이오모드 승급[ENDCOLOR]을 부여합니다.[NEWLINE][NEWLINE][ICON_CULTURE]무료에서 오는 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 감소합니다. [NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]생체강화센터[ENDCOLOR]와 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]제노포자 배양 연구소[ENDCOLOR]가 있어야 건설할 수 있습니다.[NEWLINE][NEWLINE][ICON_RES_XENO_FUNGUS]제노포자 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]가 필요합니다.'),
...
('TXT_KEY_BUILDING_FW_QUANTUM_LINK_HELP', '[ICON_GREAT_SCIENTIST]위대한 과학자의 출현율이 [COLOR_POSITIVE_TEXT]25%[ENDCOLOR] 증가합니다.[NEWLINE]모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]원격현실허브[ENDCOLOR]의 [ICON_PRODUCTION]생산, [ICON_RESEARCH]과학, [ICON_CULTURE]문화가 각각 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]씩 증가하고 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]바이오 컴퓨터[ENDCOLOR]의 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]4[ENDCOLOR] 증가합니다. 전역 [ICON_HAPPINESS_1]행복이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다.[NEWLINE][NEWLINE]잠수함유닛을 생산할 때 [ICON_PRODUCTION]생산 보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 제공합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]원격현실 허브[ENDCOLOR]와 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]바이오 컴퓨터[ENDCOLOR]가 있어야 건설할 수 있습니다.[NEWLINE][NEWLINE][ICON_RES_NANOMAT]나노물질 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]가 필요합니다.'),
...
('TXT_KEY_BUILDING_FW_BIGBROTHER_CONTROL_HELP', '[ICON_SPY] 도시 보안이 +20 증가합니다. [NEWLINE]궁수유닛, 헬리콥터유닛을 생산할 때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 제공합니다.[NEWLINE][NEWLINE][ICON_FOOD]/[ICON_PRODUCTION]낙후, [ICON_GOLD] 빈곤, [ICON_RESEARCH] 문맹, [ICON_CULTURE]무료에서 오는 [ICON_HAPPINESS_3]불행이 각각 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 감소하고, [ICON_URBANIZATION]도시화에서 오는 불행이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR]감소합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]국제치안국[ENDCOLOR]이 있어야 건설할 수 있습니다.'),
...
('TXT_KEY_BUILDING_FW_FUSION_PLANT_HELP', '도시의 모든 전문가들의 [ICON_PRODUCTION]생산, [ICON_GOLD]골드, [ICON_RESEARCH]과학, [ICON_CULTURE]문화 산출량이 각각 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 도시의 [ICON_PRODUCTION]생산을 다른 산출량으로 전환할 때의 효율성이 [COLOR_POSITIVE_TEXT]20%[ENDCOLOR] 증가합니다.도시의 [ICON_GREAT_PEOPLE]위인 출현율이 [COLOR_POSITIVE_TEXT]25%[ENDCOLOR] 증가합니다. 기갑유닛과 공성유닛을 생산할 때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR]제공합니다. [NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]공장[ENDCOLOR]과 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]지구심층 물리연구소[ENDCOLOR]가 있어야 건설할 수 있습니다. [NEWLINE][NEWLINE][ICON_RES_URANIUM]우라늄 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]와 [ICON_RES_NANOMAT]나노물질 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]가 필요합니다.[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]헥손 정유 기업을 설립하면[ENDCOLOR] [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]3[ENDCOLOR] 증가합니다.'),
...
('TXT_KEY_BUILDING_FW_ORBITAL_MINING_HELP', '도시의 [ICON_CITIZEN]시민 10명 마다 [ICON_PRODUCTION]생산, [ICON_GOLD]골드, [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]씩 증가합니다. [NEWLINE]정찰, 화약, 전투기, 폭격기유닛을 생산할 때 [ICONN_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR]제공합니다. [NEWLINE][NEWLINE][ICON_RES_IRON]철과 [ICON_RES_NANOMAT]나노물질 [COLOR_POSITIVE_TEXT]2개[ENDCOLOR]를 제공합니다. [NEWLINE][NEWLINE]도시의 전문가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR]명이 더 이상 [ICON_URBANIZATION]도시화로 인한 불행을 [ICON_HAPPINESS_3] 유발하지 않습니다.[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]핵무기로 파괴되지 않는 건물입니다.[ENDCOLOR] 도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]우주반사판 전력위성[ENDCOLOR]이 있어야 건설할 수 있습니다.'),
...
('TXT_KEY_WONDER_FW_AI_DATANETWORK_HELP','모든 도시의 전자상거래 서버, 엔터테인먼트, 클라우드 서버, 연구 서버의 관련 산출량이 [COLOR_POSITIVE_TEXT]8[ENDCOLOR] 증가합니다. 또한 원하는 [ICON_GREAT_PEOPLE][COLOR_POSITIVE_TEXT]위인[ENDCOLOR] 1명이 즉시 출현합니다.'),
...
('TXT_KEY_WONDER_FW_DEEP_RESOURCE_HELP','[ICON_GREAT_ENGINEER][COLOR_YELLOW]위대한 기술자[ENDCOLOR]가 1명 출현합니다. 모든 나노물질 군수공장의 [ICON_PRODUCTION]생산과 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]4[ENDCOLOR] 증가합니다.'),
...
('TXT_KEY_BUILDING_FW_SKYTREE_HELP', '모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]방송탑[ENDCOLOR]의 [ICON_CULTURE]문화와 [ICON_GOLDEN_AGE]황금기 점수가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR], 문명의 모든 [COLOR_POSITIVE_TEXT]통신기지국[ENDCOLOR]의 [ICON_RESEARCH]과학, [ICON_GOLD]골드, [ICON_GOLDEN_AGE]황금기 점수가 각각 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 전역 [ICON_HAPPINESS_1]행복이 [COLOR_POSITIVE_TEXT]3[ENDCOLOR] 증가합니다.  [NEWLINE][NEWLINE]이 불가사의는 전 세계에서 하나만 건설할 수 있는 [COLOR_POSITIVE_TEXT]세계 불가사의[ENDCOLOR]입니다.'),
...
('TXT_KEY_BUILDING_FW_SKYHOOK_HELP', '[COLOR_PLAYER_NETHERLANDS_BACKGROUND]우주반사판 전력위성[ENDCOLOR]을 무료로 제공합니다. 도시의 [ICON_CITIZEN]시민 10명마다 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]우주선 발사센터[ENDCOLOR]의 [ICON_GOLD]골드와 [ICON_CULTURE]문화가 각각 [COLOR_POSITIVE_TEXT]4[ENDCOLOR]증가합니다.[NEWLINE][NEWLINE][ICON_RES_ALUMINUM]알루미늄 [COLOR_POSITIVE_TEXT]6개[ENDCOLOR]를 제공합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]우주선 발사센터[ENDCOLOR]가 있어야 합니다. 이 불가사의는 전 세계에서 하나만 건설할 수 있는 [COLOR_POSITIVE_TEXT]세계 불가사의[ENDCOLOR]입니다.'),
...
('TXT_KEY_BUILDING_FW_LAPUTA_HELP', '문명의 모든 [COLOR_POSITIVE_TEXT]인공환경도시[ENDCOLOR] 타일의 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR], [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]씩 증가합니다. [NEWLINE]모든 [COLOR_YELLOW] 도시[ENDCOLOR]의 체력이 [COLOR_POSITIVE_TEXT]50[ENDCOLOR], [ICON_STRENGTH]방어력이 [COLOR_POSITIVE_TEXT]10[ENDCOLOR], 군사 유닛 보급한도가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가하고, [COLOR_PLAYER_NETHERLANDS_BACKGROUND]우주반사판 전력위성[ENDCOLOR]당 [ICON_CULTURE]문화, [ICON_GOLD]골드, [ICON_PRODUCTION]생산, [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR]씩 증가합니다.[COLOR:105:105:105:255](상한 15개)[ENDCOLOR][NEWLINE][NEWLINE]이 불가사의는 전 세계에서 하나만 건설할 수 있는 [COLOR_POSITIVE_TEXT]세계 불가사의[ENDCOLOR]입니다. [NEWLINE][NEWLINE][ICON_RES_NANOMAT]나노물질 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]개가 필요합니다.'),
...
('TXT_KEY_BUILDING_FW_SKYNET_HELP', '[COLOR_PLAYER_NETHERLANDS_BACKGROUND]가상현실 허브[ENDCOLOR]를 무료로 제공합니다. 도시의 체력이 [COLOR_POSITIVE_TEXT]150[ENDCOLOR]와 [ICON_STRENGTH]방어력 [COLOR_POSITIVE_TEXT]30[ENDCOLOR]이 증가합니다. [COLOR_PLAYER_NETHERLANDS_BACKGROUND]휴머노이드 로봇 공장[ENDCOLOR]과 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]무인관리기지[ENDCOLOR]의 [ICON_FOOD]식량, [ICON_CULTURE]문화, [ICON_PRODUCTION]생산이 각각 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다.[NEWLINE][NEWLINE]로봇 계열 유닛[COLOR:105:105:105:255](궁수, 헬리콥터, 기갑, 공성, 잠수함유닛)[ENDCOLOR]을 생산할 때 [ICON_PRODUCTION]생산보너스를 제공하고 [COLOR_PLAYER_PURPLE]스카이넷과 연결[ENDCOLOR] 승급을 부여합니다.[NEWLINE][NEWLINE]도시에 [COLOR_NEGATIVE_TEXT]하이브, 우주궤도 정제소[ENDCOLOR]가 없어야 건설할 수 있습니다. 이 불가사의는 전 세계에서 하나만 건설할 수 있는 [COLOR_POSITIVE_TEXT]세계 불가사의[ENDCOLOR]입니다.'),
...
('TXT_KEY_BUILDING_FW_AI_DATANETWORK_HELP', '모든 도시의 [COLOR_POSITIVE_TEXT]전자상거래 서버, 엔터테인먼트, 클라우드 서버, 연구서버[ENDCOLOR]의 관련 산출량이 [COLOR_POSITIVE_TEXT]8[ENDCOLOR] 증가합니다.  [COLOR_YELLOW]원하는 [ICON_GREAT_PEOPLE]위인[ENDCOLOR] 1명이 출현합니다.[NEWLINE][NEWLINE][COLOR_YELLOW]세계 의회 결의안[ENDCOLOR]으로 비준되어야만 건설할 수 있습니다.'),
...
('TXT_KEY_BUILDING_FW_DEEP_RESOURCE_HELP','모든 [COLOR_POSITIVE_TEXT]나노물질 공장[ENDCOLOR]의 [ICON_PRODUCTION]생산과 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]4[ENDCOLOR] 증가합니다.[NEWLINE][NEWLINE][COLOR_YELLOW]세계 의회 결의안[ENDCOLOR]으로 비준되어야만 건설할 수 있습니다.'),
...
('TXT_KEY_UNIT_FW_CLUSTER_MISSILE_HELP','포탄을 발산하는 유닛 기준으로 3칸까지 모두에게 손상시키는 데 한번 사용될 수 있는 유닛입니다. 범위가 멀어질수록 효과가 감소합니다. [COLOR_POSITIVE_TEXT]군사 유닛 보급한도를 차지하지 않습니다.[ENDCOLOR][NEWLINE][NEWLINE][ICON_RES_IRON]철 [COLOR_POSTITIVE_TEXT]1개[ENDCOLOR]가 필요합니다.'),
-- 플라즈마탄
...
('TXT_KEY_UNIT_FW_HYPERMISSILE_HELP','포탄을 발산하는 유닛 기준으로 3칸까지 모두에게 손상시키는 데 한번 사용될 수 있는 유닛입니다. 범위가 멀어질수록 효과가 감소합니다. [COLOR_POSITIVE_TEXT]군사 유닛 보급한도를 차지하지 않습니다.[ENDCOLOR][NEWLINE][NEWLINE][ICON_RES_IRON]철 [COLOR_POSTITIVE_TEXT]1개[ENDCOLOR]가 필요합니다.'),
-- 고열압탄 (플라즈마탄 상위 업그레이드)
...
('TXT_KEY_UNIT_FW_THERMOMISSILE_HELP','포탄을 발산하는 유닛 기준으로 3칸까지 모두에게 손상시키는 데 한번 사용될 수 있는 유닛입니다. 범위가 멀어질수록 효과가 감소합니다. [COLOR_POSITIVE_TEXT]군사 유닛 보급한도를 차지하지 않습니다.[ENDCOLOR][NEWLINE][NEWLINE][ICON_RES_IRON]철 [COLOR_POSTITIVE_TEXT]1개[ENDCOLOR]가 필요합니다.'),
--탄도미사일
...
('TXT_KEY_UNIT_FW_ADVANCED_MISSILE_GUIDED_HELP','적 유닛 또는 도시에 주둔한 유닛을 손상시키는 데 한번 사용될 수 있는 유닛입니다. [COLOR_POSITIVE_TEXT]군사 유닛 보급한도를 차지하지 않습니다.[ENDCOLOR][NEWLINE][NEWLINE][ICON_RES_OIL]석유 [COLOR_POSTITIVE_TEXT]1개[ENDCOLOR]가 필요합니다.'),
-- 극초음속 미사일
...
('TXT_KEY_UNIT_FW_GOD_ROD_HELP','적 유닛을 장거리에서 한 번 사용해 타격합니다. 주변의 1타일의 적은 [COLOR_NEGATIVE_TEXT]40[ENDCOLOR]의 피해를 받습니다. [COLOR_POSITIVE_TEXT]군사 유닛 보급한도를 차지하지 않습니다.[ENDCOLOR][NEWLINE][NEWLINE][ICON_RES_IRON]철 [COLOR_POSITIVE_TEXT]1개[ENDCOLOR]와 [ICON_RES_NANOMAT]나노물질 [COLOR_POSTITIVE_TEXT]1개[ENDCOLOR]가 필요합니다.'),
-- 신의 지팡이 (업그레이드)
...
('TXT_KEY_UNIT_FW_GOD_ROD2_HELP','적 유닛을 장거리에서 한 번 사용해 타격합니다. 주변 1타일의 적 유닛은 [COLOR_NEGATIVE_TEXT]50[ENDCOLOR]의 추가 피해를 받습니다. [COLOR_POSITIVE_TEXT]군사 유닛 보급한도를 차지하지 않습니다.[ENDCOLOR][NEWLINE][NEWLINE][ICON_RES_IRON]철 [COLOR_POSITIVE_TEXT]1개[ENDCOLOR]와 [ICON_RES_NANOMAT]나노물질 [COLOR_POSTITIVE_TEXT]1개[ENDCOLOR]가 필요합니다.'),
-- HYDROGEN BOMB
...
('TXT_KEY_UNIT_FW_HYDROGEN_BOMB_DESC', '적에게 지옥의 맛을 보여주십시오. 도시와 유닛에 막심한 피해를 줍니다. [NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]맨해튼 프로젝트[ENDCOLOR]와 1개의 [ICON_RES_URANIUM]우라늄이 필요합니다.수소 핵융합 폭탄, 또는 열핵 폭탄은 원자핵이 합쳐져서 더 무거운 원자핵을 형성하며 방출되는 에너지를 이용한 폭탄이다. 일반적인 원자 폭탄에 비해 훨씬 더 많은 파괴력을 가지며, 이는 데우터륨과 트리튬 같은 무거운 수소 동위 원소들의 핵융합 반응에서 나오는 에너지 때문이다. 이러한 폭탄은 대량 살상 무기에 속하며, 그 사용은 국제법에 의해 엄격히 규제되어 있다.'),
