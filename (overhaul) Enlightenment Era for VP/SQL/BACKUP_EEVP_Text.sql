...
WHERE Tag = 'TXT_KEY_UNIT_BANDEIRANTE_HELP';
...
('TXT_KEY_UNIT_EE_2HANDER_HELP', 'Early Renaissance Era Melee Unit. Additional +33% [ICON_WAR] Attack against Spearmen, {TXT_KEY_UNIT_PIKEMAN}, {TXT_KEY_UNIT_SPANISH_TERCIO} and {TXT_KEY_UNIT_FREE_COMPANY}. Starts with the [COLOR_POSITIVE_TEXT]Cover I[ENDCOLOR] Promotion.');
...
('TXT_KEY_WONDER_EE_TOPKAPI_HELP', '+1 [ICON_PEACE] Faith from Defensive Buildings in the Empire. Contains 2 slots of [ICON_GREAT_WORK] Great Works of Art and Artifacts, and comes with a [COLOR_POSITIVE_TEXT]Free[ENDCOLOR] [ICON_ARTIFACT] Artifact. +3 [ICON_PRODUCTION] Production and [ICON_RESEARCH] Science if [COLOR_POSITIVE_TEXT]Themed[ENDCOLOR].'),
...
('TXT_KEY_WONDER_EE_BELEM_TOWER_HELP', 'Receive a [COLOR_POSITIVE_TEXT]Free[ENDCOLOR] Tavern in the City, and two [COLOR_POSITIVE_TEXT]Free[ENDCOLOR] Adventurers appear near the City. Land Units created by this City (past or future) have +1 [ICON_MOVES] Movement and +2 [ICON_VISION] Sight while Embarked.[NEWLINE][NEWLINE]City must be built on Coast.'),
