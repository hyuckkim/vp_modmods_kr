...
VALUES
	...
	240, 'TECH_EE_SOVEREIGNTY', 1, -20, -1, 'BUILDING_ATLAS_VP_2', 35, 'ART_DEF_BUILDING_HERMITAGE', 1, 10, 1,
	30, 10);
...
INSERT INTO Language_en_US
	(Tag, Text)
VALUES
	('TXT_KEY_THEMING_BONUS_EE_TOPKAPI', 'Imperial Treasury'),
	('TXT_KEY_THEMING_BONUS_EE_TOPKAPI_HELP', 'To maximize your bonus, make sure the Great Work Slots are filled with a work of Art and an Artifact from consecutive Eras and from different Civilizations.');
...
('BUILDING_EE_DERWENT_MILLS', 'BUILDINGCLASS_REFINERY',      'YIELD_GOLD', 2),
('BUILDING_EE_DERWENT_MILLS', 'BUILDINGCLASS_EE_CLOTH_MILL',   'YIELD_GOLDEN_AGE_POINTS', 2),
('BUILDING_EE_DERWENT_MILLS', 'BUILDINGCLASS_SEAPORT',         'YIELD_GOLDEN_AGE_POINTS', 2),
('BUILDING_EE_DERWENT_MILLS', 'BUILDINGCLASS_REFINERY',      'YIELD_GOLDEN_AGE_POINTS', 2);
...
-- Move Neuschwanstein
-----------------------------------
UPDATE Buildings SET PrereqTech = 'TECH_EE_ROMANTICISM' WHERE Type = 'BUILDING_NEUSCHWANSTEIN';
...
Text = '[COLOR_POSITIVE_TEXT]Free[ENDCOLOR] {TXT_KEY_BUILDING_HARBOR} in all of your coastal Cities. Incoming [ICON_ARROW_LEFT] Trade Routes generate +2 [ICON_GOLD] Gold for the City, and +1 [ICON_GOLD] Gold for the [ICON_ARROW_RIGHT] Trade Route owner. Gain 2 [COLOR_POSITIVE_TEXT]Additional[ENDCOLOR] [ICON_INTERNATIONAL_TRADE] Trade Routes. All Harbors gain +3 [ICON_PRODUCTION] Production, and all Lighthouses gain +2 [ICON_CULTURE] Culture.[NEWLINE][NEWLINE]Provides 2 [ICON_RES_IRON] Iron. +25 [ICON_RESEARCH] Science when you construct a Building in this City, scaling with Era.[NEWLINE][NEWLINE]-1 [ICON_HAPPINESS_3] Unhappiness from [ICON_GOLD] Poverty in this City.[NEWLINE][NEWLINE]The [ICON_PRODUCTION] Production Cost increases based on the number of Cities you own.'
