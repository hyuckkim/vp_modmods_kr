...
('TXT_KEY_WONDER_EE_TOPKAPI_HELP', 'Possible Theming Bonuses:[NEWLINE][ICON_BULLET] +8 [ICON_CULTURE] and [ICON_TOURISM] for a [ICON_GW_ART] and [ICON_ARTIFACT] from the [COLOR_POSITIVE_TEXT]different Civilizations[ENDCOLOR] and [COLOR_CYAN]consecutive Eras[ENDCOLOR].'),
