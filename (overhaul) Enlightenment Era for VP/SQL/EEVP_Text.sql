...
('TXT_KEY_PROMOTION_EE_ADVENTURER_HELP', '+2 [ICON_MOVES] Movement and +2 [ICON_VP_VISION] Sight while Embarked.'),
-- Drydock
...
('TXT_KEY_UNIT_EE_GALLEON_STRATEGY', 'The Galleon is a Renaissance Era Naval Ranged Unit. Upgrading from the Galleass, the Galleon is the first ranged ship to be able to enter Oceans. Use a fleet of Galleons, supported by larger ships, to conquer overseas Cities and protect your overseas holdings.'),
-- Marksman
...
('TXT_KEY_UNIT_EE_CUIRASSIER_HELP', 'Final melee Mounted Unit before Armor.'),
...
-- Frigate
UPDATE Language_en_US
SET Text = 'Powerful late-Enlightenment Naval Ranged Unit. The first Sea Unit with 2 Range and an [ICON_RES_IRON] Iron requirement.'
...
UPDATE Language_en_US
SET Text = 'Unique Austrian Dragoon that excels at scouting and flanking. Can move faster and ignore Zone of Control.'
...
/*
UPDATE Language_en_US
SET Text = 'Only the Russians may build it. This Unit has a combat bonus when fighting enemies that have already taken damage, and is stronger than the Dragoon, which it replaces.'
WHERE Tag = 'TXT_KEY_UNIT_HELP_COSSACK';
UPDATE Language_en_US
SET Text = 'The Cossack is the Russian unique unit, replacing the Dragoon. They get a combat bonus when battling damaged units. This makes Cossacks exceptionally strong at counter attacking, let the enemy chew up the front line peasants, then tear the weakened foe apart with a Cossack charge!'
...
('TXT_KEY_UNIT_EE_2HANDER_STRATEGY', 'Greatswordsmen are much stronger than Longswordsmen, and gains a devastating combat bonus when attacking Spearmen, {TXT_KEY_UNIT_PIKEMAN}, {TXT_KEY_UNIT_SPANISH_TERCIO} and {TXT_KEY_UNIT_FCOMPANY}.'),
...
UPDATE Language_en_US
SET Text = 'Unique Dutch Carrack that specializes in attacking both Cities and Ships. Starts with [COLOR_POSITIVE_TEXT]Vanguard[ENDCOLOR] and [COLOR_POSITIVE_TEXT]Supply[ENDCOLOR] Promotions.'
...
('TXT_KEY_UNIT_EE_GRENADIER_STRATEGY', 'Grenadiers replace the anti-Melee Greatsword in the era of Gunpowder, and are more generally powerful as an offensive force.'),
('TXT_KEY_UNIT_EE_GRENADIER_HELP', 'Late Enlightenment Era Gunpowder Unit. Performs a [COLOR_POSITIVE_TEXT]Ranged Attack[ENDCOLOR] before [COLOR_POSITIVE_TEXT]attacking Units[ENDCOLOR], and deals 15 AoE Damage to all newly-adjacent enemy Units on kill. Starts with the [COLOR_POSITIVE_TEXT]Cover I[ENDCOLOR] Promotion.');
...
('TXT_KEY_WONDER_EE_TOPKAPI_HELP', '+1 [ICON_PEACE] Faith from Defensive Buildings in the Empire. Contains 2 slots of [ICON_GREAT_WORK] Great Works of Art and Artifacts, and comes with a [COLOR_POSITIVE_TEXT]Free[ENDCOLOR] [ICON_VP_ARTIFACT] Artifact. +3 [ICON_PRODUCTION] Production and [ICON_RESEARCH] Science if [COLOR_POSITIVE_TEXT]Themed[ENDCOLOR].'),
...
('TXT_KEY_WONDER_EE_VERSAILLES_HELP', 'Receive a [COLOR_POSITIVE_TEXT]Free[ENDCOLOR] Gallery in the City in which it is built. +2 [ICON_GOLD] Gold from all Galleries, Menageries, and Opera Houses. 15% of [ICON_GOLD] Gold created by this City counts as [ICON_CULTURE] Culture each turn. '),
...
VALUES
	...
	('TXT_KEY_BUILDING_SUMMER_PALACE_HELP', '+1 [ICON_RES_PAPER] Paper. +20% [ICON_PRODUCTION] Production of Diplomatic Units in all Cities. All Diplomatic Units receive the [COLOR_POSITIVE_TEXT]{TXT_KEY_PROMOTION_NOBILITY}[ENDCOLOR] Promotion. All Chanceries gain +3 [ICON_GOLD] Gold and +1 [ICON_CULTURE] Culture.[NEWLINE][NEWLINE]Requires the [COLOR_POSITIVE_TEXT]Summer Palace[ENDCOLOR] to have been built in your Empire.'),
...
('TXT_KEY_WONDER_EE_DERWENT_MILLS_HELP', 'Provides a [COLOR_POSITIVE_TEXT]Free[ENDCOLOR] Cloth Mill in the City. +2 [ICON_GOLD] Gold and [ICON_GOLDEN_AGE] Golden Age Points from Cloth Mills, Seaports, and Coaling Stations in the Empire. +2 [ICON_PRODUCTION] Production and [ICON_GOLDEN_AGE] Golden Age Points from Towns in the Empire.'),
...
('TXT_KEY_WONDER_EE_BELEM_TOWER_HELP', 'Receive a [COLOR_POSITIVE_TEXT]Free[ENDCOLOR] Tavern in the City, and two [COLOR_POSITIVE_TEXT]Free[ENDCOLOR] Adventurers appear near the City. Land Units created by this City (past or future) have +1 [ICON_MOVES] Movement and +2 [ICON_VP_VISION] Sight while Embarked.[NEWLINE][NEWLINE]City must be built on Coast.'),
...
('TXT_KEY_BUILDING_EE_ACADEMY_HELP', '+1 [ICON_RESEARCH] Science for every 6 [ICON_CITIZEN] Citizens in the City. Cost of [ICON_GOLD] Gold purchasing in this City reduced by 10%. Receive 15 [ICON_RESEARCH] Science, scaling with Era, and 10 [ICON_GREAT_GENERAL] Great General Points when a [ICON_CITIZEN] Citizen is born in this City.[NEWLINE][NEWLINE]+20% [ICON_GREAT_SCIENTIST] Great Scientist and [ICON_GREAT_ENGINEER] Great Engineer rate in the City.[NEWLINE][NEWLINE]City must not contain a [COLOR_NEGATIVE_TEXT]Seminary[ENDCOLOR].'),
...
('TXT_KEY_BUILDING_EE_SEMINARY_HELP', '+1 [ICON_PEACE] Faith for every 6 [ICON_CITIZEN] Citizens in the City. Refund 10% of all [ICON_PEACE] Faith spent on purchases in this City. Receive 10 [ICON_PEACE] Faith, scaling with Era, and 20 [ICON_GOLDEN_AGE] Golden Age Points when a [ICON_CITIZEN] Citizen is born in this City.[NEWLINE][NEWLINE]Boosts starting Religious Strength of all [ICON_MISSIONARY] Missionaries by 5%.[NEWLINE][NEWLINE]City must not contain a [COLOR_NEGATIVE_TEXT]Polytechnic[ENDCOLOR].'),
...
('TXT_KEY_BUILDING_EE_DRYDOCK_HELP', '+15% [ICON_PRODUCTION] Production toward Sea Units, and Naval Combat Units created by this City have +15% [ICON_STRENGTH] Combat Strength. +5% [ICON_SILVER_FIST] Military Supply from Population.[NEWLINE][NEWLINE]+1 [ICON_PRODUCTION] Production and [ICON_GOLD] Gold to Taverns, Weigh Houses, and Seaports in the City.[NEWLINE][NEWLINE]City must have a [COLOR_CYAN]Harbor[ENDCOLOR].'),
...
('TXT_KEY_BUILDING_EE_MANOR_HELP', '+20% [ICON_GREAT_MERCHANT] Great Merchant and [ICON_DIPLOMAT] Great Diplomat rate in the City. +10 [ICON_FOOD] Food when your Borders expand, scaling with Era. +2 [ICON_GOLD] Gold and +1 [ICON_TOURISM] Tourism from Lake tiles.[NEWLINE][NEWLINE]Nearby [ICON_RES_DEER] Deer: +1 [ICON_FOOD] Food and [ICON_CULTURE] Culture.[NEWLINE]Nearby [ICON_RES_JADE] Jade: +1 [ICON_CULTURE] Culture and +2 [ICON_PRODUCTION] Production.[NEWLINE]Nearby [ICON_RES_PEARLS] Pearls: +1 [ICON_CULTURE] Culture and +2 [ICON_TOURISM] Tourism.[NEWLINE]Nearby [ICON_RES_LAPIS] Lapis Lazuli: +2 [ICON_PRODUCTION] Production and [ICON_GOLDEN_AGE] Golden Age Points.[NEWLINE]Nearby [ICON_RES_PERFUME] Perfume: +1 [ICON_CULTURE] and +2 [ICON_GOLDEN_AGE] Golden Age Points.'),
...
('TXT_KEY_BUILDING_EE_SALON_HELP', '+1 [ICON_FOOD] Food for every 6 [ICON_CITIZEN] Citizens in the City. +20% [ICON_GREAT_WRITER] Great Writer, [ICON_GREAT_ARTIST] Great Artist, [ICON_GREAT_MUSICIAN] Great Musician rate in the City.[NEWLINE][NEWLINE]Nearby [ICON_RES_SPICES] Cinnamon: +1 [ICON_FOOD] Food, [ICON_GOLD] Gold, and [ICON_TOURISM] Tourism.[NEWLINE]Nearby [ICON_RES_COCOA] Cocoa: +2 [ICON_GOLD] Gold and +1 [ICON_TOURISM] Tourism.[NEWLINE]Nearby [ICON_RES_COFFEE] Coffee: +2 [ICON_GOLD] Gold and +1 [ICON_CULTURE] Culture.[NEWLINE]Nearby [ICON_RES_TEA] Tea: +2 [ICON_FOOD] Food and +1 [ICON_CULTURE] Culture.[NEWLINE]Nearby [ICON_RES_SUGAR] Sugar: +2 [ICON_FOOD] Food and [ICON_GOLD] Gold.[NEWLINE][NEWLINE]1 Specialist in this City no longer produces [ICON_HAPPINESS_3] Unhappiness from [ICON_URBANIZATION] Urbanization.'),
...
('TXT_KEY_BUILDING_EE_MENAGERIE_HELP', '+1 [ICON_TOURISM] Tourism for every 6 [ICON_CITIZEN] Citizens in the City. +250 [ICON_TOURISM] Tourism when completed.[NEWLINE][NEWLINE]Nearby [ICON_RES_BISON] Bison: +1 [ICON_FOOD] Food and [ICON_CULTURE] Culture.[NEWLINE]Nearby [ICON_RES_HORSE] Horses: +1 [ICON_PRODUCTION] Production and [ICON_CULTURE] Culture.[NEWLINE]Nearby [ICON_RES_BANANA] Banana: +2 [ICON_GOLD] Gold and +1 [ICON_TOURISM] Tourism.[NEWLINE]Nearby [ICON_RES_IVORY] Ivory: +2 [ICON_PRODUCTION] Production and [ICON_TOURISM] Tourism.[NEWLINE]Nearby [ICON_RES_CORAL] Coral: +1 [ICON_RESEARCH] Science and [ICON_CULTURE] Culture.[NEWLINE][NEWLINE]-1 [ICON_HAPPINESS_3] Unhappiness from [ICON_CULTURE] Boredom.'),
...
UPDATE Language_en_US
SET Text = Replace(Text, '+5% [ICON_CULTURE] Culture in the City. [ICON_GREAT_WORK] Great Works in the City produce +1 [ICON_TOURISM] Tourism. +33% [ICON_GREAT_MUSICIAN] Great Musician Rate in the City.', '+1 [ICON_CULTURE] Culture for every 6 [ICON_CITIZEN] Citizens in the City. [ICON_GREAT_WORK] Great Works in the City produce +1 [ICON_TOURISM] Tourism. +33% [ICON_GREAT_MUSICIAN] Great Musician Rate in the City.[NEWLINE][NEWLINE]Nearby [ICON_RES_INCENSE] Incense: +2 [ICON_GOLD] Gold and +1 [ICON_TOURISM] Tourism.[NEWLINE]Nearby [ICON_RES_WINE] Wine: +1 [ICON_FOOD] Food, [ICON_GOLD] Gold, and [ICON_CULTURE] Culture.[NEWLINE]Nearby [ICON_RES_TRUFFLES] Truffles: +1 [ICON_GOLD] Gold and +2 [ICON_TOURISM] Tourism.[NEWLINE]Nearby [ICON_RES_OLIVE] Olives: +1 [ICON_FOOD] Food and [ICON_CULTURE] Culture.[NEWLINE]Nearby [ICON_RES_TOBACCO] Tobacco: +2 [ICON_GOLD] Gold and +1 [ICON_CULTURE] Culture.')
...
UPDATE Language_en_US
SET Text = Replace(Text, 'Citizens in the City.', 'Citizens in the City. Gain 25% of the [ICON_RESEARCH] Science of the City as an instant boost when a new [ICON_CITIZEN] Citizen is born.[NEWLINE][NEWLINE]Nearby [ICON_RES_COW] Cattle: +1 [ICON_PRODUCTION] Production and [ICON_RESEARCH] Science.[NEWLINE]Nearby [ICON_RES_WHEAT] Wheat, [ICON_RES_MAIZE] Maize, [ICON_RES_RICE] Rice: +1 [ICON_FOOD] Food and [ICON_RESEARCH] Science.[NEWLINE]Nearby [ICON_RES_CITRUS] Citrus: +2 [ICON_FOOD] Food and +1 [ICON_RESEARCH] Science.[NEWLINE]Nearby [ICON_RES_AMBER] Amber: +2 [ICON_RESEARCH] Science.')
