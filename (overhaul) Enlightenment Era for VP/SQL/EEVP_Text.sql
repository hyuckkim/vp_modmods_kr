...
('TXT_KEY_PROMOTION_EE_ADVENTURER_HELP', '+1 [ICON_MOVES] Movement Point and +2 [ICON_VP_VISION] Sight while Embarked.'),
-- Drydock
...
('TXT_KEY_BUILDING_EE_MANOR_HELP', '+10 [ICON_FOOD] Food when your Borders expand, scaling with Era. +2 [ICON_GOLD] Gold and +1 [ICON_TOURISM] Tourism from Lake tiles.[NEWLINE][NEWLINE]Nearby [ICON_RES_DEER] Deer: +1 [ICON_FOOD] Food and [ICON_CULTURE] Culture.[NEWLINE]Nearby [ICON_RES_JADE] Jade: +1 [ICON_CULTURE] Culture and +2 [ICON_GOLDEN_AGE] Golden Age Points.[NEWLINE]Nearby [ICON_RES_AMBER] Amber: +1 [ICON_CULTURE] Culture and [ICON_PEACE] Faith.[NEWLINE]Nearby [ICON_RES_PEARLS] Pearls: +1 [ICON_CULTURE] Culture and +2 [ICON_TOURISM] Tourism.[NEWLINE]Nearby [ICON_RES_LAPIS] Lapis Lazuli: +2 [ICON_PRODUCTION] Production and [ICON_GOLDEN_AGE] Golden Age Points.[NEWLINE]Nearby [ICON_RES_INCENSE] Incense: +2 [ICON_PEACE] Faith.'),
