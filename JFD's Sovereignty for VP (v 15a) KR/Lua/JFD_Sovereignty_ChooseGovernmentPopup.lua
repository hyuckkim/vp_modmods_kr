...
function RefreshList()
	...
	if g_IsViewingGovt then
		Controls.ChooseGovtOptionsChoose:LocalizeAndSetText("TXT_KEY_CHOOSE_JFD_GOVERNMENT_OPTIONS_VIEW")
	end
...
function OnConfirmYes( )
	...
	player:SetHasGovernment(g_iChoice, (currentGovernmentID == governmentTribeID), g_IsChangingGovt)
