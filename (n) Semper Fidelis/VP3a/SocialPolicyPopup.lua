...
local g_pipeManagers = {
	...
	POLICY_BRANCH_HARMONY = InstanceManager:new( "ConnectorPipe", "ConnectorImage", Controls.DevotionPanel ),
	POLICY_BRANCH_DEVOTION = InstanceManager:new( "ConnectorPipe", "ConnectorImage", Controls.DevotionPanel ),	
	POLICY_BRANCH_PROSPERITY = InstanceManager:new( "ConnectorPipe", "ConnectorImage", Controls.DevotionPanel ),
}
local g_instanceManagers = {
	...
	POLICY_BRANCH_HARMONY = InstanceManager:new( "PolicyButton", "PolicyIcon", Controls.DevotionPanel ),
	POLICY_BRANCH_DEVOTION = InstanceManager:new( "PolicyButton", "PolicyIcon", Controls.DevotionPanel ),	
	POLICY_BRANCH_PROSPERITY = InstanceManager:new( "PolicyButton", "PolicyIcon", Controls.DevotionPanel ),
}
...
local g_IdeologyBackgrounds = {
		...
		POLICY_BRANCH_HARMONY = "SocialPoliciesHarmony_long.dds",
		POLICY_BRANCH_DEVOTION = "SocialPoliciesDevotion_long.dds",		
		POLICY_BRANCH_PROSPERITY = "SocialPoliciesProsperity_long.dds",
}
