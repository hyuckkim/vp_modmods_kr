...
function RefreshList()
	...
	local ideologies = {
		{
			...
			VictoryTypes = {"CultureVictory", "TimeVictory", "DominationVictory"},
		...
		{
			PolicyBranchType = "POLICY_BRANCH_HARMONY",
			VictoryTypes = {"DiplomaticVictory", "TimeVictory", "ReligiousVictory"},
			Image = "SocialPoliciesHarmony.dds",
			ImageOffsetX = 0,
			ImageOffsetY = 0,
		},
		{
			PolicyBranchType = "POLICY_BRANCH_PROSPERITY",
			VictoryTypes = {"ScienceVictory", "TimeVictory", "ReligiousVictory"},
			Image = "SocialPoliciesProsperity.dds",
			ImageOffsetX = 0,
			ImageOffsetY = 0,
		}		
	}	
	...
	for _, ideology in ipairs(ideologies) do
			...
			itemInstance.TimeVictory:SetHide(true);
			itemInstance.ReligiousVictory:SetHide(true);
