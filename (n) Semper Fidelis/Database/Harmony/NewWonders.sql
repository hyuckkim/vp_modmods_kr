...
VALUES
	...
	('TXT_KEY_WONDER_WH_DINOSAUR_HELP', 'Requires the [COLOR_MAGENTA]World Heritage[ENDCOLOR] Policy, a nearby [ICON_RES_STONE] Stone and/or [ICON_RES_IRON] Iron Resource, and the City must be on a River. Receive a [COLOR_POSITIVE_TEXT]Free[ENDCOLOR] Interpretive Centre in the City and 2 [ICON_VP_ARTIFACT] Artifacts. Contains 2 slots for [ICON_GREAT_WORK] Great Works of Art or Artifacts.[NEWLINE][NEWLINE]+8 [ICON_RESEARCH] Science if Themed.'),
	...
	('TXT_KEY_WONDER_WH_BUTRINT_HELP', 'Requires the [COLOR_MAGENTA]World Heritage[ENDCOLOR] Policy and a nearby Marsh Feature. Receive a [COLOR_POSITIVE_TEXT]Free[ENDCOLOR] Interpretive Centre in the City and 1 [ICON_VP_ARTIFACT] Artifact. Contains 2 slots for [ICON_GREAT_WORK] Great Works of Art or Artifacts.[NEWLINE][NEWLINE]+6 [ICON_GOLD] Gold and [ICON_CULTURE] Culture if Themed.'),
