...
WHERE Tag IN ('TXT_KEY_UNIT_HELP_ZERO', 'TXT_KEY_UNIT_JAPANESE_ZERO_STRATEGY', 'TXT_KEY_WONDER_PRORA_RESORT_HELP', 'TXT_KEY_BUILDING_HALL_OF_HONOR_HELP', 'TXT_KEY_RESPONSE_DENOUNCE_HUMAN_BELIEVES_AUTOCRACY_2', 'TXT_KEY_GENERIC_SWITCHED_TO_AUTOCRACY_2');
