...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]외교국[ENDCOLOR][NEWLINE][ICON_BULLET][ICON_SPY_POINT] 스파이 점수를 100 제공합니다.[NEWLINE][ICON_BULLET] 위대한 외교관의 출현율이 50% 증가합니다.[NEWLINE][ICON_BULLET] 도시 국가의 퀘스트 보상이 [COLOR_POSITIVE_TEXT]50%[ENDCOLOR] 증가합니다.[NEWLINE][ICON_BULLET] 유지하는 도시 국가 동맹 3개 마다 모든 전략 자원이 +1씩 증가합니다.'
