...
UPDATE Language_ko_KR
SET Text = 'B-17 폭격기는 자유 이념의 고유 무기입니다. "최고의 순간" 교리를 해제해야 합니다. 폭격기와 유사하지만, 적 대공포와 전투기의 조준이 더 어렵습니다. 또한 B-17은 적 도시를 공격할 때 보너스를 받습니다. 폭격기와 달리 사거리는 9입니다. 자세한 내용은 항공기 규칙을 참조하세요.'
