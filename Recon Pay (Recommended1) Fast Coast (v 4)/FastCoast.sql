...
UPDATE UnitPromotions	SET ExtraNavalMovement = 0 WHERE Type LIKE 'PROMOTION%TRAILBLAZER_1';
...
UPDATE UnitPromotions	SET ExtraNavalMovement = 0 WHERE Type LIKE 'PROMOTION%TRAILBLAZER_2';
...
UPDATE UnitPromotions	SET AllowsEmbarkation = 0, ExtraNavalMovement = 0 WHERE Type LIKE 'PROMOTION%TRAILBLAZER_3';
