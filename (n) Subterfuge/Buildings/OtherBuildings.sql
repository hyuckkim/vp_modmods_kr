...
VALUES
	('BUILDING_FOREIGN_BUREAU', 'YIELD_TOURISM', 75);

/*
UPDATE Language_en_US
SET Text = 'Provides 1 additional [ICON_RES_PAPER] Paper and 100 [ICON_SPY_POINT] Spy Points. +20% [ICON_PRODUCTION] Production of Diplomatic Units in this City. All Diplomatic Units receive the [COLOR_POSITIVE_TEXT]{TXT_KEY_PROMOTION_DIPLOMATIC_IMMUNITY}[ENDCOLOR] Promotion. Receive 75 [ICON_TOURISM] Tourism when you sucessfully rig an election in a [ICON_CITY_STATE] City-State, scaling with Era.[NEWLINE][NEWLINE]The [ICON_PRODUCTION] Production Cost and [ICON_CITIZEN] Population Requirements increase based on the number of Cities you own.'
WHERE Tag = 'TXT_KEY_BUILDING_FOREIGN_BUREAU_HELP';
*/
...
WHERE Tag = 'TXT_KEY_BUILDING_FOREIGN_BUREAU_STRATEGY';
