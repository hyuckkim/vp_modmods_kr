...
INSERT INTO	 Buildings
	(Type,						Description,						Civilopedia,							Strategy,					Help,									GoldMaintenance, 	Cost, HurryCostModifier, 	MinAreaSize, 	ConquestProb, 	BuildingClass, 				ArtDefineTag, 				PrereqTech, 			PortraitIndex, 	IconAtlas, NationalPopRequired)
VALUES	
	('BUILDING_GENERAL_POST',	'TXT_KEY_BUILDING_GENERAL_POST', 	'TXT_KEY_BUILDING_GENERAL_POST_TEXT',	'TXT_KEY_BUILDING_GENERAL_POST_STRATEGY',	'TXT_KEY_BUILDING_GENERAL_POST_HELP',	0, 				600, -20, 					-1, 			0, 			'BUILDINGCLASS_GENERAL_POST', 	'ART_DEF_BUILDING_MARKET', 	'TECH_MILITARY_SCIENCE', 	7,				'SpyRework_Atlas', 35);
