...
VALUES
	('BELIEF_DAOGUAN', 'TXT_KEY_BELIEF_DAOGUAN', 'TXT_KEY_BELIEF_DAOGUAN_SHORT', 'TXT_KEY_BELIEF_DAOGUAN_TOOLTIP',	
		0, 	0, 	1, 	0, 	0);
...
VALUES
	...
	('TXT_KEY_BELIEF_DAOGUAN_TOOLTIP', '+4 [ICON_PEACE] Faith[NEWLINE]+10 [ICON_SPY] City Security[NEWLINE][NEWLINE]+10 [ICON_SPY_POINT] Spy Points on construction[NEWLINE][NEWLINE]Boost Pressure of [ICON_RELIGION] Religious Majority emanating from this City by +25%[NEWLINE]Increases the City''s resistance to [ICON_RELIGION] Religious conversion by 10%.[NEWLINE][NEWLINE]1 Specialist in this City no longer produces [ICON_HAPPINESS_3] Unhappiness from Urbanization.[NEWLINE][NEWLINE]Contains 1 slot for a [ICON_GREAT_WORK] Great Work of Writing.'),
...
UPDATE Language_en_US
SET Text = Replace(Text, '; +5 [ICON_GOLDEN_AGE] Golden Age Points from [ICON_RELIGION] Holy Sites;', ', +80 [ICON_VP_SPY_POINTS] Spy Points; +5 [ICON_GOLDEN_AGE] Golden Age Points from [ICON_RELIGION] Holy Sites;')
