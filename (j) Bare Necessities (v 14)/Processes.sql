...
('TECHPRIEST_ATLAS', 256, 'FaithTourismAtlas256.dds', 8, 1),
('TECHPRIEST_ATLAS', 128, 'FaithTourismAtlas128.dds', 8, 1),
...
SELECT	'PROCESS_GOLDEN_AGE', 'TXT_KEY_PROCESS_GOLDEN_AGE', 'TXT_KEY_PROCESS_GOLDEN_AGE_HELP', 'TXT_KEY_PROCESS_GOLDEN_AGE_STRATEGY', 'TECH_ECOLOGY', 'TECHPRIEST_ATLAS', 2;
...
SELECT 'PROCESS_GOLDEN_AGE', 'YIELD_FAITH', 5;
--==========================================================================================================================	
INSERT OR REPLACE INTO Processes (Type, Description, Help, Strategy, TechPrereq, IconAtlas, PortraitIndex)
SELECT 	'PROCESS_FAITH', 'TXT_KEY_PROCESS_FAITH', 'TXT_KEY_PROCESS_FAITH_HELP', 'TXT_KEY_PROCESS_FAITH_STRATEGY', 'TECH_PHILOSOPHY', 'TECHPRIEST_ATLAS', 0
WHERE NOT EXISTS (SELECT * FROM Policies WHERE Type= 'POLICY_MARTYRDOM');

INSERT OR REPLACE INTO Process_ProductionYields (ProcessType, YieldType, Yield)
SELECT 'PROCESS_FAITH', 'YIELD_FAITH', 25 WHERE NOT EXISTS (SELECT * FROM Policies WHERE Type= 'POLICY_MARTYRDOM');

INSERT OR REPLACE INTO LocalizedText (Language, Tag, Text)
SELECT	'en_US', 'TXT_KEY_PROCESS_FAITH', 'Prayer' WHERE NOT EXISTS (SELECT * FROM Policies WHERE Type= 'POLICY_MARTYRDOM') UNION ALL
SELECT	'en_US', 'TXT_KEY_PROCESS_FAITH_HELP', '[COLOR_POSITIVE_TEXT]Prayer[ENDCOLOR] converts 25% of [ICON_PRODUCTION] Production of this City into [ICON_PEACE] Faith, and reduces [ICON_RELIGION] Religious Unrest by 25%.' WHERE NOT EXISTS (SELECT * FROM Policies WHERE Type= 'POLICY_MARTYRDOM') UNION ALL
SELECT	'en_US', 'TXT_KEY_PROCESS_FAITH_STRATEGY', 'Investing production in prayer is a good way to boost your City''s faith output, which can be useful if you are currently in need of missionaires and inquisitors or if your cities need to birth Great People! Also reduce Religious Unrest.' WHERE NOT EXISTS (SELECT * FROM Policies WHERE Type= 'POLICY_MARTYRDOM');
--==========================================================================================================================	
--==========================================================================================================================	