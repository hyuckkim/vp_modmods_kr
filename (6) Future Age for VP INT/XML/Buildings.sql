...
UPDATE Language_ko_KR SET Text = Text||'[NEWLINE][NEWLINE]Spaceships, Space Marines, ODST and XCOM units trained in this city have +15% [ICON_STRENGTH] Combat Strength.' WHERE Tag IN ('TXT_KEY_BUILDING_SPACESHIP_FACTORY_HELP');
