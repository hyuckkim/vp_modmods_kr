...
INSERT INTO Language_ko_KR
			(Tag,										Text)
VALUES		('TXT_KEY_PROMOTION_KAILASH',				'마하프라스탄니카 파르바'),
			('TXT_KEY_PROMOTION_KAILASH_HELP',			'언덕에서 [ICON_MOVES] 이동력 두 배.'),
			('TXT_KEY_PROMOTION_ULURU',					'고대 부족'),
			('TXT_KEY_PROMOTION_ULURU_HELP',			'외교 임무 후 [ICON_INFLUENCE] 영향력 +10.'),
			('TXT_KEY_PROMOTION_SOLOMONS_MINES',		'왕을 위하여!'),
			('TXT_KEY_PROMOTION_SOLOMONS_MINES_HELP',	'[ICON_WORKER] 작업 속도 +25%.'),
			('TXT_KEY_PROMOTION_BERMUDA_TRIANGLE',		'시공간 속으로 사라지다'),
			('TXT_KEY_PROMOTION_BERMUDA_TRIANGLE_HELP',	'[ICON_MOVES] 이동력 -3. [COLOR_NEGATIVE_TEXT]승급은 3턴 동안 지속됩니다.[ENDCOLOR]'),
			('TXT_KEY_PROMOTION_DALLOL',				'폭발성 혼합물'),
			('TXT_KEY_PROMOTION_DALLOL_HELP',			'[ICON_RANGE_STRENGTH] 공격 전투력 +10%.'),
			('TXT_KEY_PROMOTION_CAUSEWAY',				'호기심'),
			('TXT_KEY_PROMOTION_CAUSEWAY_HELP',			'[ICON_MOVES] 이동력 +1. [ICON_WORKER] 작업 속도 +10%.'),
			('TXT_KEY_PROMOTION_MT_EVEREST',			'세계의 지붕'),
			('TXT_KEY_PROMOTION_MT_EVEREST_HELP',		'유닛이 타일을 드러낼 때 [ICON_TOURISM] 관광을 얻습니다.'),
			('TXT_KEY_PROMOTION_HA_LONG',				'하강하는 용'),
			('TXT_KEY_PROMOTION_HA_LONG_HELP',			'적 유닛 처치 시 적 유닛의 [ICON_STRENGTH] 전투력의 80%를 [ICON_CULTURE] 문화로 얻습니다. [ICON_STRENGTH] 방어 전투력 +20%'),
			('TXT_KEY_PROMOTION_AURORA',				'레본툴레트'),
			('TXT_KEY_PROMOTION_AURORA_HELP',			'눈에서 [ICON_MOVES] 이동력 두 배.');
...
INSERT INTO Language_ko_KR 
			(Tag,									Text) 
VALUES		('TXT_KEY_GREAT_WORK_MT_PAEKTU',		'백두산 정상에 서 있는 김일성과 김정일');
--============================================--
-- BUILDINGS
--============================================--
...
INSERT INTO Language_ko_KR
			(Tag,										Text)
VALUES		('TXT_KEY_BUILDING_MT_PAEKTU',				'산 아래 탄생의 제단'),
			('TXT_KEY_BUILDING_MT_PAEKTU_PEDIA',		'TODO'),
			('TXT_KEY_BUILDING_MT_PAEKTU_HELP',			'[ICON_GREAT_PEOPLE] 위대한 음악가 점수 +1. [ICON_GREAT_WORK] 위대한 예술품 슬롯 1개를 가지며, [ICON_GREAT_WORK] [COLOR_CULTURE_STORED]백두산 정상에 선 김일성 동지와 김정일 동지[ENDCOLOR]로 시작합니다.'),
			('TXT_KEY_BUILDING_SCUBA_RESORT',			'스쿠버 다이빙 리조트'),
			('TXT_KEY_BUILDING_SCUBA_RESORT_PEDIA',		'TODO'),
			('TXT_KEY_BUILDING_SCUBA_RESORT_HELP',		'이 도시가 개발한 환초에서 [ICON_GOLD] 금 +1, [ICON_TOURISM] 관광 +1. 이 도시가 개발한 해양 타일에서 [ICON_GOLD] 금 +1, [ICON_RESEARCH] 과학 +1.'),
			('TXT_KEY_BUILDING_BATHYSCAPHE_BAY',		'심해 잠수정 도킹 베이'),
			('TXT_KEY_BUILDING_BATHYSCAPHE_BAY_PEDIA',	'TODO'),
			...
			('TXT_KEY_BUILDING_OCEAN_FACILITY_PEDIA',	'TODO'),
			('TXT_KEY_BUILDING_OCEAN_FACILITY_HELP',	'이 도시가 개발한 해양 타일에서 [ICON_FOOD] 식량 +1, [ICON_RESEARCH] 과학 +1.[NEWLINE][NEWLINE]이 도시의 모든 해상 자원에서 [ICON_FOOD] 식량 +1을 얻습니다.');
...
INSERT INTO Language_ko_KR
			(Tag,										Text)
VALUES		('TXT_KEY_BUILDING_SALAR_A_DUMMY',			'살라르 데 우유니 A'),
			('TXT_KEY_BUILDING_SALAR_B_DUMMY',			'살라르 데 우유니 B'),
			('TXT_KEY_BUILDING_EL_DORADO_DUMMY',		'엘도라도'),
			('TXT_KEY_BUILDING_POTOSI_DUMMY',			'포토시 은광'),
			('TXT_KEY_BUILDING_CRATER_DUMMY',			'베링거 운석구'),
			('TXT_KEY_BUILDING_MESA_DUMMY',				'그랜드 메사'),
			('TXT_KEY_BUILDING_SOLOMONS_MINES_DUMMY',	'솔로몬 왕의 광산'),
			('TXT_KEY_BUILDING_VOLCANO_DUMMY',			'크라카토아'),
			...
			('TXT_KEY_BUILDING_REEF_DUMMY',				'대보초'),
			('TXT_KEY_BUILDING_GIBRALTAR_DUMMY',		'지브롤터 바위'),
			('TXT_KEY_BUILDING_LAKE_VICTORIA_DUMMY',	'빅토리아 호'),
			...
			('TXT_KEY_BUILDING_LUMI_BAY_DUMMY',			'생물 발광 만'),
			...
			('TXT_KEY_BUILDING_ULURU_DUMMY',			'울룰루'),
			('TXT_KEY_BUILDING_BLUE_HOLE_DUMMY',		'그레이트 블루 홀'),
			('TXT_KEY_BUILDING_GALAPAGOS_A_DUMMY',		'갈라파고스 A'),
			('TXT_KEY_BUILDING_GALAPAGOS_B_DUMMY',		'갈라파고스 B'),
			('TXT_KEY_BUILDING_HA_LONG_A_DUMMY',		'하롱 베이 A'),
			('TXT_KEY_BUILDING_HA_LONG_B_DUMMY',		'하롱 베이 B'),
