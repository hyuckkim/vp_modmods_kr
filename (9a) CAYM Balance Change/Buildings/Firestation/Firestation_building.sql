...
('TXT_KEY_BUILDING_FIRESTATION_STRATEGY',"Building a fire station reduces the city's requirements."),
...
('TXT_KEY_BUILDING_FIRESTATION_STRATEGY','소방대를 건설하면 도시의 전역 요구가 감소합니다.'),
