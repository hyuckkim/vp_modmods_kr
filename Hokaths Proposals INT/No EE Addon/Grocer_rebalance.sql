...
*/
UPDATE Language_ko_KR
SET Text = '식료품점은 르네상스 시대 건물로, 도시에 송수로를 건설한 경우에만 건설할 수 있습니다. 송수로와 마찬가지로 식료품점은 도시가 더 빨리 성장하고 빈곤에 맞서는 데 도움이 됩니다. 또한 신앙 생산량을 늘려주며, 기술 트리에서 신앙 생산량을 늘려주는 마지막 건물입니다.'
