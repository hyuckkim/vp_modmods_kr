...
VALUES	('TXT_KEY_BUILDING_AIRFIELD',	 '비행장'),
		...
		('TXT_KEY_BUILDING_AIRFIELD_HELP', '');
/*
도시에 있는 모든 [ICON_WONDER] 세계 불가사의에서 [ICON_GOLD] 골드 +2, [ICON_TOURISM] 관광 +1을 획득합니다. 공중 및 호버링 유닛에 대한 [ICON_PRODUCTION] 생산량이 +20% 증가합니다.[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]도시의 공중 유닛 수용량이 1만큼 증가합니다[ENDCOLOR]. 도시에 대한 공습 시 공중 유닛의 [ICON_STRENGTH] 피해가 +5 증가합니다.
