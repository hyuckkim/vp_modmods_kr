...
-- 100% of the [ICON_STRENGTH] Combat Strength of defeated Enemy Units as [ICON_PEACE] Faith.
	...
	('TXT_KEY_UNIT_SWEDISH_JARL_STRATEGY', '다른 장군들이 원거리 진영이나 방어 가능한 위치의 안전한 곳에서 군대를 지휘하는 반면, 스웨덴의 야를은 최전선에서 군대를 지휘합니다! 지형적 비용을 무시함으로써 최적의 위치로 쉽게 기동할 수 있으며, 적의 전선에 구멍을 뚫기 위해 사방에서 자신의 군대로 호위하여 힘을 얻을 수 있습니다. 게임을 진행하면서 모든 야를의 힘이 자연스럽게 증가하므로 야를을 업그레이드할 필요조차 없습니다! [COLOR_POSITIVE_TEXT]스웨덴 사자[ENDCOLOR] 승급 외에도 게임 초반에 점진적으로 잠금 해제되는 레벨업에 따른 6가지 추가 선택 사항이 있으며, 이를 통해 군사, 탐험 또는 비전투 용도로든 자신의 필요에 맞게 영웅적인 야를을 원하는대로 사용할 수 있습니다.'),
	('TXT_KEY_UNIT_SWEDISH_JARL_HELP', '근접 지상 유닛처럼 행동하는 독특한 스웨덴의 위대한 장군입니다. 현재 [COLOR_CYAN]시대[ENDCOLOR]에 적합하게 보정된 [ICON_STRENGTH] 전투력으로 싸웁니다. 일반적인 리더십 보너스 외에도 고유한 [COLOR_POSITIVE_TEXT]승급[ENDCOLOR]을 이용할 수 있습니다. [COLOR_POSITIVE_TEXT]스웨덴 사자[ENDCOLOR] 진급부터 시작하며, [COLOR_CYAN]산업 시대[ENDCOLOR] 이후에 태어난 경우 [COLOR_POSITIVE_TEXT]스키 보병[ENDCOLOR] 진급도 추가로 제공됩니다.[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]요새[ENDCOLOR] 시설을 건설하는 데 사용할 수 있으며 요새를 점유하는 모든 유닛에게 큰 방어 보너스를 주고, 요새 근처에서 턴을 마치는 적 유닛에게 피해를 주며, 인접한 모든 타일을 플레이어 영토로 만들고, 군사 유닛 보급 한도를 1 늘려줍니다.');

INSERT INTO Language_ko_KR
	(Tag, Text)
VALUES
	('TXT_KEY_UNIT_SWEDISH_JARL_1', '비르예르 보르사'),
	('TXT_KEY_UNIT_SWEDISH_JARL_2', '요한 1세 (요한 스베르케르손)'),
	('TXT_KEY_UNIT_SWEDISH_JARL_3', '크누트 비르예르손'),
	('TXT_KEY_UNIT_SWEDISH_JARL_4', '폴케 비르예르손'),
	('TXT_KEY_UNIT_SWEDISH_JARL_5', '귀먹은 칼'),
	('TXT_KEY_UNIT_SWEDISH_JARL_6', '울프 파세'),
	('TXT_KEY_UNIT_SWEDISH_JARL_7', '비르예르 망누손'),
	('TXT_KEY_UNIT_SWEDISH_JARL_8', '울프 토스테손'),
	('TXT_KEY_UNIT_SWEDISH_JARL_9', '랑발드 울프손'),
	('TXT_KEY_UNIT_SWEDISH_JARL_10', '니콜라우스 아우구스트'),
	('TXT_KEY_UNIT_SWEDISH_JARL_11', '외스테르예틀란드 공작 요한'),
	('TXT_KEY_UNIT_SWEDISH_JARL_12', '오스카르 베르나도테'),
	('TXT_KEY_UNIT_SWEDISH_JARL_13', '할란드 공작 베르틸 왕자'),
	('TXT_KEY_UNIT_SWEDISH_JARL_14', '칼 구스타프'),
	('TXT_KEY_UNIT_SWEDISH_JARL_15', '베스테르예틀란드 공작 칼 왕자(파란 왕자)'),  -- 아들은 썩은 놈이었어, 혼란스럽게 하고 싶지 않아
	('TXT_KEY_UNIT_SWEDISH_JARL_16', '욀란드 공작 칼'),
	('TXT_KEY_UNIT_SWEDISH_JARL_17', '카롤루스');