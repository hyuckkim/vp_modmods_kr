...
VALUES		('TXT_KEY_RESOURCE_TERN',						'제비갈매기 알'),
			...
			('TXT_KEY_RESOURCE_TERN_MONOPOLY',				'[ICON_WONDER] 아후 통가리키에서 승인됩니다. [COLOR_POSITIVE_TEXT]독점 보너스:[ENDCOLOR] 문명에 [ICON_PEACE] 신앙 +5%'),
			...
			('TXT_KEY_RESOURCE_SYLVITE',					'실빈'),
			('TXT_KEY_RESOURCE_SYLVITE_TEXT',				'TODO'),
			('TXT_KEY_RESOURCE_SYLVITE_MONOPOLY',			'댈롤에서 승인됩니다. [COLOR_POSITIVE_TEXT]독점 보너스:[ENDCOLOR] [COLOR_YIELD_GOLD]공성[ENDCOLOR] 유닛에 [COLOR_WATER_TEXT]폭발성 혼합물[ENDCOLOR] 승급'),
			...
			('TXT_KEY_RESOURCE_TROPICAL_FISH_MONOPOLY',		'그레이트 배리어 리프와 갈라파고스 자연 경관에서 생성될 수 있습니다.'),
			('TXT_KEY_RESOURCE_TORTOISE',					'코끼리거북'),
			('TXT_KEY_RESOURCE_TORTOISE_TEXT',				'TODO'),
			('TXT_KEY_RESOURCE_TORTOISE_MONOPOLY',			'갈라파고스 제도에서 나타납니다. [COLOR_POSITIVE_TEXT]독점 보너스:[ENDCOLOR] [ICON_GOLDEN_AGE] 황금기 기간 +10%');
...
UPDATE Language_ko_KR SET Text = Text||'[NEWLINE][NEWLINE][ICON_RES_TORTOISE] 코끼리거북: [ICON_RESEARCH] 과학 +2' WHERE Tag = 'TXT_KEY_BUILDING_LABORATORY_HELP';