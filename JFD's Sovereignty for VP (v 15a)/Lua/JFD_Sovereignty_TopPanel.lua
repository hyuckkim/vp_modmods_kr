...
TTManager:GetTypeControlTable( "TooltipTypeTopPanelJFD", textTipControls )
...
local function JFD_Sovereignty_UpdateTopPanel()
	...
	if activePlayer:IsHasGovernment() then
        ...
        textTipControls.TooltipLabel:SetText( strSovTT )
        textTipControls.TopPanelMouseover:DoAutoSize()
