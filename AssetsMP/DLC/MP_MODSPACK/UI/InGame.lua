...
ContextPtr:LoadNewContext("WWonders_Functions")
ContextPtr:LoadNewContext("highlight")
ContextPtr:LoadNewContext("Jar_VolcanoesFunctions")
ContextPtr:LoadNewContext("ManualFix")
...
ContextPtr:LoadNewContext("FutureLua")
ContextPtr:LoadNewContext("ImprovementUnderseaTunnel")
ContextPtr:LoadNewContext("EventLUA")
ContextPtr:LoadNewContext("CompatibilityFile")
ContextPtr:LoadNewContext("JAR_BareFunctions")
...
ContextPtr:LoadNewContext("FletcherPromotion")
ContextPtr:LoadNewContext("DummyBuildingsForWonders")
ContextPtr:LoadNewContext("NaturalWonderPopupOnClick")
ContextPtr:LoadNewContext("NaturalWondersOnStrategicMap")
ContextPtr:LoadNewContext("UniqueNaturalWondersAbilities")
ContextPtr:LoadNewContext("UniqueWorldWondersRequirements")
ContextPtr:LoadNewContext("TheBalanceDemandsIt")
...
ContextPtr:LoadNewContext("CivicChecker")
ContextPtr:LoadNewContext("TheLastGoodbye")
ContextPtr:LoadNewContext("CounterRecon")
ContextPtr:LoadNewContext("ElephantSoundOnCircusBuild")
ContextPtr:LoadNewContext("EHhelper")
ContextPtr:LoadNewContext("GW_Main")
ContextPtr:LoadNewContext("GW_Meter")
ContextPtr:LoadNewContext("IGE_Loader")
ContextPtr:LoadNewContext("Jar_Outpost_Functions")
ContextPtr:LoadNewContext("Landmines_Main")
ContextPtr:LoadNewContext("MBweatherEvents")
ContextPtr:LoadNewContext("MusicButton")
ContextPtr:LoadNewContext("NotificationSettings")
...
ContextPtr:LoadNewContext("FastCoastal")
ContextPtr:LoadNewContext("HorseThieves")
ContextPtr:LoadNewContext("RPTCexplorationSpecialization")
ContextPtr:LoadNewContext("Reforestation")
ContextPtr:LoadNewContext("RoutePlanner")
ContextPtr:LoadNewContext("Core_Functions")
ContextPtr:LoadNewContext("TGEvent")
ContextPtr:LoadNewContext("UIAntiquitiesSiteTooltips")
ContextPtr:LoadNewContext("AutoMapPins")
ContextPtr:LoadNewContext("CityHappiness")
ContextPtr:LoadNewContext("CityProduction")
ContextPtr:LoadNewContext("CityReligions")
ContextPtr:LoadNewContext("DiplomacyLogPopup")
ContextPtr:LoadNewContext("GoldAlerts")
ContextPtr:LoadNewContext("MapPins")
ContextPtr:LoadNewContext("UINoAutoEmbarkWorkers")
ContextPtr:LoadNewContext("UINotifyExitResistance")
ContextPtr:LoadNewContext("PromotionTree")
ContextPtr:LoadNewContext("UI_notifications")
ContextPtr:LoadNewContext("WhaleBattles")
ContextPtr:LoadNewContext("WonderRace")
ContextPtr:LoadNewContext("SphereOfInfluences")
ContextPtr:LoadNewContext("Population")
ContextPtr:LoadNewContext("XCOM")
ContextPtr:LoadNewContext("CulturalLandmarks_Functions")
