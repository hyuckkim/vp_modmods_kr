...
UPDATE Language_en_US SET Text = REPLACE(Text, '[NEWLINE][NEWLINE]Requires an Aqueduct in the City.', '[NEWLINE]Nearby [ICON_RES_ALOEVERA] Aloe Vera: +1 [ICON_FOOD] Food, +1 [ICON_GOLD] Gold.[NEWLINE][NEWLINE]Requires an Aqueduct in the City.')
