...
('TXT_KEY_WONDER_EE_VERSAILLES_HELP', 'Receive a [COLOR_POSITIVE_TEXT]Free[ENDCOLOR] Gallery in the City in which it is built. 15% of [ICON_GOLD] Gold created by this City counts as [ICON_CULTURE] Culture each turn. All owned Monuments, Amphitheaters, Galleries, Opera Houses gain +2 [ICON_GOLD] Gold.'),
...
('TXT_KEY_BUILDING_EE_ACADEMY_HELP', '+1 [ICON_RESEARCH] Science for every 6 [ICON_CITIZEN] Citizens in the City. Cost of [ICON_GOLD] Gold purchasing in this City reduced by 10%. Receive 20 [ICON_RESEARCH] Science and 5 [ICON_GREAT_GENERAL] Great General Points when you unlock a [ICON_CITIZEN] Citizen is born in this City, scaling with Era.[NEWLINE][NEWLINE]+20% [ICON_GREAT_SCIENTIST] Great Scientist, [ICON_GREAT_ENGINEER] Great Engineer, [ICON_GREAT_MERCHANT] Great Merchant, and [ICON_DIPLOMAT] Great Diplomat rate in the City.[NEWLINE][NEWLINE]City must not contain a [COLOR_NEGATIVE_TEXT]Seminary[ENDCOLOR].'),
...
('TXT_KEY_BUILDING_EE_SEMINARY_HELP', '+1 [ICON_PEACE] Faith for every 6 [ICON_CITIZEN] Citizens in the City. Refund 10% of all [ICON_PEACE] Faith spent on purchases in this City. Receive 10 [ICON_PEACE] Faith and 20 [ICON_GOLDEN_AGE] Golden Age Points when you unlock a [ICON_CITIZEN] Citizen is born in this City, scaling with Era.[NEWLINE][NEWLINE]Boosts starting Religious Strength of all [ICON_MISSIONARY] Missionaries by 5%.[NEWLINE][NEWLINE]City must not contain a [COLOR_NEGATIVE_TEXT]Polytechnic[ENDCOLOR].'),
