...
VALUES	('TXT_KEY_BUILDING_MONGOLIA_TUVAN',			'투바 아일'),
		...
		('TXT_KEY_BUILDING_MONGOLIA_TUVAN_HELP',		'도시의 [ICON_VP_MUSICIAN] 음악가와 목장에서 [ICON_FOOD] 식량 +2, [ICON_CULTURE] 문화 +2, [ICON_CULTURE_LOCAL] 국경 성장 점수 +2, [ICON_GREAT_GENERAL] 위대한 장군 점수 +2 증가합니다. 작업 가능한 타일 내의 모든 산에 대해 [ICON_CULTURE] 문화 +3, [ICON_PEACE] 신앙 +3, [ICON_TOURISM] 관광 +3 증가합니다.[NEWLINE][NEWLINE]초원: [ICON_FOOD] 음식 +1, [ICON_TOURISM] 관광 +1[NEWLINE]평원: [ICON_PRODUCTION] 생산 +1, [ICON_PEACE] 신앙 +1[NEWLINE][NEWLINE]이 도시의 전문가 1명이 더 이상 [ICON_URBANIZATION] 도시화로 인한 [ICON_HAPPINESS_3] 불행을 생성하지 않습니다.[NEWLINE][NEWLINE]문명에는 이러한 건물이 최대 3개까지 있을 수 있습니다.');

------------------------------------------------
--UPDATE Language_ko_KR
--SET Text = '{TXT_KEY_BUILDING_LODGE}을 대체하는 몽골의 고유 건물입니다. {TXT_KEY_BUILDING_LODGE}의 보너스 외에도 {TXT_KEY_BUILDING_YURT}는 [ICON_GOLD] 골드를 생산하고, 목장를 늘리고, 국경이 확장될 때 [ICON_PRODUCTION] 생산력을 제공하며, 국경이 더 빨리 확장되도록 합니다.'
