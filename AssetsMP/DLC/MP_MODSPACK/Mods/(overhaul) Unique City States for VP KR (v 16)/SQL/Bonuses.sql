...
SELECT 'TXT_KEY_CITYSTATE_RISHIKESH', 					'	' UNION ALL
...
SELECT 'TXT_KEY_CSTRAIT_MINOR_CIV_MONACO', 				'[COLOR_MAGENTA]금융 천국:[ENDCOLOR] [COLOR_YIELD_FOOD]시장[ENDCOLOR], [COLOR_YIELD_FOOD]운하[ENDCOLOR]의 [ICON_CULTURE_LOCAL] 국경 확장 점수 +1. 모든 도시의 [ICON_GOLD] 타일 골드 구매 비용 -33%.[NEWLINE]' UNION ALL
...
SELECT 'TXT_KEY_CSTRAIT_MINOR_CIV_NYARYANA_MARQ', 		'[COLOR_MAGENTA]순록 목동:[ENDCOLOR] [COLOR_CITY_BLUE]설원[ENDCOLOR] 타일의 [ICON_CULTURE] 문화 +1. [COLOR_CITY_BLUE]툰드라[ENDCOLOR], [COLOR_CITY_BLUE]설원[ENDCOLOR] 타일에 [COLOR_CITY_BROWN]첨[ENDCOLOR] 건설 가능 (인접 불가, [ICON_FOOD] 식량, [ICON_PRODUCTION] 생산, [ICON_GOLD] 골드 제공)[NEWLINE]' UNION ALL
...
SELECT 'TXT_KEY_UNIT_SWISS_GUARD_STRATEGY', 				'스위스 근위대는 바티칸시티의 고유 용병 유닛으로, [COLOR_POSITIVE_TEXT]자유용병대[ENDCOLOR]와 [COLOR_POSITIVE_TEXT]외인부대[ENDCOLOR] 사이에 위치합니다. 특정 정책 없이 골드 또는 신앙으로 구매할 수 있으며, 구매 이후 즉시 이동 가능합니다. 스위스 근위대는 추가 전투력을 가지며 소유한 도시, 수도, 성도 근처에서 회복합니다. ([COLOR_CYAN]라디오[ENDCOLOR]와 [COLOR_CYAN]통신[ENDCOLOR]) 연구 시 추가 산출을 제공합니다. 퇴보되지 않습니다.' UNION ALL
SELECT 'TXT_KEY_UNIT_SWISS_GUARD_HELP', 					'[COLOR_CYAN]바티칸시티[ENDCOLOR]와 동맹인 문명만이 스위스 근위대를 [ICON_GOLD] 골드 또는 [ICON_PEACE] 신앙으로 구매할 수 있습니다.[NEWLINE][NEWLINE]퇴보되지 않습니다. 동시대의 유닛에 비해 추가 [ICON_STRENGTH] 전투력을 얻습니다. 구입 후 즉시 이동할 수 있습니다.[NEWLINE][NEWLINE]도시 근처에서 적 처치 시 체력을 회복합니다 (일반 도시, 수도, 성도). 신앙 +2를 생성하고, [COLOR_CYAN]Radio[ENDCOLOR]  연구 시 [ICON_PEACE] 문화 +2, [COLOR_CYAN]통신[ENDCOLOR] 연구 시 [ICON_TOURISM] 관광 +2를 생성합니다.' UNION ALL
...
SELECT 'TXT_KEY_UNIT_SISQENO_HELP', 						'[COLOR_CYAN]티와나쿠[ENDCOLOR]와 동맹인 문명만이 시스퀘노를 [ICON_PEACE] 신앙으로 구매할 수 있습니다.[NEWLINE][NEWLINE]선교사를 대체해, 선교사보다 약간 저렴합니다.[NEWLINE][NEWLINE]선교 횟수를 소모하지 않았다면 [COLOR_POSITIVE_TEXT]성큰 가든[ENDCOLOR] 시설을 건설할 수 있습니다.' UNION ALL
...
-- improvements
	...
	SELECT 'TXT_KEY_BUILD_MOUND_HELP', 						'다른 [COLOR_CITY_BROWN]카호키아 마운드[ENDCOLOR]와 인접할 수 없고, [COLOR_GREY]자원[ENDCOLOR] 위에는 건설할 수 없습니다. 도심에 인접해 건설하면 [ICON_GOLDEN_AGE]황금기 점수가 +1 증가합니다. [COLOR_CYAN]고고학[ENDCOLOR] 연구 시 [ICON_RESEARCH] 과학이 +1 증가하고, [COLOR_CYAN]군사과학[ENDCOLOR] 연구 시 [ICON_GREAT_GENERAL] 위대한 장군 포인트가 +1 증가합니다. 마을 또는 소도시에 인접하여 건설하면 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. [ENDCOLOR]와 동맹 관계를 유지해야 건설할 수 있습니다.' UNION ALL
	...
	SELECT 'TXT_KEY_BUILD_SUNK_COURT_HELP', 				'다른 [COLOR_CITY_BROWN]성큰 가든[ENDCOLOR]과 인접할 수 없고, [COLOR_GREY]자원[ENDCOLOR] 위에는 건설할 수 없습니다. 언덕이 없는 [COLOR_CITY_BLUE]평원[ENDCOLOR], [COLOR_CITY_BLUE]툰드라[ENDCOLOR], [COLOR_CITY_BLUE]사막[ENDCOLOR] 타일에만 건설할 수 있습니다. 도시에 인접했다면 [ICON_RESEARCH] 과학 +1, [COLOR_CITY_BLUE]산[ENDCOLOR]에 인접했다면 [ICON_CULTURE] 문화 및 [ICON_PEACE] 신앙 +1, [COLOR_CYAN]고고학[ENDCOLOR] 연구 시 [ICON_TOURISM] 관광 +1, [COLOR_CYAN]레이더[ENDCOLOR] 연구 시 [ICON_RESEARCH] 과학 +1을 제공합니다. [COLOR_CYAN]티와나쿠[ENDCOLOR]와 동맹 관계를 유지해야 건설할 수 있습니다.' UNION ALL
	...
	SELECT 'TXT_KEY_IMPROVEMENT_SUNK_COURT_HELP', 			'티와나쿠와 동맹인 문명만이 이 건축물의 아름다움을 누릴 수 있습니다.' UNION ALL
	-- colossal head
	SELECT 'TXT_KEY_BUILD_BIG_HEAD', 						'거대 두상 건설'  UNION ALL
	SELECT 'TXT_KEY_BUILD_BIG_HEAD_HELP', 					'[COLOR_GREY]자원[ENDCOLOR] 위에는 건설할 수 없고, [COLOR_CITY_GREEN]숲[ENDCOLOR] 또는 [COLOR_CITY_GREEN]정글[ENDCOLOR]이 있는 [COLOR_CITY_BLUE]평원[ENDCOLOR] 혹은 [COLOR_CITY_BLUE]초원[ENDCOLOR]에만 건설할 수 있습니다. 도시 근처에 건설 시 [ICON_GOLDEN_AGE] 황금기 점수 +1, [ICON_RES_STONE] [COLOR_GREY]석재[ENDCOLOR] 또는 [ICON_RES_MARBLE] [COLOR_GREY]대리석[ENDCOLOR]. 인접 시[ICON_PRODUCTION] 생산 +1, [COLOR_CYAN]기계[ENDCOLOR] 연구 시 [ICON_GOLDEN_AGE] 황금기 점수 +2, [COLOR_CYAN]건축[ENDCOLOR] 연구 시 [ICON_RESEARCH] 과학 +3, [COLOR_CYAN]과학이론[ENDCOLOR] 연구 시  [ICON_PRODUCTION] 생산 +2, [COLOR_MAGENTA]뉴딜 정책[ENDCOLOR] 채택 시  [ICON_CULTURE] 문화 +3. [COLOR_CITY_BROWN]거대 두상[ENDCOLOR] 둘 인접 시 [ICON_GOLDEN_AGE] 황금기 점수 +1, [ICON_GREAT_GENERAL] 위대한 장군 포인트 +1, [ICON_GREAT_ADMIRAL] 위대한 제독 포인트 +1을 얻습니다. 인접한 [COLOR_CITY_BROWN]농장[ENDCOLOR], [COLOR_CITY_BROWN]광산[ENDCOLOR], [COLOR_CITY_BROWN]채석장[ENDCOLOR]에게 [ICON_PRODUCTION] 생산 +1를 제공합니다. [COLOR_CYAN]라벤타[ENDCOLOR]와 동맹 관계를 유지해야 건설할 수 있습니다.' UNION ALL
	...
	SELECT 'TXT_KEY_IMPROVEMENT_BIG_HEAD_HELP', 			'라벤타와 동맹인 문명만이 이 건축물의 아름다움을 누릴 수 있습니다.' UNION ALL
	-- monastery
	SELECT 'TXT_KEY_BUILD_MONASTERY', 						'수사원 건설'  UNION ALL
	SELECT 'TXT_KEY_BUILD_MONASTERY_HELP', 					'다른 [COLOR_CITY_BROWN]수사원[ENDCOLOR]에 인접할 수 없습니다. 도시 또는 [COLOR_GREY]자원[ENDCOLOR]에 인접 시 [ICON_PEACE] 신앙 +1, [COLOR_CITY_BLUE]산[ENDCOLOR]에 인접 시 [ICON_PEACE] 신앙 +1, [COLOR_CYAN]과학이론[ENDCOLOR] 연구 시 [ICON_PEACE] 신앙 +1, [COLOR_CYAN]전기[ENDCOLOR] 연구 시 [ICON_PEACE] 신앙 +1을 제공합니다. 인접한 [COLOR_CITY_BROWN]마을[ENDCOLOR], [COLOR_CITY_BROWN]소도시[ENDCOLOR]의 [ICON_PRODUCTION] 생산이 +1 증가합니다. [COLOR_CYAN]카리에스[ENDCOLOR]와 동맹 관계를 유지해야 건설할 수 있습니다..' UNION ALL
	...
	SELECT 'TXT_KEY_IMPROVEMENT_MONASTERY_HELP', 			'카리에스와 동맹인 문명만이 이 건축물의 아름다움을 누릴 수 있습니다.' UNION ALL
	-- totem pole
	SELECT 'TXT_KEY_BUILD_TOTEM_POLE', 						'토템 폴 건설'  UNION ALL
	SELECT 'TXT_KEY_BUILD_TOTEM_POLE_HELP', 				'[COLOR_GREY]자원[ENDCOLOR] 위에는 건설할 수 없습니다. [COLOR_CYAN]나침반[ENDCOLOR] 연구 시 [ICON_PRODUCTION] +1, [COLOR_CYAN]항해술[ENDCOLOR] 연구 시 [ICON_GOLD] 골드 +1. 인접한 [COLOR_CITY_BROWN]토템 폴[ENDCOLOR] 2개마다  [ICON_PRODUCTION] 생산 +2를 제공합니다. 인접한 [COLOR_CITY_BLUE]해안 [ENDCOLOR]타일의 [ICON_CULTURE] 문화가 +1 증가합니다.[COLOR_CYAN]스구앵과이[ENDCOLOR]와 동맹 관계를 유지해야 건설할 수 있습니다.' UNION ALL
	SELECT 'TXT_KEY_IMPROVEMENT_TOTEM_POLE', 				'토템 폴' UNION ALL
	...
	SELECT 'TXT_KEY_IMPROVEMENT_TOTEM_POLE_HELP', 			'스구앵과이와 동맹인 문명만이 이 건축물의 아름다움을 누릴 수 있습니다.' UNION ALL
	-- chum
	SELECT 'TXT_KEY_BUILD_CHUM', 							'첨 건설'  UNION ALL
	SELECT 'TXT_KEY_BUILD_CHUM_HELP', 						'[COLOR_GREY]자원[ENDCOLOR] 위에는 건설할 수 없고, 다른 [COLOR_CITY_BROWN]첨[ENDCOLOR]에 인접할 수 없습니다.[COLOR_GREY]보너스 자원[ENDCOLOR] 인접 시  [ICON_FOOD] 식량 +1, [COLOR_CITY_BROWN]야영지[ENDCOLOR] 또는 [COLOR_CITY_BROWN]목장[ENDCOLOR]에 인접 시  [ICON_PRODUCTION] 생산 +1, [COLOR_CYAN]교육[ENDCOLOR] 연구 시 [ICON_FOOD] 식량 +1, [COLOR_CYAN]비료[ENDCOLOR] 연구 시 [ICON_FOOD] 식량 +1, [COLOR_CYAN]냉동기술[ENDCOLOR] 연구 시 [ICON_PRODUCTION] 생산 +1을 제공합니다.  인접한 [COLOR_CITY_BROWN]야영지[ENDCOLOR] 및 [COLOR_CITY_BROWN]목장[ENDCOLOR]의 [ICON_GOLD] 골드가 +1 증가합니다. [COLOR_CYAN]네네츠[ENDCOLOR]와 동맹 관계를 유지해야 건설할 수 있습니다..' UNION ALL
	...
	SELECT 'TXT_KEY_IMPROVEMENT_CHUM_HELP', 				'네네츠와 동맹인 문명만이 이 건축물의 아름다움을 누릴 수 있습니다.' UNION ALL
	-- dogo canario
	SELECT 'TXT_KEY_BUILD_DOGO_CANARIO', 					'[ICON_RES_DOGO_CANARIO] 도고 카나리오 배치'  UNION ALL
	SELECT 'TXT_KEY_BUILD_DOGO_CANARIO_HELP', 				'[ICON_RES_DOGO_CANARIO] 도고 카나리오를 번식시켜, [COLOR_CITY_BROWN]야영지[ENDCOLOR] 시설을 건설할 수 있게 만들고 근처[COLOR_CITY_BROWN]목장[ENDCOLOR]에 [ICON_FOOD] 식량 +1, [ICON_GOLD] 골드 +1을 제공합니다.' UNION ALL
	...
	SELECT 'TXT_KEY_IMPROVEMENT_DOGO_CANARIO_HELP', 		'아데헤와 동맹인 문명만이 이 강아지의 아름다움을 누릴 수 있습니다.' UNION ALL
-- resources
