print("This is the modded InfoCorner from the 'UI - Map Pins' mod")
...
m_InfoData[ InfoCornerID.MapPins ] = {
    ToolTip="Map Pins",
    Image="assets/UI/Art/Icons/MainStrategicButton.dds",
    HL="assets/UI/Art/Icons/MainStrategicButtonHL.dds" };
