...
('TECH_EE_REFRACTION',  'TXT_KEY_TECH_EE_REFRACTION',  'TXT_KEY_TECH_EE_REFRACTION_DESC',  'TXT_KEY_TECH_EE_REFRACTION_HELP',  'ERA_RENAISSANCE',   1, 8, 5, 'TXT_KEY_TECH_EE_REFRACTION_QUOTE',  34, 'TECH_ATLAS_1', 'AS2D_TECH_EE_REFRACTION',  'AS2D_TECH_EE_REFRACTION');
...
-- more 1 prod from mine earlier because there is now a long time where they are worse than isolated lumbermill
INSERT INTO Improvement_TechYieldChanges 
	(TechType, ImprovementType, YieldType, Yield)
VALUES
	('TECH_EE_FORTIFICATION', 'IMPROVEMENT_MINE', 'YIELD_PRODUCTION', 1);

UPDATE Improvement_TechYieldChanges SET Yield = 1 WHERE ImprovementType = 'IMPROVEMENT_MINE' AND TechType = 'TECH_STEAM_POWER';
...
VALUES
	('TECH_EE_SOVEREIGNTY',	  'SPECIALIST_WRITER',	      'YIELD_CULTURE', 1),
	('TECH_ACOUSTICS',  	  'SPECIALIST_MUSICIAN',      'YIELD_CULTURE', 1),
	('TECH_EE_ROMANTICISM',	  'SPECIALIST_ARTIST',	      'YIELD_CULTURE', 1),
	('TECH_EE_HUMANISM',	  'SPECIALIST_CIVIL_SERVANT', 'YIELD_CULTURE', 1),
	('TECH_CIVIL_SERVICE',	  'SPECIALIST_CIVIL_SERVANT', 'YIELD_GOLD', 1),
