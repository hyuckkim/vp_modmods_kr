...
('UNIT_EE_CUIRASSIER',    'UNITAI_DEFENSE'),
('UNIT_EE_CUIRASSIER',    'UNITAI_FAST_ATTACK'),
...
WHERE Type = 'UNIT_EE_CUIRASSIER';

INSERT INTO Unit_ResourceQuantityRequirements
		(UnitType, ResourceType, Cost)
SELECT 'UNIT_EE_CUIRASSIER', ResourceType, Cost
FROM Unit_ResourceQuantityRequirements WHERE UnitType = 'UNIT_LANCER';

INSERT INTO Unit_FreePromotions
		(UnitType, PromotionType)
SELECT 'UNIT_EE_CUIRASSIER', PromotionType
...
--		(UnitType, PromotionType)
--VALUES
--('UNIT_EE_CUIRASSIER', 'PROMOTION_ANTI_MOUNTED_I');
...
UPDATE Units
SET ObsoleteTech = (SELECT PrereqTech FROM Units WHERE Type = 'UNIT_EE_CUIRASSIER'),
	GoodyHutUpgradeUnitClass = 'UNITCLASS_EE_CUIRASSIER'
WHERE Type = 'UNIT_LANCER';

-- Knight UUs now obsolete on CUIRASSIER
UPDATE Units
SET ObsoleteTech = (SELECT PrereqTech FROM Units WHERE Type = 'UNIT_EE_CUIRASSIER')
WHERE Class = 'UNITCLASS_KNIGHT' AND Type != 'UNIT_KNIGHT';

CREATE TRIGGER EE_CUIRASSIER_KnightCompatibility
AFTER INSERT ON Civilization_UnitClassOverrides
...
-------------------------------------------------------
-- Polish Winged Hussar (replaces Lancer, upgrades to CUIRASSIER)
...
-- Hakkapeliitta
UPDATE Unit_ClassUpgrades SET UnitClassType = 'UNITCLASS_EE_CUIRASSIER' WHERE UnitType = 'UNIT_SWEDISH_HAKKAPELIITTA';
UPDATE Units SET 
...
('UNIT_EE_CUIRASSIER',	'FLAVOR_OFFENSE', 12),
('UNIT_EE_CUIRASSIER',	'FLAVOR_DEFENSE', 4),
('UNIT_EE_CUIRASSIER',	'FLAVOR_MOBILE',  9),
