...
UPDATE Language_ko_KR SET Text = REPLACE(Text, ' {2_InfluenceAnchor}에 있습니다.', ' {2_InfluenceAnchor} [ICON_INFLUENCE] 에 있습니다.') WHERE Tag = 'TXT_KEY_CSTATE_INFLUENCE_RATE';
UPDATE Language_ko_KR SET Text = REPLACE(Text, '일찍.[NEWLINE][NEWLINE]', '일찍.') WHERE Tag = 'TXT_KEY_CSTATE_JERK_STATUS';
UPDATE Language_ko_KR SET Text = REPLACE(Text, '다음으로', '[ICON_BULLET] 다음으로') WHERE Tag = 'TXT_KEY_CSTATE_JERK_STATUS';
UPDATE Language_ko_KR SET Text = REPLACE(Text, '만일 당신이', '[ICON_BULLET] 만일 당신이') WHERE Tag = 'TXT_KEY_CSTATE_JERK_STATUS';
--==========================================================================================================================
-- TEXTS
--==========================================================================================================================	
