...
UPDATE Units SET Combat = 53 WHERE Type = 'UNIT_BRAZIL_AMAZONAS';
UPDATE Units SET Combat = 55 WHERE Type = 'UNIT_AMERICA_MONITOR';
UPDATE Units SET Combat = 60 WHERE Type = 'UNIT_EARLY_DESTROYER';
UPDATE Units SET Combat = 72 WHERE Type = 'UNIT_DESTROYER';
UPDATE Units SET Combat = 78 WHERE Type = 'UNIT_JFD_KAGERO';
UPDATE Units SET Combat = 86 WHERE Type = 'UNIT_MISSILE_DESTROYER';
...
UPDATE Units SET Combat = 95, RangedCombat = 71 WHERE Type = 'UNIT_JAPAN_YAMATO';
...
VALUES
	('PROMOTION_HEAVY_FIRE', 'TXT_KEY_PROMOTION_HEAVY_FIRE', 'TXT_KEY_PROMOTION_HEAVY_FIRE_HELP', 'AS2D_IF_LEVELUP', 1, 1, 28, 'extraPromo_Atlas', 'PEDIA_NAVAL', 'TXT_KEY_PROMOTION_HEAVY_FIRE');
...
VALUES
	...
	('PROMOTION_HEAVY_FIRE', 'UNITCLASS_EARLY_DESTROYER', 50),
	('PROMOTION_HEAVY_FIRE', 'UNITCLASS_DESTROYER', 50),
	('PROMOTION_HEAVY_FIRE', 'UNITCLASS_MISSILE_DESTROYER', 50);
...
UPDATE UnitPromotions SET PromotionPrereqOr2 = 'PROMOTION_BETTER_BOMBARDMENT' WHERE Type = 'PROMOTION_LOGISTICS';
UPDATE UnitPromotions SET PromotionPrereqOr1 = 'PROMOTION_TARGETING_3' WHERE Type = 'PROMOTION_BETTER_BOMBARDMENT';
UPDATE UnitPromotions SET PromotionPrereqOr3 = 'PROMOTION_BOMBARDMENT_3' WHERE Type = 'PROMOTION_TARGETING_4';
