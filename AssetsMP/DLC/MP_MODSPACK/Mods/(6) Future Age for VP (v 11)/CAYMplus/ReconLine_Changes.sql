...
INSERT INTO Unit_FreePromotions
		(UnitType,							PromotionType)
VALUES	('UNIT_COMMANDO','PROMOTION_SAPPER'),
		...
		('UNIT_GREECE_KLEPHT','PROMOTION_SCOUT_GOODY_BONUS'),
...
------------------------------	
/*
DELETE FROM Unit_FreePromotions  WHERE UnitType = 'UNIT_XCOM_SQUAD' AND PromotionType = 'PROMOTION_COMMANDO';
DELETE FROM Unit_FreePromotions  WHERE UnitType = 'UNIT_XCOM_SQUAD' AND PromotionType = 'PROMOTION_IGNORE_TERRAIN_COST';
DELETE FROM Unit_FreePromotions  WHERE UnitType = 'UNIT_XCOM_SQUAD' AND PromotionType = 'PROMOTION_SAPPER';
DELETE FROM Unit_FreePromotions  WHERE UnitType = 'UNIT_XCOM_SQUAD' AND PromotionType = 'PROMOTION_OCEAN_CROSSING';
DELETE FROM Unit_FreePromotions  WHERE UnitType = 'UNIT_XCOM_SQUAD' AND PromotionType = 'PROMOTION_EMBARKED_SIGHT';
DELETE FROM Unit_FreePromotions  WHERE UnitType = 'UNIT_XCOM_SQUAD' AND PromotionType = 'PROMOTION_DEFENSIVE_EMBARKATION';
...
UPDATE Units SET Moves = '3' WHERE Type = 'UNIT_PARATROOPER';
UPDATE Units SET Moves = '3' WHERE Type = 'UNIT_MARINE';
UPDATE Units SET Moves = '3' WHERE Type = 'UNIT_XCOM_SQUAD';
