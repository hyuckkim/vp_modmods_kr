...
('BUILDING_FW_AQUACULTURE_LAB', 		'TECH_QUANTUM_COMPUTERS', 			2750, 'ART_DEF_BUILDING_LABORATORY',         51,'CIV_COLOR_ATLAS_FW_2'),
('BUILDING_FW_SEAWATER_ARTIFICIAL_REEF','TECH_QUANTUM_COMPUTERS',       	2750, 'ART_DEF_FEATURE_REEF',                 1,'NW_ATLAS'),
('BUILDING_FW_UNDERSEA_MINING', 		'TECH_QUANTUM_COMPUTERS', 	        2750, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',     53,'CIV_COLOR_ATLAS_FW_2'),
...
('BUILDING_FW_CYBERPOLICE', 			'TECH_GLOBALIZATION', 				3250, 'ART_DEF_BUILDING_COLOSSEUM',         57,'CIV_COLOR_ATLAS_FW_3'),
('BUILDING_FW_AUTOPLANT', 				'TECH_ROBOTICS', 		            3250, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',     7,'TCS_MOD_ICON_ATLAS'),

('BUILDING_FW_NANOMAT_PLANT', 			'TECH_NANOTECHNOLOGY', 				3250, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',     3,'CIV_COLOR_ATLAS_FW'),
...
('BUILDING_FW_VIRTUAL_MUSEUM', 			'TECH_MEMETICS', 					3500, 'ART_DEF_BUILDING_MUSEUM',              39,'CIV_COLOR_ATLAS_FW_2'),
...
('BUILDING_FW_SPACE_STATION', 			'TECH_ASTRODYNAMICS', 				4250, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',     43,'TCS_MOD_ICON_ATLAS'),
...
('BUILDING_FW_MOON_BASE', 				'TECH_PROMETHEUS_PROGRAM', 			4750, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',     58,'CIV_COLOR_ATLAS_FW_2'),
...
('BUILDING_FW_ALLOY_FOUNDRY', 			'TECH_SMART_MATERIALS', 			5000, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',     13,'CIV_COLOR_ATLAS_FW_2'),
('BUILDING_FW_UTILITY_FOG', 			'TECH_SMART_MATERIALS', 			5000, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',     11,'CIV_COLOR_ATLAS_FW_2'),
...
-- ----------------------------------------------
UPDATE Buildings
SET FreeBuildingThisCity = 'BUILDINGCLASS_FW_SPACE_STATION'
...
VALUES
	...
	('BUILDING_FW_CYBERCLINIC', 			'BUILDINGCLASS_TELEPRESENCE_HUB'),
...
('BUILDING_FW_CLONE_LAB',                'FLAVOR_OEFFENSE',              25),
...
('BUILDING_FW_BIOCONVERTER_ADNF',        'FLAVOR_OEFFENSE',              25),
