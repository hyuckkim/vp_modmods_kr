...
('BUILDING_FW_MOON_BASE', 				'TECH_PROMETHEUS_PROGRAM', 			4750, 'ART_DEF_BUILDING_LABORATORY',         58,'CIV_COLOR_ATLAS_FW_2'),
...
('BUILDINGCLASS_FW_ASTEROID_MINING_1', 	     'BUILDING_FW_FW_ASTEROID_MINING_1',    'TXT_KEY_BUILDING_FW_ASTEROID_MINING_1', 	1),
('BUILDINGCLASS_FW_ASTEROID_MINING_2', 	     'BUILDING_FW_FW_ASTEROID_MINING_2', 	'TXT_KEY_BUILDING_FW_ASTEROID_MINING_2', 	1),
('BUILDINGCLASS_FW_NANOFORGE', 	     		 'BUILDING_FW_NANOFORGE', 	    		'TXT_KEY_BUILDING_FW_NANOFORGE', 			6),
...
-- ----------------------------------------------
UPDATE Buildings
SET GoldMaintenance = 14, DistressFlatReduction = 1, NoUnhappfromXSpecialists = 1,  MutuallyExclusiveGroup = 69231
WHERE Type = 'BUILDING_FW_LAUNCH_FACILITY';

UPDATE Buildings
SET TrainedFreePromotion = 'PROMOTION_FW_SPACESHIP'
WHERE Type = 'BUILDING_FW_LAUNCH_FACILITY' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='MUCfVP-CAYM' AND Value= 1);
-- ----------------------------------------------
-- -- Biofuel Refinery
-- ----------------------------------------------
UPDATE Buildings
...
-- ----------------------------------------------
UPDATE Buildings
SET GoldMaintenance = 14, FoodKept = 10, NoUnhappfromXSpecialists = 2
WHERE Type = 'BUILDING_FW_MYCOPROTEIN_VATS';
-- ----------------------------------------------
-- -- Space Station
-- ----------------------------------------------
UPDATE Buildings
SET NukeImmune = 1, GoldMaintenance = 14, NoUnhappfromXSpecialists = 1, WLTKDTurns = 15, CityAirStrikeDefense = 5, Defense = 500
...
-- ----------------------------------------------
UPDATE Buildings
SET GoldMaintenance = 16, NeverCapture = 1, BoredomFlatReduction = 2, TrainedFreePromotion = 'PROMOTION_FW_BIOMODS'
...
-- ----------------------------------------------
UPDATE Buildings
SET NeverCapture = 1, NukeImmune = 1, NationalPopRequired = 125, SpecialistType = 'SPECIALIST_SCIENTIST', SpecialistCount = 2, Happiness = 3, NoUnhappfromXSpecialists = 2
WHERE Type = 'BUILDING_FW_MOON_BASE';
-- ----------------------------------------------
-- -- Orbital Habitat
-- ----------------------------------------------
UPDATE Buildings
SET GoldMaintenance = 16, NukeImmune = 1, NoUnhappfromXSpecialists = 2, BuildingProductionModifier = 15
...
VALUES
	...
	('BUILDING_FW_CYBERCLINIC', 			'BUILDINGCLASS_MEDICAL_LAB'),
...
VALUES
	...
	('BUILDING_FW_CYBERCLINIC',          'BUILDINGCLASS_MEDICAL_LAB',             'YIELD_SCIENCE',    3),
	('BUILDING_FW_CYBERCLINIC',          'BUILDINGCLASS_FW_TELEPRESENCE_HUB',     'YIELD_SCIENCE',    3),
	...
	('BUILDING_FW_GENOME_PROJECT_1',     'BUILDINGCLASS_LABORATORY',              'YIELD_SCIENCE',    3),
...
('UNIT_FW_HYBRID_DRONE', 		       'BUILDING_FW_TRANSGENIC_NURSERY', 15),
...
('UNIT_FW_HYBRID_DRONE', 		       'BUILDING_FW_ECTOGENESIS_POD',    15),
...
---------------------------------------------------------------
--------------------------------------------------------------
-- Religion: Balace all delted, only improvement change
--------------------------------------------------------------
--------------------------------------------------------------
-- Policies: Balace all delted, only improvement change
---------------------------------------------------------------
------------------------
-- Flavors 
------------------------
...
('BUILDING_FW_AQUACULTURE_LAB',          'FLAVOR_TILE_IMPROVEMENT',		 5),
...
('BUILDING_FW_IMPLANT_CLINIC',           'FLAVOR_GOLD',                 10),
('BUILDING_FW_IMPLANT_CLINIC',           'FLAVOR_CULTURE',              10),
...
('BUILDING_FW_LAUNCH_FACILITY',          'FLAVOR_MILITARY_TRAINING',    25),
('BUILDING_FW_LAUNCH_FACILITY', 	     'FLAVOR_HAPPINESS', 	    	10),
('BUILDING_FW_LAUNCH_FACILITY',          'FLAVOR_SPACESHIP', 		    80),
...
('BUILDING_FW_CYBERCLINIC', 		     'FLAVOR_DEFENSE',               20),
