...
('TXT_KEY_TECH_FW_MEMETICS_HELP','가상훈련장을 건설하여 군사 유닛의 경험치를 빠르게 향상시킬 수 있습니다. 메타버스 박물관을 건설하여 문화와 관광의 산출을 올릴 수 있습니다. 가상 아이돌을 건설할 수 있습니다.'),
...
('TXT_KEY_TECH_FW_IMPLANTS_TITLE','생체의학공학'),
('TXT_KEY_TECH_FW_IMPLANTS_DESC','생체의학공학은 배아줄기세포 연구와 정밀 유전자 편집 기술의 발전을 바탕으로, 손상된 조직과 장기를 유전적으로 재설계하여 맞춤형 치료와 장기 재생을 가능하게 하는 미래 의생명공학입니다. CRISPR-Cas9과 같은 유전자 편집 도구와 줄기세포 배양 기술을 결합함으로써, 특정 질환에 저항성을 가진 세포를 설계하거나, 맞춤형 장기를 실험실에서 배양해 이식하는 것이 현실화되고 있습니다. 이러한 연구는 유전자 치료뿐만 아니라 인간의 질병 취약성을 근본적으로 줄이고, 유전적 특성을 개선하는 데까지 확장되고 있습니다. 이 기술은 단순한 치료를 넘어 인간 생물학의 한계를 재설계하는 새로운 시대를 열어가고 있습니다.'),
('TXT_KEY_TECH_FW_IMPLANTS_HELP','생체의학공학 기술을 통해 유전자 편집 연구소와 배아줄기세포 재생 센터를 이용한 임플란트 시술로를 건설할 수 있으며, 맞춤형 치료를 위한 고급 의료 유닛과 특수 연구 시설을 생산할 수 있습니다. 이를 통해 도시의 식량 산출량증대로 인구 성장에 이점을 제공할 수 있습니다.'),
...
('TXT_KEY_TECH_FW_MECHATRONICS_DESC','생성형 AI는 지식·언어·시각·코드를 실시간으로 생성·결합해 연구와 산업의 개발 주기를 대폭 단축합니다. 사람은 AI와 협업하여 기억력·분석력·창작력이 확장되고, 소수의 팀도 대규모 조직에 맞먹는 생산성을 발휘합니다. 데이터와 모델이 상호강화되는 가속 루프는 신소재 설계, 신약 탐색, 도시 운영, 외교 분석 등 전 영역의 의사결정을 고도화하며, 이를 선점한 문명은 혁신의 속도 자체로 우위를 확보합니다.'),
('TXT_KEY_TECH_FW_MECHATRONICS_HELP','생성형 AI를 통해 네트워크 중심지와 데이터 타워를 건설할 수 있으며, 모든 산출량을 동시에 증가시킵니다. 또한 AI 기반 행정 시스템을 구축하여 도시의 생산성과 외교적 영향력을 높일 수 있습니다. 해양타일에 해상발전기를 건설할 수 있습니다.'),
...
('TXT_KEY_TECH_FW_POWER_SYSTEMS_HELP','지구에너지공학을 통해 심층 시추공과 지구물리 연구소를 건설하여 도시의 에너지 산출량을 대폭 향상시킬 수 있습니다. 또한 첨단 바이오연료 정제공장을 운영하여 식물 자원과 광물 자원을 고효율 에너지원으로 전환할 수 있습니다.'),
...
('TXT_KEY_TECH_FW_EUTHENICS_HELP','생체하이브리드공학을 통해 도시에서 바이오-금속 융합 배양소/추출소를 건설할 수 있습니다. 이 건물은 미래형 전략 자원을 기존 자원에서 추출할 수 있게 합니다. 하이브리드 유닛으로 진화한 공중정찰 유닛 생산이 가능합니다.'),
...
('TXT_KEY_TECH_FW_COGNITIVE_TECH_DESC','통합형 AI는 시각을 넘어 청각·촉각·후각·미각 등 오감 정보를 고정밀 센서로 데이터화하고, 이를 다중모달 모델이 통합·추론하여 현실 환경을 맥락적으로 이해하는 기술입니다. 인지–계획–제어가 하나의 폐루프로 결합되어 실시간 대응과 예측적 제어가 가능해지며, 생성형 AI의 표현력을 실세계 피드백과 결합해 안전성·정확성·적응성이 지속적으로 향상됩니다.'),
('TXT_KEY_TECH_FW_COGNITIVE_TECH_HELP','통합형 AI를 통해 발전한 기술에 의해 휴모노이드 로봇 공장을 건설할 수 있으며, 그에 따른 원격허브 시스템이 강화됩니다.'),
...
('TXT_KEY_TECH_FW_TRANSGENICS_HELP','생명공학센터를 건설해 [ICON_RES_ADN_FUNGUS]제노포자와 폴루스 돌연변이원을 추가로 얻을 수 있습니다. 도시의 과학·식량·생산 산출량이 증가하고, 돌연변이 승급을 지닌 특수 유전자 개조 유닛을 생산할 수 있게 됩니다.'),
...
('TXT_KEY_TECH_FW_NEURAL_INTERFACE_TITLE','신경양자 인터페이스'),
...
('TXT_KEY_TECH_FW_SUPERCONDUCTIVITY_DESC','초전도-플라즈마 에너지 역학은 초전도체의 무저항 전류 전송 능력과 고온 플라즈마 제어 기술을 결합하여 차세대 에너지 시스템을 가능케 한 융합 학문입니다. 초전도체는 강력한 자기장을 손실 없이 유지할 수 있어, 핵융합로 내부의 초고온 플라즈마를 안정적으로 가두는 데 필수적인 역할을 합니다. 이를 통해 안전하고 지속 가능한 핵융합 발전이 실현되었으며, 나아가 고출력 에너지 저장 장치, 자기부상 교통망, 전자기 추진체계 등으로 응용이 확장되었습니다.[NEWLINE]궁극적으로 이 기술은 플라즈마 에너지 응용과 초전도 기반 양자 회로를 연결하여, 우주항공·국방·첨단 산업 전반에 걸쳐 혁신적인 변화를 일으킬 것으로 전망됩니다.'),
('TXT_KEY_TECH_FW_SUPERCONDUCTIVITY_HELP','초전도-플라즈마 에너지 역학을 통해 자기부상 초고속 철도를 건설할 수 있으며, 플라즈마 폭격기와 첨단 전투기를 생산할 수 있습니다. 또한 우주 정거장에 고성능 에너지 모듈을 추가해 장기적 우주 탐사의 기반을 마련할 수 있습니다.'),
...
('TXT_KEY_TECH_FW_CYBERNETICS_HELP','기갑유닛에 대한 파괴력과 빠른 이동력이 장점인 호버탱크와 바다의 조용한 암살자인 레비아탄을 생산할 수 있습니다. 양자접속기와 므네모시네 시설을 건설하여 빠른 승급을 위한 경험치 증가 승급을 얻을 수 있습니다.'),
...
('TXT_KEY_TECH_FW_AI_HELP','스카이넷 세계 불가사의를 건설하여 로봇유닛을 강화할 수 있습니다. 빅브라더 관제소를 건설하여 스파이에 대한 저항을 증가시킵니다. 로봇군단을 생산할 수 있습니다. '),
...
('TXT_KEY_TECH_FW_PROMETHEUS_PROGRAM_HELP', '소행성 채굴 기지를 건설하여 나노물질을 얻으십시오. 아주 강력한 방어유닛인 건담과 정찰유닛인 X-COM을 생산할 수 있습니다. 프로메테우스 프로그램을 통해 과학 승리에 다가갑니다.'),
...
('TXT_KEY_TECH_FW_ADAMANTIUM_HELP','이 기술을 연구하면 궤도에 거주에 필요한 궤도 식량재배시설을 건축하여 [ICON_RESEARCH]과학·[ICON_FOOD]식량·[ICON_PRODUCTION]생산 산출을 향상시킬 수 있습니다. 또한 세계 불가사의인  **우주궤도정제소**를 건설할 수 있습니다. 고순도 정제와 궤도 식량 재배를 통해 [ICON_RES_NANOMAT]나노물질을 얻을 수 있습니다. 도시를 공격하는 적에게 신의 지팡이로 보복을 할 수 있습니다.)'),
...
('TXT_KEY_TECH_FW_TERRAFORMING_DESC','유전자 가속은 진화와 적응 과정을 분자 수준에서 인위적으로 단축하는 차세대 생명과학 기술입니다. 정밀 유전자 편집과 발현 조절, 인공 선택을 결합해 종의 적응 속도를 높이거나 새로운 생물형을 설계하는 데 활용됩니다. 응용 분야는 크게 두 가지로 나뉩니다. 첫째, ‘유전자 강화’를 통해 기존 생명체의 체력·반응·인지 능력을 개선할 수 있으며, 둘째, ‘유전자 창조’를 통해 특정 임무에 특화된 신생 개체를 설계·배양할 수 있습니다.'),
('TXT_KEY_TECH_FW_TERRAFORMING_HELP','이동력이 빠르고 상대방을 괴롭히는 키메라와 궁극의 정찰 유닛인 바이오드론을 생산할 수 있습니다.'),
...
('TXT_KEY_BUILDING_FW_CRYPTOBANK_HELP', '도시의 [ICON_CITIZEN]시민 5명마다 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]암호화폐 거래소[ENDCOLOR]의 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 도시에서 작업하는 소도시와 마을의 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. [NEWLINE][NEWLINE][ICON_GOLD]골드로 유닛을 구매하거나 건물 건설에 투자하는 비용이 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 감소합니다. [NEWLINE][NEWLINE][ICON_GOLD]빈곤에서 오는 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 감소합니다. [NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]서버 허브[ENDCOLOR]와 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]증권 거래소[ENDCOLOR]가 있어야 건설할 수 있습니다.[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]시드 무역 주식회사를 설립하면[ENDCOLOR] [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]3[ENDCOLOR] 증가합니다.'),
...
('TXT_KEY_BUILDING_FW_IMPLANT_CLINIC_HELP', '도시의 [ICON_CITIZEN]시민 10명마다 [ICON_FOOD]식량과 [ICON_PEACE]신앙이 각각 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]VR 훈련장[ENDCOLOR]의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. [NEWLINE]화약유닛을 생산할 때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 제공하고, [COLOR_PLAYER_PURPLE]임플란트[ENDCOLOR]승급을 부여합니다. . [ICON_SILVER_FIST]군사 유닛 보급한도가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. [NEWLINE][NEWLINE][ICON_FOOD]/[ICON_PRODUCTION]낙후에서 오는 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 감소합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]병원[ENDCOLOR]이 있어야 하고 [COLOR_NEGATIVE_TEXT]우주선 발사센터[ENDCOLOR]가 없어야 건설할 수 있습니다.'),
...
('TXT_KEY_BUILDING_FW_LAUNCH_FACILITY_HELP', '도시의 [ICON_CITIZEN]시민 10명마다 [ICON_GOLD]골드와 [ICON_RESEARCH]과학이 각각 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]우주선 공장[ENDCOLOR]의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 도시의 공중 유닛 정원이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. [NEWLINE]정찰유닛을 생산할 때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 제공하고, [COLOR_PLAYER_PURPLE]궤도정찰[ENDCOLOR]승급을 부여합니다. [NEWLINE][NEWLINE][ICON_FOOD]/[ICON_PRODUCTION]낙후, [ICON_URBANIZATION]도시화에서 오는 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]감소합니다. [NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]공장[ENDCOLOR]이 있어야 하고, [COLOR_NEGATIVE_TEXT]임플란트 시술소[ENDCOLOR]가 없어야 건설할 수 있습니다.'),
...
('TXT_KEY_BUILDING_FW_FEEDSITE_HUB_HELP', '도시의 [ICON_VP_WRITER] 작가, [ICON_VP_ARTIST] 음악가,  [ICON_VP_MUSICIAN] 예술가의 [ICON_CULTURE]문화가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 걸작 1개마다 [ICON_CULTURE]문화가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 전역 [ICON_HAPPINESS_1]행복이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR]증가합니다. [NEWLINE][NEWLINE][ICON_CULTURE]무료, [ICON_URBANIZATION]도시화에서 오는 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]씩 감소합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]서버 허브[ENDCOLOR]가 있어야 하고 [COLOR_NEGATIVE_TEXT]유통 허브, 복합도시 허브, 가상현실 허브[ENDCOLOR]가 없어야 건설할 수 있습니다.[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]조르지오 아르미에 기업을 설립하면[ENDCOLOR] [ICON_CULTURE]문화가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다.'),
...
('TXT_KEY_BUILDING_FW_BIOCONVERTER_ADNF_HELP', "[ICON_RES_ADN_FUNGUS]제노포자 [COLOR_POSITIVE_TEXT]5개[ENDCOLOR]를 제공합니다. [NEWLINE][NEWLINE][ICON_RES_NANOMAT]나노물질 [COLOR_NEGATIVE_TEXT]5개[ENDCOLOR]와 [ICON_RES_ALUMINUM]알루미늄 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]가 필요합니다."),
...
('TXT_KEY_BUILDING_FW_DISTRIBUTION_HUB_HELP', '도시에서 작업하는 제조소와 산업단지의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR], [ICON_GOLE]골드가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 도시의 [ICON_VP_ENGINEER] 기술자의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. [NEWLINE][NEWLINE] 도시에 건물을 건설할때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR]제공합니다.[NEWLINE][NEWLINE][ICON_FOOD]/[ICON_PRODUCTION]낙후, [ICON_URBANIZATION]도시화에서 오는 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]씩 감소합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]서버 허브[ENDCOLOR]가 있어야 하고 [COLOR_NEGATIVE_TEXT]정보관리 허브, 복합도시 허브, 가상현실 허브[ENDCOLOR]가 없어야 건설할 수 있습니다.'),
...
('TXT_KEY_BUILDING_FW_ENGINEERING_MODULE_HELP', '[COLOR_YELLOW][ICON_GREAT_ENGINEER]위대한 기술자[ENDCOLOR]가 1명 출현합니다. [NEWLINE] 도시의 [ICON_VP_ENGINEER] 기술자의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]3[ENDCOLOR] 증가합니다.[NEWLINE]전투기유닛과 폭격기 유닛을 생산할 때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 제공합니다.[NEWLINE][NEWLINE][ICON_FOOD]/[ICON_PRODUCTION]낙후, [ICON_URBANIZATION]도시화에서 오는 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]씩 감소합니다.[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]핵무기로 파괴되지 않는 건물입니다.[ENDCOLOR] 도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]우주반사판 전력위성[ENDCOLOR]이 있어야 하고 [COLOR_NEGATIVE_TEXT]라그랑주-상업지구, 라그랑주-연구단지[ENDCOLOR]가 없어야 건설할 수 있습니다.[NEWLINE][NEWLINE][ICON_RES_NANOMAT]나노물질 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]가 필요합니다. '),
...
('TXT_KEY_BUILDING_FW_ECTOGENESIS_POD_HELP', '문명의 총 군사 유닛 10개마다 도시의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]증가합니다.[COLOR:105:105:105:255](상한 200 유닛)[ENDCOLOR][NEWLINE]도시에서 근접, 기마 및 공중정찰 유닛을 생산할 때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR]제공하고, [COLOR_PLAYER_PURPLE]유전자개조 승급[ENDCOLOR]을 부여합니다.[NEWLINE][NEWLINE][ICON_FOOD]/[ICON_PRODUCTION]낙후에서 오는 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR]감소합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]유전자개조 연구소[ENDCOLOR]가 있어야 건설할 수 있습니다.[NEWLINE][NEWLINE][ICON_RES_ADN_FUNGUS]제노포자 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]가 필요합니다. '),
...
('TXT_KEY_BUILDING_FW_BIOMOD_TANK_HELP', '문명의 총 군사 유닛 10개마다 [ICON_GREAT_GENERAL]위대한 장군, [ICON_GREAT_ADMIRAL]위대한제독의 점수가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR], [ICON_GOLDEN_AGE]황금기 점수가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR]씩 증가합니다.[COLOR:105:105:105:255](상한 200 유닛)[ENDCOLOR][NEWLINE]도시에서 화약 유닛을 생산할 때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 제공하고, [COLOR_PLAYER_PURPLE]바이오모드 승급[ENDCOLOR]을 부여합니다.[NEWLINE][NEWLINE][ICON_CULTURE]무료에서 오는 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 감소합니다. [NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]임플란트 시술소[ENDCOLOR]와 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]제노포자 배양 연구소[ENDCOLOR]가 있어야 건설할 수 있습니다.[NEWLINE][NEWLINE][ICON_RES_ADN_FUNGUS]제노포자 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]가 필요합니다.'),
...
-- Cyberclinic
('TXT_KEY_BUILDING_FW_CYBERCLINIC', '양자동기화 접속기'),
('TXT_KEY_BUILDING_FW_CYBERCLINIC_HELP', '[ICON_GREAT_SCIENTIST]위대한 과학자의 출현율이 [COLOR_POSITIVE_TEXT]25%[ENDCOLOR] 증가합니다.[NEWLINE]모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]원격현실허브[ENDCOLOR]의 [ICON_PRODUCTION]생산, [ICON_RESEARCH]과학, [ICON_CULTURE]문화가 각각 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]씩 증가하고 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]바이오 컴퓨터[ENDCOLOR]의 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]4[ENDCOLOR] 증가합니다. 전역 [ICON_HAPPINESS_1]행복이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다.[NEWLINE][NEWLINE]항공모함을 제외한 해상유닛을 생산할 때 [ICON_PRODUCTION]생산 보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 제공합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]원격현실 허브[ENDCOLOR]와 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]바이오 컴퓨터[ENDCOLOR]가 있어야 건설할 수 있습니다.[NEWLINE][NEWLINE][ICON_RES_NANOMAT]나노물질 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]가 필요합니다.'),
('TXT_KEY_BUILDING_FW_CYBERCLINIC_STRATEGY', '양자동기화 접속기는 인체 뇌파를 양자 스캔해 안드로이드 분신으로 전송, 사용자가 직접 원격 아바타처럼 활동할 수 있게 합니다. 사이버 유닛과 해상 병력(항공모함 제외)의 생산 효율을 높이며, 과학 연구와 사회적 역량을 동시에 강화합니다.'),
('TXT_KEY_BUILDING_FW_CYBERCLINIC_PEDIA', '양자동기화 접속기는 발전된 MRI 기술, 뇌파 분석기술이 양자적 정밀도로 뇌 신호를 스캔하면서 탄생했습니다. 사용자의 의식 패턴은 실시간으로 동기화되어, 아바타와 같은 안드로이드 분신을 통해 물리적 제약 없이 활동할 수 있습니다.[NEWLINE][NEWLINE]다만 방대한 양자 정보가 필요해, 현재로서는 지구권 통신 범위 안에서만 안정적인 동기화가 가능합니다. 이 한계에도 불구하고, 사람들은 이제 새로운 육체를 빌려 사회와 모험에 참여할 수 있으며, 이는 노동·연구·군사·일상 전반에서 인류 활동의 지평을 넓혀 주고 있습니다.'),

-- Digital Police
('TXT_KEY_BUILDING_FW_DIGITAL_POLICE', '빅브라더 관제소'),
('TXT_KEY_BUILDING_FW_DIGITAL_POLICE_HELP', '[ICON_SPY] 도시 보안이 +20 증가합니다. [NEWLINE]궁수유닛, 헬리콥터유닛을 생산할 때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 제공합니다.[NEWLINE][NEWLINE][ICON_FOOD]/[ICON_PRODUCTION]낙후, [ICON_GOLD] 빈곤, [ICON_RESEARCH] 문맹, [ICON_CULTURE]무료에서 오는 [ICON_HAPPINESS_3]불행이 각각 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 감소하고, [ICON_URBANIZATION]도시화에서 오는 불행이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR]감소합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]국제치안국[ENDCOLOR]이 있어야 건설할 수 있습니다.'),
...
('TXT_KEY_BUILDING_FW_FUSION_PLANT_HELP', '도시의 모든 전문가들의 [ICON_PRODUCTION]생산, [ICON_GOLD]골드, [ICON_RESEARCH]과학, [ICON_CULTURE]문화 산출량이 각각 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 도시의 [ICON_PRODUCTION]생산을 다른 산출량으로 전환할 때의 효율성이 [COLOR_POSITIVE_TEXT]20%[ENDCOLOR] 증가합니다.도시의 [ICON_GREAT_PEOPLE]위인 출현율이 [COLOR_POSITIVE_TEXT]25%[ENDCOLOR] 증가합니다. 기갑, 공성, 전투기, 폭격기 유닛을 생산할 때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR]제공합니다. [NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]공장[ENDCOLOR]과 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]지구심층 물리연구소[ENDCOLOR]가 있어야 건설할 수 있습니다. [NEWLINE][NEWLINE][ICON_RES_URANIUM]우라늄 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]와 [ICON_RES_NANOMAT]나노물질 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]가 필요합니다.[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]헥손 정유 기업을 설립하면[ENDCOLOR] [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]3[ENDCOLOR] 증가합니다.'),
...
-- Moon Base
('TXT_KEY_BUILDING_FW_MOON_BASE', '소행성 채굴기지'),
('TXT_KEY_BUILDING_FW_MOON_BASE_HELP', '도시의 [ICON_CITIZEN]시민 10명 마다 [ICON_PRODUCTION]생산, [ICON_GOLD]골드, [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]씩 증가합니다. [NEWLINE]화약유닛과 정찰유닛을 생산할 때 [ICONN_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR]제공합니다. [NEWLINE][NEWLINE][ICON_RES_IRON]철과 [ICON_RES_NANOMAT]나노물질 [COLOR_POSITIVE_TEXT]2개[ENDCOLOR]를 제공합니다. [NEWLINE][NEWLINE]도시의 전문가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR]명이 더 이상 [ICON_URBANIZATION]도시화로 인한 불행을 [ICON_HAPPINESS_3] 유발하지 않습니다.[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]핵무기로 파괴되지 않는 건물입니다.[ENDCOLOR] 도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]우주반사판 전력위성[ENDCOLOR]이 있어야 건설할 수 있습니다.'),
('TXT_KEY_BUILDING_FW_MOON_BASE_STRATEGY', '우주 기반 채굴 인프라를 갖추면 자원 수급이 원활해져 장기적인 생산·경제·연구 효율이 개선됩니다. 전자·에너지·우주 라인의 도시와 궁합이 좋습니다.'),
('TXT_KEY_BUILDING_FW_MOON_BASE_PEDIA', '소행성 채굴은 지구 밖에서 직접 자원을 조달하는 인류의 첫 산업 중 하나로, 철·니켈·백금군 금속과 공학용 휘소 물질을 안정적으로 확보해 줍니다. 궤도 정거장·운반선·재처리 모듈로 구성된 채굴 기지는 도시 경제를 다변화하고, 고부가가치 우주 산업의 기반을 제공하며, 장기적으로는 행성 간 확장 전략의 교두보 역할을 합니다.'),
...
('TXT_KEY_BUILDING_FW_ASTEROID_MINING_1_HELP', '[ICON_RES_IRON]철 [COLOR_POSITIVE_TEXT]6개[ENDCOLOR], [ICON_RES_COAL]석탄 [COLOR_POSITIVE_TEXT]3개[ENDCOLOR], [ICON_RES_NANOMAT]나노물질 [COLOR_POSITIVE_TEXT]1개[ENDCOLOR]를 제공합니다.'),
...
('TXT_KEY_BUILDING_FW_ASTEROID_MINING_2', '희귀 합금소재'),
...
INSERT INTO Language_ko_KR (Tag, Text) VALUES
-- 게놈프로젝트
('TXT_KEY_PROCESS_FW_GENOME_PROJECT','생명 유전자지도 네트워크'),
('TXT_KEY_PROCESS_FW_GENOME_PROJECT_HELP','이 도시의 [ICON_PRODUCTION]생산을 생명유전자 지도 네트워크 공헌에 사용합니다.'),
('TXT_KEY_LEAGUE_PROJECT_FW_GENOME_PROJECT','생명 유전자지도 네트워크'),
('TXT_KEY_WONDER_FW_GENOME_PROJECT_HELP','도시의 모든 전문가들의 관련 산출량이 [COLOR_POSITIVE_TEXT]+1[ENDCOLOR] 증가합니다.'),
('TXT_KEY_LEAGUE_PROJECT_FW_GENOME_PROJECT_SPLASH','생명 유전자지도 네트워크는 모든 생명, 유기물 유전자의 이해도를 높이기 위한 게놈(유전체)의 맵을 만드려는 노력의 일환입니다.'),
('TXT_KEY_LEAGUE_PROJECT_REWARD_FW_GENOME_PROJECT_1','연구 교환'),
('TXT_KEY_LEAGUE_PROJECT_REWARD_FW_GENOME_PROJECT_1_HELP','모든 도시의 연구소[ENDCOLOR]의 과학이 +2 증가하고, 의학 연구소의 [ICON_FOOD]식량이 +3 증가합니다.'),
('TXT_KEY_LEAGUE_PROJECT_REWARD_FW_GENOME_PROJECT_2','유전자 치료'),
('TXT_KEY_LEAGUE_PROJECT_REWARD_FW_GENOME_PROJECT_2_HELP','모든 도시의 [ICON_CITIZEN]시민이 +1 증가하고, 유전자공학 연구소의 [ICON_RESEARCH]과학이 +2 증가합니다.'),
('TXT_KEY_LEAGUE_PROJECT_REWARD_FW_GENOME_PROJECT_3','응용 유전체학'),
('TXT_KEY_LEAGUE_PROJECT_REWARD_FW_GENOME_PROJECT_3_HELP','[ICON_CAPITAL]수도에 [COLOR_POSITIVE_TEXT]국제 유전체 컨소시엄[ENDCOLOR] 불가사의가 출현합니다. ({TXT_KEY_WONDER_FW_GENOME_PROJECT_HELP})'),
('TXT_KEY_RESOLUTION_FW_GENOME_PROJECT','생명 유전자지도 네트워크'),
('TXT_KEY_RESOLUTION_FW_GENOME_PROJECT_HELP','[COLOR_POSITIVE_TEXT]생명 유전자 지도 네트워크[ENDCOLOR]를 시작합니다. 프로젝트가 시작되면 도시의 생산 목록에서 해당 프로젝트를 선택해 프로젝트에 기여할 수 있습니다. 프로젝트가 완료되면, 프로젝트에 참여한 문명은 기여한 [ICON_PRODUCTION]생산에 따라 보너스를 받게 됩니다.[NEWLINE][NEWLINE][ICON_TROPHY_GOLD]: {TXT_KEY_LEAGUE_PROJECT_REWARD_FW_GENOME_PROJECT_3_HELP}[NEWLINE][ICON_TROPHY_SILVER]: {TXT_KEY_LEAGUE_PROJECT_REWARD_FW_GENOME_PROJECT_2_HELP}[NEWLINE][ICON_TROPHY_BRONZE]: {TXT_KEY_LEAGUE_PROJECT_REWARD_FW_GENOME_PROJECT_1_HELP}[NEWLINE][NEWLINE][COLOR_RESEARCH_STORED]생명기술 공학[ENDCOLOR]을 연구한 문명이 있어야 안건으로 채택할 수 있습니다.'),
...
('TXT_KEY_WONDER_FW_AI_SINGULARITY_HELP','모든 도시의 전자상거래 서버, 엔터테인먼트, 클라우드 서버, 연구서버의 관련 산출량이 [COLOR_POSITIVE_TEXT]8[ENDCOLOR] 증가합니다. 즉시 원하는 [ICON_GREAT_PEOPLE][COLOR_POSITIVE_TEXT]위인[ENDCOLOR] 1명이 출현합니다.'),
('TXT_KEY_LEAGUE_PROJECT_REWARD_FW_AI_DATANETWORK_1','글로벌 광 통신망'),
...
('TXT_KEY_LEAGUE_PROJECT_REWARD_FW_AI_DATANETWORK_2','글로벌 데이터센터'),
...
('TXT_KEY_LEAGUE_PROJECT_REWARD_FW_AI_DATANETWORK_3','글로벌 데이터센터 허브'),
('TXT_KEY_LEAGUE_PROJECT_REWARD_FW_AI_DATANETWORK_3_HELP','[ICON_CAPITAL]수도에 [COLOR_POSITIVE_TEXT]글로벌 데이터센터 허브[ENDCOLOR] 불가사의가 출현합니다. ({TXT_KEY_WONDER_FW_AI_SINGULARITY_HELP})'),
('TXT_KEY_RESOLUTION_FW_AI_DATANETWORK','국제 데이터네트워크 회의'),
('TXT_KEY_RESOLUTION_FW_AI_DATANETWORK_HELP','[COLOR_POSITIVE_TEXT]국제 데이터센터 네트워크[ENDCOLOR]를 시작합니다. 프로젝트가 시작되면 도시의 생산 목록에서 해당 프로젝트를 선택해 프로젝트에 기여할 수 있습니다. 프로젝트가 완료되면, 기여한 [ICON_PRODUCTION]생산에 따라 보너스를 받게 됩니다.[NEWLINE][NEWLINE][ICON_TROPHY_GOLD]: {TXT_KEY_LEAGUE_PROJECT_REWARD_FW_AI_DATANETWORK_3_HELP}[NEWLINE][ICON_TROPHY_SILVER]: {TXT_KEY_LEAGUE_PROJECT_REWARD_FW_AI_DATANETWORK_2_HELP}[NEWLINE][ICON_TROPHY_BRONZE]: {TXT_KEY_LEAGUE_PROJECT_REWARD_FW_AI_DATANETWORK_1_HELP}[NEWLINE][NEWLINE][COLOR_RESEARCH_STORED]AI:생성형[ENDCOLOR]를 연구한 문명이 있어야 안건으로 채택할 수 있습니다.'),

-- 국제 심층 자원 회의
('TXT_KEY_PROCESS_FW_ASTEROID_MINING','심층 자원 탐사 프로젝트'),
('TXT_KEY_PROCESS_FW_ASTEROID_MINING_HELP','이 도시의 [ICON_PRODUCTION]생산을 심층 자원 탐사 프로젝트 공헌에 사용합니다.'),
('TXT_KEY_LEAGUE_PROJECT_FW_ASTEROID_MINING','국제 심층 자원 회의'),
('TXT_KEY_LEAGUE_PROJECT_FW_ASTEROID_MINING_SPLASH','국제 심층 자원 회의는 지구 심층부와 해저에 존재하는 희귀 금속과 나노 소재를 어떻게 탐사·분배할지 논의하는 국제 협력 프로젝트입니다. 최첨단 나노 드릴과 자원 관리 체계를 통해 자원의 불균형을 줄이고, 미래 산업에 필요한 핵심 소재를 확보합니다.'),
('TXT_KEY_WONDER_FW_ASTEROID_MINING_HELP','[ICON_GREAT_ENGINEER][COLOR_YELLOW]위대한 기술자[ENDCOLOR]가 1명 출현합니다. 모든 나노물질 군수공장의 [ICON_PRODUCTION]생산이과 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]4[ENDCOLOR] 증가합니다.'),
('TXT_KEY_LEAGUE_PROJECT_REWARD_FW_ASTEROID_MINING_1','심층 금속 매장지'),
('TXT_KEY_LEAGUE_PROJECT_REWARD_FW_ASTEROID_MINING_1_HELP','[ICON_RES_IRON]철 [COLOR_POSITIVE_TEXT]6개[ENDCOLOR], [ICON_RES_COAL]석탄 [COLOR_POSITIVE_TEXT]3개[ENDCOLOR], [ICON_RES_NANOMAT]나노물질 [COLOR_POSITIVE_TEXT]1개[ENDCOLOR]를 제공합니다.'),
('TXT_KEY_LEAGUE_PROJECT_REWARD_FW_ASTEROID_MINING_2','희귀 합금소재'),
('TXT_KEY_LEAGUE_PROJECT_REWARD_FW_ASTEROID_MINING_2_HELP','[ICON_RES_ALUMINUM]알루미늄 [COLOR_POSITIVE_TEXT]4개[ENDCOLOR]와 [ICON_RES_NANOMAT]나노물질 [COLOR_POSITIVE_TEXT]3개[ENDCOLOR], [ICON_RES_URANIUM]우라늄 [COLOR_POSITIVE_TEXT]1개[ENDCOLOR]를 제공합니다.'),
('TXT_KEY_LEAGUE_PROJECT_REWARD_FW_ASTEROID_MINING_3','지구 심층 채굴 허브'),
('TXT_KEY_LEAGUE_PROJECT_REWARD_FW_ASTEROID_MINING_3_HELP','[ICON_CAPITAL]수도에 [COLOR_POSITIVE_TEXT]심층 채굴 허브[ENDCOLOR] 불가사의가 출현합니다. ({TXT_KEY_WONDER_FW_ASTEROID_MINING_HELP})'),
('TXT_KEY_RESOLUTION_FW_ASTEROID_MINING','국제 심층 자원 회의'),
('TXT_KEY_RESOLUTION_FW_ASTEROID_MINING_HELP','[COLOR_POSITIVE_TEXT]국제 심층 자원 회의[ENDCOLOR]를 시작합니다. 프로젝트가 시작되면 도시의 생산 목록에서 해당 프로젝트를 선택해 프로젝트에 기여할 수 있습니다. 프로젝트가 완료되면, 참여한 문명은 기여한 [ICON_PRODUCTION]생산에 따라 보상을 받습니다.[NEWLINE][NEWLINE][ICON_TROPHY_GOLD]: {TXT_KEY_LEAGUE_PROJECT_REWARD_FW_ASTEROID_MINING_3_HELP}[NEWLINE][ICON_TROPHY_SILVER]: {TXT_KEY_LEAGUE_PROJECT_REWARD_FW_ASTEROID_MINING_2_HELP}[NEWLINE][ICON_TROPHY_BRONZE]: {TXT_KEY_LEAGUE_PROJECT_REWARD_FW_ASTEROID_MINING_1_HELP}[NEWLINE][NEWLINE][COLOR_RESEARCH_STORED]지구에너지 공학[ENDCOLOR]을 연구한 문명이 있어야 안건으로 채택할 수 있습니다.');
...
('TXT_KEY_BUILDING_FW_NEPHILIM_GENE_TEMPLATE2_HELP', '[COLOR_PLAYER_NETHERLANDS_BACKGROUND]유통 허브[ENDCOLOR]를 무료로 제공합니다. [COLOR_PLAYER_NETHERLANDS_BACKGROUND]복제 연구소[ENDCOLOR]와 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]유전자개조 연구소[ENDCOLOR]의 [ICON_FOOD]식량, [ICON_CULTURE]문화, [ICON_PEACE]신앙이 각각 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. 전역 [ICON_HAPPINESS_1]행복이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR]증가합니다. [NEWLINE][NEWLINE]도시에서 [COLOR_POSITIVE_TEXT]유전자 계열 유닛[ENDCOLOR][COLOR:105:105:105:255](근접, 화약, 기마, 공중정찰, 근접해상, 원거리해상 유닛)[ENDCOLOR]을 생산할 때 [ICON_PRODUCTION]생산 보너스를 얻고, [COLOR_PLAYER_PURPLE]포식 본능[ENDCOLOR] 승급을 부여합니다.[NEWLINE][NEWLINE]도시에 [COLOR_NEGATIVE_TEXT]스카이넷[ENDCOLOR], [COLOR_NEGATIVE_TEXT]우주궤도 정제소[ENDCOLOR]가 없어야 건설할 수 있습니다. 이 불가사의는 전 세계에서 하나만 건설할 수 있는 [COLOR_POSITIVE_TEXT]세계 불가사의[ENDCOLOR]입니다.  [NEWLINE][NEWLINE][ICON_RES_ADN_FUNGUS]제노포자 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]가 필요합니다.'),
...
('TXT_KEY_BUILDING_FW_AI_SINGULARITY_HELP', '모든 도시의 [COLOR_POSITIVE_TEXT]전자상거래 서버, 엔터테인먼트, 클라우드 서버, 연구서버[ENDCOLOR]의 관련 산출량이 [COLOR_POSITIVE_TEXT]8[ENDCOLOR] 증가합니다. 즉시 원하는 [ICON_GREAT_PEOPLE][COLOR_YELLOW]위인[ENDCOLOR] 1명이 출현합니다.[NEWLINE][NEWLINE][COLOR_YELLOW]세계 의회 결의안[ENDCOLOR]으로 비준되어야만 건설할 수 있습니다.'),
...
('TXT_KEY_BUILDING_FW_ASTEROID_MINING_HELP','모든 [COLOR_POSITIVE_TEXT]나노물질 공장[ENDCOLOR]의 [ICON_PRODUCTION]생산과 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]4[ENDCOLOR] 증가합니다.[NEWLINE][NEWLINE][COLOR_YELLOW]세계 의회 결의안[ENDCOLOR]으로 비준되어야만 건설할 수 있습니다.'),
...
-- Units
--===========================
UPDATE Language_ko_KR SET Text = '자주대공포' 
...
UPDATE Language_ko_KR SET Text = '주변에 폭격을 시도하는 적의 비행 유닛을 요격합니다.'
...
UPDATE Language_ko_KR SET Text = '자주포' 
WHERE Tag = 'TXT_KEY_UNIT_ROCKET_ARTILLERY';
UPDATE Language_ko_KR SET Text = '자주포는 포병대보다 훨씬 성능이 좋은 무시무시하게 강력한 공성유닛입니다. 자주포는 적 영토에서 이동력이 감소하지 않으며 자주포보다 공력력이 훨씬 강합니다. 자주포의 시야는 제한적이지만 볼 수 없는 목표도 곡사능력으로 타격할 수 있습니다. 다른대포처럼 자주포는 보병이나 전차의 공격에 약하므로 적절히 유닛으로 보호해야 합니다.'
...
UPDATE Language_ko_KR SET Text = '이 자주포는 1분도 안 되는 시간에 12발의 포탄을 발사하는 고도로 기동성이 뛰어나고 파괴력이 뛰어난 공성 유닛입니다.  높은 연사력으로 미리 적진을 무너뜨리고, 도시를 공략하거나 방어하는 데 매우 주요한 역할을 수행합니다. 자주포에 궤도를 장착해서 기존에 무거운 야포를 가지고 다닐 수 있으며 험지로도 주행이 있어 빠르게 이동할 수 있는 공성유닛이 되었습니다. 아마도 이보다 더 진보된 포는 발사체 안에 자체 추진체가 장착된 체계를 가지고 있게 됩니다.' 
...
('TXT_KEY_UNIT_FW_ORGANIC_MERCENARIES','사이보그 용병'),
('TXT_KEY_UNIT_FW_ENHANCED_MERCENARIES','사이보그 용병'),
...
('TXT_KEY_FW_AEROPLEX_DROP','공중 강하'),
-- 유전자강화
