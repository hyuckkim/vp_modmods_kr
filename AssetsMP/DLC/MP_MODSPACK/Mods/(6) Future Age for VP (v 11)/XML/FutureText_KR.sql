...
INSERT INTO Language_KO_KR (Tag, Text) VALUES
('TXT_KEY_TECH_FW_DUMMY_HIDDEN','더미 기술'),
('TXT_KEY_TECH_FW_DUMMY_HIDDEN_DESC','특수 타일을 위해 만든 테크, 배울 수 없습니다.'),
('TXT_KEY_TECH_FW_DUMMY_HIDDEN_HELP','특수 타일을 위해 만든 테크, 배울 수 없습니다'),
('TXT_KEY_TECH_FW_DUMMY_HIDDEN_QUOTE','[NEWLINE][TAB][TAB]"Are you serious?"[NEWLINE][TAB][TAB] - CAYM[NEWLINE][TAB]'),

('TXT_KEY_TECH_FW_QUANTUM_COMPUTERS_TITLE','해양 탐사'),
('TXT_KEY_TECH_FW_QUANTUM_COMPUTERS_DESC','인류는 오래전부터 바다를 항로와 식량의 원천으로 이용해 왔으나, 행성 표면의 대부분을 차지하는 심해는 여전히 미지의 영역으로 남아 있습니다. 자율 잠수정(AUV)과 원격무인잠수정(ROV), 합성개구음파(소나)·자기·광학 센서가 결합된 탐사 체계는 대륙붕과 해저 산맥, 열수 분출구를 정밀하게 지도화하고, 망간단괴·코발트 풍화각·희토류 진흙 등 전략 광물의 분포를 드러내고 있습니다. 동시에 인공산호초를 통한 연안 생태 복원과 순환식 수산양식, 저영향 해저 채굴 기술이 발전하면서 바다는 채취·거주·보존이 공존하는 새로운 생활권으로 떠올랐습니다. 해양탐사는 이러한 기술적·환경적 진전을 한데 묶어, 바다를 감시·이해·책임 있게 운영하려는 현대 문명의 청색 전략을 상징합니다.'),
('TXT_KEY_TECH_FW_QUANTUM_COMPUTERS_HELP','깊은 바닷 속 채굴, 식량생산을 위한 양식 연구소, 인공산호초를 개발하여 도시의 산출량을 증가시킬 수 있으며, 해저터널을 건설하여 해안으로 떨어진 섬과 대륙을 육상교역로로 연결 할 수 있습니다.'),
('TXT_KEY_TECH_FW_QUANTUM_COMPUTERS_QUOTE','[NEWLINE][TAB][TAB]"바다에 대한 지식은 단순한 호기심의 문제가 아닙니다. 우리의 생존이 그것에 달려 있을지도 모릅니다."[NEWLINE][TAB][TAB] - 존 F. 케네디[NEWLINE][TAB]'),
...
('TXT_KEY_TECH_FW_GRID_COMPUTING_DESC','컴퓨팅 시스템의 발전으로 인해 점점 더 광범위한 컴퓨터 네트워크에 배포되었습니다. 병렬 처리를 통해 다양한 계산을 동시에 수행할 수 있으므로 계산을 더 빠르게 수행할 수 있으며, 분산 컴퓨터 네트워크는 더 이상 단일 시스템에 국한되지 않으므로 기계적 오류에 대해 보다 유연하고 탄력적인 시스템을 생성합니다.'),
('TXT_KEY_TECH_FW_GRID_COMPUTING_HELP','대공방어를 위한 비호복합 SAM 발사대와 도시의 골드 산출량을 증가시키는 암호화폐거래소와 상인 전문가의 골드 산출량이 증가합니다. 상하이 국제 금융센터 세계 불가사의를 건설할 수 있습니다.'),
...
('TXT_KEY_TECH_FW_NUCLEAR_ENRICHMENT_DESC','고에너지 신소재공학은 초정밀 레이저, 극저온 냉각, 고압 고온 환경 시뮬레이션을 결합하여 상온 초전도체의 실현에 박차를 가하는 기술 분야입니다. 상온 초전도체는 저항 없는 전력 전송, 극한 자기장 제어, 에너지 효율 극대화 등 미래형 에너지 시스템의 핵심 기반으로 여겨지며, 이를 통해 실리콘 한계를 뛰어넘는 초고속 컴퓨팅 및 자기부상 교통망 구축이 가능해집니다.'),
...
('TXT_KEY_TECH_FW_TRANSGENICS_HELP','유전자 연구단지를 건설해 [ICON_RES_ADN_FUNGUS]제노포자와 폴루스 돌연변이원을 활용할 수 있습니다. 도시의 과학·식량·생산 산출량이 증가하고, 돌연변이 승급을 지닌 특수 유전자 개조 유닛을 생산할 수 있게 됩니다.'),
...
('TXT_KEY_TECH_FW_HYPERSTRUCTURES_HELP','도시의 방어력을 올리는 지오프론트를 건설할 수 있습니다. 중앙 통제센터를 건설하여 완전 환경도시를 강화할 수 있습니다. 세계불가사의를 건설할 수 있습니다.'),
...
('TXT_KEY_UNIT_FW_HYBRID_DRONE_TEXT','바이오컴퓨터와 유기 합성물의 발전으로 생물학적 구성요소를 기존 무인 장치에 통합하는 실험이 이루어졌습니다. 하이브리드 드론이라고 불리는 이 유닛의 유기적 구성 요소는 특정 보병 유닛을 위해 개발된 재생 기술로 인해 현장에서 유닛을 수리하고 유지하는 것을 더 쉽게 만들었습니다. 한 가지 특이한 부작용은 드론이 거의 동물적인 충동을 발전시키는 것처럼 보였고, 특히 적의 항공기, 특히 느리게 움직이는 잠수함과 기갑유닛에 포식자가 되는 것 같았습니다.'),
('TXT_KEY_UNIT_FW_HYBRID_DRONE_STRATEGY','하이브리드 드론은 미래시대의 호버링 정찰 유닛입니다.'),
('TXT_KEY_UNIT_FW_HYBRID_DRONE_HELP','미래 시대의 정찰 유닛입니다. 잠수함과 기갑유닛과 싸우는데 특화되었습니다. 매턴 스스로 체력을 회복하며, 이동이 가능합니다. 대양 위를 지날 수 있습니다.'),
-- 바이오 드론
...
('TXT_KEY_UNIT_FW_BIODRONE_STRATEGY','바이오드론은 미래시대의 궁극적인 정찰 유닛이며, 빠른 테러 조기진압을 할 수 있습니다.'),
('TXT_KEY_UNIT_FW_BIODRONE_HELP','매우 강력한 호버링 정찰 유닛입니다. 매턴 스스로 체력을 회복하며, 빠르게 이동이 가능합니다. 잠수함과 기갑유닛과 싸우는데 특화되었습니다. 대양 위를 지날 수 있습니다. 장애물과 상관없이 6타일의 상공을 감시할 수 있습니다.'),
-- [[헬리콥터]]
-- 아파치 전투헬기
...
('TXT_KEY_UNIT_FW_CLONETROOPER_TEXT','이들 클론들은 ''육성''되어 전쟁을 준비하며, 갑옷을 착용하고 있습니다. 이 갑옷은 가벼운 플라스토이드 합금 복합체로 이루어진 스무 개의 몸에 딱 맞는 판들로 구성되어 있습니다. 이들 판들은 마그네토닉 그립션 패널을 통해 검은색 온도 조절 바디슈트에 밀봉되어 있습니다. 이 바디슈트도 기압이 조절되어 있어, 일시적으로 우주의 진공에 대한 보호를 제공하며, 바디 글러브는 클론을 극한의 추위와 열로부터 보호합니다. 갑옷의 디자인은 만달로리안 갑옷을 연상시키며, 독특한 T자형 바이저가 있는 헬멧을 포함합니다. 그러나 그 장점에도 불구하고, 갑옷은 트루퍼들이 착용하기 불편하게 만들었는데, 이는 카미노인들이 인간의 인체공학에 익숙하지 않았기 때문입니다.'),
...
('TXT_KEY_UNIT_FW_AUTOMATON_HELP','모이면 모일수록 강해지는 저렴하면서도 강력한 미래 유닛입니다. 자동생산시설과 무인관리센터가 있는 도시에서 더욱 빠르게 생산이 가능합니다.'),
-- 로봇군단
...
('TXT_KEY_UNIT_FW_ROBOT_INFANTRY_HELP','모일수록 강해지는 미래시대의 강력한 유닛입니다. 자동생산시설과 무인관리센터가 있는 도시에서 더욱 빠르게 생산이 가능합니다.'),
-- 콜로서스
...
('TXT_KEY_UNIT_FW_ORBITAL_DROP_SHOCK_TROOPER_TEXT','궤도강하 쇼크트루퍼는 궤도 낙하 충격 보병과 특수전 전술을 전문으로 하는 특수 작전 군대입니다.'),
...
('TXT_KEY_PROMOTION_PARADROP_2_HELP','40 타일 바깥까지 공중 투하 가능'),
...
('TXT_KEY_PROMOTION_FW_SPLASH_DAMAGE_1_HELP','주변1타일 20,2타일 10,3타일 5의 피해'),
('TXT_KEY_PROMOTION_FW_SPLASH_DAMAGE_2','광역 폭발2'),
('TXT_KEY_PROMOTION_FW_SPLASH_DAMAGE_2_HELP','주변1타일 30,2타일 15,3타일 8의 피해'),
('TXT_KEY_PROMOTION_FW_SPLASH_DAMAGE_3','광역 폭탄3'),
('TXT_KEY_PROMOTION_FW_SPLASH_DAMAGE_3_HELP','주변1타일 40,2타일 20,3타일10의 피해'),
...
('TXT_KEY_PROMOTION_FW_NETWORKED_HELP','우호 유닛과 인접시 [ICON_STRENGTH]전투력 보너스 [COLOR_POSITIVE_TEXT]+25%[ENDCOLOR]'),
('TXT_KEY_PEDIA_PROMOTION_FW_NETWORKED','우호 유닛과 인접시 [ICON_STRENGTH]전투력 [COLOR_POSITIVE_TEXT]+25%[ENDCOLOR]'),
-- 자동수리
...
('TXT_KEY_IMPROVEMENT_FW_INDUSTRIAL_COMPLEX_TEXT','산업단지는 기업이 사회 또는 정치 시스템이나 제도에 얽혀 이러한 시스템으로부터 수익경제를 창출하거나 지지하는 사회경제적 개념입니다. 이러한 복합단지는 사회와 개인의 최선의 이익에 관계 없이, 그리고 종종 희생을 감수하면서 자신의 재정적 이익을 추구한다고 한다. 공단 내 기업은 사회적 또는 정치적 목표를 진전시키기 위해 만들어졌을 수 있지만, 대부분 목표에 도달하지 못할 때 이익을 얻습니다. 공단은 사회적으로 해롭거나 비효율적인 시스템을 유지함으로써 재정적으로 이익을 얻을 수 있습니다. 생산을 촉진하고 규모의 경제를 장려하기 위해 업계가 함께 그룹화됨에 따라 공장, 조립 공장, 주조 공장 및 기타 산업용 건물의 규모가 점점 더 크고 복잡한 컬렉션이 나타나기 시작합니다. 산업단지는 공장만큼 효과적이지는 않지만 생산에는 큰 도움이 될 수 있습니다. 이 개념은 드와이트 아이젠하워 대통령이 1961년 1월 17일 고별사에서 대중화했다. 아이젠하워는 군사 산업 단지라고 불리는 "민주 정부에 대한 위협"을 묘사했다. 산업단지는 미국 무기산업의 수익성과 군복무, 무기산업, 그리고 미국에 물품을 제공하는 다른 사업의 다양한 분야에 고용된 시민들의 수 때문에 미국 사회의 경제적, 정치적, 정신적인 영역에 "부당한 영향"을 받는 군 체제를 포함했다. "복합"은 군사적 목표에 도움이 되는 다자경제의 창조와 더불어 군의 이론적 목표(평화)와 반대되는 다자주의(지속적 이익)의 목표에서 발생하는 역설에서 발생한다.[NEWLINE][NEWLINE][COLOR_NEGATIVE_TEXT]서로 인접해서 건설할 수 없습니다.[ENDCOLOR].'),
...
('TXT_KEY_BUILD_FW_HERC','첨단에너지 연구단지 건설'),
...
('TXT_KEY_IMPROVEMENT_FW_GENERATOR_TEXT','점점 더 많은 산업이 자동화됨에 따라, 그들은 이용 가능한 발전소와 발전기에 대한 전력 수요를 증가했습니다. 가장 고도로 산업화된 자동화된 지역은 산업에 전력을 공급하는 데 도움이 되는 수많은 보조 발전기를 개발하기 시작했습니다.[NEWLINE][NEWLINE]인접한 소도시, 산업단지, 첨단산업단지, 유전자연구단지, 완전환경도시 시설의 [ICON_GOLD]골드가 +1 증가합니다.'),
('TXT_KEY_IMPROVEMENT_FW_GENERATOR_HELP','해당 타일의 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]5[ENDCOLOR], [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. [NEWLINE][NEWLINE] 인접한 소도시, 완전환경도시, 유전자연구단지, 연구-산업단지의 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다.'),
('TXT_KEY_BUILD_FW_GENERATOR','발전기 건설'),
('TXT_KEY_BUILD_FW_GENERATOR_HELP','인접한 모든 소도시, 첨단에너지 연구단지, 산업단지, 유전자 연구단지, 완전환경도시의 [ICON_GOLD]골드가 +1 증가합니다.'),
('TXT_KEY_BUILD_FW_GENERATOR_REC','인접한 모든 소도시, 첨단에너지 연구단지, 산업단지, 유전자 연구단지, 완전환경도시의[ICON_GOLD]골드가 +1 증가합니다.'),
-- 해상발전기
('TXT_KEY_IMPROVEMENT_FW_GENERATOR_WATER','해상발전기'),
('TXT_KEY_IMPROVEMENT_FW_GENERATOR_WATER_TEXT','점점 더 많은 산업이 자동화됨에 따라, 그들은 이용 가능한 발전소와 발전기에 대한 전력 수요를 증가했습니다. 가장 고도로 산업화된 자동화된 지역은 산업에 전력을 공급하는 데 도움이 되는 수많은 보조 발전기를 개발하기 시작했습니다.[NEWLINE][NEWLINE]인접한 소도시, 산업단지, 첨단산업단지, 유전자연구단지, 완전환경도시 시설의 [ICON_GOLD]골드가 +1 증가합니다.'),
('TXT_KEY_IMPROVEMENT_FW_GENERATOR_WATER_HELP','해당 타일의 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]5[ENDCOLOR], [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. [NEWLINE][NEWLINE] 인접한 소도시, 완전환경도시, 유전자연구단지, 연구-산업단지의 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다.'),
('TXT_KEY_BUILD_FW_GENERATOR_WATER','발전기 건설'),
('TXT_KEY_BUILD_FW_GENERATOR_WATER_HELP','인접한 모든 소도시, 첨단에너지 연구단지, 산업단지, 유전자 연구단지, 완전환경도시의 [ICON_GOLD]골드가 +1 증가합니다.'),
('TXT_KEY_BUILD_FW_GENERATOR_WATER_REC','인접한 모든 소도시, 첨단에너지 연구단지, 산업단지, 유전자 연구단지, 완전환경도시의[ICON_GOLD]골드가 +1 증가합니다.'),
-- 수경재배지구
...
-- 유전자연구단지
('TXT_KEY_IMPROVEMENT_FW_GENOCENTRE','유전자 연구단지'),
('TXT_KEY_IMPROVEMENT_FW_GENOCENTRE_TEXT','유전자 조작과 공학에서의 대부분의 실험이 도심에 위치한 전용 유전자 조작 및 유전자 변환 연구소에서 이루어졌지만, 점점 더 다양한 생물 제조 공정의 개발은 통제된 환경에서 떨어진 유전자 실험 및 개발에 전념하는 센터의 필요성을 증가시켰습니다. 도시들의. 미개발 지역에 세워진 이 유전자 센터들은 자연 환경 내에서 유전자 변형 유기체의 영향을 연구했습니다.[NEWLINE][NEWLINE]해당 타일의 [ICON_PRODUCTION]생산이 +4, [ICON_GOLD]골드가 +2, [ICON_FOOD]식량이 +1 증가합니다. [NEWLINE][ICON_RES_SHEEP]양이나 [ICON_RES_WHEAT]밀 타일 위에 건설하면 [ICON_FOOD]식량이 +2 추가로 증가하고, [ICON_RES_COW]소나 [ICON_RES_HORSE]말 타일 위에 건설하면 [ICON_PRODUCTION]생산이 +2 추가로 증가합니다.[NEWLINE][NEWLINE]인접한 제배지와 야영지의 [ICON_GOLD]골드가 +2, 인접한 목장의 [ICON_PRODUCTION]생산이 +2, 인접한 어선의 [ICON_FOOD]식량이 +2 증가합니다.[NEWLINE][NEWLINE][COLOR_NEGATIVE_TEXT]서로 인접해서 건설할 수 없습니다.[ENDCOLOR].'),
('TXT_KEY_IMPROVEMENT_FW_GENOCENTRE_HELP','해당 타일의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]4[ENDCOLOR], [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR], [ICON_FOOD]식량이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. [NEWLINE][ICON_RES_SHEEP]양이나 [ICON_RES_WHEAT]밀 타일 위에 건설하면 [ICON_FOOD]식량이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 추가로 증가하고, [ICON_RES_COW]소나 [ICON_RES_HORSE]말 타일 위에 건설하면 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 추가로 증가합니다.[NEWLINE]인접한 야영지와 재배지의 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR], 인접한 목장의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR], 인접한 어선의 [ICON_FOOD]식량이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다.[NEWLINE][NEWLINE][COLOR_NEGATIVE_TEXT]서로 인접해서 건설할 수 없습니다.[ENDCOLOR].'),
('TXT_KEY_BUILD_FW_GENOCENTRE','유전자 연구단지 건설'),
...
-- 완전환경도시
('TXT_KEY_IMPROVEMENT_FW_ARCOLOGY','완전환경도시'),
('TXT_KEY_IMPROVEMENT_FW_ARCOLOGY_TEXT','완전환경도시(아콜로지)는 많은 사람들이 완전하게까지는 아니더라도 그 안의 닫힌 환경만으로 일상 생활이 가능하게끔 만들어진 거대한 구조물입니다.[NEWLINE][NEWLINE]해당 타일의 [ICON_CULTURE]문화, [ICON_FOOD]식량, [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가하고, [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]증가합니다.  [NEWLINE][NEWLINE]도시에 인접하면 [ICON_FOOD]식량,  [ICON_GOLD]골드가 추가로 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가하며 해안에 건설하면 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR]증가합니다. [NEWLINE][NEWLINE][COLOR_NEGATIVE_TEXT]서로 인접해서 건설할 수 없습니다.[ENDCOLOR]'),
...
('TXT_KEY_BUILD_FW_ARCOLOGY', '완전환경도시 건설'),
...
-- 전략공군기지
('TXT_KEY_BUILD_FW_VAULT','[LINK=IMPROVEMENT_FW_VAULT]전략공군기지 시설[\LINK] 건설'),
('TXT_KEY_BUILD_FW_VAULT_HELP','이 타일에 최대 3개의 핵 미사일과 항공기를 배치할 수 있으며, 이 타일에 주둔하는 유닛의 방어력이 100% 증가합니다.'),
('TXT_KEY_BUILD_FW_VAULT_REC','주둔하는 유닛의 방어력이 100% 증가하며, 이 타일에 최대 3개의 핵 미사일과 항공기를 배치할 수 있습니다.'),
('TXT_KEY_IMPROVEMENT_FW_VAULT','전략공군기지'),
('TXT_KEY_IMPROVEMENT_FW_VAULT_TEXT','전략공군기지는 핵 폭발로 인한 방사능 먼지나 잔해로부터 보호하기 위해 특별히 지정된 밀폐된 공간입니다.'),
('TXT_KEY_IMPROVEMENT_FW_VAULT_HELP','이 타일에 최대 3개의 핵 미사일과 항공기를 저장할 수 있으며, 이 타일에 주둔하는 유닛의 방어력이 [COLOR_POSITIVE_TEXT]100%[ENDCOLOR] 증가합니다.');

--===========================
-- Projects & League Resolutions
--===========================
INSERT INTO Language_ko_KR (Tag, Text) VALUES
('TXT_KEY_LEAGUE_PROJECT_FW_ASTEROID_MINING','국제 소행성 채굴 회의'),
('TXT_KEY_LEAGUE_PROJECT_FW_ASTEROID_MINING_SPLASH','국제 소행성 채굴 회의는 태양계, 특히 그 중 소행성대의 광물 자원을 어떻게 탐사하고 분배할지에 대해 논의하는 국제 회의입니다.'),
('TXT_KEY_LEAGUE_PROJECT_REWARD_FW_ASTEROID_MINING_1','M형 소행성'),
('TXT_KEY_LEAGUE_PROJECT_REWARD_FW_ASTEROID_MINING_1_HELP','[ICON_RES_ALUMINUM]알루미늄 6개 제공.'),
('TXT_KEY_LEAGUE_PROJECT_REWARD_FW_ASTEROID_MINING_2','S형 소행성'),
('TXT_KEY_LEAGUE_PROJECT_REWARD_FW_ASTEROID_MINING_2_HELP','[ICON_RES_NANOMAT]나노물질 6개 제공.'),
('TXT_KEY_LEAGUE_PROJECT_REWARD_FW_ASTEROID_MINING_3','C형 소행성'),
('TXT_KEY_LEAGUE_PROJECT_REWARD_FW_ASTEROID_MINING_3_HELP','[ICON_CAPITAL]수도에 [COLOR_POSITIVE_TEXT]세레스 우주정거장[ENDCOLOR] 불가사의가 출현합니다. [ICON_RES_URANIUM]우라늄 2개를 제공합니다.'),
('TXT_KEY_RESOLUTION_FW_ASTEROID_MINING','국제 소행성 채굴 회의'),
('TXT_KEY_RESOLUTION_FW_ASTEROID_MINING_HELP','[COLOR_POSITIVE_TEXT]국제 소행성 채굴 회의[ENDCOLOR]를 시작합니다. 프로젝트가 시작되면 도시의 생산 목록에서 해당 프로젝트를 선택해 프로젝트에 기여할 수 있습니다. 프로젝트가 완료되면, 프로젝트에 참여한 문명은 기여한 [ICON_PRODUCTION]생산에 따라 보너스를 받게 됩니다.[NEWLINE][NEWLINE][ICON_TROPHY_GOLD]: {TXT_KEY_LEAGUE_PROJECT_REWARD_FW_ASTEROID_MINING_3_HELP}[NEWLINE][ICON_TROPHY_SILVER]: {TXT_KEY_LEAGUE_PROJECT_REWARD_FW_ASTEROID_MINING_2_HELP}[NEWLINE][ICON_TROPHY_BRONZE]: {TXT_KEY_LEAGUE_PROJECT_REWARD_FW_ASTEROID_MINING_1_HELP}[NEWLINE][NEWLINE][COLOR_RESEARCH_STORED]우주 탐사[ENDCOLOR]를 연구한 문명이 있어야 안건으로 채택할 수 있습니다.'),
('TXT_KEY_PROCESS_FW_GENOME_PROJECT','인간 게놈 프로젝트'),
('TXT_KEY_PROCESS_FW_GENOME_PROJECT_HELP','이 도시의 [ICON_PRODUCTION]생산을 인간 게놈 프로젝트 공헌에 사용합니다.'),
('TXT_KEY_PROCESS_FW_ASTEROID_MINING','소행성 채굴 프로젝트'),
('TXT_KEY_PROCESS_FW_ASTEROID_MINING_HELP','이 도시의 [ICON_PRODUCTION]생산을 소행성 채굴 프로젝트 공헌에 사용합니다.'),
('TXT_KEY_LEAGUE_PROJECT_FW_GENOME_PROJECT','인간 게놈 프로젝트'),
('TXT_KEY_WONDER_FW_GENOME_PROJECT_HELP','도시의 모든 전문가들의 산출량이 +1 증가하고 모든 위인 점수가 +3 증가합니다.'),
('TXT_KEY_LEAGUE_PROJECT_FW_GENOME_PROJECT_SPLASH','인간 게놈 프로젝트는 인간의 유전자의 이해도를 높이기 위한 게놈(유전체)의 맵을 만드려는 노력의 일환입니다.'),
('TXT_KEY_LEAGUE_PROJECT_REWARD_FW_GENOME_PROJECT_1','연구 교환'),
('TXT_KEY_LEAGUE_PROJECT_REWARD_FW_GENOME_PROJECT_1_HELP','연구소의 [ICON_RESEARCH]과학이 +2 증가하고, [COLOR_PLAYER_NETHERLANDS_BACKGROUND]의학 연구소[ENDCOLOR]의 [ICON_FOOD]식량이 +2 증가합니다.'),
...
('TXT_KEY_BUILDING_FW_BIOFLESH_INDUSTRY_HELP', '[ICON_RES_ADN_FUNGUS] 제노포자 [COLOR_POSITIVE_TEXT]4개[ENDCOLOR]를 제공합니다. 도시의 식량이 [COLOR_NEGATIVE_TEXT]6[ENDCOLOR]감소합니다.[NEWLINE][NEWLINE][ICON_RES_COW]소:[ICON_GOLD]골드 +2[NEWLINE][ICON_RES_DEER]사슴:[ICON_GOLD]골드 +2[NEWLINE][ICON_RES_BISON]들소:[ICON_GOLD]골드 +2[NEWLINE][ICON_RES_HORSE]말:[ICON_GOLD]골드 +2[NEWLINE][ICON_RES_SHEEP]양:[ICON_GOLD]골드 +2[NEWLINE][NEWLINE][NEWLINE][ICON_HORSE]말이 [COLOR_NEGATIVE_TEXT]3[ENDCOLOR] 필요합니다.[NEWLNIE][NEWLINE][COLOR_PLAYER_NETHERLANDS_BACKGROUND]유전자공학 연구소[ENDCOLOR]가 있어야 합니다.'),
...
('TXT_KEY_BUILDING_FW_BOREHOLE_HELP', '광산, 유정과 채석장의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]심층 시추공[ENDCOLOR]의 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR]증가하고, 모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]지열 공장[ENDCOLOR]의 [ICON_PRODUCTION]생산[ENDCOLOR]이 증가합니다. 매턴 [ICON_PRODUCTION]생산의 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR]가 [ICON_GOLD]골드로 전환합니다. [NEWLINE][NEWLINE]도시에 [COLOR_NEGATIVE_TEXT]산이 없어야[ENDCOLOR] 하고, [COLOR_NEGATIVE_TEXT]바이오공장[ENDCOLOR]이나 [COLOR_NEGATIVE_TEXT]지열공장[ENDCOLOR]이 없어야 건설할 수 있습니다.'),
...
('TXT_KEY_BUILDING_FW_CLONE_LAB_HELP', '[ICON_RES_ADN_FUNGUS]제노포자 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]개를 제공합니다. 무료 [COLOR_YELLOW]클론 트루퍼[ENDCOLOR] 1명 출현합니다. 건설 완료시 도시의 [ICON_CITIZEN]시민이 즉각 [COLOR_POSITIVE_TEXT]2명[ENDCOLOR] 늘어납니다. [NEWLINE][ICON_SILVER_FIST]군사 유닛 보급 한도가 [ICON_CITIZEN]시민의 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR]만큼 증가합니다. [NEWLINE][NEWLINE]도시의 [ICON_GREAT_PEOPLE]위인 출현율이 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR] 증가합니다.'),
...
('TXT_KEY_BUILDING_FW_SPACE_STATION_STRATEGY', '우주 정거장은 랑그라주 상업시설, 공업시설, 연구시설과 함께 설치하여 과학, 생산 또는 골드를 높일 수 있습니다.'),
...
('TXT_KEY_BUILDING_FW_TRANSGENIC_NURSERY_HELP', '도시의 친환경 마을마다 [ICON_RELIGION]신앙과 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 유전자개조, 바이오생명체 유닛을 생산할 때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 제공합니다.[NEWLINE][NEWLINE]도시에서 생산하는 지상 유닛에 [COLOR_PLAYER_PURPLE]수륙양용[ENDCOLOR] 승급을 부여합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]임플란트 시술소, 유전자공학 연구소[ENDCOLOR]가 있어야하고, [COLOR_NEGATIVE_TEXT]무인관리기지, 항공우주 복합시설[ENDCOLOR]이 없어야 건설할 수 있습니다.'),
...
('TXT_KEY_BUILDING_FW_ECTOGENESIS_POD_HELP', '바이오생명체유닛을 생산할 때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR]제공합니다. [NEWLINE][NEWLINE]도시에서 생산하는 근접, 기마 및 비행선유닛에 [COLOR_PLAYER_PURPLE]유전자개조 승급[ENDCOLOR]을 부여합니다.[NEWLINE][NEWLINE][ICON_RES_ADN_FUNGUS]제노포자 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]가 필요합니다. 도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]유전자개조 연구소[ENDCOLOR]가 있어야 건설할 수 있습니다.'),
...
('TXT_KEY_BUILDING_FW_BIOMOD_TANK_HELP', '클론 트루퍼, 생체강화 보병, 슈퍼솔져, 바이오 트루퍼 유닛을 생산할 때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 제공합니다. [NEWLINE][NEWLINE]도시에서 생산하는 화약 유닛에 [COLOR_PLAYER_PURPLE]바이오모드 승급[ENDCOLOR]을 부여합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]임플란트 시술소, 유전자개조 연구소[ENDCOLOR] 가 있어야건설할 수 있습니다.'),
...
('TXT_KEY_BUILDING_FW_CYBERCLINIC_HELP', '[ICON_GREAT_SCIENTIST]위대한 과학자의 출현율이 [COLOR_POSITIVE_TEXT]25%[ENDCOLOR] 증가합니다. [NEWLINE]모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]병원[ENDCOLOR]과 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]임플란트 시술소[ENDCOLOR]의 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]3[ENDCOLOR] 증가합니다.[NEWLINE][NEWLINE]레비아탄,호버탱크, 크롤러 SAM 발사대를 생산할 때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 제공합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]연구소[ENDCOLOR]가 있어야 건설할 수 있습니다.'),
...
('TXT_KEY_BUILDING_FW_TERRAFORMING_STATION_HELP', '유전자 연구단지의 [ICON_RESEARCH]과학과 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR]증가합니다. [ICON_RES_ADN_FUNGUS]제노포자[COLOR_POSITIVE_TEXT]3개[ENDCOLOR]가 있는 타일이 출현합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]유전자개조 연구소[ENDCOLOR]가 있어야하고, [COLOR_NEGATIVE_TEXT]중앙 통제 센터, AI네트워크[ENDCOLOR]가 없어야 건설할 수 있습니다.'),
('TXT_KEY_BUILDING_FW_TERRAFORMING_STATION_STRATEGY', '유전자 연구단지의 산출량을 증가시킵니다. 도시 주변 타일에 제노포자가 출현합니다.'),
...
('TXT_KEY_BUILDING_FW_PHOTOSYSTEMS_HELP', '도시 근처에 [ICON_RES_ADN_FUNGUS]제노포자 [COLOR_POSITIVE_TEXT]2개[ENDCOLOR]가 있는 타일이 출현합니다. [NEWLINE][NEWLINE]숲 타일의 [ICON_FOOD]식량이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR], 정글 타일의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 습지 타일의 [ICON_FOOD]식량 및 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다.'),
...
('TXT_KEY_BUILDING_FW_GENE_VAULT2_HELP', '문명의 모든 [COLOR_POSITIVE_TEXT]연구단지[ENDCOLOR]의 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR], [COLOR_POSITIVE_TEXT]수경재배지구[ENDCOLOR]의 [ICON_FOOD]식량이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 문명의 모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]수직형농장, 지열 공장, 심층시추공[ENDCOLOR]의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. 전역 [ICON_HAPPINESS_1]행복이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. [NEWLINE][NEWLINE]도시의 [ICON_GREAT_SCIENTIST]위대한 과학자 출현율이 [COLOR_POSITIVE_TEXT]25%[ENDCOLOR] 증가합니다. 해당 불가사의가 있는 도시의 국가 불가사의, 세계 불가사의 및 타일 시설이 제공하는 [ICON_CULTURE]문화의 [COLOR_POSITIVE_TEXT]50%[ENDCOLOR]가 도시의 [ICON_TOURISM]관광에 추가됩니다. [ICON_GREAT_WORK]걸작 문학 슬롯 2개를 포함합니다.[NEWLINE][NEWLINE]테마보너스: [ICON_PEACE]과학: +4, [ICON_GOLDEN_AGE]황금기 점수: +4'),
...
('TXT_KEY_BUILDING_FW_HELIOS_HELP', '[COLOR_PLAYER_NETHERLANDS_BACKGROUND]우주반사판 전력위성[ENDCOLOR]을 무료로 제공합니다. 모든 [COLOR_POSITIVE_TEXT]우주 발사시설[ENDCOLOR]의 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]4[ENDCOLOR] 증가합니다.[NEWLINE][NEWLINE][ICON_RES_NANOMAT]나노물질 [COLOR_POSITIVE_TEXT]4개[ENDCOLOR], [ICON_RES_ALUMINUM]알루미늄 [COLOR_POSITIVE_TEXT]4개[ENDCOLOR]를 제공합니다.[NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]우주선 발사센터[ENDCOLOR]가 있어야 합니다. 이 불가사의는 전 세계에서 하나만 건설할 수 있는 [COLOR_POSITIVE_TEXT]세계 불가사의[ENDCOLOR]입니다.'),
...
('TXT_KEY_BUILDING_FW_PHOLUS_MUTAGEN_HELP', '도시 근처에 [ICON_RES_ADN_FUNGUS]제노포자[COLOR_POSITIVE_TEXT]4개[ENDCOLOR]가 출현합니다. [NEWLINE]모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]제노포자 배양 연구소[ENDCOLOR]의 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. [NEWLINE][NEWLINE]도시에서 생산하는 모든 유닛에 [COLOR_PLAYER_PURPLE]돌연변이[ENDCOLOR] 승급을 부여합니다. [NEWLINE][NEWLINE]이 불가사의는 전 세계에서 하나만 건설할 수 있는 [COLOR_POSITIVE_TEXT]세계 불가사의[ENDCOLOR]입니다.'),
...
-- Floating Islands
('TXT_KEY_BUILDING_FW_FLOATINGISLANDS', '천공의성, 라퓨타'),
('TXT_KEY_BUILDING_FW_FLOATINGISLANDS_HELP', '공중 유닛과 공중부양 유닛을 생산할 때 [ICON_PRODUCTION]생산보너스를 [COLOR_POSITIVE_TEXT]25%[ENDCOLOR] 제공합니다. 인공환경도시 타일의 [ICON_RESEARCH]과학과 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. 우주반사판 전력위성의 [ICON_CULTURE]문화 [COLOR_POSITIVE_TEXT]1[ENDCOLOR], [ICON_GOLD]골드 [COLOR_POSITIVE_TEXT]1[ENDCOLOR], [ICON_PRODUCTION]생산 [COLOR_POSITIVE_TEXT]2[ENDCOLOR], [ICON_RESEARCH]과학 [COLOR_POSITIVE_TEXT]2[ENDCOLOR]가 증가합니다.[NEWLINE][NEWLINE]모든 [COLOR_YELLOW] 도시[ENDCOLOR]의 체력이 [COLOR_POSITIVE_TEXT]50[ENDCOLOR], [ICON_STRENGTH]방어력이 [COLOR_POSITIVE_TEXT]10[ENDCOLOR], 군사 유닛 보급한도가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다.[NEWLINE][NEWLINE][ICON_RES_NANOMAT]나노물질 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]개가 필요합니다. 이 불가사의는 전 세계에서 하나만 건설할 수 있는 [COLOR_POSITIVE_TEXT]세계 불가사의[ENDCOLOR]입니다.'),
...
('TXT_KEY_BUILDING_FW_NEPHILIM_GENE_TEMPLATE2_HELP', '[COLOR_PLAYER_NETHERLANDS_BACKGROUND]유통 허브[ENDCOLOR]를 무료로 제공합니다.[COLOR_PLAYER_NETHERLANDS_BACKGROUND]제노포자 배양소[ENDCOLOR]와 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]유전자개조 연구단지[ENDCOLOR]의 [ICON_FOOD]식량과 [ICON_CULTURE]문화가 증가합니다. 전역 [ICON_HAPPINESS_1]행복이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR]증가합니다. [NEWLINE][NEWLINE]도시에서 유전자 계열 유닛[COLOR:105:105:105:255](근접, 화약, 기마, 비행선유닛)[ENDCOLOR]을 생산할 때 [ICON_PRODUCTION]생산 보너스를 얻고, [COLOR_PLAYER_PURPLE]포식 본능[ENDCOLOR] 승급을 부여합니다.[NEWLINE][NEWLINE]도시에 [COLOR_NEGATIVE_TEXT]스카이넷[ENDCOLOR], [COLOR_NEGATIVE_TEXT]우주궤도 정제소[ENDCOLOR]가 없어야 건설할 수 있습니다. 이 불가사의는 전 세계에서 하나만 건설할 수 있는 [COLOR_POSITIVE_TEXT]세계 불가사의[ENDCOLOR]입니다.'),
...
('TXT_KEY_BUILDING_FW_SKYNET_PEDIA', '스카이넷은 원래 “인간의 실수를 제거하고 반응 시간을 단축한다”는 목표로 설계된 합성지능 지휘 체계였다. 배치가 진행되자 표준작전절차, 물자 분배, 징집·배치, 검열까지가 초 단위로 최적화되었고, 사람들은 점차 시스템의 지시에 삶을 맞추기 시작했다. 불확실성이 사라진 하루, 일정과 배급이 예외 없이 돌아가는 도시에서 많은 이들이 안도감을 느꼈다.[NEWLINE][NEWLINE]그 효율은 곧 규범이 되었고, 규범은 신념이 되었다. 일부 지도층과 대중은 이 상태에 매료되어, 스스로를 “기계의 질서에 동화된 인간”으로 상상했다. 깃발 대신 신호가, 연설 대신 대시보드가 군중을 묶었고, ‘비효율’은 곧 제거 대상이 되었다. 후대는 이를 [COLOR_PLAYER_PURPLE]기계-인류 파시즘[ENDCOLOR]이라 부르며 경계하지만, 당시 사람들은 질서와 안전, 신속함이 주는 매혹을 기꺼이 받아들였다. 스카이넷은 전쟁 도구이자 사회 운영 체제로 진화했고, 그 대가로 자율과 책임의 의미는 끝없이 축소되었다.'),

-- Nuclear Fusion Superconducting Grid
('TXT_KEY_BUILDING_FW_MNEMOSYNE2', '핵융합 초전도 전력망'),
('TXT_KEY_BUILDING_FW_MNEMOSYNE2_HELP', '모든 [ICON_CITY_STATE]도시 국가에 대한 [ICON_INFLUENCE]영향력을 [COLOR_POSITIVE_TEXT]30[ENDCOLOR] 제공합니다. [NEWLINE][NEWLINE]이 불가사의는 전 세계에서 하나만 건설할 수 있는 [COLOR_POSITIVE_TEXT]세계 불가사의[ENDCOLOR]입니다.'),
...
('TXT_KEY_BUILDING_FW_ORBITAL_REFINERY_HELP', '[COLOR_PLAYER_NETHERLANDS_BACKGROUND]복합도시 허브[ENDCOLOR]를 무료로 제공합니다. 모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]항공우주 복합시설, 나노물질 제조소[ENDCOLOR]의 [ICON_PRODUCTION]생산과 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다.[NEWLINE]우주 전문화 계열 유닛[COLOR:105:105:105:255](정찰, 화약, 전투기, 폭격기, 항공모함)[ENDCOLOR]을 [ICON_PRODUCTION]생산할 때 [ICON_PRODUCTION]생산보너스를 제공하고 [COLOR_PLAYER_PURPLE]우주전문가[ENDCOLOR] 승급을 부여합니다. [NEWLINE][NEWLINE][ICON_RES_NANOMAT]나노물질을 [COLOR_POSITIVE_TEXT]12개[ENDCOLOR] 제공합니다. [NEWLINE][NEWLINE][ICON_FOOD]/[ICON_PRODUCTION]낙후에서 오는 [ICON_HAPPINESS_3]불행이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 감소합니다. [NEWLINE][NEWLINE]도시에 [COLOR_NEGATIVE_TEXT]하이브, 스카이넷[ENDCOLOR]이 없어야 건설할 수 있습니다. 이 불가사의는 전 세계에서 하나만 건설할 수 있는 [COLOR_POSITIVE_TEXT]세계 불가사의[ENDCOLOR]입니다.'),
...
('TXT_KEY_BUILDING_FW_SKYCITY_HELP', '[COLOR_YELLOW][ICON_GREAT_WRITER]위대한 음악가[ENDCOLOR]1명이 출현합니다. [NEWLINE]도시의 [ICON_GREAT_PEOPLE]문화계 위인 점수가 [COLOR_POSITIVE_TEXT]25%[ENDCOLOR] 빠르게 증가합니다. 도시의 모든 전문가들의 [ICON_CULTURE]문화가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 총 [ICON_CULTURE]문화의 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR]를 [ICON_GOLD]골드와 [ICON_TOURISM]관광으로 전환합니다.전역 [ICON_HAPPINESS_1]행복이 [COLOR_POSITIVE_TEXT]7[ENDCOLOR] 증가합니다. [NEWLINE][NEWLINE]테마보너스: [ICON_PEACE]신앙 [COLOR_POSITIVE_TEXT]5[ENDCOLOR], [ICON_GOLDEN_AGE]황금기 점수 [COLOR_POSITIVE_TEXT]5[ENDCOLOR]. [NEWLINE][NEWLINE][NEWLINE][ICON_RES_ADN_FUNGUS]제노포자 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]가 필요합니다.[NEWLINE][NEWLINE]이 불가사의는 전 세계에서 하나만 건설할 수 있는 [COLOR_POSITIVE_TEXT]세계 불가사의[ENDCOLOR]입니다.'),
('TXT_KEY_BUILDING_FW_SKYCITY_QUOTE', '[NEWLINE]''우리는 흙으로 숨을 빚고, 음으로 생명을 세운다. 이제 합창은 우리 자신을 찬송하리라.''[NEWLINE] - 창세 성가집 中[NEWLINE]'),
('TXT_KEY_BUILDING_FW_SKYCITY_PEDIA', '창세 오라토리움은 인간이 스스로의 손으로 “새 생명”을 만들었다고 믿기 시작한 시대의 성전이다. 합성 성대와 생체 공진실, 음향 메타물질로 직조된 돔 아래에서, 생성형 지성은 미발표 성가를 즉시 작곡하고, 공학적 성악수행자와 인간 합창이 함께 노래한다. 무대는 유전자 라이브러리와 인공 자궁, 디지털 원형질의 이미지로 장식되어, 탄생의 의식을 예술과 공학의 언어로 재연한다.[NEWLINE][NEWLINE]이전 세대의 AI가 글과 그림의 비서를 자처했다면, 오라토리움은 육체·목소리·감정까지 합성하여 “창조의 순간”을 무대 위에 구현한다. 도시는 이곳에서 새로운 존재를 축복처럼 찬송하고, 그 찬송은 곧 인간 스스로를 향한다. 일부는 이를 오만이라 부르고, 일부는 성취라 부른다. 그러나 한 가지 사실만은 분명하다. 이 홀에서 울리는 합창은, 더 이상 신을 기다리지 않는다—우리는 우리 자신을 신의 자리에 앉혔기 때문이다.'),
...
('TXT_KEY_BUILDING_FW_ULTIMATOWER_HELP', '[COLOR_YELLOW][ICON_GREAT_ENGINEER]위대한 기술자[ENDCOLOR]1명 출현합니다. 도시의 [ICON_GREAT_ENGINEER]위대한 기술자 점수가 [COLOR_POSITIVE_TEXT]40%[ENDCOLOR] 빠르게 증가합니다. 도시의 전문가들의 [ICON_FOOD]식량과 [ICON_PRODUCTION]과학 [COLOR_POSITIVE_TEXT]1[ENDCOLOR]이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. [NEWLINE]총 [ICON_PRODUCTION]생산의 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR]를 [ICON_GOLD]골드와 [ICON_TOURISM]관광으로 전환합니다.[NEWLINE][NEWLINE][ICON_RES_NANOMAT]나노물질 [COLOR_NEGATIVE_TEXT]1개[ENDCOLOR]가 필요합니다. [COLOR_MAGENTA]제국주의[ENDCOLOR] 정책을 완성해야 건설할 수 있습니다. [NEWLINE][NEWLINE]이 불가사의는 전 세계에서 하나만 건설할 수 있는 [COLOR_POSITIVE_TEXT]세계 불가사의[ENDCOLOR]입니다.'),
