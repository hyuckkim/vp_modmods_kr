...
SET Text = '+2 [ICON_GOLD] Gold, [ICON_PRODUCTION] Production, [ICON_RESEARCH] Science to Merchants in all Cities. [NEWLINE]Cost of [ICON_GOLD] Gold purchasing in all Cities reduced by 10%. [NEWLINE][NEWLINE]Must be built in the [ICON_CAPITAL] Capital. The [ICON_PRODUCTION] Production Cost and [ICON_CITIZEN] Population Requirements increase based on the number of cities you own.'
