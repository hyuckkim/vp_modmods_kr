...
VALUES	('TXT_KEY_BUILDING_NIGHTCLUB',			'Nightclub'),
		...
		('TXT_KEY_BUILDING_NIGHTCLUB_HELP',		'+750 [ICON_TOURISM] Tourism when completed. Gain 200% of the [ICON_TOURISM] Tourism output of the City as an instant boost when a [ICON_CITIZEN] Citizen is born in this City.[NEWLINE][NEWLINE]1 Specialist in this City no longer produces [ICON_HAPPINESS_3] Unhappiness from [ICON_URBANIZATION] Urbanization.');
