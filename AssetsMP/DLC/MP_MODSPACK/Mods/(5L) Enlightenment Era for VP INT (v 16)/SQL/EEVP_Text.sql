...
('TXT_KEY_TECH_EE_FLINTLOCK_DESC', '화기는 머스킷이나 소총의 화약에 불을 붙이기 위해 부싯돌을 사용하는 특정한 잠금 방식으로 설명할 수도 있고, 17세기, 18세기, 19세기의 무기 전체를 지칭할 수도 있습니다. 프랑스에서 처음 개발된 이 무기는 부싯돌 조각으로 만들어졌는데, 이 부싯돌을 강철(프리젠이라고 함)로 치면 불꽃이 생기고, 이 불꽃이 화약이 담긴 팬에 떨어지면서 불이 붙어 무기가 발사되는 방식이었습니다.[NEWLINE][NEWLINE]플린트락 소총은 이전의 매치락 소총보다 개량되었기 때문에 빠르게 인기를 얻었으며, 1630년대에는 영국 내전에서 복무하는 용기병이 선호하는 무기로 명성을 얻었고, 1700년대에는 대부분 유럽 보병의 제식 무기로 자리 잡았습니다. 19세기 중반까지 이러한 지위를 유지했지만, 이후 점차 폐지되고 퍼커션 캡으로 대체되었고, 나중에는 탄환 기반 시스템으로 대체되었습니다.'),
...
('TXT_KEY_TECH_EE_FORTIFICATION_HELP', '강력하고 효과적인 공성 유닛인[COLOR_POSITIVE_TEXT]야포[ENDCOLOR]를 생산할 수 있습니다. 또한 [COLOR_POSITIVE_TEXT]성형 요새[ENDCOLOR]를 건설하여 도시의 [ICON_STRENGTH] 방어력을 더욱 강화할 수 있습니다.'),
...
('TXT_KEY_TECH_EE_HUMANISM_HELP', '[COLOR_POSITIVE_TEXT]기술대학[ENDCOLOR]과 [COLOR_POSITIVE_TEXT]신학대학[ENDCOLOR] 모두 건설할 수 있습니다. 이 두 건물은 상호 배타적이며, 각각 도시의 과학 또는 신앙의 산출량을 높여줍니다.'),
...
('TXT_KEY_TECH_EE_WARSHIPS_HELP', '계몽 시대 해군의 필수 원거리 유닛인 [COLOR_POSITIVE_TEXT]프리깃[ENDCOLOR]과 [COLOR_POSITIVE_TEXT]코르벳[ENDCOLOR]을 건조할 수 있습니다.'),
...
-- 흉갑기병
('TXT_KEY_UNIT_EE_CUIRASSIER', '흉갑기병'),
('TXT_KEY_UNIT_EE_CUIRASSIER_HELP', '기갑 유닛으로 넘어가기 전에 등장하는 최종 기마 유닛입니다.'),
('TXT_KEY_UNIT_EE_CUIRASSIER_PEDIA', '흉갑기병은 갑옷을 갖춘 기병(기사·데미랜서 등)이 창을 버리고 권총을 주된 무기로 채택하면서 등장했습니다. 프랑스어 명칭은 “흉갑(cuirasse)을 착용한 자”를 뜻하며, 말 그대로 흉갑을 착용했습니다. 흉갑기병의 장비 비용은 매우 비싸서, 더 가볍게 장비한 하르퀘버지어보다 세 배 이상 들기도 했습니다.[NEWLINE][NEWLINE]17세기 후반에 이르러 흉갑기병은 팔·다리 갑옷을 버리고 흉갑(때로는 투구만)을 남겨 운용했습니다. 이 시기부터 흉갑기병의 주무기는 칼이 되었고, 권총은 보조 무기로 격하되었습니다. 흉갑기병은 나폴레옹 전쟁기에 특히 활약했으며, 제1차 세계대전(1914–1918) 초기에 마지막으로 실전 배치되었습니다.'),
('TXT_KEY_UNIT_EE_CUIRASSIER_STRATEGY', '산업 시대의 근접 기병인 흉갑기병은 창기병에서 업그레이드되며, 르네상스 시기의 전작과 유사한 역할을 수행합니다. 위치가 무너진 적을 포착해 추격하고, 후방을 돌파하는 데 활용하세요.');

UPDATE Language_ko_KR
SET Text = '화승총 기병'
WHERE Tag = 'TXT_KEY_DESC_CUIRASSIER';

UPDATE Language_ko_KR
SET Text = '화승총 기병은 르네상스 시대의 기병으로, 빠른 기동과 원거리 공격이 가능합니다. 적을 괴롭히고 전쟁 노력에 보조 화력을 제공하는 데 활용하세요.'
WHERE Tag = 'TXT_KEY_CIV5_CUIRASSIER_STRATEGY';

UPDATE Language_ko_KR
SET Text = '화승총 기병(하르퀘버지어)는 카빈총의 한 형태를 사용하는 기병으로, 가장 이른 형태의 카빈은 ‘‘하르퀘버스’’라 불렸습니다(보병이 쓰던 더 무거운 화승총, 아큐버스에서 파생된 말입니다). 이 기병은 보통 흉갑과 등판으로 이루어진 철제 흉갑, 그리고 로브스터 테일드 팟(lobster-tailed pot) 같은 개방형 투구만을 갖춘 경장 장비였기에, 질 좋은 버프 가죽 코트보다도 비용이 덜 들어 비교적 저렴하게 편성할 수 있었습니다.[NEWLINE][NEWLINE]16세기 말부터 다음 세기 초 수십 년 동안, 하르퀘버지어는 이전의 페트로넬과 마찬가지로 데미 랜서 같은 중장기병이나 권총 무장 기병을 지원하는 역할로 운용되었습니다.'
WHERE Tag = 'TXT_KEY_CIV5_CUIRASSIER_PEDIA';
...
-- 스웨덴 카롤린넬
UPDATE Language_ko_KR
SET Text = '{TXT_KEY_UNIT_SWEDISH_CAROLEAN}은 {TXT_KEY_UNIT_EE_LINE_INFANTRY}을 대체하는 스웨덴의 고유 유닛입니다. 그들은 행동을 수행하더라도 매 턴마다 치유를 할 수 있는 행군 승급을 가지고 시작합니다. 카롤리너는 위대한 장군과 함께 배치될 경우 전투력이 15% 증가하고, 유닛을 처치한 후 전진하면 인접한 모든 유닛에 피해를 입힙니다.'
WHERE Tag = 'TXT_KEY_UNIT_SWEDISH_CAROLEAN_STRATEGY';

UPDATE Language_ko_KR 
SET Text = '{TXT_KEY_UNIT_EE_LINE_INFANTRY}을 대체하는 스웨덴의 고유 유닛입니다. 적 유닛을 제거 시 주변에 15 피해를 줍니다. 행동하더라도 매 턴 회복할 수 있습니다.'
WHERE Tag = 'TXT_KEY_UNIT_HELP_SWEDISH_CAROLEAN';

-- 미국 민병대
UPDATE Language_ko_KR
SET Text = '{TXT_KEY_UNIT_MUSKETMAN}을 대체하는 미국의 고유 유닛입니다. 지형 [ICON_MOVES]이동 비용을 무시하고 적 유닛을 처치할 때 [ICON_GOLDEN_AGE] 황금기 점수를 제공합니다. [COLOR_POSITIVE_TEXT]{TXT_KEY_PROMOTION_BARRAGE_1}[ENDCOLOR] 승급을 보유합니다.'
WHERE Tag = 'TXT_KEY_UNIT_HELP_MINUTEMAN';

UPDATE Language_ko_KR
SET Text = '{TXT_KEY_UNIT_AMERICAN_MINUTEMAN}는 미국의 고유 유닛으로 {TXT_KEY_UNIT_EE_SKIRMISHER}를 대체합니다. 민병대는 험지를 패널티 없이 이동할 수 없고, [ICON_GOLDEN_AGE] 적을 처치하면 황금기 접수를 얻습니다.'
WHERE Tag = 'TXT_KEY_UNIT_AMERICAN_MINUTEMAN_STRATEGY';


-- 오스트리아 후사르
UPDATE Language_ko_KR
SET Text = '{TXT_KEY_UNIT_AUSTRIAN_HUSSAR}는{TXT_KEY_UNIT_EE_DRAGOON}를 대체하는 오스트리아의 고유 유닛입니다. 더 빠르고, 더 멀리 보며 ZOC를 무시합니다. 또한 약간의 공격 보너스가 있습니다.'
WHERE Tag = 'TXT_KEY_UNIT_AUSTRIAN_HUSSAR_STRATEGY';

UPDATE Language_ko_KR
SET Text = '{TXT_KEY_UNIT_EE_DRAGOON}을 대체하는 오스트리아의 고유 유닛입니다. 측면 공격을 담당하는 강력한 유닛입니다. 더 빠르며 ZOC를 무시합니다.'
...
-- 양손검병
INSERT INTO Language_ko_KR (Tag, Text) VALUES
('TXT_KEY_UNIT_EE_2HANDER', '양손검병'),
('TXT_KEY_UNIT_EE_2HANDER_PEDIA', '르네상스 시대에 이탈리아와 스페인에서 활동했던 양손검병입니다. 테르시오 대형의 측면을 보호하는 임무를 맡은 보조 부대로서, 그들은 레콩키스타가 끝나고 이탈리아 전쟁이 시작될 때까지 매우 활발하게 활동했습니다. 16세기 중반, 테르시오에서 머스킷병과 장창병의 위치가 모호하여 전투가 머스킷병의 집중 공격과 장창병의 견고한 방어로 완료되었기 때문에, 머스킷병과 장창병에게 검술 교육을 하는 것이 더 낫다는 이유로 이들을 훈련시켰습니다. 이들은 도태되었습니다. 그러나 여전히 비정규전에서 사용되었으며, 유럽처럼 테르시오 방진을 짜고 엮는 것이 불가능했던 아메리카 정복 과정에서 핵심적인 역할을 했습니다.실제로 화약의 공급과 수요가 제한된 상황에서 총기는 심리적인 충격은 컸지만, 실제로는 그 효과가 크게 감소했습니다. 반면, 스페인 검찰관들의 톨레도 강철 검은 당시 아메리카 원주민의 기술로는 극복하기 어려웠습니다. 당시 원주민들은 칼을 빼앗아도 어떻게 다루어야 할지 몰라 창끝에 묶어 창처럼 사용했습니다.'),
('TXT_KEY_UNIT_EE_2HANDER_STRATEGY', '양손검병은 장검병보다 훨씬 강력하며, 창병, {TXT_KEY_UNIT_PIKEMAN}, {TXT_KEY_UNIT_SPANISH_TERCIO} 그리고 {TXT_KEY_UNIT_FCOMPANY}를 공격할 때 파괴적인 전투 보너스를 얻습니다.'),
...
-- 프랑스 머스킷병
UPDATE Language_ko_KR
SET Text = '{TXT_KEY_UNIT_EE_2HANDER}를 대체하는 프랑스의 고유 유닛입니다. 적에게 공격하기 위해 빠르게 이동할 수 있습니다.'
WHERE Tag = 'TXT_KEY_UNIT_HELP_MUSKETEER';

UPDATE Language_ko_KR
SET Text = '{TXT_KEY_UNIT_EE_2HANDER}는 프랑스의 고유 유닛으로 {TXT_KEY_UNIT_FRENCH_MUSKETEER}를 대체합니다. 눈에 띄게 강하며 통제 구역을 무시합니다.'
...
UPDATE Language_ko_KR
SET Text = '용병으로 특화된 독일 고유의 {TXT_KEY_UNIT_EE_2HANDER}으로, 구매 즉시 이동할 수 있으며 경험치 패널티나 재사용 대기시간이 없습니다. [COLOR_POSITIVE_TEXT]{TXT_KEY_PROMOTION_FORMATION_1}[ENDCOLOR]과 [COLOR_POSITIVE_TEXT]{TXT_KEY_PROMOTION_FORMATION_2}[ENDCOLOR] 승급을 가지고 시작합니다.'
...
UPDATE Language_ko_KR
SET Text = '도펠죌트너 또는 "2배 급료 병사"는 유럽 전쟁의 창총진 시대에 등장해 자원하여 최전선에서 싸우고 두 배의 급여를 받는 사람들을 말합니다. 부대의 약 4분의 1은 장창병 앞에서 날개를 형성한 최전선 군인이었고, 장창병은 석궁병 및/또는 화승총병을 방어했습니다. 도펠죌트너의 주된 무기는 가벼운 원거리 무기였지만, 적의 창과 그 휘두르는 자의 머리를 자르는 데 사용된 것은 거대한 양손검인 츠바이헨더였습니다!'
...
UPDATE Language_ko_KR
SET Text = '카락을 대체하는 네덜란드의 고유 유닛입니다. 도시와 선박을 모두 공격하는 데 특화되었습니다. [COLOR_POSITIVE_TEXT]선봉[ENDCOLOR]과 [COLOR_POSITIVE_TEXT]보급[ENDCOLOR] 승급을 보유합니다.'
WHERE Tag = 'TXT_KEY_UNIT_HELP_SEA_BEGGAR';

-- TERICIO ->PIKEMAN
UPDATE Language_ko_KR
SET Text = '창총보병'
WHERE Tag = 'TXT_KEY_UNIT_SPANISH_TERCIO' AND EXISTS (SELECT * FROM Units WHERE TYPE = 'UNIT_EE_SKIRMISHER');	

UPDATE Language_ko_KR
SET Text = '창총보병은 르네상스 시대의 기본 근접 공격 유닛으로, 중세 시대의 무시무시한 기사단에 쉽게 맞설 수 있습니다.'
WHERE Tag = 'TXT_KEY_CIV5_SPAIN_TERCIO_HELP' AND EXISTS (SELECT * FROM Units WHERE TYPE = 'UNIT_EE_SKIRMISHER');	
...
WHERE Tag = 'TXT_KEY_CIV5_SPAIN_TERCIO_STRATEGY' AND EXISTS (SELECT * FROM Units WHERE TYPE = 'UNIT_EE_SKIRMISHER');
...
WHERE Tag = 'TXT_KEY_CIV5_SPAIN_TERCIO_TEXT' AND EXISTS (SELECT * FROM Units WHERE TYPE = 'UNIT_EE_SKIRMISHER');
...
UPDATE Language_ko_KR
SET Text = '{TXT_KEY_UNIT_ZULU_IMPI}는 {TXT_KEY_UNIT_SPANISH_TERCIO}를 대체하는 줄루의 고유 유닛입니다. {TXT_KEY_UNIT_PIKEMAN}보다 훨씬 더 튼튼하고 제작 비용도 더 많이 들지만, 동시대의 다른 유닛과 비교하면 눈에 띄게 비용이 적게 듭니다. 방패에는 엄폐 I이 부여되어 원거리 공격의 피해를 줄여주고, 근접 공격을 하기 전에는 창 던지기 공격을 하여 근접 전투가 시작되기 전에 방어측을 약화시킵니다. 또한 화약 유닛과 싸울 때 [ICON_STRENGTH] 전투력 보너스도 있어 산업 시대에도 치명적인 유닛입니다.'
...
('TXT_KEY_WONDER_EE_TOPKAPI_HELP', '문명의 방어 건물에서 [ICON_PEACE] 신앙이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. [ICON_GREAT_WORK] 걸작 예술품 또는 [ICON_VP_ARTIFACT]유물 슬롯 [COLOR_POSITIVE_TEXT]2개[ENDCOLOR]를 포함하며, 그 중 1개는 [ICON_VP_ARTIFACT] [COLOR_YELLOW]무료[ENDCOLOR][ICON_VP_ARTIFACT]유물로 채워집니다.  [NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]테마[ENDCOLOR]보너스:  [ICON_PRODUCTION]생산 +3 [ICON_RESEARCH]과학 +3 [NEWLINE][NEWLINE]이 불가사의는 전 세계에서 하나만 건설할 수 있는 [COLOR_POSITIVE_TEXT]세계 불가사의[ENDCOLOR]입니다.'),
...
('TXT_KEY_BUILDING_EE_SUMMER_PALACE_HELP', '[ICON_CAPITAL] 수도 근처에 무료 [COLOR_YELLOW][ICON_GREAT_PEOPLE]원하는 위인[ENDCOLOR] 1명이 출현합니다. 모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]이국 박람회[ENDCOLOR]의 [ICON_TOURISM] 관광이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다.[NEWLINE][NEWLINE]문명에 도시가 많을수록 건설에 필요한 [ICON_PRODUCTION]생산과 [ICON_CITIZEN]시민이 증가합니다.'),
...
('TXT_KEY_WONDER_EE_DERWENT_MILLS_HELP', '[COLOR_PLAYER_NETHERLANDS_BACKGROUND]방직소[ENDCOLOR]를 무료로 제공합니다. 모든 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]방직소, 항구, 제련소[ENDCOLOR]의 [ICON_GOLD] 골드와 [ICON_GOLDEN_AGE]황금기 점수가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. [NEWLINE][NEWLINE]이 불가사의는 전 세계에서 하나만 건설할 수 있는 [COLOR_POSITIVE_TEXT]세계 불가사의[ENDCOLOR]입니다'),
...
INSERT INTO Language_ko_KR (Tag, Text) VALUES
-- 기술대학
('TXT_KEY_BUILDING_EE_ACADEMY', '기술대학'),
('TXT_KEY_BUILDING_EE_ACADEMY_HELP', '[ICON_CITIZEN]시민 6명마다 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. [ICON_CITIZEN]시민이 증가할때 [ICON_RESEARCH] 과학 [COLOR_POSITIVE_TEXT]15[ENDCOLOR][COLOR:105:105:105:255](시대별 보정)[ENDCOLOR], [ICON_GREAT_GENERAL] 위대한 장군 점수 [COLOR_POSITIVE_TEXT]10[ENDCOLOR]점을 제공합니다.[NEWLINE][NEWLINE][ICON_GOLD]골드로 유닛을 구매하거나 건물 건설에 투자하는 비용이 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR] 감소합니다. [NEWLINE][NEWLINE][ICON_GREAT_SCIENTIST] 위대한 과학자, [ICON_GREAT_ENGINEER] 위대한 기술자, [ICON_GREAT_MERCHANT] 위대한 상인, [ICON_DIPLOMAT] 위대한 외교관의 출현율이 [COLOR_POSITIVE_TEXT]20%[ENDCOLOR] 증가합니다.[NEWLINE][NEWLINE]도시에 [COLOR_NEGATIVE_TEXT]신학대학[ENDCOLOR]이 없어야 건설할 수 있습니다.'),
('TXT_KEY_BUILDING_EE_ACADEMY_STRATEGY', '기술대학은 도시의 [ICON_RESEARCH] 과학 생산량을 늘리는 르네상스 시대의 건물입니다. 신학교가 있는 도시에는 건설할 수 없으므로, 도시는 문화나 신앙 중 하나를 전문으로 삼아야 합니다.'),
('TXT_KEY_BUILDING_EE_ACADEMY_PEDIA', '기술대학 또는 그랑제콜은 프랑스와 함께 모로코, 튀니지 등의 다른 나라에도 있는 최고 수준의 전문 교육 기관으로, 아이비 리그나 옥스브리지 같은 다른 엘리트 기관과 비교할 수 있습니다. 최초의 폴리테크닉은 1794년 프랑스 혁명 당시 공학자와 군 장교 부족 문제를 해결하기 위해 수학자 가스파르 몽주에 의해 설립되었고, 1804년 나폴레옹 1세에 의해 군사화되었습니다. 프랑스 국방부의 감독을 받고 있습니다. 대학과는 별개로 운영되기 때문에 대부분 프랑스의 학사(Licence) 학위를 제공하지 않고, 공학계 준박사 학위(écoles d’ingénieurs)와 같은 그랑제콜 석사 학위를 제공합니다.'),
-- 신학대학
('TXT_KEY_BUILDING_EE_SEMINARY', '신학대학'),
('TXT_KEY_BUILDING_EE_SEMINARY_HELP', '[ICON_CITIZEN]시민 6명마다 [ICON_PEACE]신앙이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. [ICON_CITIZEN]시민이 증가할때 [ICON_PEACE] 신앙 [COLOR_POSITIVE_TEXT]10[COLOR:105:105:105:255](시대별 보정)[ENDCOLOR][ENDCOLOR]과 [ICON_GOLDEN_AGE] 황금기 점수 [COLOR_POSITIVE_TEXT]20[ENDCOLOR]을 제공합니다.[ICON_MISSIONARY]선교사의 전도력이 [COLOR_POSITIVE_TEXT]5%[ENDCOLOR]씩 증가합니다.[NEWLINE][NEWLINE][ICON_PEACE]신앙으로 유닛을 구매하거나 건물 건설할 때 비용의 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR]를 [ICON_PEACE]신앙으로 제공합니다. [NEWLINE][NEWLINE]도시에 [COLOR_NEGATIVE_TEXT]기술대학[ENDCOLOR]이 없어야 건설할 수 있습니다.'),
('TXT_KEY_BUILDING_EE_SEMINARY_STRATEGY', '신학대학는 게임에서 해제되는 마지막 종교 건물 중 하나입니다. 기술대학이 있는 도시에는 건설할 수 없으므로, 도시는 문화나 신앙 중 하나를 전문으로 삼아야 합니다.'),
...
('TXT_KEY_BUILDING_EE_CLOTH_MILL_HELP', '[ICON_CITIZEN]시민 6명마다 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다.[NEWLINE][NEWLINE]강: [ICON_GOLD] 골드 +1[NEWLINE][ICON_RES_SHEEP] 양: [ICON_PRODUCTION] 생산, [ICON_GOLD] 골드 +1[NEWLINE][ICON_RES_FUR] 모피: [ICON_GOLD] 골드 +1, [ICON_TOURISM] 관광 +2[NEWLINE] [ICON_RES_DYE] 염료: [ICON_GOLD] 골드 +2, [ICON_CULTURE] 문화 +1[NEWLINE][ICON_RES_SILK]비단: [ICON_GOLD] 골드 +2, [ICON_TOURISM]관광 +1[NEWLINE][ICON_RES_COTTON]면: [ICON_GOLD] 골드 +3'),
...
-- 조선소
('TXT_KEY_BUILDING_EE_DRYDOCK', '조선소'),
('TXT_KEY_BUILDING_EE_DRYDOCK_HELP', '해상 유닛을 생산할 때 [ICON_PRODUCTION] 생산 보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 제공합니다. 도시에서 생성하는 해상 유닛에 [COLOR_PLAYER_PURPLE]정비 양호[ENDCOLOR] 승급을 부여합니다. [ICON_SILVER_FIST] 인구수에 따른 지역 군사 보급 한도가 [COLOR_POSITIVE_TEXT]5%[ENDCOLOR] 증가합니다. [NEWLINE][NEWLINE]도시에 [COLOR_PLAYER_NETHERLANDS_BACKGROUND]항만[ENDCOLOR]이 있어야 건설할 수 있습니다.'),
('TXT_KEY_BUILDING_EE_DRYDOCK_STRATEGY', '조선소는 도시에서 훈련받는 해군 부대의 전투력을 강화하는 계몽 시대 후기의 건물입니다. 도시 내 인구에 따른 군사 유닛 공급 한도가 증가합니다. 조선소를 건설하려면 먼저 도시에 항만이 있어야 합니다.'),
('TXT_KEY_BUILDING_EE_DRYDOCK_PEDIA', '조선소는 선박 및 기타 수상 운송 수단의 건조와 유지 관리를 용이하게 하기 위해 침수와 배수가 가능한 직사각형 분지입니다. 조선소에서 물이 빠지는 동안 선박을 건조하거나 수리합니다. 배가 출항할 준비가 되면 선거에 물을 채웁니다. 대부분의 건선거는 해안을 따라 건설된 고정식 선거이지만, 수리를 위해 작은 선박을 실어 나를 수 있는 이동식 부선거도 있습니다.'),
-- 화기 제작소
('TXT_KEY_BUILDING_EE_GUNSMITH', '화기 제작소'),
('TXT_KEY_BUILDING_EE_GUNSMITH_HELP', '지상 유닛을 생산할 때 [ICON_PRODUCTION] 생산 보너스를 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 제공합니다. [ICON_WAR] 지역 군사 보급 한도가 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다.[NEWLINE][NEWLINE]도시에서 생산하는 유닛 [ICON_PRODUCTION] 생산 비용의 10%만큼 [ICON_RESEARCH] 과학을 제공합니다.[NEWLINE][NEWLINE][ICON_RES_IRON] 철: [ICON_PRODUCTION] 생산 +2[NEWLINE][ICON_RES_COAL] 석탄: [ICON_PRODUCTION] 생산 +1, [ICON_RESEARCH] 과학 +1'),
...
-- 장원
('TXT_KEY_BUILDING_EE_MANOR', '장원'),
('TXT_KEY_BUILDING_EE_MANOR_HELP', '도시 주변 호수 타일의 [ICON_GOLD]골드가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR], [ICON_TOURISM]관광이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 타일을 획득할 때 [ICON_FOOD] 식량이 [COLOR_POSITIVE_TEXT]10[ENDCOLOR][COLOR:105:105:105:255](시대별 보정)[ENDCOLOR] 제공합니다. [NEWLINE][NEWLINE][ICON_RES_DEER] 사슴: [ICON_FOOD] 식량 +1,  [ICON_CULTURE] 문화 +1[NEWLINE][ICON_RES_PEARLS] 진주: [ICON_CULTURE] 문화 +1, [ICON_TOURISM] 관광 +2[NEWLINE][ICON_RES_AMBER] 호박: [ICON_CULTURE] 문화 +1, [ICON_PEACE] 신앙 +1[NEWLINE][ICON_RES_JADE] 옥: [ICON_CULTURE] 문화 +1, [ICON_GOLDEN_AGE] 황금기 점수 +2[NEWLINE][ICON_RES_PERFUME] 향수: [ICON_CULTURE] 문화 +1, [ICON_GOLDEN_AGE] 황금기 점수 +2[NEWLINE][ICON_RES_LAPIS] 청금석: [ICON_PRODUCTION] 생산 +2, [ICON_GOLDEN_AGE] 황금기 점수 +2'),
('TXT_KEY_BUILDING_EE_MANOR_STRATEGY', '장원은 도시 반경 내에 존재하는 사치 자원을 기반으로 문화와 신앙과 같은 수익성 있는 산출물을 제공하므로, 나열된 사치 자원이 근처에 있다면 바람직합니다. 또한 게임 계획에 맞는 황금기 점수를 생성하는 여러 가지 방법을 제공하지만, 다른 건물을 위해 포기할 수도 있습니다.'),
('TXT_KEY_BUILDING_EE_MANOR_PEDIA', '중세 시대에 장원은 영주(또는 주택 관리인)의 거주지였으며, 봉건 영지의 행정 중심지였습니다. 중세 저택은 일반적으로 해당 국가나 지역의 평화로운 정착 정도에 비례하여 요새화되었습니다. 이곳은 세속적인 마을 생활의 중심지 역할을 했으며, 그레이트 홀은 장원 재판소와 소작농 집회의 장소였습니다. 경제가 번영하고 더 넓은 주거 공간에 대한 수요가 증가하면서 16세기 영주 저택은 르네상스풍 시골 주택으로 변화했습니다. 영국에서는 더욱 정교한 건물이 건설되었으며, 이는 새로운 시대의 형식을 반영합니다. 주택은 대개 규칙적인 사각형 평면을 이루었고, 홀의 크기와 중요성은 상대적으로 작았습니다. 후년에 영국에서 영주 저택이라는 명칭은 영지적 기반이 없는 대규모 시골 저택을 지칭하게 되면서 특별한 의미를 잃었습니다.'),
-- 카페 (구 살롱)
('TXT_KEY_BUILDING_EE_SALON', '카페'),
('TXT_KEY_BUILDING_EE_SALON_HELP', '[ICON_CITIZEN]시민 6명마다 [ICON_FOOD] 식량이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. [NEWLINE][NEWLINE][ICON_GREAT_WRITER] 위대한 작가, [ICON_GREAT_ARTIST] 위대한 예술가, [ICON_GREAT_MUSICIAN] 위대한 음악가의 출현율이 [COLOR_POSITIVE_TEXT]20%[ENDCOLOR] 증가합니다.[NEWLINE][NEWLINE]전문가 [COLOR_POSITIVE_TEXT]1명[ENDCOLOR]이 더 이상 [ICON_URBANIZATION] 도시화에서 오는 [ICON_HAPPINESS_3] 불행을 증가시키지 않습니다. [NEWLINE][NEWLINE][ICON_RES_SPICES] 향신료: [ICON_GOLD] 골드 +1, [ICON_FOOD] 식량 +1, [ICON_TOURISM] 관광 +1[NEWLINE][ICON_RES_SUGAR] 설탕: [ICON_FOOD] 식량 +2, [ICON_GOLD] 골드 +2[NEWLINE][ICON_RES_CITRUS] 감귤: [ICON_FOOD] 식량 +2, [ICON_RESEARCH] 과학 +1[NEWLINE] [ICON_RES_COCOA] 코코아: [ICON_GOLD] 골드 +2,  [ICON_TOURISM] 관광 +1[NEWLINE][ICON_RES_COFFEE] 커피: [ICON_GOLD] 골드 +2, [ICON_CULTURE] 문화 +1[NEWLINE][ICON_RES_TEA] 차: [ICON_FOOD] 식량 +2, [ICON_CULTURE] 문화 +1'),
...
-- 이국 박람회
('TXT_KEY_BUILDING_EE_MENAGERIE', '이국 박람회'),
('TXT_KEY_BUILDING_EE_MENAGERIE_HELP', '[ICON_CITIZEN]시민 6명마다 [ICON_TOURISM]관광이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 건설을 완료하면 [ICON_TOURISM]관광 [COLOR_POSITIVE_TEXT]250[ENDCOLOR] 제공합니다.[NEWLINE][NEWLINE][ICON_CULTURE]무료로 인한 [ICON_HAPPINESS_3] 불행이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 감소합니다.[NEWLINE][NEWLINE][ICON_RES_HORSE] 말: [ICON_PRODUCTION] 생산 +1 [ICON_CULTURE] 문화 +1[NEWLINE][ICON_RES_BANANA] 바나나: [ICON_GOLD] 골드 +2, [ICON_TOURISM] 관광 +1[NEWLINE][ICON_RES_WHALE] 고래:[ICON_RESEARCH] 과학 +2 [NEWLINE][ICON_RES_IVORY] 상아: [ICON_PRODUCTION] 생산+2, [ICON_TOURISM] 관광+2[NEWLINE][ICON_RES_CORAL] 산호: [ICON_RESEARCH] 과학+1, [ICON_CULTURE] 문화 +1'),
('TXT_KEY_BUILDING_EE_MENAGERIE_STRATEGY', '이국 박람회는 근처 자원에 따라 과학, 문화, 관광 등의 수확을 높여줍니다. 자원이 풍부한지에 따라 이 건물을 건설하는 것이 얼마나 시급한지가 결정됩니다. 모든 관광에 보너스가 있으며, 원자재 생산물과 교역로 완성으로 얻는 산출량도 보너스입니다.'),
('TXT_KEY_BUILDING_EE_MENAGERIE_PEDIA', '이국 박람회는 전시를 위해 키우는 이국적인 동물을 모아 놓은 곳이거나, 이런 동물을 모아 두는 장소로, 현대 동물원이나 동물학 정원의 전신입니다. 이 용어는 17세기 프랑스에서 처음 사용되었으며, 가정이나 가축의 관리를 지칭하는 용어였습니다. 이국적인 동물들이 아프리카와 동양으로 항해할 때 포획되어 유럽으로 돌아와 상류 계층을 자극하는 신분 상징으로 판매되었습니다. 사자, 원숭이, 앵무새, 코끼리, 호랑이, 곰은 모두 얻기 어렵고 살아 있는 상태로 키우는 데 비용이 많이 들었으며, 종종 이해되지 않거나 쉽게 구할 수 없는 매우 특별한 식단이 필요했습니다. 중세 시대에도 유럽 전역의 여러 군주들은 왕실 내에 동물 전시관을 운영했습니다. 중세 영국에서 가장 유명한 동물 컬렉션은 1204년 초에 시작된 런던의 타워 동물원이었습니다. 이곳은 1199년부터 1216년까지 영국을 통치했던 왕 존에 의해 세워졌으며, 사자와 곰을 키웠던 것으로 알려져 있습니다.');
...
WHERE Tag = 'TXT_KEY_BUILDING_GALLERY_HELP';
