...
local g_tStrategicResources = table()
...
for resource in GameInfo.Resources() do
	...
	if Game.GetResourceUsageType(resource.ID) == ResourceUsageTypes.RESOURCEUSAGE_STRATEGIC then
		g_tStrategicResources:insert( resource )
		...
		g_tStrategicResources:sort( function(a,b) return ( a.StrategicPriority < b.StrategicPriority ) end )
...
for _, resource in pairs( g_tStrategicResources) do
	local resourceID = resource.ID
