...
INSERT INTO Language_ko_KR 
			(Tag,										Text) 
VALUES		('TXT_KEY_PROMOTION_KAILASH',				'위대한 여정의 책'),
			('TXT_KEY_PROMOTION_KAILASH_HELP',			'[COLOR:255:230:85:255]언덕[ENDCOLOR]에서 [ICON_MOVES]이동력 2배.'),
			('TXT_KEY_PROMOTION_ULURU',					'고대 부족'),
			('TXT_KEY_PROMOTION_ULURU_HELP',			'[COLOR:255:230:85:255]외교 임무[ENDCOLOR] 이후 [ICON_INFLUENCE]영향력 +10'),
			('TXT_KEY_PROMOTION_SOLOMONS_MINES',		'왕을 위하여!'),
			('TXT_KEY_PROMOTION_SOLOMONS_MINES_HELP',	'[ICON_WORKER]작업 효율 +25%'),	
			('TXT_KEY_PROMOTION_BERMUDA_TRIANGLE',		'시공간에서의 표류'),
			('TXT_KEY_PROMOTION_BERMUDA_TRIANGLE_HELP',	'[ICON_MOVES] 이동력 -3[NEWLINE][COLOR_NEGATIVE_TEXT]승급이 3턴동안 남아있음[ENDCOLOR]'),
			('TXT_KEY_PROMOTION_DALLOL',				'폭발 혼합물'),
			('TXT_KEY_PROMOTION_DALLOL_HELP',			'[ICON_RANGE_STRENGTH]원거리 공격력 +10%'),
			('TXT_KEY_PROMOTION_CAUSEWAY',				'호기심'),
			('TXT_KEY_PROMOTION_CAUSEWAY_HELP',			'[ICON_MOVES]이동력 +1[NEWLINE][ICON_WORKER]작업 효율 +10%.'),
			('TXT_KEY_PROMOTION_MT_EVEREST',			'세계의 지붕'),
			('TXT_KEY_PROMOTION_MT_EVEREST_HELP',		'[COLOR:255:230:85:255]지도를 밝힐 때[ENDCOLOR] [ICON_TOURISM]관광을 얻음');
...
INSERT INTO Language_ko_KR 
			(Tag,										Text) 
VALUES		('TXT_KEY_BUILDING_MT_PAEKTU',				'산 아래 출생의 제단'),
			('TXT_KEY_BUILDING_MT_PAEKTU_PEDIA',		'TODO'),
			('TXT_KEY_BUILDING_MT_PAEKTU_HELP',			'[ICON_GREAT_PEOPLE] 위대한 음악가 점수 +1을 제공합니다. [ICON_GREAT_WORK][COLOR_CULTURE_STORED]백두산 정상에 서 있는 김일성과 김정일[ENDCOLOR]이 포함된 [ICON_GREAT_WORK]걸작 슬롯 1개를 제공합니다.'),
			('TXT_KEY_BUILDING_SCUBA_RESORT',			'스쿠버 다이빙 휴양지'),
			('TXT_KEY_BUILDING_SCUBA_RESORT_PEDIA',		'TODO'),
			('TXT_KEY_BUILDING_SCUBA_RESORT_HELP',		'이 도시의 산호섬에서 [ICON_GOLD]골드 +1 [ICON_TOURISM]관광 +1을 제공합니다. 이 도시의 대양 타일에서 [ICON_GOLD]골드 +1 [ICON_RESEARCH]과학 +1을 제공합니다.'),
			('TXT_KEY_BUILDING_BATHYSCAPHE_BAY',		'심해용 잠수정 도킹 구역'),
			('TXT_KEY_BUILDING_BATHYSCAPHE_BAY_PEDIA',	'TODO'),
			('TXT_KEY_BUILDING_BATHYSCAPHE_BAY_HELP',	'이 도시에서 [COLOR_POSITIVE_TEXT]잠수함[ENDCOLOR]에 대한 [ICON_PRODUCTION]생산력이 +35% 증가합니다.'),
			('TXT_KEY_BUILDING_OCEAN_FACILITY',			'심해 연구 시설'),
			('TXT_KEY_BUILDING_OCEAN_FACILITY_PEDIA',	'TODO'),
			('TXT_KEY_BUILDING_OCEAN_FACILITY_HELP',	'이 도시의 해양 타일에서 [ICON_FOOD]식량 +1 [ICON_RESEARCH]과학 +1을 제공합니다.[NEWLINE][NEWLINE]이 도시의 모든 해상 자원에서 [ICON_FOOD]식량 +1을 제공합니다.');
...
VALUES		('TXT_KEY_BUILDING_SALAR_A_DUMMY',			'살라르 데 우유니 A'),
			...
			('TXT_KEY_BUILDING_POTOSI_DUMMY',			'세로데파스코'),
			('TXT_KEY_BUILDING_CRATER_DUMMY',			'베린저 운석공'),
			('TXT_KEY_BUILDING_MESA_DUMMY',				'그랜드 메사'),
			('TXT_KEY_BUILDING_SOLOMONS_MINES_DUMMY',	'솔로몬 왕의 광산'),
			('TXT_KEY_BUILDING_VOLCANO_DUMMY',			'크라카토아 화산'),
			...
			('TXT_KEY_BUILDING_GIBRALTAR_DUMMY',		'지브롤터 암벽'),
			...
			('TXT_KEY_BUILDING_LUMI_BAY_DUMMY',			'바이오루미네센트 베이'),
			('TXT_KEY_BUILDING_DALLOL_DUMMY',			'댈롤'),
			('TXT_KEY_BUILDING_EYE_OF_SAHARA_DUMMY',	'사하르의 눈'),
			('TXT_KEY_BUILDING_MT_KAILASH_DUMMY',		'카일라스 산'),
			('TXT_KEY_BUILDING_KILIMANJARO_DUMMY',		'킬리만자로'),
