...
INSERT OR IGNORE INTO Sapiens_DBUpdates (Name) VALUES ('NEUs_Babylon');
--=======================================================================================================================
-- UNIQUE COMPONENTS
--=======================================================================================================================
...
('_BABYLON',		'PIKEMAN',				'Pikeman_Babylon',				12),
('_BABYLON',		'ARCHER',				'Archer_Babylon',				12),
('_BABYLON',		'SWORDSMAN',			'Swordsman_Babylon',			12),
('_BABYLON',		'KNIGHT',				'Knight_Babylon',				5),
('_BABYLON',		'WARRIOR',				'Mesopotamic_warrior_tc',		12),
('_BABYLON',		'CROSSBOWMAN',			'Longbowman_Babylon',			12);

--=======================================================================================================================
UPDATE Sapiens_DBUpdates SET Value = 1 WHERE Name = 'NEUs_Babylon';
