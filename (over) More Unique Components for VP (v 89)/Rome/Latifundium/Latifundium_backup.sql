...
VALUES		('IMPROVEMENT_ROME_LATIFUNDIUM',	'TXT_KEY_IMPROVEMENT_ROME_LATIFUNDIUM',	'TXT_KEY_IMPROVEMENT_ROME_LATIFUNDIUM_TEXT',	'ART_DEF_IMPROVEMENT_ROME_LATIFUNDIUM',	'TXT_KEY_IMPROVEMENT_ROME_LATIFUNDIUM_HELP',	1,						'CIVILIZATION_ROME',	25,				0,						0,						0,						0,			0,				'IMPROVEMENT_ROME_ATLAS',	1,				0,					0);
------------------------------	
-- Improvement_Yields
------------------------------		
...
VALUES		('IMPROVEMENT_ROME_LATIFUNDIUM',	'IMPROVEMENT_PLANTATION',	'YIELD_CULTURE',	1),
			...
			('IMPROVEMENT_ROME_LATIFUNDIUM',	'IMPROVEMENT_FARM',			'YIELD_FOOD',		1),
...
VALUES		('BUILD_ROME_LATIFUNDIUM',	'TECH_ENGINEERING',	'IMPROVEMENT_ROME_LATIFUNDIUM',	'TXT_KEY_BUILD_ROME_LATIFUNDIUM',	'TXT_KEY_BUILD_ROME_LATIFUNDIUM_HELP',	'TXT_KEY_BUILD_ROME_LATIFUNDIUM_REC',	'ENTITY_EVENT_IRRIGATE',	900,	95,				0,		0,			'IMPROVEMENT_ROME_2_ATLAS');
------------------------------				
-- Unit_Builds
------------------------------				
