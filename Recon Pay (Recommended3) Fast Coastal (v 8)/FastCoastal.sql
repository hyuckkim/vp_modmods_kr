...
INSERT INTO UnitPromotions_Features
			(PromotionType,	FeatureType,			DoubleMove) 
	SELECT	Type,			'FEATURE_COASTAL_2',	1
	FROM UnitPromotions	WHERE Type LIKE 'PROMOTION%TRAILBLAZER_3';

INSERT INTO UnitPromotions_Features
			(PromotionType,	FeatureType,			DoubleMove) 
	SELECT	Type,			'FEATURE_COASTAL',		1
	FROM UnitPromotions	WHERE Type LIKE 'PROMOTION%TRAILBLAZER_3';

INSERT INTO UnitPromotions_Features
			(PromotionType,	FeatureType,			IgnoreTerrainCostFrom) 
	SELECT	Type,			'FEATURE_COASTAL_2',	1
	FROM UnitPromotions	WHERE Type LIKE 'PROMOTION%TRAILBLAZER_2';
...
SET EnemyRoute = 0
WHERE Type LIKE 'PROMOTION%TRAILBLAZER_3';
