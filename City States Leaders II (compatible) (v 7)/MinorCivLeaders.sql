...
SELECT	'MINOR_CIV_WELLINGTON',		'wellington_leadericon.dds',	'New Zealand',							'New Zealand',			'New Zealand',			'Henry Sewell',			'Premier',			'',				'TPangolin'				UNION ALL
...
SELECT	'MINOR_CIV_ZURICH',			'zurich_leadericon.dds',		'The Swiss Confederation',				'Switzerland',			'the Swiss Confederacy', 'Matthaus Schiner',	'Cardinal',			'',				'Krateng'				;
--[ALTERNATE]SELECT	'MINOR_CIV_ZURICH',	'zurich_leadericon2.dds',	'The Swiss Confederation',	'Switzerland',	'Zurich',	'Rudolf Brun',	'Mayor',	'',	'G. Closs/TPangolin'	;
