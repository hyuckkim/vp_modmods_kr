...
INSERT INTO BuildingClasses 
			(Type,									Description,								DefaultBuilding)
VALUES		('BUILDINGCLASS_JEJU_DO_DUMMY',			'TXT_KEY_BUILDING_JEJU_DO_DUMMY',			'BUILDING_JEJU_DO_DUMMY'),
			('BUILDINGCLASS_SALAR_A_DUMMY',			'TXT_KEY_BUILDING_SALAR_A_DUMMY',			'BUILDING_SALAR_A_DUMMY'),
			...
			('BUILDINGCLASS_ARCH_DUMMY',			'TXT_KEY_BUILDING_ARCH_DUMMY',				'BUILDING_ARCH_DUMMY'),
			('BUILDINGCLASS_MARIANA_A_DUMMY',		'TXT_KEY_BUILDING_MARIANA_DUMMY',			'BUILDING_MARIANA_A_DUMMY'),
			('BUILDINGCLASS_MARIANA_B_DUMMY',		'TXT_KEY_BUILDING_MARIANA_DUMMY',			'BUILDING_MARIANA_B_DUMMY'),
			('BUILDINGCLASS_MARIANA_C_DUMMY',		'TXT_KEY_BUILDING_MARIANA_DUMMY',			'BUILDING_MARIANA_C_DUMMY');
...
VALUES		-- dummy building with direct placement
			...
			('BUILDING_MARIANA_A_DUMMY',		'BUILDINGCLASS_MARIANA_A_DUMMY',		'TXT_KEY_BUILDING_MARIANA_DUMMY',			NULL,       -1,   -1,        -1,              1,          0,			1),
			('BUILDING_MARIANA_B_DUMMY',		'BUILDINGCLASS_MARIANA_B_DUMMY',		'TXT_KEY_BUILDING_MARIANA_DUMMY',			NULL,       -1,   -1,        -1,              1,          0,			1),
			('BUILDING_MARIANA_C_DUMMY',		'BUILDINGCLASS_MARIANA_C_DUMMY',		'TXT_KEY_BUILDING_MARIANA_DUMMY',			NULL,       -1,   -1,        -1,              1,          0,			1);
...
UPDATE Buildings SET CityConnectionTradeRouteModifier = 20 WHERE Type = 'BUILDING_ARCH_DUMMY';
...
INSERT INTO Building_InstantYield
			(BuildingType,				YieldType,		Yield) 
VALUES		('BUILDING_MT_SINAI_DUMMY',	'YIELD_FAITH',	50);
...
INSERT INTO Building_YieldFromGoldenAgeStart
			(BuildingType,					YieldType,			Yield) 
VALUES		('BUILDING_MARIANA_A_DUMMY',	'YIELD_SCIENCE',	10),
			('BUILDING_MARIANA_B_DUMMY',	'YIELD_SCIENCE',	10),
			('BUILDING_MARIANA_C_DUMMY',	'YIELD_SCIENCE',	10);
...
INSERT INTO Building_YieldFromInternalTREnd
			(BuildingType,				YieldType,				Yield) 
VALUES		('BUILDING_ARCH_DUMMY',		'YIELD_GOLD',			40),
			('BUILDING_ARCH_DUMMY',		'YIELD_CULTURE',		15);

INSERT INTO Building_YieldFromGPBirthScaledWithArtistBulb
			(BuildingType,				YieldType,		Yield) 
VALUES		('BUILDING_JEJU_DO_DUMMY',	'YIELD_GOLD',	25);
--============================================--
-- POLICIES
--============================================--
...
VALUES		('POLICY_RETBA_DUMMY', 			'TXT_KEY_POLICY_RETBA_DUMMY'),
			...
			('POLICY_ULURU_DUMMY', 			'TXT_KEY_POLICY_ULURU_DUMMY'),
			('POLICY_MARIANA_A_DUMMY', 		'TXT_KEY_POLICY_MARIANA_DUMMY'),
			('POLICY_MARIANA_B_DUMMY', 		'TXT_KEY_POLICY_MARIANA_DUMMY'),
			('POLICY_MARIANA_C_DUMMY', 		'TXT_KEY_POLICY_MARIANA_DUMMY'),
			('POLICY_DANXIA_A_DUMMY', 		'TXT_KEY_POLICY_DANXIA_DUMMY'),
			('POLICY_DANXIA_B_DUMMY', 		'TXT_KEY_POLICY_DANXIA_DUMMY');
...
VALUES		('TXT_KEY_POLICY_RETBA_DUMMY',			'Lake Retba'),
			...
			('TXT_KEY_POLICY_ULURU_DUMMY',			'Uluru'),
			('TXT_KEY_POLICY_MARIANA_DUMMY',		'Mariana Trench'),
			('TXT_KEY_POLICY_DANXIA_DUMMY',			'Zhangye Danxia');
...
VALUES 		('POLICY_MESA_DUMMY', 		'UNITCOMBAT_MOUNTED', 		20),
			...
			('POLICY_ULURU_DUMMY',		'UNITCOMBAT_DIPLOMACY',		20);
...
VALUES 		('POLICY_ZHANGJIAJIE_DUMMY', 	'YIELD_GOLDEN_AGE_POINTS', 	2),
			('POLICY_DANXIA_A_DUMMY', 		'YIELD_FAITH', 				2),
			('POLICY_DANXIA_B_DUMMY', 		'YIELD_FAITH', 				2);
...
VALUES 		('POLICY_DANXIA_A_DUMMY', 		'GREATPERSON_ARTIST', 		3),
			('POLICY_DANXIA_A_DUMMY', 		'GREATPERSON_SCIENTIST', 	3),
			('POLICY_DANXIA_B_DUMMY', 		'GREATPERSON_ARTIST', 		3),
			('POLICY_DANXIA_B_DUMMY', 		'GREATPERSON_SCIENTIST', 	3);

INSERT INTO Policy_UnitCombatFreeExperiences
			(PolicyType, 					UnitCombatType, 			FreeExperience)
VALUES 		('POLICY_MARIANA_A_DUMMY', 		'UNITCOMBAT_SUBMARINE', 	7),
	 		('POLICY_MARIANA_B_DUMMY', 		'UNITCOMBAT_SUBMARINE', 	7),
	 		('POLICY_MARIANA_C_DUMMY', 		'UNITCOMBAT_SUBMARINE', 	7);
