...
INSERT INTO COMMUNITY
		(Type,							Value)
VALUES	('JAR_VOLCANOES_MINDISTANCE',	12);  -- minimum tile distance between Volcanoes
--=======================================================================================================================
-- VP FIXES
--=======================================================================================================================
...
('FEATURE_JAR_VOLCANO',	'TXT_FEATURE_JAR_VOLCANO',	'TXT_FEATURE_JAR_VOLCANO_TEXT', 'ART_DEF_FEATURE_JAR_VOLCANO',		2,			60,			1,						1,			1,			1,		1,				1,		0,				'JAR_VOLCANO_ATLAS'),
('FEATURE_JAR_VOLCANO_P','TXT_FEATURE_JAR_VOLCANO',	null, 							'ART_DEF_FEATURE_JAR_VOLCANO_P',	2,			60,			1,						1,			1,			1,		1,				1,		0,				'JAR_VOLCANO_ATLAS');

ALTER TABLE Features ADD COLUMN 'IsVolcano' BOOLEAN DEFAULT 0;
UPDATE Features SET IsVolcano=1 WHERE Type IN ('FEATURE_JAR_VOLCANO','FEATURE_VOLCANO','FEATURE_FUJI','FEATURE_KILIMANJARO');
...
INSERT INTO Improvements
		(Type,						Description, 				ArtDefineTag,						Permanent, 	PortraitIndex, IconAtlas)
SELECT	'IMPROVEMENT_JAR_ERUPTION',	'TXT_FEATURE_JAR_VOLCANO',	'ART_DEF_IMPROVEMENT_JAR_ERUPTION',	1,			0,			'JAR_VOLCANO_ATLAS';
--======================================================================================================================
-- BUILDINGS
--======================================================================================================================
-- BuildingClasses
...
('ART_DEF_FEATURE_JAR_VOLCANO',			'Resource',		'Jar_Volcano'),
('ART_DEF_FEATURE_JAR_VOLCANO_P',			'Resource',		'Jar_Volcano_P'),
('ART_DEF_IMPROVEMENT_JAR_ERUPTION',	'Improvement',	'Jar_Eruption');
----------------------------------------------------------
-- ArtDefine_StrategicView
----------------------------------------------------------
INSERT INTO ArtDefine_StrategicView (StrategicViewType, TileType, Asset) VALUES
('ART_DEF_FEATURE_JAR_VOLCANO',			'Feature',	'SV_Krakatoa.dds');
----------------------------------------------------------
-- ArtDefine_Landmarks
----------------------------------------------------------
INSERT INTO ArtDefine_Landmarks
(Era, 	State, 	Scale,	ImprovementType,					LayoutHandler,	ResourceType,					Model,				TerrainContour) VALUES
('Any', 'Any',	0.75,	'ART_DEF_IMPROVEMENT_NONE',			'SNAPSHOT',		'ART_DEF_FEATURE_JAR_VOLCANO_P','feature_volcano_2.fxsxml',	1	),
('Any', 'Any',	1,		'ART_DEF_IMPROVEMENT_NONE',			'SNAPSHOT',		'ART_DEF_FEATURE_JAR_VOLCANO',	'Dormant.fxsxml',	1	),
('Any', 'Any',	1,		'ART_DEF_IMPROVEMENT_JAR_ERUPTION',	'SNAPSHOT',		'ART_DEF_RESOURCE_ALL',			'Eruption2.fxsxml',	1	);
--==========================================================================================================================
-- OBSIDIAN
--==========================================================================================================================
-- IconFontTextures
...
('TXT_KEY_BUILDING_OBSIDIAN_WORKS_HELP', 'Places 1 [ICON_RES_OBSIDIAN] Obsidian resource inside City range if possible.'),
...
('TXT_KEY_BUILDING_JAR_POMPEII_HELP', 'All Archaeologist Units get [COLOR_POSITIVE_TEXT]Pompeian Alacrity[ENDCOLOR] promotion.'),
...
('TXT_KEY_BUILDING_JAR_TONGARIRO_HELP', '+2 [ICON_PEACE] Faith, +2 [ICON_GOLDEN_AGE] Golden Age Points from Forests and Jungles across the empire. [NEWLINE]Can only be built in a City with a [COLOR_CYAN]Volcano[ENDCOLOR] nearby and, in addition, either a [COLOR_CYAN]Forest[ENDCOLOR] or [COLOR_CYAN]Jungle[ENDCOLOR] nearby.'),
