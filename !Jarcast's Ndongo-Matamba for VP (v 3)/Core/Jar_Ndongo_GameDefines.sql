...
FROM Policy_ImprovementYieldChanges WHERE ImprovementType IN ('IMPROVEMENT_TRADING_POST','IMPROVEMENT_MOAI');
--------------------------------------------------------------------------------------------------------------------------
...
FROM Belief_ImprovementYieldChanges WHERE ImprovementType IN ('IMPROVEMENT_TRADING_POST','IMPROVEMENT_MOAI');
--------------------------------------------------------------------------------------------------------------------------
...
FROM Building_ImprovementYieldChanges WHERE ImprovementType IN ('IMPROVEMENT_TRADING_POST');
--------------------------------------------------------------------------------------------------------------------------
...
INSERT INTO Building_ImprovementYieldChangesGlobal
		(BuildingType,	ImprovementType,			YieldType,	Yield) 
SELECT	BuildingType,	'IMPROVEMENT_JAR_KILOMBO',	YieldType,	Yield
FROM Building_ImprovementYieldChangesGlobal WHERE ImprovementType IN ('IMPROVEMENT_TRADING_POST');
--------------------------------------------------------------------------------------------------------------------------
-- SQL TRIGGERS
--------------------------------------------------------------------------------------------------------------------------
...
VALUES	('PROMOTION_UA_NDONGO',	'TXT_KEY_PROMOTION_UA_NDONGO',	 'TXT_KEY_PROMOTION_UA_NDONGO_HELP',	'AS2D_IF_LEVELUP',	0,				 0, 					1,				17, 'PROMOTION_ATLAS_VP_02', 	'PEDIA_ATTRIBUTES', 'TXT_KEY_PROMOTION_UA_NDONGO');
...
INSERT INTO Unit_FreePromotions
		(UnitType, 			PromotionType)
SELECT	'UNIT_JAR_MAKUNZE',	'PROMOTION_MILITARY_TRADITION' UNION ALL
...
UPDATE Leaders SET PrimaryVictoryPursuit = 'VICTORY_PURSUIT_DIPLOMACY'
