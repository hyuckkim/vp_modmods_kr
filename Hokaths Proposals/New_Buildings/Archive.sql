...
GreatWorkCount = 2,
UnlockedByBelief = 1,
GPPOnCitizenBirth = 10  -- was on china at 15
...
VALUES
	('BUILDING_CHARTARIUM', 'BUILDINGCLASS_ARCHIVE', 'YIELD_FAITH', 3);
...
SELECT
	'BUILDING_ARCHIVE', a.Type, 'YIELD_TOURISM', b.Type, 50
FROM GreatPersons a, Yields b WHERE
b.Type IN ('YIELD_SCIENCE', 'YIELD_CULTURE');
*/
