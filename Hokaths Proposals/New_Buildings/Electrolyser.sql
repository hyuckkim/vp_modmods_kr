...
VALUES
	('BUILDING_ELECTROLYSER',  'BUILDINGCLASS_AQUEDUCT',      'YIELD_GOLD', 4);
...
VALUES	
	...
	('TXT_KEY_BUILDING_ELECTROLYSER_HELP',  'The [COLOR_YELLOW]Farming[ENDCOLOR] Process is 20% more efficient at converting [ICON_PRODUCTION] Production into [ICON_FOOD] Food. +67% [ICON_GREAT_ENGINEER] Great Engineer Rate. All Aqueducts in the Empire boost [ICON_GOLD] Gold output by 4%, all Wells produce +5 [ICON_FOOD] Food, and all Watermills +5 [ICON_PRODUCTION] Production.[NEWLINE][NEWLINE]The City is a source of [COLOR_POSITIVE_TEXT]Fresh Water[ENDCOLOR].');
