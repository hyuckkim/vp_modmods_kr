...
VALUES
	('BUILDING_GEOLOGICAL_SURVEY',  'BUILDINGCLASS_COAL_PLANT',      'YIELD_SCIENCE', 1),
...
VALUES
	...
	('TXT_KEY_NEWSROOM_HELP', '+33% [ICON_GREAT_MERCHANT] Great Merchant Rate. +1 [ICON_TOURISM] Tourism to all owned Wire Services in the Empire.[NEWLINE][NEWLINE]+1 [ICON_RES_PAPER] Paper and 1 [ICON_GOLD] Gold for every 6 [ICON_CITIZEN] Citizens. Identifying a foreign [ICON_SPY] Spy in this City gain 50 [ICON_CULTURE] Culture, when you kill a foreign [ICON_SPY] Spy in this City gain 100 [ICON_CULTURE] Culture, and when you successfully [ICON_PUPPET] Rig an Election in a [ICON_CITY_STATE] City-State gain 20 [ICON_CULTURE] Culture, all scaling with Era. Gain 10 [ICON_CULTURE] Culture whenever you kill an Enemy Unit and 25 [ICON_CULTURE] Culture whenever an Owned Unit dies, both scaling with Era.[NEWLINE][NEWLINE]Requires an [ICON_INDUSTRIAL_CONNECTED] Industrial City Connection. City [COLOR_NEGATIVE_TEXT]cannot have[ENDCOLOR] a Geological Survey or a Switchyard.'),
