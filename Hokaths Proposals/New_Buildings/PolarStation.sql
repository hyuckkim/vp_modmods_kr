...
-- +5% [ICON_RESEARCH] Science in [COLOR_POSITIVE_TEXT]all Cities[ENDCOLOR]. +3 [ICON_RESEARCH] Science from all Snow tiles worked by the City. +1 [ICON_RESEARCH] Science from all Sea Tiles worked by this City.[NEWLINE][NEWLINE]City must be built on or next to Snow.