...
VALUES	('TXT_KEY_BUILDING_ARCADE',			'Arcade'),
		...
		('TXT_KEY_BUILDING_ARCADE_STRATEGY',	'The Arcade is the last line of defense against the Cultural Victory. The building accomplishes this in two ways. Firstly it produces Culture to fight foreign Tourism, and you can boost this by discovering more Technologies, which the Arcade helps toward. Secondly it removes Unhappiness due to Boredom, which would otherwise increase foreign Tourism by a percentage. Will you hold out long enough to win by other means, or will your people be wearing the blue jeans of the enemy?'),
		('TXT_KEY_BUILDING_ARCADE_HELP',		'Receive 35 [ICON_RESEARCH] Science when a new [ICON_CITIZEN] Citizen is born in the City, scaling with Era. Gain 100 [ICON_CULTURE] Culture when you unlock a new Tech, scaling with Era. +8 [ICON_GOLD] Gold, [ICON_RESEARCH] Science, and [ICON_CULTURE] Culture once [COLOR_CYAN]The Internet[ENDCOLOR] is discovered.[NEWLINE][NEWLINE]No [ICON_HAPPINESS_3] Unhappiness from [ICON_CULTURE] Boredom.');
