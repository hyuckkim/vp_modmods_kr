...
VALUES	('TXT_KEY_BUILDING_NET_CAFE', 'Net Café'),
		...
		('TXT_KEY_BUILDING_NET_CAFE_HELP', 'Receive 50 [ICON_RESEARCH] Science when you perform a Spy Mission, scaling with Era. +1 [COLOR_POSITIVE_TEXT]All Yields[ENDCOLOR] for every one of your [ICON_VP_FRANCHISE] Franchises in foreign Cities (up to your Franchise Limit).[NEWLINE][NEWLINE]No [ICON_HAPPINESS_3] Unhappiness from [ICON_CULTURE] Boredom.');
