...
--The [COLOR_YELLOW]Research[ENDCOLOR] Process is 20% more efficient at converting [ICON_PRODUCTION] Production into [ICON_RESEARCH] Science. +1 [ICON_PRODUCTION] Production and [ICON_RESEARCH] Science from every [ICON_SCIENTIST] Scientist in the Empire. +67% [ICON_GREAT_SCIENTIST] Great Scientist Rate.[NEWLINE][NEWLINE]Requires 1 [ICON_RES_ALUMINUM] Aluminum.
