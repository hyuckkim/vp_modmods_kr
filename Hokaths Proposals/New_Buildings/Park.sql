...
INSERT INTO Building_InstantYieldFromWLTKDStart
	(BuildingType, YieldType, Yield)
VALUES
	('BUILDING_PARK_IND', 'YIELD_GOLDEN_AGE_POINTS', 25);
*/
...
VALUES
	('BUILDING_PARK_IND', 'YIELD_CULTURE', 2, 20);
...
VALUES	
	...
	('TXT_KEY_BUILDING_PARK_IND_HELP', '');

-- Receive an instant boost of 25 [ICON_GOLDEN_AGE] Golden Age Points when [COLOR_POSITIVE_TEXT]"We Love the King Day"[ENDCOLOR] begins in the City, scaling with Era.
-- The City generates +25% [ICON_GOLDEN_AGE] Golden Age Points during [COLOR_POSITIVE_TEXT]"We Love the King Day"[ENDCOLOR]. Permanently generate an additional +2 [ICON_CULTURE] Culture each time a [ICON_GOLDEN_AGE] Golden Age begins. +2 [ICON_TOURISM] Tourism from Zoos, Hotels, and Museums in the City.[NEWLINE][NEWLINE]Nearby Lakes: +1 [ICON_FOOD] Food and [ICON_TOURISM] Tourism.[NEWLINE][NEWLINE]1 Specialist in this City no longer produces [ICON_HAPPINESS_3] Unhappiness from [ICON_URBANIZATION] Urbanization.
