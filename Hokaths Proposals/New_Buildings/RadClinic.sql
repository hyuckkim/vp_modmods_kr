...
VALUES	('TXT_KEY_BUILDING_RAD_CLINIC',			'Radiation Clinic'),
		...
		('TXT_KEY_BUILDING_RAD_CLINIC_HELP',		'');

-- When a [ICON_GREAT_PEOPLE] Great Person is born in the City, receive an instant boost of [ICON_FOOD] Food equal to 20% of the [ICON_RESEARCH] Science output of your Empire. +67% [ICON_DIPLOMAT] Great Diplomat Rate. 10% of [ICON_FOOD] Food is carried over when a [ICON_CITIZEN] Citizen is born in this City.[NEWLINE][NEWLINE][ICON_CITY_STATE]City-State [COLOR_POSITIVE_TEXT]Friend[ENDCOLOR] Bonus: +2 [ICON_TOURISM] Tourism each.[NEWLINE][ICON_CITY_STATE]City-State [COLOR_CYAN]Ally[ENDCOLOR] Bonus: +4 [ICON_GOLD] Gold and +2 [ICON_TOURISM] Tourism each.[NEWLINE][NEWLINE]The City no longer produces [ICON_HAPPINESS_3] Unhappiness from [ICON_URBANIZATION] Urbanization.[NEWLINE][NEWLINE]Requires 1 [ICON_RES_URANIUM] Uranium.
