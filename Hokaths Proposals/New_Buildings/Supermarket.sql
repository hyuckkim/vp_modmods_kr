--==================================================
--Change Grocer into Pharmacy -- Adapted from Pdan version
--==================================================
--------------------------------
-- Language_en_US
--------------------------------
...
INSERT INTO	Buildings
		(Type,						Description,						Civilopedia,							Strategy,									Help,									GoldMaintenance, 	Cost, HurryCostModifier, 	MinAreaSize, 	ConquestProb, 	BuildingClass, 					ArtDefineTag, 				PrereqTech, 			PortraitIndex, 	IconAtlas, RequiresIndustrialCityConnection)
VALUES	('BUILDING_SUPERMARKET',	'TXT_KEY_BUILDING_SUPERMARKET', 	'TXT_KEY_BUILDING_SUPERMARKET_TEXT',	'TXT_KEY_BUILDING_SUPERMARKET_STRATEGY',	'TXT_KEY_BUILDING_SUPERMARKET_HELP',	8, 				2250, -20, 					-1, 			66, 			'BUILDINGCLASS_SUPERMARKET', 	'ART_DEF_BUILDING_MARKET', 	'TECH_REFRIGERATION', 	41,				'BW_ATLAS_1', 1);
