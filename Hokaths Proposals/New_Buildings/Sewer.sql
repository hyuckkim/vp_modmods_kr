...
VALUES	('TXT_KEY_BUILDING_SEWER',			'Sewer'),
		...
		('TXT_KEY_BUILDING_SEWER_HELP',		'10% of [ICON_FOOD] Food is carried over, and 50% of the [ICON_FOOD] Food output of the City is added as an instant boost when a [ICON_CITIZEN] Citizen is born in this City.[NEWLINE][NEWLINE]Nearby Marshes: +2 [ICON_RESEARCH] Science.[NEWLINE]Nearby Lakes: +1 [ICON_FOOD] Food and [ICON_RESEARCH] Science.[NEWLINE]River Tiles: +1 [ICON_PRODUCTION] Production.[NEWLINE][NEWLINE]-1 [ICON_HAPPINESS_3] Unhappiness from [ICON_GOLD] Poverty.');
