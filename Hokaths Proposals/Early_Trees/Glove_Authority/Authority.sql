DELETE FROM Policy_YieldFromKills WHERE PolicyType IN (SELECT Type FROM Policies WHERE PolicyBranchType = 'POLICY_BRANCH_HONOR');
DELETE FROM Policy_YieldFromKills WHERE PolicyType = 'POLICY_HONOR';

UPDATE Policies SET CultureFromKills = 0 WHERE PolicyBranchType = 'POLICY_BRANCH_HONOR';
UPDATE Policies SET CultureFromKills = 0 WHERE Type = 'POLICY_HONOR';

DELETE FROM Policy_YieldFromMinorDemand;

INSERT INTO Policy_YieldFromMinorDemand
	(PolicyType, YieldType, Yield)
VALUES
	('POLICY_HONOR', 'YIELD_CULTURE', 25),
	('POLICY_HONOR', 'YIELD_SCIENCE', 25),
	('POLICY_WARRIOR_CODE', 'YIELD_PRODUCTION', 33),
	('POLICY_WARRIOR_CODE', 'YIELD_FOOD', 33);

UPDATE Policies SET AllCityFreeBuilding = 'BUILDINGCLASS_D_FOR_GLOVE_1' WHERE Type = 'POLICY_MILITARY_TRADITION';
UPDATE Policies SET AllCityFreeBuilding = 'BUILDINGCLASS_D_FOR_GLOVE_2' WHERE Type = 'POLICY_PROFESSIONAL_ARMY';
UPDATE Policies SET AllCityFreeBuilding = 'BUILDINGCLASS_D_FOR_GLOVE_3' WHERE Type = 'POLICY_WARRIOR_CODE';
UPDATE Policies SET AllCityFreeBuilding = 'BUILDINGCLASS_D_FOR_GLOVE_4' WHERE Type = 'POLICY_MILITARY_CASTE';
UPDATE Policies SET AllCityFreeBuilding = 'BUILDINGCLASS_D_FOR_GLOVE_5' WHERE Type = 'POLICY_DISCIPLINE';

--INSERT INTO Building_YieldFromUnitLevelUp
--	(BuildingType, YieldType, Yield)
--VALUES
--	('BUILDING_D_FOR_GLOVE_1', 'YIELD_CULTURE', 3),	
--	('BUILDING_D_FOR_GLOVE_1', 'YIELD_SCIENCE', 3),
--	('BUILDING_D_FOR_GLOVE_2', 'YIELD_CULTURE', 3),	
--	('BUILDING_D_FOR_GLOVE_2', 'YIELD_SCIENCE', 3),
--	('BUILDING_D_FOR_GLOVE_3', 'YIELD_CULTURE', 3),	
--	('BUILDING_D_FOR_GLOVE_3', 'YIELD_SCIENCE', 3),
--	('BUILDING_D_FOR_GLOVE_4', 'YIELD_CULTURE', 3),	
--	('BUILDING_D_FOR_GLOVE_4', 'YIELD_SCIENCE', 3),
--	('BUILDING_D_FOR_GLOVE_5', 'YIELD_CULTURE', 3),	
--	('BUILDING_D_FOR_GLOVE_5', 'YIELD_SCIENCE', 3);

INSERT INTO Building_YieldFromUnitProduction
	(BuildingType, YieldType, Yield)
VALUES
	('BUILDING_D_FOR_GLOVE_1', 'YIELD_CULTURE', 5),	
	('BUILDING_D_FOR_GLOVE_1', 'YIELD_SCIENCE', 5),
	('BUILDING_D_FOR_GLOVE_2', 'YIELD_CULTURE', 5),	
	('BUILDING_D_FOR_GLOVE_2', 'YIELD_SCIENCE', 5),
	('BUILDING_D_FOR_GLOVE_3', 'YIELD_CULTURE', 5),	
	('BUILDING_D_FOR_GLOVE_3', 'YIELD_SCIENCE', 5),
	('BUILDING_D_FOR_GLOVE_4', 'YIELD_CULTURE', 5),	
	('BUILDING_D_FOR_GLOVE_4', 'YIELD_SCIENCE', 5),
	('BUILDING_D_FOR_GLOVE_5', 'YIELD_CULTURE', 5),	
	('BUILDING_D_FOR_GLOVE_5', 'YIELD_SCIENCE', 5);

DELETE FROM Policy_YieldFromBorderGrowth WHERE PolicyType IN ('POLICY_HONOR_FINISHER', 'POLICY_DISCIPLINE');

INSERT INTO Policy_YieldFromBorderGrowth
	(PolicyType, YieldType, Yield)
VALUES
	('POLICY_DISCIPLINE', 'YIELD_PRODUCTION', 40),
	('POLICY_HONOR_FINISHER', 'YIELD_GOLD', 40);
