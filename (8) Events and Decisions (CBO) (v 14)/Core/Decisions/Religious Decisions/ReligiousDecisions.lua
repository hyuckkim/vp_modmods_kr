	...
	--=========================================================
		...
		--=========================================================
			...
			if bEnacted then
				...
				local iDelta1 = math.ceil((iCurrentEra * 5 + 35) * iCurrentEra * tReligionEvents_1[tBonuses[1]] * iUnity * iMod * iScale * 1.25)
				local iDelta2 = math.ceil((iCurrentEra * 5 + 35) * iCurrentEra * tReligionEvents_1[tBonuses[2]] * iUnity * iMod * iScale * 1.1)
	...
	function(pPlayer)
		...
		for i = 1,2 do
			...
			elseif iYield == GameInfo.Yields.YIELD_SCIENCE.ID then
				...
				pTeamTech:ChangeResearchProgress(iTech, iDelta, pPlayer:GetID())
			--Culture
