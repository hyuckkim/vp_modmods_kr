...
SELECT 'BUILDING_DECISIONS_PERSIASAVARAN', 'UNITCOMBAT_MOUNTED', 15;
...
VALUES		('POLICY_DECISIONS_GERMANGUILDLAWS', 			'BUILDINGCLASS_BANK',	 		100);
--==========================================================================================================================
...
SELECT		('UNITCLASS_DECISIONS_PERSIASAVARAN'), 		('UNIT_DECISIONS_PERSIASAVARAN'), 			('TECH_ARCHERY'),		Combat, Cost, 	FaithCost,	RequiresFaithPurchaseEnabled,	Moves, 	CombatClass, Domain, DefaultUnitAI, Description, Civilopedia, Strategy, Help, MilitarySupport, MilitaryProduction, Pillage, IgnoreBuildingDefense, AdvancedStartCost, CombatLimit, ('TECH_METALLURGY'), XPValueAttack, XPValueDefense, GoodyHutUpgradeUnitClass, UnitArtInfo, 	UnitFlagIconOffset, UnitFlagAtlas,	PortraitIndex, 	IconAtlas,	MoveRate
...
FROM Unit_ResourceQuantityRequirements WHERE (UnitType = 'UNIT_SONGHAI_MUSLIMCAVALRY');	
--==========================================================================================================================	
...
FROM UnitGameplay2DScripts WHERE (UnitType = 'UNIT_SONGHAI_MUSLIMCAVALRY');
--==========================================================================================================================	
-- Unit_AITypes
--==========================================================================================================================		
...
FROM Unit_AITypes WHERE (UnitType = 'UNIT_SONGHAI_MUSLIMCAVALRY');	
--==========================================================================================================================	
-- Unit_ClassUpgrades
--==========================================================================================================================	
...
FROM Unit_ClassUpgrades WHERE (UnitType = 'UNIT_SONGHAI_MUSLIMCAVALRY');	
--==========================================================================================================================	
-- Unit_Flavors
--==========================================================================================================================		
...
FROM Unit_Flavors WHERE (UnitType = 'UNIT_SONGHAI_MUSLIMCAVALRY');	
--==========================================================================================================================
-- Unit_FreePromotions
--==========================================================================================================================
...
FROM Unit_FreePromotions WHERE (UnitType = 'UNIT_SONGHAI_MUSLIMCAVALRY');
--==========================================================================================================================		
--==========================================================================================================================