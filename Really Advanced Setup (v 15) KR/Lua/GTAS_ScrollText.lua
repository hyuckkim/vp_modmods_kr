...
TerrainCivText = {
	...
	data = {
		...
		{ },
		{ sizeY = SUB_TITLE_HEIGHT, font = "TwCenMT22", text = "개수" },
...
FeatureCivText = {
	...
	defaults = ScrollTextDefaults;
	data = {
		{ sizeY = TITLE_HEIGHT, font = "TwCenMT24", text = ColorText(COLOR_GREEN, "플레이어 특징") },
		{ sizeY = SUB_TITLE_HEIGHT, font = "TwCenMT24", 
			text = ColorText(COLOR_LIGHT_BLUE, "이 목록을 사용하여 플레이어의 시작 위치를 기준으로 특징을 배치합니다.") },
		{ sizeY = LINE_HEIGHT, mode = MODE_LINE },
		{ text = "특징을 배치하는 순서는 세 단계로 이루어집니다." },
		{ text = "이 모드 외부에서 생성된 특징이 가장 먼저 배치됩니다." },
		{ text = "모든 플레이어 특징 목록(이 목록과 같은)에서 생성된 특징은 두 번째에 배치됩니다." },
		{ text = "지도 특징 목록(지도 보너스 패널에 있는)에서 생성된 특징은 세 번째에 배치됩니다." },
		{ },
		{ sizeY = SUB_TITLE_HEIGHT, font = "TwCenMT24", text = ColorText(COLOR_LIGHT_BLUE, "특징 제어") },
		{ sizeY = LINE_HEIGHT, mode = MODE_LINE },
		{ text = "아래에 있는 특징 제어를 사용하여 이 목록에 명령을 추가하세요." },
		{ text = "각 명령은 지도가 생성될 때 하나 이상의 특징을 배치하려고 시도합니다." },
		{ text = "각 명령을 입력할 때마다 지도를 만드는 데 필요한 총 시간이 늘어난다는 점을 기억하세요." },
		{ },
		{ sizeY = SUB_TITLE_HEIGHT, font = "TwCenMT22", text = "특징 메뉴" },
		{ text = "이 메뉴에는 지도에 추가할 수 있는 특징 목록이 포함되어 있습니다." },
		{ text = "이 메뉴를 사용하여 현재 특징을 선택하세요." },
		{ text = "현재 특징은 왼쪽 이미지에 나타납니다." },
		{ },
		{ sizeY = SUB_TITLE_HEIGHT, font = "TwCenMT22", text = "기존 특징 교체" },
		{ text = "일반적으로 새로운 특징은 이미 특징이 포함된 타일에 배치되지 않습니다." },
		{ text = "이 빈 칸을 선택하면 새 특징이 기존 특징을 대체합니다." },
		{ text = "이 설정을 사용하면 이전에 다른 명령으로 만든 특징을 덮어쓸 수 있습니다." },
		{ },
		{ sizeY = SUB_TITLE_HEIGHT, font = "TwCenMT22", text = "배치" },
		{ text = "이는 모드가 다음 지형 특징을 배치할 때 적합한 타일을 어떻게 검색할지 결정합니다." },
		{ text = "가까이를 선택하면 검색이 최소 거리에서 시작하여 최대 거리까지 진행됩니다." },
		{ text = "멀리를 선택하면 검색이 최대 거리에서 시작하여 최소 거리까지 진행됩니다." },
		{ text = "무작위를 선택하면 최소 거리와 최대 거리 사이에서 무작위 타일을 찾습니다." },
		{ text = "채우기를 선택하면 최소 거리와 최대 거리 사이에 가능한 한 많은 특징을 넣습니다." },
		{ },
		{ sizeY = SUB_TITLE_HEIGHT, font = "TwCenMT22", text = "개수" },
		{ text = "이는  (가능한 경우) 생성될 특징의 수입니다." },
		{ },
		{ sizeY = SUB_TITLE_HEIGHT, font = "TwCenMT22", text = "최소 거리" },
		{ text = "특징은 플레이어의 시작 위치로부터 이 거리보다 더 가깝게 배치되지 않습니다." },
		{ text = "최소 거리는 최대 거리보다 클 수 없습니다." },
		{ text = "이 슬라이더를 최대 거리 이상으로 옮기려고 하면 해당 슬라이더도 따라오게 됩니다." },
		{ },
		{ sizeY = SUB_TITLE_HEIGHT, font = "TwCenMT22", text = "최대 거리" },
		{ text = "특징은 플레이어의 시작 위치에서 이 거리보다 멀리 배치되지 않습니다." },
		{ text = "최대 거리는 최소 거리보다 작을 수 없습니다." },
		{ text = "이 슬라이더를 최소 거리 이상으로 옮기려고 하면 해당 슬라이더도 따라오게 됩니다." },
		{ },
		{ sizeY = SUB_TITLE_HEIGHT, font = "TwCenMT22", text = "목록에 추가" },
		...
		{ text = "이 목록에 명령이 추가되면 편집에 사용되는 여러 가지 제어가 생깁니다." },
		{ text = "목록에서 명령을 삭제하려면 작은 x 버튼을 클릭하세요." },
		{ text = "둥근 버튼을 클릭하여 명령 설정을 특징 제어로 복사합니다." },
		{ text = "업데이트 버튼을 클릭하면 특징 제어 설정이 해당 명령에 복사됩니다." },
		{ },
		{ sizeY = SUB_TITLE_HEIGHT, font = "TwCenMT22", text = "모든 플레이어에게 목록 복사" },
...
FeatureMapText = {
	...
	defaults = ScrollTextDefaults;
	data = {
		{ sizeY = TITLE_HEIGHT, font = "TwCenMT24", text = ColorText(COLOR_GREEN, "지도 특징") },
		{ sizeY = SUB_TITLE_HEIGHT, font = "TwCenMT24", text = "이 목록을 사용하면 전체 지도에 지형 특징을 무작위로 배치할 수 있습니다." },
		{ sizeY = LINE_HEIGHT, mode = MODE_LINE },
		{ text = "특징을 배치하는 순서는 세 단계로 이루어집니다." },
		{ text = "이 모드 외부에서 생성된 특징이 가장 먼저 배치됩니다." },
		{ text = "모든 플레이어 기능 목록(플레이어 보너스 패널에 있는)에서 생성된 기능은 두 번째에 배치됩니다." },
		{ text = "이 지도 특징 목록에서 생성된 특징은 세 번째에 배치됩니다." },
		{ },
		{ sizeY = SUB_TITLE_HEIGHT, font = "TwCenMT24", text = ColorText(COLOR_LIGHT_BLUE, "특징 제어") },
		{ sizeY = LINE_HEIGHT, mode = MODE_LINE },
		{ text = "아래에 있는 특징 제어을 사용하여 이 목록에 명령을 추가하세요." },
		{ text = "각 명령은 지도가 생성될 때 하나 이상의 특징을 배치하려고 시도합니다." },
		{ text = "각 명령을 입력할 때마다 지도를 만드는 데 필요한 총 시간이 늘어난다는 점을 기억하세요." },
		{ },
		{ sizeY = SUB_TITLE_HEIGHT, font = "TwCenMT22", text = "특징 메뉴" },
...
ResourceCivText = {
	...
	data = {
		...
		{ text = "일반적으로 자원 배치는 지형, 언덕, 특징에 의해 제한됩니다." },
...
NaturalWonderCivText = {
	...
	data = {
		...
		{ },
		{ sizeY = SUB_TITLE_HEIGHT, font = "TwCenMT22", text = "무작위 자원 추가" },
		{ text = '근처에 무작위 개수의 자원을 추가하여 자연경관을 "향상"시키는 데 사용할 수 있습니다.' },
