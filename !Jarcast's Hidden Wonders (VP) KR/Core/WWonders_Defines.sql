...
UPDATE Buildings SET
	...
	PrereqTech = (SELECT PrereqTech FROM Buildings WHERE Type='BUILDING_FORBIDDEN_PALACE'),
	MaxStartEra = (SELECT MaxStartEra FROM Buildings WHERE Type='BUILDING_FORBIDDEN_PALACE'),
	FreeBuildingThisCity = 'BUILDINGCLASS_ORDER', AlwaysHeal=10, ExtraCityHitPoints=100, ProhibitedCityTerrain ='TERRAIN_TUNDRA'
...
INSERT INTO Building_ClassesNeededInCity 
		(BuildingType,				BuildingClassType) 
SELECT	'BUILDING_HOSPITAL_STJOHN',	'BUILDINGCLASS_TEMPLE';
------------------------------------------------------------------------------------------------------------------------------------------
-- TLACHIHUALTEPETL
------------------------------------------------------------------------------------------------------------------------------------------
UPDATE Buildings SET
...
('BUILDING_JETAVANARAMAYA',		'YIELD_PRODUCTION',	2),
('BUILDING_JETAVANARAMAYA',		'YIELD_GOLDEN_AGE_POINTS',	2);
...
INSERT INTO Building_BuildingClassYieldChanges
		(BuildingType, 			BuildingClassType,		YieldType, YieldChange)
SELECT 	'BUILDING_PADUA_GARDEN', 'BUILDINGCLASS_GARDEN', 'YIELD_FOOD', 1 UNION ALL
SELECT 	'BUILDING_PADUA_GARDEN', 'BUILDINGCLASS_GARDEN', 'YIELD_SCIENCE', 1;
...
UPDATE Buildings SET
	...
	MaxStartEra = (SELECT MaxStartEra FROM Buildings WHERE Type='BUILDING_GLOBE_THEATER'),
	SpecialistType = 'SPECIALIST_CIVIL_SERVANT', SpecialistCount=1, Hill=1, FreeGreatPeople = 1
WHERE Type = 'BUILDING_CHAANGDEOKGUNG';

INSERT OR REPLACE INTO Building_YieldChanges
		(BuildingType, 				YieldType, 		Yield)
SELECT	'BUILDING_CHAANGDEOKGUNG', 	'YIELD_CULTURE', 	2 UNION ALL
SELECT	'BUILDING_CHAANGDEOKGUNG', 	'YIELD_SCIENCE', 	2;

INSERT INTO Building_SpecialistYieldChanges
		(BuildingType,				SpecialistType,				YieldType,				Yield) 
VALUES	('BUILDING_CHAANGDEOKGUNG',	'SPECIALIST_CIVIL_SERVANT',	'YIELD_PRODUCTION',			2),
		('BUILDING_CHAANGDEOKGUNG',	'SPECIALIST_CIVIL_SERVANT',	'YIELD_GOLDEN_AGE_POINTS',	2);
		
INSERT INTO Building_Flavors 	
		(BuildingType, 				FlavorType,			Flavor)
VALUES	('BUILDING_CHAANGDEOKGUNG',	'FLAVOR_GREAT_PEOPLE', 	45),
		('BUILDING_CHAANGDEOKGUNG',	'FLAVOR_HAPPINESS', 	35),
		('BUILDING_CHAANGDEOKGUNG',	'FLAVOR_DIPLOMACY', 	15);
------------------------------------------------------------------------------------------------------------------------------------------
-- HARMANDIR SAHIB
------------------------------------------------------------------------------------------------------------------------------------------
UPDATE Buildings SET
...
INSERT INTO Building_BuildingClassYieldChanges
		(BuildingType, 			BuildingClassType,			YieldType, YieldChange)
SELECT 	'BUILDING_DAMNOEN_SADUAK', 'BUILDINGCLASS_MARKET', 'YIELD_CULTURE', 1 UNION ALL
SELECT 	'BUILDING_DAMNOEN_SADUAK', 'BUILDINGCLASS_MARKET', 'YIELD_GOLD', 	1 UNION ALL
SELECT 	'BUILDING_DAMNOEN_SADUAK', 'BUILDINGCLASS_GROCER', 'YIELD_CULTURE', 1 UNION ALL
SELECT 	'BUILDING_DAMNOEN_SADUAK', 'BUILDINGCLASS_GROCER', 'YIELD_GOLD', 	1;
...
UPDATE Buildings SET
	...
	PrereqTech = 'TECH_RIFLING', MaxStartEra = 'ERA_MODERN',
...
INSERT INTO Building_ImprovementYieldChangesGlobal 
		(BuildingType,			ImprovementType,	YieldType,			Yield) 
VALUES	('BUILDING_LAFERRIERE',	'IMPROVEMENT_FORT',	'YIELD_PRODUCTION',	1),
		('BUILDING_LAFERRIERE',	'IMPROVEMENT_FORT',	'YIELD_FOOD',		1),
		('BUILDING_LAFERRIERE',	'IMPROVEMENT_FORT',	'YIELD_CULTURE',	1),
		('BUILDING_LAFERRIERE',	'IMPROVEMENT_CITADEL',	'YIELD_PRODUCTION',	1),
		('BUILDING_LAFERRIERE',	'IMPROVEMENT_CITADEL',	'YIELD_FOOD',		1),
		('BUILDING_LAFERRIERE',	'IMPROVEMENT_CITADEL',	'YIELD_CULTURE',	1),
		('BUILDING_LAFERRIERE',	'IMPROVEMENT_MONGOLIA_ORDO',	'YIELD_PRODUCTION',	1),
		('BUILDING_LAFERRIERE',	'IMPROVEMENT_MONGOLIA_ORDO',	'YIELD_FOOD',		1),
		('BUILDING_LAFERRIERE',	'IMPROVEMENT_MONGOLIA_ORDO',	'YIELD_CULTURE',	1),
		('BUILDING_LAFERRIERE',	'IMPROVEMENT_ZULU_KRAAL',	'YIELD_PRODUCTION',	1),
		('BUILDING_LAFERRIERE',	'IMPROVEMENT_ZULU_KRAAL',	'YIELD_FOOD',		1),
		('BUILDING_LAFERRIERE',	'IMPROVEMENT_ZULU_KRAAL',	'YIELD_CULTURE',	1),
		('BUILDING_LAFERRIERE',	'IMPROVEMENT_TOMATEKH_BENIN_IYA',	'YIELD_PRODUCTION',	1),
		('BUILDING_LAFERRIERE',	'IMPROVEMENT_TOMATEKH_BENIN_IYA',	'YIELD_FOOD',		1),
		('BUILDING_LAFERRIERE',	'IMPROVEMENT_TOMATEKH_BENIN_IYA',	'YIELD_CULTURE',	1),
		('BUILDING_LAFERRIERE',	'IMPROVEMENT_AINU_CASI',	'YIELD_PRODUCTION',	1),
		('BUILDING_LAFERRIERE',	'IMPROVEMENT_AINU_CASI',	'YIELD_FOOD',		1),
		('BUILDING_LAFERRIERE',	'IMPROVEMENT_AINU_CASI',	'YIELD_CULTURE',	1);
...
SELECT	'UNIT_ARCHAEOLOGIST_CM','UNITCLASS_ARCHAEOLOGIST_CM',	0,			 Moves+1,	Cost, FaithCost, RequiresFaithPurchaseEnabled, Description, Civilopedia, Strategy, Help, 1,				 	BaseSightRange, Capture, CombatClass, Domain, CivilianAttackPriority, DefaultUnitAI, PrereqTech, 0,					WorkRate, UnitArtInfo, UnitArtInfoEraVariation, MoveRate, UnitFlagIconOffset, PortraitIndex, IconAtlas, UnitFlagAtlas, MaxHitPoints, PurchaseCooldown
