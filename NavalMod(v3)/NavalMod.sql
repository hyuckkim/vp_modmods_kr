...
('NAVALMOD_UNIT_FLAG_ATLAS',32,'Enlightenment_UnitFlags_32.dds',4,3),
('NAVALMOD_UNIT_ATLAS',256,'Enlightenment_Units_256.dds',4,3),
('NAVALMOD_UNIT_ATLAS',128,'Enlightenment_Units_128.dds',4,3),
('NAVALMOD_UNIT_ATLAS',80,'Enlightenment_Units_80.dds',4,3),
('NAVALMOD_UNIT_ATLAS',64,'Enlightenment_Units_64.dds',4,3),
('NAVALMOD_UNIT_ATLAS',45,'Enlightenment_Units_45.dds',4,3),
('naval_promoAtlas', 256, 'VPEE_promo_icons_256.dds', 8, 1),
('naval_promoAtlas', 064, 'VPEE_promo_icons_064.dds', 8, 1),
('naval_promoAtlas', 045, 'VPEE_promo_icons_045.dds', 8, 1),
('naval_promoAtlas', 032, 'VPEE_promo_icons_032.dds', 8, 1),
('naval_promoAtlas', 016, 'VPEE_promo_icons_016.dds', 8, 1),
...
VALUES
	('PROMOTION_ONLY_MELEE', 'TXT_KEY_PROMOTION_ONLY_MELEE', 'TXT_KEY_PROMOTION_ONLY_MELEE_HELP', 'AS2D_IF_LEVELUP', 1, 1, 34, 'promoVP_atlas_01', 'PEDIA_ATTRIBUTES', 'TXT_KEY_PROMOTION_ONLY_MELEE', NULL, 0, 9999, 9999),
	...
	('PROMOTION_HEAVY_SHIP_MOD', 'TXT_KEY_PROMOTION_HEAVY_SHIP_MOD', 'TXT_KEY_PROMOTION_HEAVY_SHIP_MOD_HELP', 'AS2D_IF_LEVELUP', 1, 1, 2, 'naval_promoAtlas', 'PEDIA_ATTRIBUTES', 'TXT_KEY_PROMOTION_HEAVY_SHIP_MOD', NULL, 0, 827, 827),
...
UPDATE UnitPromotions SET PlagueIDImmunity = 1 WHERE Type = 'PROMOTION_HEAVY_SHIP_MOD';	
   
INSERT INTO UnitPromotions_Terrains
	(PromotionType, TerrainType, HalfMove)
VALUES
    ('PROMOTION_HEAVY_SHIP_MOD', 'TERRAIN_COAST', 1);  

UPDATE UnitPromotions SET MaxHitPointsChange = 20 WHERE Type = 'PROMOTION_HEAVY_SHIP_MOD';

INSERT INTO UnitPromotions_UnitClasses
	(PromotionType, UnitClassType, Attack)
SELECT DISTINCT
	'PROMOTION_HEAVY_FIRE', Class, 50
FROM Units
...
UPDATE UnitPromotions SET PromotionPrereqOr1 = 'PROMOTION_COASTAL_RAIDER_3' WHERE Type = 'PROMOTION_BATTLECRUISER';	
...
UPDATE UnitPromotions SET PromotionPrereqOr1 = 'PROMOTION_HEAVY_SHIP_MOD' WHERE Type = 'PROMOTION_COASTAL_RAIDER_1' OR Type = 'PROMOTION_NAVAL_ARTL_I';
UPDATE UnitPromotions SET PromotionPrereqOr2 = 'PROMOTION_ONLY_MELEE' WHERE Type = 'PROMOTION_COASTAL_RAIDER_1';
...
INSERT INTO Unit_FreePromotions
	(UnitType, PromotionType)
VALUES
    ('UNIT_BB_SHIP_OF_THE_LINE', 'PROMOTION_HEAVY_SHIP_MOD'),
...
VALUES
	...
	('UNIT_ENGLISH_SHIPOFTHELINE', 'PROMOTION_HEAVY_SHIP_MOD');
...
VALUES
    ...
    ('UNIT_BB_IRONCLAD', 'PROMOTION_HEAVY_SHIP_MOD'),
...
VALUES
	...
	('UNIT_BB_DREADNOUGHT', 'PROMOTION_HEAVY_SHIP_MOD'),
...
VALUES
	...
	('UNIT_BB_BATTLESHIP', 'PROMOTION_HEAVY_SHIP_MOD'),
...
--VALUES
--	('PROMOTION_INTERCEPTION_I', 'UNITCOMBAT_NAVALRANGED'),
--	('PROMOTION_INTERCEPTION_II', 'UNITCOMBAT_NAVALRANGED'),
--	('PROMOTION_INTERCEPTION_III', 'UNITCOMBAT_NAVALRANGED'),
--    ('PROMOTION_INTERCEPTION_IV', 'UNITCOMBAT_NAVALRANGED');	
	
--UPDATE Units SET AirInterceptRange = 2 WHERE Type = 'UNIT_MISSILE_DESTROYER';	
--UPDATE Units SET AirInterceptRange = 0 WHERE Type = 'UNIT_DESTROYER';
--UPDATE Units SET AirInterceptRange = 2 WHERE Type = 'UNIT_BATTLESHIP';

--UPDATE Units SET BaseLandAirDefense = 10 WHERE Type = 'UNIT_EARLY_DESTROYER';	
--UPDATE Units SET BaseLandAirDefense = 15 WHERE Type = 'UNIT_DESTROYER';
--UPDATE Units SET BaseLandAirDefense = 20 WHERE Type = 'UNIT_MISSILE_DESTROYER';

--UPDATE Units SET BaseLandAirDefense = 15 WHERE Type = 'UNIT_DREADNOUGHT';	
...
--DELETE FROM Unit_FreePromotions WHERE UnitType = 'UNIT_DESTROYER' AND PromotionType = 'PROMOTION_INTERCEPTION_I';
--DELETE FROM Unit_FreePromotions WHERE UnitType = 'UNIT_MISSILE_DESTROYER' AND PromotionType = 'PROMOTION_INTERCEPTION_I';
--DELETE FROM Unit_FreePromotions WHERE UnitType = 'UNIT_MISSILE_DESTROYER' AND PromotionType = 'PROMOTION_INTERCEPTION_II';

--INSERT INTO Unit_FreePromotions
--	(UnitType, PromotionType)
--VALUES
--    ('UNIT_BATTLESHIP', 'PROMOTION_INTERCEPTION_I'), 
...
UPDATE Units SET Combat = 35, RangedCombat = 40 WHERE Type = 'UNIT_BB_SHIP_OF_THE_LINE'; --25/35
UPDATE Units SET Combat = 40, RangedCombat = 45 WHERE Type = 'UNIT_ENGLISH_SHIPOFTHELINE'; --28/38
UPDATE Units SET Combat = 50, RangedCombat = 60 WHERE Type = 'UNIT_BB_IRONCLAD'; --40/55
UPDATE Units SET Combat = 60, RangedCombat = 70 WHERE Type = 'UNIT_BB_DREADNOUGHT';--50/65
UPDATE Units SET Combat = 70, RangedCombat = 80 WHERE Type = 'UNIT_BB_BATTLESHIP';--60/75
UPDATE Units SET Combat = 75, RangedCombat = 80 WHERE Type = 'UNIT_MISSILE_CRUISER';--75/80

DELETE FROM UnitPromotions_UnitClasses WHERE PromotionType = 'PROMOTION_HEAVY_FIRE';
...
UPDATE Language_en_US SET Text = 'Bonus vs Naval Melee Units (33)' WHERE Tag = 'TXT_KEY_PROMOTION_HEAVY_FIRE';
UPDATE Language_en_US SET Text = '+33% [ICON_STRENGTH] Combat Strength VS [COLOR_POSITIVE_TEXT]Naval Melee[ENDCOLOR] Units.' WHERE Tag = 'TXT_KEY_PROMOTION_HEAVY_FIRE_HELP';
