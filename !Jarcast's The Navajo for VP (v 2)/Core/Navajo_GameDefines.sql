...
UPDATE UnitPromotions SET FreePillageMoves=1, GainsXPFromPillaging = 1 WHERE Type = 'PROMOTION_NAABAAHII';
...
'[ICON_VP_ARTIST] 도시에 있는 예술가 전문가가 +2 [ICON_PRODUCTION] 생산, [ICON_GOLD] 골드, 그리고 [ICON_PEACE] 신앙을 생성합니다. [NEWLINE][ICON_RES_JAR_DIYOGI] 디요기 사치 자원 1개를 제공합니다. [NEWLINE]인접한 [ICON_RES_SHEEP] 양: +2 [ICON_GOLD] 골드. [NEWLINE][NEWLINE]'||Text
FROM Language_en_US WHERE Tag='TXT_KEY_BUILDING_WORKSHOP_HELP';

UPDATE Language_en_US SET Text = REPLACE(Text, '+1 [ICON_PRODUCTION] Production from Forests worked by this City', '이 도시가 작업하는 평원 및 사막 타일에 +1 [ICON_PRODUCTION] 생산')
WHERE Tag = 'TXT_KEY_BUILDING_ATLOOH_HELP';

UPDATE Language_en_US SET Text = REPLACE(Text, '+1 [ICON_PRODUCTION] Production for every 4 [ICON_CITIZEN] Citizens in the City', '도시의 시민 4명당 +1 [ICON_PRODUCTION] 생산, +1 [ICON_CULTURE] 문화')
WHERE Tag = 'TXT_KEY_BUILDING_ATLOOH_HELP';
--==========================================================================================================================
--==========================================================================================================================